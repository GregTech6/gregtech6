...
public class Textures {
	public enum BlockIcons implements IIconContainer, Runnable {
		...
		, GRASSBLOCK_TOP_MEDIUM , GRASSBLOCK_TOP_LIGHT , GRASSBLOCK_TOP_DARK , GRASSBLOCK_TOP_NORMAL , GRASSBLOCK_TOP_YELLOW , GRASSBLOCK_TOP_BROWN
		, GRASSBLOCK_SIDE_MEDIUM, GRASSBLOCK_SIDE_LIGHT, GRASSBLOCK_SIDE_DARK, GRASSBLOCK_SIDE_NORMAL, GRASSBLOCK_SIDE_YELLOW, GRASSBLOCK_SIDE_BROWN
		...
		GRASSES_TOP = {
			...
			GRASSBLOCK_TOP_YELLOW,
			GRASSBLOCK_TOP_BROWN,
			GRASSBLOCK_TOP_DARK,
			GRASSBLOCK_TOP_DARK,
			GRASSBLOCK_TOP_DARK,
			GRASSBLOCK_TOP_DARK,
		...
		GRASSES_SIDE = {
			...
			GRASSBLOCK_SIDE_YELLOW,
			GRASSBLOCK_SIDE_BROWN,
			GRASSBLOCK_SIDE_DARK,
			GRASSBLOCK_SIDE_DARK,
			GRASSBLOCK_SIDE_DARK,
			GRASSBLOCK_SIDE_DARK,
