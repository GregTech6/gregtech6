...
public class Textures {
	public enum BlockIcons implements IIconContainer, Runnable {
		...
		, ORE_SULFUR, ORE_APATITE, ORE_RUBY, ORE_AMBER, ORE_GALENA, ORE_TETRAHEDRITE, ORE_CASSITERITE, ORE_SHELDONITE, ORE_PENTLANDITE, ORE_SCHEELITE, ORE_RUTILE, ORE_BASTNASITE, ORE_GRAPHITE, ORE_PITCHBLENDE, ORE_FLUORITE, ORE_BORAX
		;
