...
public class MT {
	...
	Ta4HfC5                 = alloymachine  ( 8802, "Tantalum Hafnium Carbide", SET_METALLIC        , 153, 153,   0, 255)                                                                                                                                               .uumMcfg( 0, Ta             , 4*U, Hf               , 1*U, C                , 5*U)                                                                          .aspects(TC.METALLUM, 2, TC.GELUM, 2).heat(4263).alloyCentrifuge(),
