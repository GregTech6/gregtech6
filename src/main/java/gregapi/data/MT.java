...
//  HexoriumRainbow         = hexorium      ( 9242, 224, 224, 224, DYE_INDEX_White    ),
	...
	Orichalcum              = alloymachore  ( 8769, "Orichalcum"                                    ,  84, 122,  56     , MAGICAL, MOLTEN, WASHING_MERCURY, VALUABLE, CENTRIFUGE)                                                                                   .setAloy( 4, Cu             , 3*U, Zn               , 1*U, Ma               , 2*U)                                                                          .aspects(TC.METALLUM, 2, TC.PERMUTATIO      , 2, TC.PRAECANTIO  , 1).qual(3,  4.5, 3456, 3).heat(Cu),
