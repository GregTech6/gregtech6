...
public class MT {
	...
	Bbu     = unknown( 2210,  575),
	Ad      = element( 2220, "Adamantium"            , "Ad"      , 222, 580, 5425, 14528, 13.35624762, SET_SHINY, 255, 255, 255, 255).put(G_INGOT_MACHINE_ORES, UUM, SMITHABLE, MELTING, EXTRUDER, MAGICAL, MAGNETIC_PASSIVE, WITHER_PROOF, ENDER_DRAGON_PROOF, "Adamant", "Bibibium").aspects(TC.METALLUM, 10, TC.PRAECANTIO, 10).qual(3, 10.0, 5120, 5), Bbb = Ad,
	...
	Graphene                = dcmp          ( 9175, "Graphene"              , SET_DULL              , 128, 128, 128, 255).put(G_MACHINE, BLACKLISTED_SMELTER, MORTAR, STICKS)                                                                                           .uumMcfg( 0, C              , 1*U)                                                                                                                          .qual(3,  6.0,   32,  1).setSmelting(C, U2).setPulver(C, U).setBurning(Ash, U4).heat(4300, 4400),
