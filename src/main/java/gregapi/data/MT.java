...
public class MT {
	...
	Graphene                = dcmp          ( 9175, "Graphene"              , SET_DULL              , 128, 128, 128, 255).put(G_MACHINE, BLACKLISTED_SMELTER, MORTAR, STICKS)                                                                                           .uumMcfg( 0, C              , 1*U)                                                                                                                          .setSmelting(C, U2).setPulver(C, U).setBurning(Ash, U4).heat(4300, 4400),
	...
	Anthracite              = coal          ( 8362, "Anthracite"            , SET_LIGNITE           ,  90,  90,  90, 255).put(TICKS_PER_SMELT*24).setBurning(DarkAsh, U2)                                                                                               .uumMcfg( 1, C              , 4*U)                                                                                                                          .aspects(TC.POTENTIA, 3, TC.IGNIS, 3),
	...
	Steel                   = alloymachore  ( 8630, "Steel"                 , SET_METALLIC          , 130, 130, 130, 255).put(MOLTEN, RAILS, MORTAR, MAGNETIC_PASSIVE).qual(3,  6.0,  512, 2)                                                                           .uumMcfg( 0, WroughtIron    , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.ORDO, 1).setRGBaLiquid(220, 80, 40, 255),
...
//          Al                      .addAlloyingRecipe(new OreDictConfigurationComponent( 1, OM.stack(OREMATS.Bauxite               , 2*U), OM.stack(K                  , 1*U)));
			...
			String tMakeSteel =
			  "In order to make Steel you just need to melt Iron or Wrought Iron in a Smelting Crucible and give some Carbon (1 per 50 Iron) or Graphite (1 per 25 Iron) to it.";
