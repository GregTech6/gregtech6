...
public class MT {
	...
	Hg      = precmetal   ( 800, "Mercury"        , "Hg"    ,  80, 120,   234,   629, 13.5336    , SET_SHINY   , 230, 220, 220     , UUM        , ZINC_GROUP                           , "Quicksilver", "QuickSilver", PULVERIZING_CINNABAR                        ).aspects(TC.METALLUM, 1, TC.AQUA, 1, TC.VENENUM, 1      ),
	...
	*/
	...
	Aerotheum               = dust          ( 8246, "Aerotheum"             , SET_SHINY             , 200, 176,  83, 255, CONTAINERS, MELTING, MORTAR)                                                                                                              .setMcfg(18, Sand           , 9*U, KNO3             , 9*U, Redstone         , 9*U, Blitz            , 1*U)                                                  .aspects(TC.PRAECANTIO, 2, TC.AER, 1).heat(299, 300),
	Pyrotheum               = mixdust       ( 8212, "Pyrotheum"             , SET_FIERY             , 255, 200, 120, 255, CONTAINERS, MELTING, MORTAR)                                                                                                              .setMcfg(18, Coal           , 9*U, S                , 9*U, Redstone         , 9*U, Blaze            , 1*U)                                                  .aspects(TC.PRAECANTIO, 2, TC.IGNIS, 1).heat(3800, 6400),
	Cryotheum               = dust          ( 8213, "Cryotheum"             , SET_SHINY             , 200, 220, 255, 255, CONTAINERS, MELTING, MORTAR)                                                                                                              .setMcfg(18, Snow           , 2*U, KNO3             , 9*U, Redstone         , 9*U, Blizz            , 1*U)                                                  .aspects(TC.PRAECANTIO, 2, TC.GELUM, 1).heat(40, 1000),
...
//      CassiteriteSand         = oredustelec   ( 9109, "Cassiterite Sand"          , SET_SAND              , 220, 220, 220, 255, MORTAR, FURNACE                                                           ).setSmelting(Sn, 3*U4)     .uumMcfg( 1, Sn             , 1*U, O                , 2*U)                                                                                                  .heat(3 * Sn.mMeltingPoint / 2),
		...
		Cinnabar                = oredustcent   ( 9114, "Cinnabar"                  , SET_ROUGH             , 150,   0,   0, 255, MORTAR, FURNACE, PULVERIZING_CINNABAR                                     ).setSmelting(Hg,   U3)     .uumMcfg( 0, Hg             , 1*U, S                , 1*U)                                                                                                  ,
