...
public class MT {
	...
	protected static OreDictMaterial metalore     (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             , Object... aRandomData)  {return metal           (aID, aNameOreDict, aSets           , aR, aG, aB    , aRandomData).put(G_INGOT_ORES);}
	protected static OreDictMaterial metalmachine (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             , Object... aRandomData)  {return metal           (aID, aNameOreDict, aSets           , aR, aG, aB    , aRandomData).put(G_INGOT_MACHINE);}
	protected static OreDictMaterial metalmachore (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             , Object... aRandomData)  {return metalmachine    (aID, aNameOreDict, aSets           , aR, aG, aB    , aRandomData).put(G_INGOT_MACHINE_ORES);}
	...
	protected static OreDictMaterial metalore     (int aID, String aNameOreDict                    , long aR, long aG, long aB             , Object... aRandomData)  {return metal           (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB    , aRandomData).put(G_INGOT_ORES);}
	protected static OreDictMaterial metalmachine (int aID, String aNameOreDict                    , long aR, long aG, long aB             , Object... aRandomData)  {return metal           (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB    , aRandomData).put(G_INGOT_MACHINE);}
	protected static OreDictMaterial metalmachore (int aID, String aNameOreDict                    , long aR, long aG, long aB             , Object... aRandomData)  {return metalmachine    (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB    , aRandomData).put(G_INGOT_MACHINE_ORES);}
	...
	protected static OreDictMaterial setalore     (int aID, String aNameOreDict                    , long aR, long aG, long aB             , Object... aRandomData)  {return metal           (aID, aNameOreDict, SET_SHINY       , aR, aG, aB    , aRandomData).put(G_INGOT_ORES);}
	protected static OreDictMaterial setalmachine (int aID, String aNameOreDict                    , long aR, long aG, long aB             , Object... aRandomData)  {return metal           (aID, aNameOreDict, SET_SHINY       , aR, aG, aB    , aRandomData).put(G_INGOT_MACHINE);}
	protected static OreDictMaterial setalmachore (int aID, String aNameOreDict                    , long aR, long aG, long aB             , Object... aRandomData)  {return metalmachine    (aID, aNameOreDict, SET_SHINY       , aR, aG, aB    , aRandomData).put(G_INGOT_MACHINE_ORES);}
	protected static OreDictMaterial alloy        (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             , Object... aRandomData)  {return metal           (aID, aNameOreDict, aSets           , aR, aG, aB    , aRandomData).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloyore     (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             , Object... aRandomData)  {return metalore        (aID, aNameOreDict, aSets           , aR, aG, aB    , aRandomData).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloymachine (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             , Object... aRandomData)  {return metalmachine    (aID, aNameOreDict, aSets           , aR, aG, aB    , aRandomData).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloymachore (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             , Object... aRandomData)  {return metalmachore    (aID, aNameOreDict, aSets           , aR, aG, aB    , aRandomData).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloy        (int aID, String aNameOreDict                    , long aR, long aG, long aB             , Object... aRandomData)  {return metal           (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB    , aRandomData).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloyore     (int aID, String aNameOreDict                    , long aR, long aG, long aB             , Object... aRandomData)  {return metalore        (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB    , aRandomData).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloymachine (int aID, String aNameOreDict                    , long aR, long aG, long aB             , Object... aRandomData)  {return metalmachine    (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB    , aRandomData).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloymachore (int aID, String aNameOreDict                    , long aR, long aG, long aB             , Object... aRandomData)  {return metalmachore    (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB    , aRandomData).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial slloy        (int aID, String aNameOreDict                    , long aR, long aG, long aB             , Object... aRandomData)  {return metal           (aID, aNameOreDict, SET_SHINY       , aR, aG, aB    , aRandomData).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial slloyore     (int aID, String aNameOreDict                    , long aR, long aG, long aB             , Object... aRandomData)  {return metalore        (aID, aNameOreDict, SET_SHINY       , aR, aG, aB    , aRandomData).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial slloymachine (int aID, String aNameOreDict                    , long aR, long aG, long aB             , Object... aRandomData)  {return metalmachine    (aID, aNameOreDict, SET_SHINY       , aR, aG, aB    , aRandomData).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial slloymachore (int aID, String aNameOreDict                    , long aR, long aG, long aB             , Object... aRandomData)  {return metalmachore    (aID, aNameOreDict, SET_SHINY       , aR, aG, aB    , aRandomData).put(ALLOY, DECOMPOSABLE);}
	...
	protected static OreDictMaterial metalmachnd  (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             , Object... aRandomData)  {return metalnd         (aID, aNameOreDict, aSets           , aR, aG, aB    , aRandomData).put(G_INGOT_ND_MACHINE);}
	protected static OreDictMaterial alloynd      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             , Object... aRandomData)  {return metalnd         (aID, aNameOreDict, aSets           , aR, aG, aB    , aRandomData).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloymachnd  (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             , Object... aRandomData)  {return metalmachnd     (aID, aNameOreDict, aSets           , aR, aG, aB    , aRandomData).put(ALLOY, DECOMPOSABLE);}
...
//  HexoriumRainbow         = hexorium      ( 9242, 224, 224, 224, DYE_INDEX_White    ),
	...
	Deadrock                = stone         ( 8523, "Deadrock"                                      , 153, 153, 168, 255)                                                                                                                                                                                                                                                                                                       .aspects(TC.MORTUUS     , 1).qual(1, 5.0,128, 2).heat(1800),
