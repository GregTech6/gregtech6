...
public class MT {
	...
	*/
	...
	VibraniumSteel          = slloymachine  ( 8704, "Vibranium Steel"                               ,  40,  24,  50, 255).put(CENTRIFUGE, MAGNETIC_PASSIVE).qual(3,   50.0, 2048, 10)                                                                                   .setMcfg( 0, Vb             , 1*U, Steel            , 3*U)                                                                                                  .aspects(TC.SENSUS, 1, TC.VITREUS, 1, TC.METALLUM, 1).visDefault(Vb),
	VibraniumSilver         = slloy         ( 8705, "Vibranium Silver"                              , 240, 240, 255, 255).put(CENTRIFUGE, ENDER_DRAGON_PROOF).qual(3,  100.0,  512,  9)                                                                                 .setMcfg( 0, Vb             , 1*U, Ag               , 3*U)                                                                                                  .aspects(TC.SENSUS, 1, TC.VITREUS, 1, TC.LUCRUM, 1).visDefault(Vb),
	Vibramantium            = slloymachine  ( 8706, "Vibramantium"                                  , 250, 250, 250, 255).put(CENTRIFUGE, MAGNETIC_PASSIVE).qual(3, 1000.0, 5120, 15)                                                                                   .setMcfg( 0, Vb             , 1*U, Ad               , 3*U)                                                                                                  .aspects(TC.SENSUS, 1, TC.VITREUS, 1, TC.PRAECANTIO, 1, TC.METALLUM, 1).visDefault(Vb),
...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60, 255).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                      ,
	...
	Manasteel               = slloymachine  ( 8720, "Manasteel"                                     , 110, 200, 250, 255).put(MAGICAL).qual(3, 12.0, 256, 3)                                                                                                                                                                                                                                                                        .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 2).heat(Fe.mMeltingPoint+500, Fe.mBoilingPoint+1000),
	Terrasteel              = slloymachine  ( 8721, "Terrasteel"                                    , 110, 200,  50, 255).put(MAGICAL).qual(3, 16.0,2048, 4)                                                                                                                                                                                                                                                                        .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 2).heat(Fe.mMeltingPoint+750, Fe.mBoilingPoint+1500),
	ElvenElementium         = slloymachore  ( 8722, "Elven Elementium"                              , 250, 120, 250, 255).put(MAGICAL).qual(3, 14.0, 512, 3)                                                                                                                                                                                                                                                                        .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 2).heat(Fe.mMeltingPoint+1000, Fe.mBoilingPoint+2000).setLocal("Elementium"),
