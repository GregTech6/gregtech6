...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60     ).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                  ,
	RefinedGlowstone        = alloynd       ( 8713, "GlowstoneRefined"      , SET_REDSTONE          , 255, 240, 100     , "RefinedGlowstone", GLOWING).setLocal("Refined Glowstone").qual(2, 8.0, 256, 2)                                                           .setMcfg( 1, Glowstone      , 1*U, Ge               , 1*U)                                                                                                  .aspects(TC.METALLUM, 4, TC.LUX, 4).setAllToTheOutputOf(Glowstone),
	RefinedObsidian         = alloy         ( 8714, "ObsidianRefined"       , SET_REDSTONE          , 120,  90, 140     , "RefinedObsidian").setLocal("Refined Obsidian").qual(2, 8.0, 512, 3)                                                                      .setMcfg( 1, Obsidian       , 1*U, Diamond          , 1*U)                                                                                                  .aspects(TC.VITREUS, 4, TC.IGNIS, 4).setAllToTheOutputOf(Obsidian),
