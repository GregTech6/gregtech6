...
public class MT {
	...
	Pb      = posttrans     (  820, "Lead"                  , "Pb"      ,  82, 125,   600,  2022, 11.342     , SET_DULL             , 100,  60, 110, 255).put(  G_INGOT_MACHINE_ORES        , UUM, CRYSTALLOGEN           ).aspects(TC.METALLUM, 2, TC.ORDO, 1                     ).qual(2,  8.0, 64, 1).put(SOLDERING_MATERIAL, SOLDERING_MATERIAL_BAD, MOLTEN, MD.TE),
