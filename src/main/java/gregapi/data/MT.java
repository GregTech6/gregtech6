...
public class MT {
	...
	protected static OreDictMaterial create       (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA) {return create(aID, aNameOreDict, aSets).setRGBa(aR, aG, aB, aA).put(aR==256?UNUSED_MATERIAL:null).hide(aR==256);}
	...
	protected static OreDictMaterial element      (int aID, String aNameOreDict, String aSymbol, long aProtonsAndElectrons, long aNeutrons, long aMeltingPoint, long aBoilingPoint, double aGramPerCubicCentimeter, TextureSet[] aSets)   {return create      (aID, aNameOreDict, aSets, 256, 256, 256, 255).setStats(aProtonsAndElectrons, aNeutrons, aMeltingPoint, aBoilingPoint, aGramPerCubicCentimeter).put(ELEMENT).setTooltip(aSymbol);}
	protected static OreDictMaterial unknown      (int aID, String aNameOreDict, String aSymbol, long aProtonsAndElectrons, long aNeutrons                                                                                            )   {return element     (aID, aNameOreDict, aSymbol, aProtonsAndElectrons, aNeutrons, 1000, 3000, 0, SET_SHINY).hide().aspects(TC.RADIO, 1);}
	protected static OreDictMaterial metalloid    (int aID, String aNameOreDict, String aSymbol, long aProtonsAndElectrons, long aNeutrons, long aMeltingPoint, long aBoilingPoint, double aGramPerCubicCentimeter, TextureSet[] aSets)   {return element     (aID, aNameOreDict, aSymbol, aProtonsAndElectrons, aNeutrons, aMeltingPoint, aBoilingPoint, aGramPerCubicCentimeter, aSets, 256, 256, 256, 255).put(METALLOID, SMITHABLE, MELTING, MOLTEN, EXTRUDER, aMeltingPoint < 1200 ? new Object[] {EXTRUDER_SIMPLE, FURNACE, MORTAR} : null);}
	protected static OreDictMaterial alkali       (int aID, String aNameOreDict, String aSymbol, long aProtonsAndElectrons, long aNeutrons, long aMeltingPoint, long aBoilingPoint, double aGramPerCubicCentimeter, TextureSet[] aSets)   {return metal       (aID, aNameOreDict, aSymbol, aProtonsAndElectrons, aNeutrons, aMeltingPoint, aBoilingPoint, aGramPerCubicCentimeter, aSets, 256, 256, 256, 255).put(ALKALI_METAL, MOLTEN);}
	protected static OreDictMaterial alkaline     (int aID, String aNameOreDict, String aSymbol, long aProtonsAndElectrons, long aNeutrons, long aMeltingPoint, long aBoilingPoint, double aGramPerCubicCentimeter, TextureSet[] aSets)   {return metal       (aID, aNameOreDict, aSymbol, aProtonsAndElectrons, aNeutrons, aMeltingPoint, aBoilingPoint, aGramPerCubicCentimeter, aSets, 256, 256, 256, 255).put(ALKALINE_EARTH_METAL, MOLTEN);}
	protected static OreDictMaterial lanthanide   (int aID, String aNameOreDict, String aSymbol, long aProtonsAndElectrons, long aNeutrons, long aMeltingPoint, long aBoilingPoint, double aGramPerCubicCentimeter, TextureSet[] aSets)   {return metal       (aID, aNameOreDict, aSymbol, aProtonsAndElectrons, aNeutrons, aMeltingPoint, aBoilingPoint, aGramPerCubicCentimeter, aSets, 256, 256, 256, 255).put(LANTHANIDE);}
	protected static OreDictMaterial actinide     (int aID, String aNameOreDict, String aSymbol, long aProtonsAndElectrons, long aNeutrons, long aMeltingPoint, long aBoilingPoint, double aGramPerCubicCentimeter, TextureSet[] aSets)   {return metal       (aID, aNameOreDict, aSymbol, aProtonsAndElectrons, aNeutrons, aMeltingPoint, aBoilingPoint, aGramPerCubicCentimeter, aSets, 256, 256, 256, 255).put(ACTINIDE);}
	...
	protected static OreDictMaterial posttrans    (int aID, String aNameOreDict, String aSymbol, long aProtonsAndElectrons, long aNeutrons, long aMeltingPoint, long aBoilingPoint, double aGramPerCubicCentimeter, TextureSet[] aSets)   {return metal       (aID, aNameOreDict, aSymbol, aProtonsAndElectrons, aNeutrons, aMeltingPoint, aBoilingPoint, aGramPerCubicCentimeter, aSets, 256, 256, 256, 255).put(POST_TRANSITION_METAL);}
	
	/** Making the Table a little bit more overviewable. DO NOT USE THESE FUNCTIONS YOURSELF!!! Use "OreDictMaterial.createMaterial(YOUR-ID-AS-SPECIFIED-IN-THE-ID-RANGES, OREDICT-NAME, LOCALISED-NAME)" */
	protected static OreDictMaterial dcmp         (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(DECOMPOSABLE);}
	protected static OreDictMaterial cent         (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return dcmp            (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(CENTRIFUGE);}
	protected static OreDictMaterial elec         (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return dcmp            (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(ELECTROLYSER);}
	protected static OreDictMaterial gas          (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, SET_GAS         , aR, aG, aB, aA).put(G_CONTAINERS, CONTAINERS_GAS);}
	protected static OreDictMaterial gasdcmp      (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return gas             (aID, aNameOreDict, SET_GAS         , aR, aG, aB, aA).put(DECOMPOSABLE);}
	protected static OreDictMaterial gasflam      (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return gas             (aID, aNameOreDict, SET_GAS         , aR, aG, aB, aA).put(DECOMPOSABLE);}
	protected static OreDictMaterial gasexpl      (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return gas             (aID, aNameOreDict, SET_GAS         , aR, aG, aB, aA).put(DECOMPOSABLE);}
	protected static OreDictMaterial gascent      (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return gasdcmp         (aID, aNameOreDict, SET_GAS         , aR, aG, aB, aA).put(CENTRIFUGE);}
	protected static OreDictMaterial gaselec      (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return gasdcmp         (aID, aNameOreDict, SET_GAS         , aR, aG, aB, aA).put(ELECTROLYSER);}
	protected static OreDictMaterial lqud         (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, SET_FLUID       , aR, aG, aB, aA).put(G_CONTAINERS, CONTAINERS_FLUID);}
	protected static OreDictMaterial lqudflam     (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return lqud            (aID, aNameOreDict, SET_FLUID       , aR, aG, aB, aA).put(FLAMMABLE);}
	protected static OreDictMaterial lqudexpl     (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return lqud            (aID, aNameOreDict, SET_FLUID       , aR, aG, aB, aA).put(FLAMMABLE, EXPLOSIVE);}
	protected static OreDictMaterial lquddcmp     (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return lqud            (aID, aNameOreDict, SET_FLUID       , aR, aG, aB, aA).put(DECOMPOSABLE);}
	protected static OreDictMaterial lqudcent     (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return lquddcmp        (aID, aNameOreDict, SET_FLUID       , aR, aG, aB, aA).put(CENTRIFUGE);}
	protected static OreDictMaterial lqudelec     (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return lquddcmp        (aID, aNameOreDict, SET_FLUID       , aR, aG, aB, aA).put(ELECTROLYSER);}
	protected static OreDictMaterial gaschem      (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, SET_GAS         , aR, aG, aB, aA).put(G_CONTAINERS, CONTAINERS_GAS);}
	protected static OreDictMaterial gaschemdcmp  (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return gaschem         (aID, aNameOreDict, SET_GAS         , aR, aG, aB, aA).put(DECOMPOSABLE);}
	protected static OreDictMaterial gaschemflam  (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return gaschem         (aID, aNameOreDict, SET_GAS         , aR, aG, aB, aA).put(FLAMMABLE);}
	protected static OreDictMaterial gaschemexpl  (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return gaschem         (aID, aNameOreDict, SET_GAS         , aR, aG, aB, aA).put(FLAMMABLE, EXPLOSIVE);}
	protected static OreDictMaterial gaschemcent  (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return gaschemdcmp     (aID, aNameOreDict, SET_GAS         , aR, aG, aB, aA).put(CENTRIFUGE);}
	protected static OreDictMaterial gaschemelec  (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return gaschemdcmp     (aID, aNameOreDict, SET_GAS         , aR, aG, aB, aA).put(ELECTROLYSER);}
	protected static OreDictMaterial lqudchem     (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, SET_FLUID       , aR, aG, aB, aA).put(G_CONTAINERS, CONTAINERS_FLUID);}
	protected static OreDictMaterial lqudchemdcmp (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return lqudchem        (aID, aNameOreDict, SET_FLUID       , aR, aG, aB, aA).put(DECOMPOSABLE);}
	protected static OreDictMaterial lqudchemflam (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return lqudchem        (aID, aNameOreDict, SET_FLUID       , aR, aG, aB, aA).put(FLAMMABLE);}
	protected static OreDictMaterial lqudchemexpl (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return lqudchem        (aID, aNameOreDict, SET_FLUID       , aR, aG, aB, aA).put(FLAMMABLE, EXPLOSIVE);}
	protected static OreDictMaterial lqudchemcent (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return lqudchemdcmp    (aID, aNameOreDict, SET_FLUID       , aR, aG, aB, aA).put(CENTRIFUGE);}
	protected static OreDictMaterial lqudchemelec (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return lqudchemdcmp    (aID, aNameOreDict, SET_FLUID       , aR, aG, aB, aA).put(ELECTROLYSER);}
	protected static OreDictMaterial gasacid      (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, SET_GAS         , aR, aG, aB, aA).put(G_CONTAINERS, CONTAINERS_GAS, ACID);}
	protected static OreDictMaterial gasaciddcmp  (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return gasacid         (aID, aNameOreDict, SET_GAS         , aR, aG, aB, aA).put(DECOMPOSABLE);}
	protected static OreDictMaterial gasacidflam  (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return gasacid         (aID, aNameOreDict, SET_GAS         , aR, aG, aB, aA).put(FLAMMABLE);}
	protected static OreDictMaterial gasacidexpl  (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return gasacid         (aID, aNameOreDict, SET_GAS         , aR, aG, aB, aA).put(FLAMMABLE, EXPLOSIVE);}
	protected static OreDictMaterial gasacidcent  (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return gasaciddcmp     (aID, aNameOreDict, SET_GAS         , aR, aG, aB, aA).put(CENTRIFUGE);}
	protected static OreDictMaterial gasacidelec  (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return gasaciddcmp     (aID, aNameOreDict, SET_GAS         , aR, aG, aB, aA).put(ELECTROLYSER);}
	protected static OreDictMaterial lqudacid     (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, SET_FLUID       , aR, aG, aB, aA).put(G_CONTAINERS, CONTAINERS_FLUID, ACID);}
	protected static OreDictMaterial lqudaciddcmp (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return lqudacid        (aID, aNameOreDict, SET_FLUID       , aR, aG, aB, aA).put(DECOMPOSABLE);}
	protected static OreDictMaterial lqudacidflam (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return lqudacid        (aID, aNameOreDict, SET_FLUID       , aR, aG, aB, aA).put(FLAMMABLE);}
	protected static OreDictMaterial lqudacidexpl (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return lqudacid        (aID, aNameOreDict, SET_FLUID       , aR, aG, aB, aA).put(FLAMMABLE, EXPLOSIVE);}
	protected static OreDictMaterial lqudacidcent (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return lqudaciddcmp    (aID, aNameOreDict, SET_FLUID       , aR, aG, aB, aA).put(CENTRIFUGE);}
	protected static OreDictMaterial lqudacidelec (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return lqudaciddcmp    (aID, aNameOreDict, SET_FLUID       , aR, aG, aB, aA).put(ELECTROLYSER);}
	protected static OreDictMaterial gas          (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(G_CONTAINERS, CONTAINERS_GAS);}
	protected static OreDictMaterial gasdcmp      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return gas             (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(DECOMPOSABLE);}
	protected static OreDictMaterial gascent      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return gasdcmp         (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(CENTRIFUGE);}
	protected static OreDictMaterial gaselec      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return gasdcmp         (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(ELECTROLYSER);}
	protected static OreDictMaterial lqud         (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(G_CONTAINERS, CONTAINERS_FLUID);}
	protected static OreDictMaterial lquddcmp     (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return lqud            (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(DECOMPOSABLE);}
	protected static OreDictMaterial lqudcent     (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return lquddcmp        (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(CENTRIFUGE);}
	protected static OreDictMaterial lqudelec     (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return lquddcmp        (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(ELECTROLYSER);}
	protected static OreDictMaterial gaschem      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(G_CONTAINERS, CONTAINERS_GAS);}
	protected static OreDictMaterial gaschemdcmp  (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return gaschem         (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(DECOMPOSABLE);}
	protected static OreDictMaterial gaschemcent  (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return gaschemdcmp     (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(CENTRIFUGE);}
	protected static OreDictMaterial gaschemelec  (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return gaschemdcmp     (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(ELECTROLYSER);}
	protected static OreDictMaterial lqudchem     (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(G_CONTAINERS, CONTAINERS_FLUID);}
	protected static OreDictMaterial lqudchemdcmp (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return lqudchem        (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(DECOMPOSABLE);}
	protected static OreDictMaterial lqudchemcent (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return lqudchemdcmp    (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(CENTRIFUGE);}
	protected static OreDictMaterial lqudchemelec (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return lqudchemdcmp    (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(ELECTROLYSER);}
	protected static OreDictMaterial gasacid      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(G_CONTAINERS, CONTAINERS_GAS, ACID);}
	protected static OreDictMaterial gasaciddcmp  (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return gasacid         (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(DECOMPOSABLE);}
	protected static OreDictMaterial gasacidcent  (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return gasaciddcmp     (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(CENTRIFUGE);}
	protected static OreDictMaterial gasacidelec  (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return gasaciddcmp     (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(ELECTROLYSER);}
	protected static OreDictMaterial lqudacid     (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(G_CONTAINERS, CONTAINERS_FLUID, ACID);}
	protected static OreDictMaterial lqudaciddcmp (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return lqudacid        (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(DECOMPOSABLE);}
	protected static OreDictMaterial lqudacidcent (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return lqudaciddcmp    (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(CENTRIFUGE);}
	protected static OreDictMaterial lqudacidelec (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return lqudaciddcmp    (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(ELECTROLYSER);}
	
	
	
	protected static OreDictMaterial dust         (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(G_DUST, MORTAR).setPriorityPrefix(2);}
	protected static OreDictMaterial dustdcmp     (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return dust            (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(DECOMPOSABLE);}
	protected static OreDictMaterial dustcent     (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return dustdcmp        (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(CENTRIFUGE);}
	protected static OreDictMaterial dustelec     (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return dustdcmp        (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(ELECTROLYSER);}
	...
	protected static OreDictMaterial redstone     (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return oredustcent     (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(PLATES, STICKS, MORTAR, BRITTLE, UNBURNABLE, MELTING, CRYSTAL, G_GEM_ORES_TRANSPARENT).setPriorityPrefix(2).setOreMultiplier(4);}
	protected static OreDictMaterial coal         (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return elec            (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(G_GEM_ORES, BRITTLE, FLAMMABLE, MORTAR, INGOTS, COAL).setPriorityPrefix(1);}
	protected static OreDictMaterial wax          (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return dust            (aID, aNameOreDict, SET_FOOD        , aR, aG, aB, aA).put(ANY.Wax, FOILS, PLATES, INGOTS, PARTS, FURNACE, MELTING, BRITTLE, MORTAR, EXTRUDER, EXTRUDER_SIMPLE);}
	protected static OreDictMaterial meat         (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return dustfood        (aID, aNameOreDict, SET_FINE        , aR, aG, aB, aA).put(MEAT, INGOTS, MELTING, EXTRUDER, EXTRUDER_SIMPLE);}
	protected static OreDictMaterial grain        (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return dustfood        (aID, aNameOreDict, SET_POWDER      , aR, aG, aB, aA).put(ANY.Grains, ANY.FlourGrains, FLAMMABLE);}
	protected static OreDictMaterial food         (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(FOOD, MORTAR);}
	protected static OreDictMaterial orefood      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return oredust         (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(FOOD, MORTAR);}
	protected static OreDictMaterial dustfood     (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return dust            (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(FOOD, MORTAR);}
	protected static OreDictMaterial mixfood      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return mixdust         (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(FOOD, MORTAR);}
	protected static OreDictMaterial food         (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, SET_FOOD        , aR, aG, aB, aA).put(FOOD, MORTAR);}
	protected static OreDictMaterial orefood      (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return oredust         (aID, aNameOreDict, SET_FINE        , aR, aG, aB, aA).put(FOOD, MORTAR);}
	protected static OreDictMaterial dustfood     (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return dust            (aID, aNameOreDict, SET_FINE        , aR, aG, aB, aA).put(FOOD, MORTAR);}
	protected static OreDictMaterial mixfood      (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return mixdust         (aID, aNameOreDict, SET_FINE        , aR, aG, aB, aA).put(FOOD, MORTAR);}
	protected static OreDictMaterial dye          (int aID, String aNameOreDict                    , long aR, long aG, long aB             )  {return dust            (aID, aNameOreDict, SET_FOOD        , aR, aG, aB,255).aspects(TC.SENSUS, 1).put(DONT_SHOW_THIS_COMPONENT);}
	protected static OreDictMaterial quartz       (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, SET_QUARTZ      , aR, aG, aB, aA).put(G_QUARTZ_ORES, ANY.Quartz, ANY.SiO2, MORTAR, BRITTLE, QUARTZ, BLACKLISTED_SMELTER).setSmelting(SiO2, U).setPriorityPrefix(1);}
	protected static OreDictMaterial gem          (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(G_GEM_ORES).setPriorityPrefix(1);}
	protected static OreDictMaterial gemdcmp      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return gem             (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(DECOMPOSABLE);}
	protected static OreDictMaterial gemcent      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return gemdcmp         (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(CENTRIFUGE);}
	protected static OreDictMaterial gemelec      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return gemdcmp         (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(ELECTROLYSER);}
	protected static OreDictMaterial stonedcmp    (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return stone           (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(DECOMPOSABLE);}
	protected static OreDictMaterial stonecent    (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return stonedcmp       (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(CENTRIFUGE);}
	protected static OreDictMaterial stoneelec    (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return stonedcmp       (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(ELECTROLYSER);}
	protected static OreDictMaterial stone        (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return stone           (aID, aNameOreDict, SET_STONE       , aR, aG, aB, aA);}
	protected static OreDictMaterial stonedcmp    (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return stonedcmp       (aID, aNameOreDict, SET_STONE       , aR, aG, aB, aA);}
	protected static OreDictMaterial stonecent    (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return stonecent       (aID, aNameOreDict, SET_STONE       , aR, aG, aB, aA);}
	protected static OreDictMaterial stoneelec    (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return stoneelec       (aID, aNameOreDict, SET_STONE       , aR, aG, aB, aA);}
	protected static OreDictMaterial crystal      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(G_GEM_ORES_TRANSPARENT, CRYSTAL).setPriorityPrefix(1);}
	protected static OreDictMaterial crystaldcmp  (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return crystal         (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(DECOMPOSABLE);}
	protected static OreDictMaterial crystalcent  (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return crystaldcmp     (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(CENTRIFUGE);}
	protected static OreDictMaterial crystalelec  (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return crystaldcmp     (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(ELECTROLYSER);}
	protected static OreDictMaterial crystal_tc   (int aID, String aNameOreDict                    , long aR, long aG, long aB, byte aColor)  {return crystal         (aID, aNameOreDict, SET_SHARDS      , aR, aG, aB,255).lens(aColor).put(MD.TC , ANY.ThaumCrystal, COMMON_ORE, MAGICAL, UNBURNABLE).setOreMultiplier(2).visDefault();}
	...
	protected static OreDictMaterial valgem       (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return gem             (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(G_GEM_ORES_TRANSPARENT, CRYSTAL, VALUABLE);}
	protected static OreDictMaterial valgemdcmp   (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return valgem          (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(DECOMPOSABLE).setSmelting(null, 0);}
	protected static OreDictMaterial valgemcent   (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return valgemdcmp      (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(CENTRIFUGE);}
	protected static OreDictMaterial valgemelec   (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return valgemdcmp      (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(ELECTROLYSER);}
	protected static OreDictMaterial diamond      (int aID, String aNameOreDict                    , long aR, long aG, long aB, byte aColor)  {return valgemdcmp      (aID, aNameOreDict, SET_DIAMOND     , aR, aG, aB,127).lens(aColor).put(ANY.Diamond   , COMMON_ORE).steal(C).aspects(TC.VITREUS, 3, TC.LUCRUM , 4                ).qual(3, 8.0,1280, 3).setSmelting(C    , 2*U  ).setBurning(Ash, U);}
	protected static OreDictMaterial sapphire     (int aID, String aNameOreDict                    , long aR, long aG, long aB, byte aColor)  {return valgemcent      (aID, aNameOreDict, SET_GEM_VERTICAL, aR, aG, aB,127).lens(aColor).put(ANY.Sapphire  , COMMON_ORE, MELTING).aspects(TC.VITREUS, 3, TC.LUCRUM , 4                ).qual(3, 7.0, 512, 3).setSmelting(Al2O3, 3*U4 );}
	protected static OreDictMaterial emerald      (int aID, String aNameOreDict                    , long aR, long aG, long aB, byte aColor)  {return valgemelec      (aID, aNameOreDict, SET_EMERALD     , aR, aG, aB,127).lens(aColor).put(ANY.Emerald   , COMMON_ORE, MELTING).aspects(TC.VITREUS, 3, TC.LUCRUM , 3                ).qual(3, 9.0, 128, 2).setSmelting(Be   ,   U36);}
	protected static OreDictMaterial garnet       (int aID, String aNameOreDict                    , long aR, long aG, long aB, byte aColor)  {return valgemelec      (aID, aNameOreDict, SET_RUBY        , aR, aG, aB,127).lens(aColor).put(ANY.Garnet    , MD.GT              ).aspects(TC.VITREUS, 3, TC.LUCRUM , 1                ).qual(3, 7.0, 128, 2);}
	protected static OreDictMaterial jasper       (int aID, String aNameOreDict                    , long aR, long aG, long aB, byte aColor)  {return valgemelec      (aID, aNameOreDict, SET_GLASS       , aR, aG, aB,150).lens(aColor).put(ANY.Jasper    , MD.RH              ).aspects(TC.VITREUS, 2, TC.LUCRUM , 2, TC.METALLUM, 1).qual(3, 7.0, 256, 2).uumMcfg( 0, SiO2, 2*U, Fe, 1*U);}
	protected static OreDictMaterial tigereye     (int aID, String aNameOreDict                    , long aR, long aG, long aB, byte aColor)  {return valgemelec      (aID, aNameOreDict, SET_GLASS       , aR, aG, aB,200).lens(aColor).put(ANY.TigerEye  , MD.RH              ).aspects(TC.VITREUS, 2, TC.LUCRUM , 1, TC.TERRA   , 1).qual(3, 7.0, 256, 2).uumMcfg( 0, SiO2, 1*U);}
	protected static OreDictMaterial aventurine   (int aID, String aNameOreDict                    , long aR, long aG, long aB, byte aColor)  {return valgemelec      (aID, aNameOreDict, SET_GLASS       , aR, aG, aB,200).lens(aColor).put(ANY.Aventurine, MD.RH              ).aspects(TC.VITREUS, 2, TC.LUCRUM , 1, TC.POTENTIA, 1).qual(3, 7.0, 256, 2).uumMcfg( 0, SiO2, 1*U);}
	...
	protected static OreDictMaterial mix          (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return dcmp            (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(CENTRIFUGE);}
	protected static OreDictMaterial mixdust      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return dustcent        (aID, aNameOreDict, aSets           , aR, aG, aB, aA);}
	protected static OreDictMaterial oredust      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(G_DUST_ORES);}
	protected static OreDictMaterial oredustdcmp  (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return oredust         (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(DECOMPOSABLE);}
	protected static OreDictMaterial oredustcent  (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return oredustdcmp     (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(CENTRIFUGE);}
	protected static OreDictMaterial oredustelec  (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return oredustdcmp     (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(ELECTROLYSER);}
	protected static OreDictMaterial metal        (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(G_INGOT, SMITHABLE, MELTING, EXTRUDER);}
	protected static OreDictMaterial metalore     (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return metal           (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(G_INGOT_ORES);}
	protected static OreDictMaterial metalmachine (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return metal           (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(G_INGOT_MACHINE);}
	protected static OreDictMaterial metalmachore (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return metalmachine    (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(G_INGOT_MACHINE_ORES);}
	protected static OreDictMaterial metal        (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB, aA).put(G_INGOT, SMITHABLE, MELTING, EXTRUDER);}
	protected static OreDictMaterial metalore     (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return metal           (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB, aA).put(G_INGOT_ORES);}
	protected static OreDictMaterial metalmachine (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return metal           (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB, aA).put(G_INGOT_MACHINE);}
	protected static OreDictMaterial metalmachore (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return metalmachine    (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB, aA).put(G_INGOT_MACHINE_ORES);}
	protected static OreDictMaterial setal        (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, SET_SHINY       , aR, aG, aB, aA).put(G_INGOT, SMITHABLE, MELTING, EXTRUDER);}
	protected static OreDictMaterial setalore     (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return metal           (aID, aNameOreDict, SET_SHINY       , aR, aG, aB, aA).put(G_INGOT_ORES);}
	protected static OreDictMaterial setalmachine (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return metal           (aID, aNameOreDict, SET_SHINY       , aR, aG, aB, aA).put(G_INGOT_MACHINE);}
	protected static OreDictMaterial setalmachore (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return metalmachine    (aID, aNameOreDict, SET_SHINY       , aR, aG, aB, aA).put(G_INGOT_MACHINE_ORES);}
	protected static OreDictMaterial alloy        (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return metal           (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloyore     (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return metalore        (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloymachine (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return metalmachine    (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloymachore (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return metalmachore    (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloy        (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return metal           (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB, aA).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloyore     (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return metalore        (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB, aA).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloymachine (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return metalmachine    (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB, aA).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloymachore (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return metalmachore    (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB, aA).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial slloy        (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return metal           (aID, aNameOreDict, SET_SHINY       , aR, aG, aB, aA).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial slloyore     (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return metalore        (aID, aNameOreDict, SET_SHINY       , aR, aG, aB, aA).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial slloymachine (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return metalmachine    (aID, aNameOreDict, SET_SHINY       , aR, aG, aB, aA).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial slloymachore (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return metalmachore    (aID, aNameOreDict, SET_SHINY       , aR, aG, aB, aA).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial metalnd      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(G_INGOT_ND, SMITHABLE, MELTING, EXTRUDER);}
	protected static OreDictMaterial metalmachnd  (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return metalnd         (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(G_INGOT_ND_MACHINE);}
	protected static OreDictMaterial alloynd      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return metalnd         (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloymachnd  (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return metalmachnd     (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial metal        (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             )  {return create          (aID, aNameOreDict, aSets           , aR, aG, aB,255).put(G_INGOT, SMITHABLE, MELTING, EXTRUDER);}
	protected static OreDictMaterial metalore     (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             )  {return metal           (aID, aNameOreDict, aSets           , aR, aG, aB,255).put(G_INGOT_ORES);}
	protected static OreDictMaterial metalmachine (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             )  {return metal           (aID, aNameOreDict, aSets           , aR, aG, aB,255).put(G_INGOT_MACHINE);}
	protected static OreDictMaterial metalmachore (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             )  {return metalmachine    (aID, aNameOreDict, aSets           , aR, aG, aB,255).put(G_INGOT_MACHINE_ORES);}
	protected static OreDictMaterial metal        (int aID, String aNameOreDict                    , long aR, long aG, long aB             )  {return create          (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB,255).put(G_INGOT, SMITHABLE, MELTING, EXTRUDER);}
	protected static OreDictMaterial metalore     (int aID, String aNameOreDict                    , long aR, long aG, long aB             )  {return metal           (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB,255).put(G_INGOT_ORES);}
	protected static OreDictMaterial metalmachine (int aID, String aNameOreDict                    , long aR, long aG, long aB             )  {return metal           (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB,255).put(G_INGOT_MACHINE);}
	protected static OreDictMaterial metalmachore (int aID, String aNameOreDict                    , long aR, long aG, long aB             )  {return metalmachine    (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB,255).put(G_INGOT_MACHINE_ORES);}
	protected static OreDictMaterial setal        (int aID, String aNameOreDict                    , long aR, long aG, long aB             )  {return create          (aID, aNameOreDict, SET_SHINY       , aR, aG, aB,255).put(G_INGOT, SMITHABLE, MELTING, EXTRUDER);}
	protected static OreDictMaterial setalore     (int aID, String aNameOreDict                    , long aR, long aG, long aB             )  {return metal           (aID, aNameOreDict, SET_SHINY       , aR, aG, aB,255).put(G_INGOT_ORES);}
	protected static OreDictMaterial setalmachine (int aID, String aNameOreDict                    , long aR, long aG, long aB             )  {return metal           (aID, aNameOreDict, SET_SHINY       , aR, aG, aB,255).put(G_INGOT_MACHINE);}
	protected static OreDictMaterial setalmachore (int aID, String aNameOreDict                    , long aR, long aG, long aB             )  {return metalmachine    (aID, aNameOreDict, SET_SHINY       , aR, aG, aB,255).put(G_INGOT_MACHINE_ORES);}
	protected static OreDictMaterial alloy        (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             )  {return metal           (aID, aNameOreDict, aSets           , aR, aG, aB,255).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloyore     (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             )  {return metalore        (aID, aNameOreDict, aSets           , aR, aG, aB,255).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloymachine (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             )  {return metalmachine    (aID, aNameOreDict, aSets           , aR, aG, aB,255).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloymachore (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             )  {return metalmachore    (aID, aNameOreDict, aSets           , aR, aG, aB,255).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloy        (int aID, String aNameOreDict                    , long aR, long aG, long aB             )  {return metal           (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB,255).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloyore     (int aID, String aNameOreDict                    , long aR, long aG, long aB             )  {return metalore        (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB,255).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloymachine (int aID, String aNameOreDict                    , long aR, long aG, long aB             )  {return metalmachine    (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB,255).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloymachore (int aID, String aNameOreDict                    , long aR, long aG, long aB             )  {return metalmachore    (aID, aNameOreDict, SET_METALLIC    , aR, aG, aB,255).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial slloy        (int aID, String aNameOreDict                    , long aR, long aG, long aB             )  {return metal           (aID, aNameOreDict, SET_SHINY       , aR, aG, aB,255).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial slloyore     (int aID, String aNameOreDict                    , long aR, long aG, long aB             )  {return metalore        (aID, aNameOreDict, SET_SHINY       , aR, aG, aB,255).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial slloymachine (int aID, String aNameOreDict                    , long aR, long aG, long aB             )  {return metalmachine    (aID, aNameOreDict, SET_SHINY       , aR, aG, aB,255).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial slloymachore (int aID, String aNameOreDict                    , long aR, long aG, long aB             )  {return metalmachore    (aID, aNameOreDict, SET_SHINY       , aR, aG, aB,255).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial metalnd      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             )  {return create          (aID, aNameOreDict, aSets           , aR, aG, aB,255).put(G_INGOT_ND, SMITHABLE, MELTING, EXTRUDER);}
	protected static OreDictMaterial metalmachnd  (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             )  {return metalnd         (aID, aNameOreDict, aSets           , aR, aG, aB,255).put(G_INGOT_ND_MACHINE);}
	protected static OreDictMaterial alloynd      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             )  {return metalnd         (aID, aNameOreDict, aSets           , aR, aG, aB,255).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial alloymachnd  (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             )  {return metalmachnd     (aID, aNameOreDict, aSets           , aR, aG, aB,255).put(ALLOY, DECOMPOSABLE);}
	protected static OreDictMaterial wood         (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    )  {return wood            (aID, aNameOreDict, SET_WOOD        , aR, aG, aB, aA);}
	
	protected static OreDictMaterial wood(int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA)  {
	...
	protected static OreDictMaterial woodnormal(int aID, String aNameOreDict, String aLocal, long aR, long aG, long aB) {
	...
	protected static OreDictMaterial stone(int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA)  {
		OreDictMaterial rMaterial = create(aID, aNameOreDict, aSets, aR, aG, aB, aA).put(G_STONE, ANY.Stone, STONE, BRITTLE, MORTAR, FURNACE, EXTRUDER, EXTRUDER_SIMPLE);
	...
	protected static OreDictMaterial gem_aa(int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA, OreDictMaterial aCopy) {
	...
	protected static OreDictMaterial unknown(int aID, long aNeutrons) {
	...
	WoodRubber              = wood          ( 8224, "WoodRubber"                                    , 180, 150,   0, 255).put(TICKS_PER_SMELT/ 4, FLAMMABLE, APPROXIMATE)                                                                                               .setMcfg( 0, C              , 6*U, H2O              ,15*U)                                                                                                  .aspects(TC.ARBOR, 1                   ).setBurning(Ash, U4).setSmelting(Ash, U2).qual(1, 1.5, 12, 0).heat(350, 450).setLocal("Rubber Wood"),
	...
	*/
	...
	EnergiumRed             = crystalcent   ( 8298, "EnergiumRed"           , SET_DIAMOND           , 255,   0,   0, 255).put(CRYSTALLISABLE)                                                                                                                           .uumMcfg( 0, Sapphire       , 4*U, Redstone         , 5*U)                                                                                                  .aspects(TC.LUX, 2, TC.POTENTIA, 2).setLocal("Red Energium"),
	EnergiumCyan            = crystalcent   ( 8299, "EnergiumCyan"          , SET_DIAMOND           ,   0, 255, 255, 255).put(CRYSTALLISABLE)                                                                                                                           .uumMcfg( 0, Sapphire       , 4*U, Teslatite        , 5*U)                                                                                                  .aspects(TC.LUX, 2, TC.POTENTIA, 4).setLocal("Cyan Energium"),
...
//      CassiteriteSand         = oredustelec   ( 9109, "Cassiterite Sand"          , SET_SAND              , 220, 220, 220, 255).put(MORTAR, FURNACE                                                           ).setSmelting(Sn, 3*U4)     .uumMcfg( 1, Sn             , 1*U, O                , 2*U)                                                                                                  .heat(3 * Sn.mMeltingPoint / 2),
	...
	public static class WOODS {
		...
		Warped              = woodnormal( 9307, "Warpedwood"              , "Warped Wood"         ,  42, 141, 133).put(MD.NePl),
		...
		Varnished           = woodnormal( 9405, "WoodVarnished"           , "Varnished Wood"      ,  73,  48,  16).put(MD.ERE),
		...
		Willow              = woodnormal( 9314, "Willow"                  , "Willow"              ,  37, 150,   0).put(MD.FR),
		BlueMahoe           = woodnormal( 9315, "BlueMahoe"               , "Blue Mahoe"          ,  15, 103, 254).put(MD.FR),
		Hazel               = woodnormal( 9316, "Hazel"                   , "Hazel"               , 228, 175, 175).put(MD.BINNIE),
		...
		Mahogany            = woodnormal( 9356, "Mahogany"                , "Mahogany"            , 111,  61,  55).put(MD.TROPIC),
