...
//  HexoriumRainbow         = hexorium      ( 9242, 224, 224, 224, DYE_INDEX_White    ),
	...
	Prometheum              = metalore      ( 8774, "Prometheum"                                    ,  90, 129,  86     , CENTRIFUGE, DECOMPOSABLE, SOFT)                                                                                                           .setMcfg( 0, Pm             , 3*U, O                , 4*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.POTENTIA                            , 1).qual(3,  8.0,  512, 1),
