...
public class MT {
	...
	Nichrome                = alloymachine  ( 8663, "Nichrome"              , SET_METALLIC          , 205, 206, 246, 255).qual(3,  6.0,   64,  2)                                                                                                                       .uumMcfg( 0, Ni             , 4*U, Cr               , 1*U)                                                                                                  .alloyCentrifuge(),
	Kanthal                 = alloymachine  ( 8664, "Kanthal"               , SET_METALLIC          , 194, 210, 223, 255).qual(3,  6.0,   64,  2)                                                                                                                       .uumMcfg( 0, WroughtIron    , 1*U, Al               , 1*U, Cr               , 1*U)                                                                          .alloyCentrifuge(),
