...
public class MT {
	...
	SaltedWater             = lqudelec      ( 9815, "Saltedwater"                                   , 255,   0, 200, 255, LIQUID, UNRECYCLABLE, "SaltedWater")                                                                                                      .uumMcfg( 0, H2O            , 3*U, KCl              , 1*U)                                                                                                  .aspects(TC.AQUA, 2).heat(CS.C, CS.C+90).setDensity(1.0),
...
//  HexoriumRainbow         = hexorium      ( 9242, 224, 224, 224, DYE_INDEX_White    ),
	...
	ArsenicCopper           = clloymachine  ( 8614, "Arsenic Copper"                                , 210, 160,  60     , FURNACE, EXTRUDER_SIMPLE, MORTAR, MOLTEN).qual(3, 6.0,  448, 2)                                                                           .uumAloy( 0, Cu             , 3*U, As               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.VENEMUM, 1).heat(Cu.mMeltingPoint, Cu.mBoilingPoint),
