...
public class MT {
	...
	static OreDictMaterial quartz       (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, aSets, aR, aG, aB, aA).put(G_QUARTZ_ORES, MORTAR, BRITTLE, QUARTZ, BLACKLISTED_SMELTER).setSmelting(SiO2, U).setPriorityPrefix(1);}
	...
	KNO3                    = oredustelec   ( 8205, "Potassium Nitrate"     , SET_FINE              , 230, 230, 230, 255).put(FLAMMABLE, BRITTLE, MORTAR, "Saltpeter")                                                                                                  .uumMcfg( 0, K              , 1*U, N                , 1*U, O                , 3*U)                                                                          .aspects(TC.IGNIS, 2).setPriorityPrefix(2),
	...
	Eudialyte               = elec          ( 8421, "Eudialyte"             , SET_LAPIS             , 155,  96, 114, 255).put(G_GEM_ORES, CRYSTAL, MORTAR, BRITTLE)                                                                                                     .uumMcfg( 0, Zircon         ,18*U, MnO2             , 3*U, Na               ,13*U, Ca               , 6*U, NaCl, U*4, SiO2, 75*U, O, 12*U)                  .aspects(TC.VITREUS, 1), // Na15Ca6(Fe,Mn)3Zr3SiO(O,OH,H2O)3 (Si3O9)2(Si9O27)2(OH,Cl)2
