...
public class MT {
	...
	static OreDictMaterial hexorium     (int aID                                         , long aR, long aG, long aB, byte aColor)  {return crystal(aID, "Hexorium"+DYE_NAMES[aColor], SET_HEX  , aR, aG, aB,127).lens(aColor).put(MD.HEX, MORTAR, MELTING, MOLTEN, CRYSTALLISABLE).addReRegistrations(ANY.Hexorium).setOreMultiplier(4).setLocal(DYE_NAMES[aColor] + " Hexorium").visDefault();}
...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60     ).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                      ,
	...
	AncientDebris           = metalore      ( 8744, "Ancient Debris"        , SET_SPACE             , 110,  80,  90, 255).put("Ancient", UNBURNABLE, WITHER_PROOF, VALUABLE, MELTING).qual(0, 1.0,   16,  3)                                                                                                                                                                                                                        .aspects(TC.METALLUM, 2, TC.ALIENIS, 2).heat(MeteoricIron),
