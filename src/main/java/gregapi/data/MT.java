...
public class MT {
	...
	static OreDictMaterial coal         (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return elec            (aID, aNameOreDict, aSets, aR, aG, aB, aA).put(G_GEM_ORES, BRITTLE, FLAMMABLE, MORTAR, INGOTS).setPriorityPrefix(1);}
	...
	static OreDictMaterial quartz       (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return create          (aID, aNameOreDict, aSets, aR, aG, aB, aA).put(G_QUARTZ_ORES, MORTAR, BRITTLE, QUARTZ, BLACKLISTED_SMELTER).addReRegistrations(ANY.Quartz, ANY.SiO2).setSmelting(SiO2, U).setPriorityPrefix(1);}
	...
	static OreDictMaterial diamond      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, byte aColor)  {return valgemdcmp      (aID, aNameOreDict, aSets, aR, aG, aB,127).lens(aColor).steal(C    ).aspects(TC.VITREUS, 3, TC.LUCRUM , 4                ).qual(3, 8.0,1280, 3).addReRegistrations(ANY.Diamond ).setSmelting(C    , 2*U  ).setBurning(Ash, U).heat(4200, C.mBoilingPoint);}
	static OreDictMaterial sapphire     (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, byte aColor)  {return valgemcent      (aID, aNameOreDict, aSets, aR, aG, aB,127).lens(aColor).put(MELTING).aspects(TC.VITREUS, 3, TC.LUCRUM , 4                ).qual(3, 7.0, 512, 3).addReRegistrations(ANY.Sapphire).setSmelting(Al2O3, 3*U4 );}
	static OreDictMaterial emerald      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, byte aColor)  {return valgemelec      (aID, aNameOreDict, aSets, aR, aG, aB,127).lens(aColor).put(MELTING).aspects(TC.VITREUS, 3, TC.LUCRUM , 3                ).qual(3, 9.0, 128, 2).addReRegistrations(ANY.Emerald ).setSmelting(Be   ,   U36);}
	static OreDictMaterial garnet       (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, byte aColor)  {return valgemelec      (aID, aNameOreDict, aSets, aR, aG, aB,127).lens(aColor).put(MD.GT  ).aspects(TC.VITREUS, 3, TC.LUCRUM , 1                ).qual(3, 7.0, 128, 2).addReRegistrations(ANY.Garnet  );}
	static OreDictMaterial jasper       (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, byte aColor)  {return valgemelec      (aID, aNameOreDict, aSets, aR, aG, aB,150).lens(aColor).put(MD.RH  ).aspects(TC.VITREUS, 2, TC.LUCRUM , 2, TC.METALLUM, 1).qual(3, 7.0, 256, 2).addReRegistrations(ANY.Jasper  ).uumMcfg( 0, SiO2, 2*U, Fe, 1*U);}
	static OreDictMaterial tigereye     (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, byte aColor)  {return valgemelec      (aID, aNameOreDict, aSets, aR, aG, aB,200).lens(aColor).put(MD.RH  ).aspects(TC.VITREUS, 2, TC.LUCRUM , 1, TC.TERRA   , 1).qual(3, 7.0, 256, 2).addReRegistrations(ANY.TigerEye).uumMcfg( 0, SiO2, 1*U);}
	static OreDictMaterial fluorite     (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB             )  {return gem             (aID, aNameOreDict, aSets, aR, aG, aB,255)             .put(MD.ReC ).aspects(TC.VITREUS, 2, TC.VENENUM, 2                )                     .addReRegistrations(ANY.CaF2    ).uumMcfg( 0, Ca, 1*U, F, 2*U).heat(1633).put(DECOMPOSABLE, ACID, MELTING, MOLTEN, MORTAR, INGOTS, BRITTLE, CRYSTALLISABLE);}
	...
	Li      = alkali        (   30, "Lithium"               , "Li"      ,   3,   4,   453,  1560,  0.534     , SET_ROUGH            , 225, 220, 255, 255).put(  G_INGOT_ORES                , FUSION, UUM                 ).aspects(TC.VITREUS, 1, TC.POTENTIA, 2                  ).put(TICKS_PER_SMELT*40),
	Li_6    = alkali        (   31, "Lithium-6"             , "Li-6"    ,   3,   3,   453,  1560,  0.534     , SET_ROUGH            , 230, 225, 255, 255).put(  G_INGOT_ORES                , FUSION                      ).aspects(TC.VITREUS, 1, TC.POTENTIA, 1, TC.RADIO, 1     ).put(TICKS_PER_SMELT*40),
	...
	Mg      = alkaline      (  120, "Magnesium"             , "Mg"      ,  12,  12,   923,  1363,  1.738     , SET_METALLIC         , 255, 200, 200, 255).put(  G_INGOT_ORES                , FUSION, UUM                 ).aspects(TC.METALLUM, 2, TC.SANO, 1                     ).put(FLAMMABLE, MELTING, MOLTEN),
	...
	Si      = metalloid     (  140, "Silicon"               , "Si"      ,  14,  14,  1687,  3538,  2.3296    , SET_METALLIC         ,  60,  60,  80, 255).put(  G_INGOT_ORES                , FUSION, UUM, CRYSTALLOGEN   ).aspects(TC.METALLUM, 2, TC.TENEBRAE, 1                 ).put(MOLTEN).setPriorityPrefix(5),
	...
	Mn      = transmetal    (  250, "Manganese"             , "Mn"      ,  25,  30,  1519,  2334,  7.44      , SET_DULL             , 250, 250, 250, 255).put(  G_INGOT_ORES                , FUSION, UUM, MANGANESE_GROUP).aspects(TC.METALLUM, 3                                 ).qual(3,  7.0,  256, 2).put(MAGNETIC_PASSIVE, MOLTEN),
	...
	Sb      = metalloid     (  510, "Antimony"              , "Sb"      ,  51,  70,   903,  1860,  6.685     , SET_SHINY            , 220, 220, 240, 255).put(  G_INGOT_MACHINE_ORES        , UUM, PNICTOGEN              ).aspects(TC.METALLUM, 2, TC.AQUA, 1                     ).put(MOLTEN),
	...
	La      = lanthanide    (  570, "Lanthanum"             , "La"      ,  57,  81,  1193,  3737,  6.145     , SET_METALLIC                             ).put(  G_INGOT_ORES                , UUM                         ).aspects(TC.METALLUM, 3                                 ).put("Lantanum"),
	...
	Yb      = lanthanide    (  700, "Ytterbium"             , "Yb"      ,  70, 103,  1097,  1469,  6.965     , SET_METALLIC         , 167, 167, 167, 255).put(  G_INGOT_ORES                , UUM                         ).aspects(TC.METALLUM, 3                                 ),
	...
	U_238   = actinide      (  920, "Uranium"               , "U"       ,  92, 146,  1405,  4404, 18.95      , SET_METALLIC         ,  50, 240,  50, 255).put(  G_INGOT_ORES                                              ).aspects(TC.METALLUM, 2, TC.RADIO, 1                    ).qual(3, 6.0, 512, 3).put("Uranium238", "Uran"), // No, I could not make a Variable named "U" here. That would collide with the Material Unit.
	U_235   = actinide      (  921, "Uranium-235"           , "U-235"   ,  92, 143,  1405,  4404, 18.95      , SET_SHINY            ,  70, 250,  70, 255).put(  G_INGOT_ORES                                              ).aspects(TC.METALLUM, 1, TC.RADIO, 2                    ).qual(3, 6.0, 512, 3).put("UraniumEnriched"),
	Np      = actinide      (  930, "Neptunium"             , "Np"      ,  93, 144,   917,  4273, 20.45      , SET_DULL                                 ).put(  G_INGOT_ORES                                              ).aspects(TC.METALLUM, 2, TC.RADIO, 1                    ),
	Pu      = actinide      (  940, "Plutonium"             , "Pu"      ,  94, 150,   912,  3501, 19.84      , SET_METALLIC         , 240,  50,  50, 255).put(  G_INGOT_ORES                                              ).aspects(TC.METALLUM, 2, TC.RADIO, 1                    ).qual(3, 6.0, 512, 3).put("Plutonium244"),
	...
	Vb      = element( 1520, "Vibranium"             , "Vb"      , 152, 266,  4852, 9415, 3.23978365, SET_EMERALD, 200, 128, 255, 100).put(G_GEM_ORES_TRANSPARENT, UUM, VALUABLE, GLOWING, "Unpentbium").aspects(TC.VITREUS, 10, TC.SENSUS, 10).qual(3, 1000.0, 512, 15), Upb = Vb,
	...
	Atl     = element( 2210, "Atlarus"               , "Atl"     , 221, 575, 3276, 11524, 21.24625421, SET_METALLIC, 204, 179,   0, 255).qual(3,  4.0, 4480, 4).put(G_INGOT_MACHINE_ORES, UUM, SMITHABLE, MELTING, EXTRUDER, MAGICAL, "Bibiunium").aspects(TC.METALLUM, 2, TC.COGNITO, 1), Bbu = Atl, Atlarus = Atl,
	Ad      = element( 2220, "Adamantium"            , "Ad"      , 222, 580, 5425, 14528, 13.35624762, SET_SHINY   , 255, 255, 255, 255).qual(3, 10.0, 5120, 5).put(G_INGOT_MACHINE_ORES, UUM, SMITHABLE, MELTING, EXTRUDER, MAGICAL, MAGNETIC_PASSIVE, WITHER_PROOF, ENDER_DRAGON_PROOF, "Adamant", "Bibibium").aspects(TC.METALLUM, 10, TC.PRAECANTIO, 10), Bbb = Ad,
	...
	CaF2                    = fluorite      ( 9215, "Fluorite"              , SET_RUBY              , 225, 185, 140).put(MD.RoC)                                                                                                                                                                                                                                                                                                    , Fluorite = CaF2,
	FluoriteRed             = fluorite      ( 8436, "Red Fluorite"          , SET_RUBY              , 226,  56,  65)                                                                                                                                                                                                                                                                                                                ,
	FluoritePink            = fluorite      ( 8437, "Pink Fluorite"         , SET_RUBY              , 226, 117, 148)                                                                                                                                                                                                                                                                                                                ,
	FluoriteBlue            = fluorite      ( 8438, "Blue Fluorite"         , SET_RUBY              ,  88, 172, 180)                                                                                                                                                                                                                                                                                                                ,
	FluoriteGreen           = fluorite      ( 8439, "Green Fluorite"        , SET_RUBY              ,  37, 168,  35)                                                                                                                                                                                                                                                                                                                ,
	FluoriteBlack           = fluorite      ( 8440, "Black Fluorite"        , SET_RUBY              ,  48,  48,  48).put(MD.RH)                                                                                                                                                                                                                                                                                                     ,
	FluoriteWhite           = fluorite      ( 8441, "White Fluorite"        , SET_RUBY              , 180, 180, 180)                                                                                                                                                                                                                                                                                                                ,
	FluoriteYellow          = fluorite      ( 8442, "Yellow Fluorite"       , SET_RUBY              , 206, 182,  80)                                                                                                                                                                                                                                                                                                                ,
	FluoriteOrange          = fluorite      ( 8443, "Orange Fluorite"       , SET_RUBY              , 255, 189,  88)                                                                                                                                                                                                                                                                                                                ,
	FluoriteMagenta         = fluorite      ( 8444, "Magenta Fluorite"      , SET_RUBY              , 204,  88, 255)                                                                                                                                                                                                                                                                                                                ,
	
	
	LiCl                    = oredustdcmp   ( 8029, "Lithium Chloride"      , SET_CUBE              , 222, 222, 250, 255).put(MELTING, MOLTEN, INGOTS)                                                                                                                  .uumMcfg( 0, Li             , 1*U, Cl               , 1*U)                                                                                                  .aspects(TC.FAMES, 1).setPriorityPrefix(2).heat( 880, 1655), // Can be electrolyzed for real
	...
	NaNO3                   = oredustelec   ( 8019, "Sodium Nitrate"        , SET_FINE              , 230, 230, 230, 255).put(FLAMMABLE, BRITTLE, MORTAR)                                                                                                               .uumMcfg( 0, Na             , 1*U, N                , 1*U, O                , 3*U)                                                                          .aspects(TC.IGNIS, 2).setPriorityPrefix(2),
	...
	KNO3                    = oredustelec   ( 8205, "Potassium Nitrate"     , SET_FINE              , 230, 230, 230, 255).put(FLAMMABLE, BRITTLE, MORTAR, "Saltpeter", "Nitrate")                                                                                       .uumMcfg( 0, K              , 1*U, N                , 1*U, O                , 3*U)                                                                          .aspects(TC.IGNIS, 2).setPriorityPrefix(2),
	...
	Wood                    = wood          ( 8221, "Wood"                  , SET_WOOD              , 100,  50,   0, 255).put(TICKS_PER_SMELT/ 2, FLAMMABLE, APPROXIMATE)                                                                                               .uumMcfg( 0, C              , 6*U, H2O              ,15*U)                                                                                                  .aspects(TC.ARBOR, 1                   ).setBurning(Ash, U9).setSmelting(Ash, U4).qual(1, 2.0, 16, 0).heat(400, 500),
	WoodSealed              = wood          ( 8222, "WoodSealed"            , SET_WOOD              ,  80,  40,   0, 255).put(TICKS_PER_SMELT/ 2, FLAMMABLE, COATED)                                                                                                    .setMcfg( 0, Wood           , 1*U)                                                                                                                          .aspects(TC.ARBOR, 1, TC.FABRICO    , 1).setAllToTheOutputOf(Wood).qual(1, 3.0, 24, 0).heat(500, 600).setLocal("Treated Wood"),
	WoodPolished            = wood          ( 8267, "WoodPolished"          , SET_WOOD              ,  60,  30,   0, 255).put(TICKS_PER_SMELT/ 2, FLAMMABLE, COATED)                                                                                                    .setMcfg( 0, Wood           , 1*U)                                                                                                                          .aspects(TC.ARBOR, 1, TC.FABRICO    , 1).setAllToTheOutputOf(Wood).qual(1, 3.0, 24, 0).heat(500, 600).setLocal("Polished Wood"),
	WoodRubber              = wood          ( 8224, "WoodRubber"            , SET_WOOD              , 120,  60,   0, 255).put(TICKS_PER_SMELT/ 4, FLAMMABLE, APPROXIMATE)                                                                                               .setMcfg( 0, C              , 6*U, H2O              ,15*U)                                                                                                  .aspects(TC.ARBOR, 1                   ).setBurning(Ash, U4).setSmelting(Ash, U2).qual(1, 1.5, 12, 0).heat(350, 450).setLocal("Rubber Wood"),
	Bamboo                  = wood          ( 8418, "Bamboo"                , SET_WOOD              , 100, 200, 100, 255).put(TICKS_PER_SMELT/ 2, FLAMMABLE, APPROXIMATE)                                                                                               .setMcfg( 0, C              , 6*U, H2O              ,15*U)                                                                                                  .aspects(TC.HERBA, 1                   ).setBurning(Ash, U4).setSmelting(Ash, U2).qual(1, 2.0, 32, 0).heat(350, 450),
	...
	Greatwood               = wood          ( 8296, "Greatwood"             , SET_WOOD              ,  60,  30,  25, 255).put(TICKS_PER_SMELT* 2, FLAMMABLE, APPROXIMATE)                                                                                               .setMcfg( 0, C              , 6*U, H2O              ,15*U)                                                                                                  .aspects(TC.ARBOR, 1                   ).setBurning(Ash, U4).setSmelting(Ash, U2).qual(1, 6.0, 64, 1).heat(400, 600),
	Silverwood              = wood          ( 8297, "Silverwood"            , SET_WOOD              , 234, 222, 210, 255).put(TICKS_PER_SMELT* 4, FLAMMABLE, APPROXIMATE)                                                                                               .setMcfg( 0, C              , 6*U, H2O              ,15*U)                                                                                                  .aspects(TC.ARBOR, 1, TC.PRAECANTIO , 1).setBurning(Ash,  0).setSmelting(Ash,  0).qual(1, 8.0,128, 1).heat(450, 650),
	Peanutwood              = wood          ( 8227, "Peanut Wood"           , SET_WOOD              , 120,  60,   0, 255).put(TICKS_PER_SMELT/ 2, FLAMMABLE, "Peanutwood")                                                                                              .setMcfg( 0, Wood           , 1*U)                                                                                                                          .aspects(TC.ARBOR, 1                   ).steal(Wood).heat(350, 450),
	...
	Coffee                  = dustfood      ( 9784, "Coffee"                , SET_FINE              , 150,  75,   0, 255).put("CoffeeDust")                                                                                                                                                                                                                                                                                         .aspects(TC.MOTUS, 1),
	...
	PEZ                     = orefood       ( 9716, "PEZ"                   , SET_FINE              , 210, 210, 210, 255)                                                                                                                                                                                                                                                                                                           .aspects(TC.FAMES, 1).setOriginalMod(MD.CANDY).qual(2,  8.0,  512, 3),
	Licorice                = orefood       ( 9717, "Licorice"              , SET_FINE              ,  30,  30,  30, 255)                                                                                                                                                                                                                                                                                                           .aspects(TC.FAMES, 1).setOriginalMod(MD.CANDY).qual(2,  6.0,  128, 2),
	Nougat                  = orefood       ( 9718, "Nougat"                , SET_FINE              , 240, 200, 150, 255)                                                                                                                                                                                                                                                                                                           .aspects(TC.FAMES, 1).setOriginalMod(MD.CANDY),
	...
	Honey                   = orefood       ( 9791, "Honey"                 , SET_FINE              , 250, 200,   0, 255).put(G_CONTAINERS)                                                                                                                                                                                                                                                                                         .aspects(TC.SANO, 1).heat(CS.C, CS.C+100).setOriginalMod(MD.FR),
	Honeydew                = orefood       ( 9793, "Honeydew"              , SET_FINE              , 210, 100,   0, 255).put(G_CONTAINERS)                                                                                                                                                                                                                                                                                         .aspects(TC.SANO, 1).heat(CS.C, CS.C+100).setOriginalMod(MD.FR),
	...
	DiamondPink             = diamond       ( 8424, "Pink Diamond"          , SET_DIAMOND           , 240, 160, 160, DYE_INDEX_Pink       )                                                                                                                             .uumMcfg( 1, C              , 4*U)                                                                                                                          .aspects(TC.AURAM      , 4).qual(3, 12.0,  1600,  3),
	...
	Emerald                 = emerald       ( 8301, "Emerald"               , SET_EMERALD           ,  80, 255,  80, DYE_INDEX_Green      )                                                                                                                             .uumMcfg( 0, Al2O3          , 5*U, Be               , 3*U, SiO2             ,18*U, O                , 3*U)                                                  .aspects(TC.LUCRUM     , 2),
	Aquamarine              = emerald       ( 8323, "Aquamarine"            , SET_EMERALD           , 200, 220, 255, DYE_INDEX_Cyan       )                                                                                                                             .uumMcfg( 0, Al2O3          , 5*U, Be               , 3*U, SiO2             ,18*U, O                , 3*U)                                                  .aspects(TC.AQUA       , 2),
	Morganite               = emerald       ( 8324, "Morganite"             , SET_EMERALD           , 255, 200, 200, DYE_INDEX_Pink       )                                                                                                                             .uumMcfg( 0, Al2O3          , 5*U, Be               , 3*U, SiO2             ,18*U, O                , 3*U)                                                  .aspects(TC.TEMPESTAS  , 2),
	Heliodor                = emerald       ( 8384, "Heliodor"              , SET_EMERALD           , 255, 255, 150, DYE_INDEX_Yellow     )                                                                                                                             .uumMcfg( 0, Al2O3          , 5*U, Be               , 3*U, SiO2             ,18*U, O                , 3*U)                                                  .aspects(TC.LUX        , 2),
	Goshenite               = emerald       ( 8385, "Goshenite"             , SET_EMERALD           , 240, 240, 240, DYE_INDEX_White      )                                                                                                                             .uumMcfg( 0, Al2O3          , 5*U, Be               , 3*U, SiO2             ,18*U, O                , 3*U)                                                  .aspects(TC.VACUOS     , 2),
	Bixbite                 = emerald       ( 8386, "Bixbite"               , SET_EMERALD           , 255,  80,  80, DYE_INDEX_Red        ).put("ScarletEmerald")                                                                                                       .uumMcfg( 0, Al2O3          , 5*U, Be               , 3*U, SiO2             ,18*U, O                , 3*U)                                                  .aspects(TC.SANO       , 2),
	Maxixe                  = emerald       ( 8387, "Maxixe"                , SET_EMERALD           ,  80,  80, 255, DYE_INDEX_Blue       )                                                                                                                             .uumMcfg( 0, Al2O3          , 5*U, Be               , 3*U, SiO2             ,18*U, O                , 3*U)                                                  .aspects(TC.RADIO      , 2),
	
	
	Sapphire                = sapphire      ( 8304, "Sapphire"              , SET_GEM_VERTICAL      , 120, 120, 160, DYE_INDEX_Blue       ).put("Saphire")                                                                                                              .uumMcfg( 6, Al2O3          , 5*U)                                                                                                                          .aspects(TC.LUCRUM     , 1),
	GreenSapphire           = sapphire      ( 8305, "Green Sapphire"        , SET_GEM_VERTICAL      , 100, 200, 130, DYE_INDEX_Green      )                                                                                                                             .uumMcfg( 6, Al2O3          , 5*U, Mg               , 1*U)                                                                                                  .aspects(TC.SANO       , 1),
	YellowSapphire          = sapphire      ( 8315, "Yellow Sapphire"       , SET_GEM_VERTICAL      , 220, 220,  50, DYE_INDEX_Yellow     )                                                                                                                             .uumMcfg( 6, Al2O3          , 5*U, TiO2             , 1*U)                                                                                                  .aspects(TC.TUTAMEN    , 1),
	OrangeSapphire          = sapphire      ( 8314, "Orange Sapphire"       , SET_GEM_VERTICAL      , 220, 150,  50, DYE_INDEX_Orange     )                                                                                                                             .uumMcfg( 6, Al2O3          , 5*U, Cu               , 1*U)                                                                                                  .aspects(TC.PERMUTATIO , 1),
	BlueSapphire            = sapphire      ( 8328, "Blue Sapphire"         , SET_GEM_VERTICAL      , 100, 100, 200, DYE_INDEX_Blue       )                                                                                                                             .uumMcfg( 6, Al2O3          , 5*U, Fe               , 1*U)                                                                                                  .aspects(TC.METALLUM   , 1),
	PurpleSapphire          = sapphire      ( 8383, "Purple Sapphire"       , SET_GEM_VERTICAL      , 220,  50, 255, DYE_INDEX_Purple     )                                                                                                                             .uumMcfg( 6, Al2O3          , 5*U, V                , 1*U)                                                                                                  .aspects(TC.ELECTRUM   , 1),
	Ruby                    = sapphire      ( 8302, "Ruby"                  , SET_RUBY              , 255, 100, 100, DYE_INDEX_Red        )                                                                                                                             .uumMcfg( 6, Al2O3          , 5*U, Cr               , 1*U)                                                                                                  .aspects(TC.MACHINA    , 1),
	
	
	Spinel                  = valgemelec    ( 8326, "Spinel"                , SET_RUBY              ,   0, 100,   0, 127).lens(DYE_INDEX_Green      )                                                                                                                   .uumMcfg( 0, Al2O3          , 5*U, Mg               , 1*U, O                , 1*U)                                                                          .aspects(TC.VITREUS, 2, TC.LUCRUM                   , 3).qual(3,  7.0,   384,  2),
	BalasRuby               = valgemelec    ( 8303, "Balas Ruby"            , SET_RUBY              , 255, 100, 100, 127).lens(DYE_INDEX_Red        ).put("FoolsRuby").setLocal("Ruby").steal(Ruby)                                                                     .uumMcfg( 0, Cr             , 2*U, Mg               , 1*U, O                , 4*U)                                                                          .aspects(TC.VITREUS, 2, TC.LUCRUM, 2, TC.STRONTIO   , 2).qual(3,  7.0,   384,  2),
	...
	Jasper                  = jasper        ( 8309, "Red Jasper"            , SET_GLASS             , 200,  80,  80, DYE_INDEX_Red        ).put("Jasper")                                                                                                                                                                                                                                                                           ,
	JasperOcean             = jasper        ( 8425, "Ocean Jasper"          , SET_GLASS             , 139, 115,  86, DYE_INDEX_Orange     )                                                                                                                                                                                                                                                                                         ,
	JasperRainforest        = jasper        ( 8426, "Rainforest Jasper"     , SET_GLASS             , 129, 123,  55, DYE_INDEX_Yellow     )                                                                                                                                                                                                                                                                                         ,
	JasperBlue              = jasper        ( 8427, "Blue Jasper"           , SET_GLASS             ,  60, 124, 151, DYE_INDEX_Blue       )                                                                                                                                                                                                                                                                                         ,
	JasperGreen             = jasper        ( 8428, "Green Jasper"          , SET_GLASS             ,  91, 131, 108, DYE_INDEX_Green      )                                                                                                                                                                                                                                                                                         ,
	JasperYellow            = jasper        ( 8429, "Yellow Jasper"         , SET_GLASS             , 156, 128,  39, DYE_INDEX_Yellow     )                                                                                                                                                                                                                                                                                         ,
	
	
	TigerEyeYellow          = tigereye      ( 8430, "Tiger Eye"             , SET_GLASS             , 142, 116,  61, DYE_INDEX_Yellow     ).put("YellowTigerEye")                                                                                                                                                                                                                                                                   ,
	TigerEyeGreen           = tigereye      ( 8431, "Cat's Eye"             , SET_GLASS             ,  77, 116,  81, DYE_INDEX_Green      ).put("GreenTigerEye" )                                                                                                                                                                                                                                                                   ,
	TigerEyeRed             = tigereye      ( 8432, "Dragon Eye"            , SET_GLASS             , 164,  95,  83, DYE_INDEX_Red        ).put("RedTigerEye"   )                                                                                                                                                                                                                                                                   ,
	TigerEyeBlue            = tigereye      ( 8433, "Hawk's Eye"            , SET_GLASS             ,  76,  94, 109, DYE_INDEX_Blue       ).put("BlueTigerEye"  )                                                                                                                                                                                                                                                                   ,
	TigerEyeBlack           = tigereye      ( 8434, "Black Eye"             , SET_GLASS             ,  66,  68,  66, DYE_INDEX_Black      ).put("BlackTigerEye" )                                                                                                                                                                                                                                                                   ,
	TigerIron               = tigereye      ( 8435, "Tiger Iron"            , SET_GLASS             , 106,  86,  66, DYE_INDEX_Yellow     )                                                                                                                                                                                                                                                                                         ,
	...
	*/
	...
	HydratedCoal            = mixdust       ( 8335, "Hydrated Coal"         , SET_LIGNITE           ,  70,  70, 100, 255).put(BRITTLE, FURNACE, MORTAR)                                                                                                                 .uumMcfg( 8, Coal           , 8*U, H2O              , 1*U)                                                                                                  ,
	...
	SmokeyQuartz            = quartz        ( 8397, "Smokey Quartz"         , SET_QUARTZ            ,  20,  20,  20, 255).put(CRYSTALLISABLE, "QuartzSmoky", "SmokyQuartz")                                                                                             .uumMcfg( 0, SiO2           , 1*U)                                                                                                                          .aspects(TC.POTENTIA, 1, TC.VITREUS, 1, TC.TENEBRAE     , 1).qual(1, 2.5, 32, 1),
	...
	MoonRock                = stone         ( 8513, "Moon Stone"            , SET_STONE             , 189, 189, 189, 255).put(MELTING, MOLTEN)                                                                                                                                                                                                                                                                                      .aspects(TC.ALIENIS     , 1).qual(1, 5.0, 32, 1).setLocal("Moon"),
	MoonTurf                = stone         ( 8514, "Moon Turf"             , SET_STONE             , 207, 207, 207, 255)                                                                                                                                                                                                                                                                                                           .aspects(TC.ALIENIS     , 1).qual(1, 3.0, 16, 1),
	MarsRock                = stone         ( 8515, "Mars Stone"            , SET_STONE             , 189,  77,  77, 255).put(MELTING, MOLTEN)                                                                                                                                                                                                                                                                                      .aspects(TC.ALIENIS     , 1).qual(1, 5.0, 32, 1).setLocal("Mars"),
	MarsSand                = stone         ( 8516, "Mars Sand"             , SET_STONE             , 207,  66,  66, 255)                                                                                                                                                                                                                                                                                                           .aspects(TC.ALIENIS     , 1).qual(1, 3.0, 16, 1),
	...
	Slate                   = stone         ( 9222, "Slate"                 , SET_STONE             , 148, 151, 156, 255)                                                                                                                                                                                                                                                                                                           .aspects(TC.TERRA       , 1).qual(1, 2.0, 16, 0),
	...
	Adamantine              = metalore      ( 8784, "Adamantine"            , SET_METALLIC          , 255,   0,  64, 255).qual(3, 10.0, 4500, 5).put(MAGNETIC_PASSIVE, DECOMPOSABLE, ELECTROLYSER, WITHER_PROOF, ENDER_DRAGON_PROOF)                                    .uumMcfg( 0, Ad             , 3*U, O                , 4*U)                                                                                                  .aspects(TC.METALLUM, 5, TC.PRAECANTIO                          , 5).heat(Ad),
	...
	Tartarite               = alloy         ( 8782, "Tartarite"             , SET_METALLIC          , 255, 118,  60, 255).qual(3, 20.0, 7680, 5).put(MAGNETIC_PASSIVE, WITHER_PROOF, ENDER_DRAGON_PROOF)                                                                .uumMcfg( 0, Adamantine     , 1*U, Atl              , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM    , 1, TC.COGNITO     , 1).alloyCentrifuge(),
	...
	Electrum                = alloymachore  ( 8600, "Electrum"              , SET_SHINY             , 255, 255, 100, 255).put(RAILS, WASHING_MERCURY, MORTAR, MOLTEN, WITHER_PROOF, ENDER_DRAGON_PROOF).qual(3, 12.0,   64, 2)                                          .uumMcfg( 0, Ag             , 1*U, Au               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.LUCRUM, 2).alloyCentrifuge(),
	SterlingSilver          = alloymachine  ( 8601, "Sterling Silver"       , SET_SHINY             , 250, 220, 225, 255).put(MORTAR, VALUABLE, ENDER_DRAGON_PROOF).qual(3, 13.0,  128, 2)                                                                              .uumMcfg( 0, Cu             , 1*U, Ag               , 4*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.LUCRUM, 2).alloyCentrifuge(),
	RoseGold                = alloymachine  ( 8602, "Rose Gold"             , SET_SHINY             , 255, 230,  30, 255).put(MORTAR, VALUABLE, WITHER_PROOF, "Tumbaga").qual(3, 14.0,  128, 2)                                                                         .uumMcfg( 0, Cu             , 1*U, Au               , 4*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.LUCRUM, 2).alloyCentrifuge(),
	...
	InductiveAlloy          = alloymachine  ( 8604, "GoldInductive"         , SET_SHINY             , 255, 150,  75, 255).put(MORTAR, MAGNETIC_PASSIVE, MOLTEN)                                                                                                         .uumMcfg( 0, Au             , 1*U, Redstone         , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.MAGNETO, 1).alloyCentrifuge().setLocal("Inductive Alloy"),
	Cd_In_Ag_Alloy          = alloymachine  ( 8605, "Cd-In-Ag-Alloy"        , SET_METALLIC          , 100, 100, 128, 255)                                                                                                                                               .uumMcfg( 0, Cd             , 1*U, In               , 1*U, Ag               , 1*U)                                                                          .aspects(TC.METALLUM, 2, TC.TENEBRAE, 1).alloyCentrifuge(),
	...
	AluminiumAlloy          = alloymachine  ( 8622, "Aluminium Alloy"       , SET_METALLIC          , 200, 200, 180, 255).put(CENTRIFUGE)                                                                                                                               .uumMcfg(45, Al             ,45*U, Si               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.FABRICO, 1).qual(Al),
	
	
	Bronze                  = alloymachine  ( 8610, "Bronze"                , SET_METALLIC          , 210, 130,  60, 255).put(RAILS, FURNACE, EXTRUDER_SIMPLE, MORTAR, MOLTEN).qual(3, 6.0,  192, 2)                                                                    .uumMcfg( 0, Cu             , 3*U, Sn               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1).alloyCentrifuge(Cu.mMeltingPoint, Cu.mBoilingPoint),
	...
	Steel                   = alloymachore  ( 8630, "Steel"                 , SET_METALLIC          , 130, 130, 130, 255).put(MOLTEN, RAILS, MORTAR, MAGNETIC_PASSIVE).qual(3,  6.0,  512, 2)                                                                           .uumMcfg( 0, WroughtIron    , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.ORDO, 1).heat(2046, Fe.mBoilingPoint, Fe.mPlasmaPoint).setRGBaLiquid(255, 20, 10, 255),
	BlackSteel              = alloymachine  ( 8631, "Black Steel"           , SET_METALLIC          ,  90,  90,  90, 255).put(MOLTEN).qual(3,  6.5,  768, 2)                                                                                                            .uumMcfg( 0, Ni             , 1*U, BlackBronze      , 1*U, Steel            , 3*U)                                                                          .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.INSTRUMENTUM, 1).alloyCentrifuge(),
	RedSteel                = alloymachine  ( 8632, "Red Steel"             , SET_METALLIC          , 140, 100, 100, 255).put(MOLTEN).qual(3,  7.0,  896, 2)                                                                                                            .setMcfg( 0, SterlingSilver , 1*U, BismuthBronze    , 1*U, Steel            , 2*U, BlackSteel       , 4*U)                                                  .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.INSTRUMENTUM, 1).alloyCentrifuge(),
	BlueSteel               = alloymachine  ( 8633, "Blue Steel"            , SET_METALLIC          , 100, 100, 140, 255).put(MOLTEN).qual(3,  7.5, 1024, 2)                                                                                                            .uumMcfg( 0, RoseGold       , 1*U, Brass            , 1*U, Steel            , 2*U, BlackSteel       , 4*U)                                                  .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.INSTRUMENTUM, 1).alloyCentrifuge(),
	...
	TungstenSteel           = alloymachine  ( 8635, "Tungstensteel"         , SET_METALLIC          , 100, 100, 160, 255).put(MOLTEN, RAILS, MAGNETIC_PASSIVE, "TungstenSteel", "Wolframsteel", "WolframSteel").qual(3, 10.0, 5120, 4)                                  .uumMcfg( 0, Steel          , 1*U, W                , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.TUTAMEN, 1).alloyCentrifuge(),
	TungstenCarbide         = alloymachine  ( 8638, "Tungsten Carbide"      , SET_METALLIC          , 123, 123, 123, 255).put(RAILS, "Carbide", "WolframCarbide").qual(3, 10.0, 5120, 4)                                                                                .uumMcfg( 0, W              , 1*U, C                , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.TUTAMEN, 1).setDensity(15.6).alloyCentrifuge(3070, 6270),
	HSLA                    = alloymachine  ( 8637, "HSLA-Steel"            , SET_METALLIC          , 210, 210, 255, 255).put(MOLTEN, RAILS, CENTRIFUGE, MORTAR, MAGNETIC_PASSIVE, "HSLA")                                                                              .uumMcfg( 0, WroughtIron    , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.ORDO, 1).steal(Steel).heat(1873, Fe.mBoilingPoint, Fe.mPlasmaPoint),
	SpringSteel             = alloymachine  ( 8639, "HSLA-SpringSteel"      , SET_METALLIC          , 220, 100, 100, 255).put(CENTRIFUGE, MAGNETIC_PASSIVE)                                                                                                             .uumMcfg(45, HSLA           ,45*U, Redstone         , 2*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.ORDO, 1).steal(HSLA).setLocal("Spring Steel"),
	...
	TitaniumGold            = alloymachine  ( 8654, "Titanium-Gold"         , SET_METALLIC          , 222, 222, 255, 255).put(MOLTEN).qual(3, 12.0, 5120, 4)                                                                                                            .uumMcfg( 0, Ti             , 3*U, Au               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 3, TC.LUCRUM, 1).alloyCentrifuge(),
	Ta4HfC5                 = alloymachine  ( 8802,"Tantalum Hafnium Carbide",SET_METALLIC          ,  32, 128,  32, 255)                                                                                                                                               .uumMcfg( 0, Ta             , 4*U, Hf               , 1*U, C                , 5*U)                                                                          .aspects(TC.METALLUM, 2, TC.GELUM, 2).heat(4263).alloyCentrifuge(),
	...
	Invar                   = alloymachine  ( 8661, "Invar"                 , SET_METALLIC          , 220, 220, 150, 255).put(MORTAR, MAGNETIC_PASSIVE, MOLTEN).qual(3,  6.0,    256,  2)                                                                               .uumMcfg( 0, WroughtIron    , 2*U, Ni               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.GELUM, 1).alloyCentrifuge(),
	Constantan              = alloymachine  ( 8662, "Constantan"            , SET_METALLIC          , 227, 150, 128, 255).put(MORTAR, MAGNETIC_PASSIVE, MOLTEN, "Cupronickel").qual(3,  6.0,  64,  1)                                                                   .uumMcfg( 0, Cu             , 1*U, Ni               , 1*U)                                                                                                  .alloyCentrifuge(), Cupronickel = Constantan,
	Nichrome                = alloymachine  ( 8663, "Nichrome"              , SET_METALLIC          , 205, 206, 246, 255).put(MOLTEN).qual(3,  6.0,   64,  2)                                                                                                           .uumMcfg( 0, Ni             , 4*U, Cr               , 1*U)                                                                                                  .alloyCentrifuge(),
	Kanthal                 = alloymachine  ( 8664, "Kanthal"               , SET_METALLIC          , 194, 210, 223, 255).put(MOLTEN).qual(3,  6.0,   64,  2)                                                                                                           .uumMcfg( 0, WroughtIron    , 1*U, Al               , 1*U, Cr               , 1*U)                                                                          .alloyCentrifuge(),
	...
	StainlessSteel          = alloymachine  ( 8636, "Stainless Steel"       , SET_SHINY             , 200, 200, 220, 255).put(MOLTEN, RAILS).qual(3,  7.0, 480,  2)                                                                                                     .uumMcfg( 0, WroughtIron    , 4*U, Invar            , 3*U, Cr               , 1*U, Mn               , 1*U)                                                  .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.VITREUS, 1).alloyCentrifuge(),
	...
	Osmiridium              = alloymachine  ( 8682, "Osmiridium"            , SET_METALLIC          , 100, 100, 255, 255).put(VALUABLE, MOLTEN).qual(3, 11.0, 3840, 4)                                                                                                  .uumMcfg( 0, Os             , 1*U, Ir               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.MACHINA, 2, TC.NEBRISUM, 1).alloyCentrifuge(),
	...
	Signalum                = alloymachine  ( 8708, "Signalum"              , SET_METALLIC          , 255,  64,   0, 255).put(MOLTEN, FURNACE, EXTRUDER_SIMPLE)                                                                                                         .uumMcfg( 8, Cu             , 1*U, Ag               , 2*U, RedAlloy         , 5*U)                                                                          .aspects(TC.METALLUM, 3, TC.POTENTIA, 1).alloyCentrifuge(),
	Lumium                  = alloymachine  ( 8709, "Lumium"                , SET_SHINY             , 255, 255,  80, 255).put(MOLTEN, FURNACE, EXTRUDER_SIMPLE, LIGHTING, GLOWING)                                                                                      .uumMcfg( 4, Sn             , 3*U, Ag               , 1*U, Glowstone        , 4*U)                                                                          .aspects(TC.METALLUM, 3, TC.LUX, 1).alloyCentrifuge(),
	...
	Enderium                = alloymachine  ( 8710, "Enderium"              , SET_METALLIC          ,  60, 125, 115, 255).put(MAGICAL, MOLTEN).qual(3,  8.0, 256, 3)                                                                                                    .setMcfg( 1, EnderiumBase   , 1*U, EnderPearl       , 1*U)                                                                                                  .aspects(TC.METALLUM, 3, TC.ALIENIS, 1).alloyCentrifuge(),
//  InfusedGold             = alloymachore  ( 8712, "Infused Gold"          , SET_SHINY             , 255, 200,  60, 255).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                      ,
	FakeOsmium              = alloy         ( 8719, "Osmium"                , SET_METALLIC          , 160, 160, 255, 255).put(G_INGOT_MACHINE_ORES, MOLTEN, FURNACE, EXTRUDER_SIMPLE).setLocal("'Osmium'").steal(Os).qual(2, 6.0, 256, 2)                               .uumMcfg( 0, Os             , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.MACHINA, 2),
	...
	RedstoneAlloy           = alloy         ( 8733, "Redstone Alloy"        , SET_METALLIC          , 140,  50,  50, 255).put(MOLTEN)                                                                                                                                   .uumMcfg( 1, Si             , 1*U, Redstone         , 1*U)                                                                                                  .aspects(TC.METALLUM, 3, TC.MACHINA, 1).setOriginalMod(MD.EIO).alloyCentrifuge().setPriorityPrefix(5),
	NikolineAlloy           = alloy         ( 8737, "Nikoline Alloy"        , SET_METALLIC          ,  50,  90, 140, 255).put(MOLTEN)                                                                                                                                   .uumMcfg( 1, Si             , 1*U, Nikolite         , 1*U)                                                                                                  .aspects(TC.METALLUM, 3, TC.POTENTIA, 1).alloyCentrifuge().setPriorityPrefix(5),
	TeslatineAlloy          = alloy         ( 8738, "Teslatine Alloy"       , SET_METALLIC          ,  50,  90, 140, 255).put(MOLTEN)                                                                                                                                   .uumMcfg( 1, Si             , 1*U, Teslatite        , 1*U)                                                                                                  .aspects(TC.METALLUM, 3, TC.POTENTIA, 1).alloyCentrifuge().setPriorityPrefix(5),
	...
	Mauftrium               = alloymachore  ( 8739, "Mauftrium"             , SET_SHINY             , 250, 225, 121, 255).put(MAGICAL).qual(3, 12.0,1024, 3)                                                                                                                                                                                                                                                                        .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 1).heat(Fe.mMeltingPoint, Fe.mBoilingPoint),
	Elvorium                = alloymachore  ( 8740, "Elvorium"              , SET_SHINY             , 235, 164,  77, 255).put(MAGICAL).qual(3, 14.0,2048, 3)                                                                                                            .setMcfg( 1, ElvenElementium, 1*U, ElvenDragonstone , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 4).heat(Fe.mMeltingPoint+1000, Fe.mBoilingPoint+2000),
	NiflheimPower           = alloy         ( 8741, "Niflheim Power"        , SET_SHINY             ,  94,  94, 174, 255).put(MAGICAL, GLOWING, UNBURNABLE).qual(3, 18.0,2048, 3)                                                                                       .setMcfg( 1, Elvorium       , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.GELUM     , 2, TC.POTENTIA, 2),
	MuspelheimPower         = alloy         ( 8742, "Muspelheim Power"      , SET_SHINY             , 174,  94,  94, 255).put(MAGICAL, GLOWING, UNBURNABLE, BURNING).qual(3, 18.0,2048, 3)                                                                              .setMcfg( 1, Elvorium       , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.IGNIS     , 2, TC.POTENTIA, 2),
	...
	HSSG                    = alloymachine  ( 8796, "HSS-G"                 , SET_METALLIC          , 153, 153,   0, 255).put(MOLTEN).qual(3, 10.0F, 4000, 3)                                                                                                           .uumMcfg( 0, TungstenSteel  , 5*U, Cr               , 1*U, Mo               , 2*U, V                , 1*U)                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 1, TC.MACHINA, 1).alloyCentrifuge(),
	HSSE                    = alloymachine  ( 8797, "HSS-E"                 , SET_METALLIC          ,  51, 102,   0, 255).put(MOLTEN).qual(3, 10.0F, 5120, 4)                                                                                                           .uumMcfg( 0, HSSG           , 6*U, Co               , 1*U, Mn               , 1*U, Si               , 1*U)                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 2, TC.MACHINA, 2).alloyCentrifuge(),
	HSSS                    = alloymachine  ( 8798, "HSS-S"                 , SET_METALLIC          , 102,   0,  51, 255).put(MOLTEN).qual(3, 14.0F, 3000, 4)                                                                                                           .uumMcfg( 0, HSSG           , 6*U, Osmiridium       , 2*U, Ir               , 1*U)                                                                          .aspects(TC.METALLUM, 2, TC.TUTAMEN, 2, TC.MACHINA, 2, TC.NEBRISUM, 1).alloyCentrifuge(),
	
	
	Bedrockium              = metalmachore  ( 8795, "Bedrockium"            , SET_ROUGH             ,  88,  88,  88, 255).put(WITHER_PROOF, ENDER_DRAGON_PROOF)                                                                                                                                                                                                                                                                     .aspects(TC.METALLUM, 1, TC.TERRA, 10).heat(2000),
	
	
	Draconium               = metalmachore  ( 8791, "Draconium"             , SET_METALLIC          , 150,  50, 250, 255).qual(3, 16.0F,  5000, 4).put(MOLTEN, WITHER_PROOF, ENDER_DRAGON_PROOF)                                                                                                                                                                                                                                    .aspects(TC.METALLUM, 2, TC.ALIENIS, 1).heat(4500),
	DraconiumAwakened       = alloymachine  ( 8792, "DraconiumAwakened"     , SET_METALLIC          , 250, 150,  50, 255).qual(3, 24.0F, 10000, 5).put(MOLTEN, WITHER_PROOF, ENDER_DRAGON_PROOF, GLOWING)                                                               .setMcfg( 1, Draconium      , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.ALIENIS, 4).heat(5500).setLocal("Awakened Draconium"),
	
	
	CrystalMatrix           = alloymachine  ( 8799, "Crystal Matrix"        , SET_SHINY             ,  83, 231, 234, 255).qual(3,        20.0,     25600,  4).put(VALUABLE, UNBURNABLE, MAGICAL, WITHER_PROOF, ENDER_DRAGON_PROOF)                                      .setMcfg( 1, Diamond        ,20*U, NetherStar       , 2*U)                                                                                                  .aspects(TC.VITREUS, 8, TC.PRAECANTIO, 4, TC.NEBRISUM, 4).heat(3896, 5127),
	CosmicNeutronium        = metalmachine  ( 8800, "Cosmic Neutronium"     , SET_SHINY             ,  30,  10,  40, 255).qual(3,        50.0,    100000, 10).put(VALUABLE, UNBURNABLE, MAGICAL, WITHER_PROOF, ENDER_DRAGON_PROOF)                                                                                                                                                                                                  .aspects(TC.POTENTIA, 10, TC.NEBRISUM, 10, TC.RADIO, 10, TC.TENEBRAE, 10, TC.TERRA, 10).heat(100000),
	Infinity                = metalmachine  ( 8801, "Infinity"              , SET_SHINY             , 250, 250, 250, 255).qual(3,1000000000.0,1000000000, 15).put(VALUABLE, UNBURNABLE, MAGICAL, WITHER_PROOF, ENDER_DRAGON_PROOF, GLOWING, LIGHTING, MAGNETIC_ACTIVE)                                                                                                                                                              .aspects(TC.POTENTIA, 10, TC.NEBRISUM, 10, TC.PERMUTATIO, 10, TC.MAGNETO, 10, TC.PRAECANTIO, 10, TC.AURAM, 10).heat(100000),
	
	
	Trinaquadalloy          = alloymachine  ( 8684, "Trinaquadalloy"        , SET_METALLIC          , 146, 186, 146, 255).put(CENTRIFUGE, "NaquadahAlloy").qual(3, 14.0,  20480,  5)                                                                                    .uumMcfg( 0, Ke             , 6*U, Nq               , 2*U, C                , 1*U)                                                                          .aspects(TC.METALLUM, 3, TC.TUTAMEN, 3, TC.NEBRISUM, 1).alloyCentrifuge(),
