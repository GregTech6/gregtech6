...
public class MT {
	...
	Ad      = element( 2220, "Adamantium"            , "Ad"      , 222, 580, 5425, 14528, 13.35624762, SET_SHINY   , 255, 255, 255, 255).qual(3, 10.0, 5120, 5).put(G_INGOT_MACHINE_ORES, UUM, SMITHABLE, MELTING, MOLTEN, EXTRUDER, MAGICAL, MAGNETIC_PASSIVE, WITHER_PROOF, ENDER_DRAGON_PROOF, "Adamant", "Bibibium").aspects(TC.METALLUM, 10, TC.PRAECANTIO, 10), Bbb = Ad,
