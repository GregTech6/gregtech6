...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60     ).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                      ,
	...
	AncientDebris           = metalore      ( 8744, "Ancient Debris"        , SET_LAPIS             , 110,  80,  90, 255).put("Ancient", UNBURNABLE, WITHER_PROOF, VALUABLE, MELTING).qual(0, 1.0,   16,  3)                                                                                                                                                                                                                        .aspects(TC.METALLUM, 2, TC.ALIENIS, 2).heat(MeteoricIron),
