...
public class MT {
	...
	S       = polyatomic  ( 160, "Sulfur"         , "S"     ,  16,  16,   388,   717,  2.067     , SET_FINE    , 234, 234,   0, 255, UUM, FUSION, CHALCOGEN      , G_CRYSTAL_ORES      , TICKS_PER_SMELT* 5, FLAMMABLE, MELTING, MOLTEN, BRITTLE, MORTAR, "Sulphur", "Brimstone").aspects(TC.IGNIS, 1                                    ).setPriorityPrefix(2),
	...
	Au_198  = noblemetal  ( 791, "Gold-198"       , "Au-198",  79, 119,  1337,  3129, 19.282     , SET_SHINY   , 255, 230,  80                  , COPPER_GROUP   , G_INGOT_ORES        , WASHING_MERCURY, MOLTEN, VALUABLE, WITHER_PROOF                                        ).aspects_met_rad(2, 1                                   ).qual(3, 12.5, 64, 2),
	...
	Am_242  = actinide    ( 952, "Americium-242"  , "Am-242",  95, 147,  1449,  2880, 13.69      , SET_RAD     , 210, 210, 210                                                                                                                                                  ).aspects_met_rad(1, 3                                   ).qual(3, 4.0, 256, 2),
