...
public class MT {
	...
	static OreDictMaterial emerald      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, byte aColor)  {return valgemcent      (aID, aNameOreDict, aSets, aR, aG, aB, 127).lens(aColor).put(MELTING).aspects(TC.VITREUS, 3, TC.LUCRUM, 3).qual(3, 9.0, 128, 2).setSmelting(Be, U36);}
	static OreDictMaterial sapphire     (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, byte aColor)  {return valgemcent      (aID, aNameOreDict, aSets, aR, aG, aB, 127).lens(aColor).put(MELTING).aspects(TC.VITREUS, 3, TC.LUCRUM, 4).qual(3, 7.0, 512, 3).setSmelting(Al2O3, 3*U4);}
	...
	Grossular               = valgemelec    ( 9119, "Grossular"             , SET_RUBY              , 200, 100,   0, 127).lens(DYE_INDEX_Orange     ).put(MD.GT, "GarnetOrange")                                                                                        .uumMcfg( 0, Al2O3          , 5*U, SiO2             , 9*U, Ca               , 3*U, O                , 3*U)                                                  .aspects(TC.VITREUS, 3, TC.LUCRUM, 1, TC.VOLATUS    , 1).qual(3,  7.0,   128,  2).setSmelting(null, 0),
	Pyrope                  = valgemelec    ( 9127, "Pyrope"                , SET_RUBY              , 120,  50, 100, 127).lens(DYE_INDEX_Purple     ).put(MD.GT, "GarnetPurple")                                                                                        .uumMcfg( 0, Al2O3          , 5*U, SiO2             , 9*U, Mg               , 3*U, O                , 3*U)                                                  .aspects(TC.VITREUS, 3, TC.LUCRUM, 1, TC.SANO       , 1).qual(3,  7.0,   128,  2).setSmelting(null, 0),
	...
	Uvarovite               = valgemelec    ( 9135, "Uvarovite"             , SET_RUBY              , 180, 255, 180, 127).lens(DYE_INDEX_Lime       ).put(MD.GT, "GarnetGreen")                                                                                         .uumMcfg( 0, Ca             , 3*U, SiO2             , 9*U, Cr               , 2*U, O                , 6*U)                                                  .aspects(TC.VITREUS, 3, TC.LUCRUM, 1, TC.MACHINA    , 1).qual(3,  8.0,   128,  2).setSmelting(null, 0),
	...
	Amazonite               = valgemelec    ( 8417, "Amazonite"             , SET_LAPIS             ,  71, 241, 170, 255).lens(DYE_INDEX_Green      ).put(MD.VOLTZ)                                                                                                     .uumMcfg( 0, Al2O3          , 5*U, SiO2             ,18*U, K                , 2*U, O                , 1*U)                                                  .aspects(TC.VITREUS, 3, TC.LUCRUM                   , 5).qual(3,  7.0,   256,  2).setSmelting(null, 0),
	...
	OnyxRed                 = valgemelec    ( 8415, "OnyxRed"               , SET_LAPIS             , 255,  88,  77, 255).lens(DYE_INDEX_Red        ).put(MD.VOLTZ)                                                                                                     .uumMcfg( 0, SiO2           , 1*U)                                                                                                                          .aspects(TC.VITREUS, 4, TC.LUCRUM                   , 2).qual(3,  7.0,   256,  2).setSmelting(null, 0).setLocal("Red Onyx"),
	OnyxBlack               = valgemelec    ( 8416, "OnyxBlack"             , SET_LAPIS             ,  50,  50,  50, 255).lens(DYE_INDEX_Black      ).put(MD.VOLTZ)                                                                                                     .uumMcfg( 0, SiO2           , 1*U)                                                                                                                          .aspects(TC.VITREUS, 4, TC.LUCRUM                   , 2).qual(3,  7.0,   256,  2).setSmelting(null, 0).setLocal("Black Onyx"),
	...
	Craponite               = valgem        ( 8322, "Craponite"             , SET_FLINT             , 255, 170, 185, 127).lens(DYE_INDEX_Magenta    ).put(MORTAR, CRYSTALLISABLE, MD.GT)                                                                                                                                                                                                                                            .aspects(TC.VITREUS, 3, TC.LUCRUM, 3, TC.STRONTIO   , 2).qual(3,  7.0,   256,  2).setSmelting(null, 0),
