...
public class MT {
	...
	Amethyst                = valgemelec    ( 8313, "Amethyst"              , SET_RUBY              , 166, 120, 241, 127, RANDOM_SMALL_GEM_ORE                                ).lens(DYE_INDEX_Pink       )                                                         .uumMcfg( 0, SiO2           , 4*U, Fe               , 1*U)                                                                                                  .aspects(TC.VITREUS, 4, TC.LUCRUM                   , 6).qual(3,  7.0,   256,  3),
