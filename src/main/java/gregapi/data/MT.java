...
public class MT {
	...
	ClayBrown               = dustelec      ( 8276, "ClayBrown"             , SET_ROUGH             , 230, 140,  75, 255).put(MORTAR, MD.GT)                                                                                                                            .uumMcfg( 7, Li             , 1*U, Al2O3            , 2*U, SiO2             , 2*U, K                , 2*U)                                                  .heat(2000).setLocal("Brown Clay"),
	Ceramic                 = dust          ( 8225, "Ceramic"               , SET_ROUGH             , 220, 130,  70, 255).put(PLATES, BRITTLE, MORTAR, MD.GT)                                                                                                           .uumMcfg( 7, Li             , 1*U, Al2O3            , 2*U, SiO2             , 2*U)                                                                          .steal(Clay).heat(2000).setPulver(Clay, U2).setCompressing(null, 0).setBending(null, 0).setForging(null, 0).setSmashing(null, 0),
	...
	AnnealedCopper          = metalnd       ( 8640, "Annealed Copper"       , SET_SHINY             , 255, 120,  20, 255).put(MOLTEN, FURNACE, EXTRUDER_SIMPLE, MORTAR, WIRES, RAILS, MD.GT)                                                                            .uumMcfg( 0, Cu             , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.PERMUTATIO, 1           ).setPulver(Cu      , U)                                                                                                                                                        .steal(Cu).alloyCentrifuge(2800, Cu.mBoilingPoint),
...
//  InfusedGold             = alloymachore  ( 8712, "Infused Gold"          , SET_SHINY             , 255, 200,  60, 255).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                      ,
	...
	HSSG                    = alloymachine  ( 8796, "HSS-G"                 , SET_METALLIC          , 153, 153,   0, 255).put(MOLTEN, MD.GT).qual(3, 10.0F, 4000, 3)                                                                                                    .uumMcfg( 0, TungstenSteel  , 5*U, Cr               , 1*U, Mo               , 2*U, V                , 1*U)                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 1, TC.MACHINA, 1).alloyCentrifuge(),
	HSSE                    = alloymachine  ( 8797, "HSS-E"                 , SET_METALLIC          ,  51, 102,   0, 255).put(MOLTEN, MD.GT).qual(3, 10.0F, 5120, 4)                                                                                                    .uumMcfg( 0, HSSG           , 6*U, Co               , 1*U, Mn               , 1*U, Si               , 1*U)                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 2, TC.MACHINA, 2).alloyCentrifuge(),
	HSSS                    = alloymachine  ( 8798, "HSS-S"                 , SET_METALLIC          , 102,   0,  51, 255).put(MOLTEN, MD.GT).qual(3, 14.0F, 3000, 4)                                                                                                    .uumMcfg( 0, HSSG           , 6*U, Osmiridium       , 2*U, Ir               , 1*U)                                                                          .aspects(TC.METALLUM, 2, TC.TUTAMEN, 2, TC.MACHINA, 2, TC.NEBRISUM, 1).alloyCentrifuge(),
