...
public class MT {
	...
	static OreDictMaterial diamond      (int aID, String aNameOreDict                    , long aR, long aG, long aB, byte aColor)  {return valgemdcmp      (aID, aNameOreDict, SET_DIAMOND     , aR, aG, aB,127).lens(aColor).steal(C    ).aspects(TC.VITREUS, 3, TC.LUCRUM , 4                ).qual(3, 8.0,1280, 3).addReRegistrations(ANY.Diamond   ).setSmelting(C    , 2*U  ).setBurning(Ash, U).heat(4200, C.mBoilingPoint);}
	...
	Diamond                 = diamond       ( 8300, "Diamond"                                       , 200, 255, 255, DYE_INDEX_White      )                                                                                                                             .uumMcfg( 1, C              , 4*U)                                                                                                                          ,
	DiamondPink             = diamond       ( 8424, "Pink Diamond"                                  , 240, 160, 160, DYE_INDEX_Pink       )                                                                                                                             .uumMcfg( 1, C              , 4*U)                                                                                                                          .aspects(TC.AURAM      , 4).qual(3, 12.0,  1600,  3),
	DiamondIndustrial       = diamond       ( 8423, "DiamondIndustrial"                             , 255, 255, 210, DYE_INDEX_Yellow     )                                                                                                                             .uumMcfg( 1, C              , 4*U)                                                                                                                          .aspects(TC.FABRICO    , 2).qual(3,  9.0,  1440,  3).setLocal("Industrial Diamond"),
	ManaDiamond             = diamond       ( 8278, "Mana Diamond"                                  , 128, 255, 255, DYE_INDEX_Cyan       ).put(MAGICAL, UNBURNABLE)                                                                                                    .setMcfg( 1, C              , 4*U, Ma               , 1*U)                                                                                                  .aspects(TC.PRAECANTIO , 2).qual(3, 10.0,  1280,  3),
	ElvenDragonstone        = diamond       ( 8279, "Elven Dragonstone"                             , 240, 140, 240, DYE_INDEX_Magenta    ).put(MAGICAL, UNBURNABLE)                                                                                                    .setMcfg( 1, C              , 4*U, Ma               , 2*U)                                                                                                  .aspects(TC.PRAECANTIO , 4).qual(3, 12.0,  1280,  3).setLocal("Dragonstone"),
