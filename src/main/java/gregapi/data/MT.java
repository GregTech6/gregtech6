...
public class MT {
	...
	At      = metalloid   ( 850, "Astatine"       , "At"    ,  85, 124,   575,   610,  7.0       , SET_RAD     ,  33,  33,  33, 255             , HALOGEN        , CONTAINERS_GAS      , GASSES                                                                    ).aspects(TC.POTENTIA, 2, TC.RADIO, 1                    ),
	...
	Th      = actinide    ( 900, "Thorium"        , "Th"    ,  90, 142,  2115,  5061, 11.72      , SET_RAD     ,   0,  30,   0                                                         , "Thorium232"                                                              ).aspects_met_rad(2, 1                                   ).qual(3, 6.0, 512, 2),
	Pa      = actinide    ( 910, "Protactinium"   , "Pa"    ,  91, 138,  1841,  4300, 15.37      , SET_RAD                                                                                                                                                         ).aspects_met_rad(2, 1                                   ),
	U_238   = actinide    ( 920, "Uranium"        , "U"     ,  92, 146,  1405,  4404, 18.95      , SET_RAD     ,  50, 240,  50                                                         , MELTING, MOLTEN, "Uranium238", "Uran"                                     ).aspects_met_rad(2, 1                                   ).qual(3, 6.0, 512, 3), // No, I could not make a Variable named "U" here. That would collide with the Material Unit.
	U_235   = actinide    ( 921, "Uranium-235"    , "U-235" ,  92, 143,  1405,  4404, 18.95      , SET_RAD     ,  70, 250,  70                                                         , MELTING, MOLTEN, "UraniumEnriched"                                        ).aspects_met_rad(1, 2                                   ).qual(3, 6.0, 512, 3),
	...
	public static class TECH {
		...
		static {
			...
			*/
			...
			OREMATS.Garnierite              .addOreByProducts(Ni                    , OREMATS.Sperrylite        );          OREMATS.Tungstate               .addOreByProducts(MnO2                  , Ag                        , LiCl                  );
