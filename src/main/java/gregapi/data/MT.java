...
public class MT {
	...
	HSLA                    = alloymachine  ( 8637, "HSLA-Steel"            , SET_METALLIC          , 210, 210, 255, 255).put(MOLTEN, RAILS, CENTRIFUGE, MORTAR, MAGNETIC_PASSIVE, "HSLA")                                                                              .uumMcfg(50, WroughtIron    ,50*U, C                , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.ORDO, 1).steal(Steel).heat(1873, Fe.mBoilingPoint, Fe.mPlasmaPoint),
