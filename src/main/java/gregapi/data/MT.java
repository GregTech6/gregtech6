...
public class MT {
	...
	Peridot                 = valgemelec    ( 8311, "Peridot"               , SET_RUBY              , 150, 255, 150, 127, RANDOM_SMALL_GEM_ORE, "Peridot"                     ).lens(DYE_INDEX_Lime       )                                                         .uumMcfg( 0, SiO2           , 2*U, Fe               , 1*U, Mg               , 2*U)                                                                          .aspects(TC.VITREUS, 2, TC.LUCRUM                   , 4).qual(3,  7.0,   256,  2),
