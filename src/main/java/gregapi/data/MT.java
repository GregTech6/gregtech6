...
public class MT {
	...
	Osmiridium              = alloymachine  ( 8682, "Osmiridium"            , SET_METALLIC          , 100, 100, 255, 255).put(MOLTEN).qual(3, 11.0, 3840, 4)                                                                                                            .uumMcfg( 0, Os             , 1*U, Ir               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.MACHINA, 2, TC.NEBRISUM, 1).alloyCentrifuge(),
