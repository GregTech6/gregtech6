...
public class MT {
	...
	Vb      = element( 1520, "Vibranium"             , "Vb"      , 152, 266,  4852, 9415, 3.23978365, SET_EMERALD, 200, 128, 255, 100, G_GEM_ORES_TRANSPARENT, UUM, VALUABLE, GLOWING, UNBURNABLE, "Unpentbium").aspects(TC.VITREUS, 10, TC.SENSUS, 10).setPriorityPrefix(1).qual(3, 200.0, 512, 15), Upb = Vb,
	...
	RoughGlass              = gemcent       ( 8111, "Rough Glass"           , SET_GLASS             , 120, 200, 200,  35, UNRECYCLABLE, BRITTLE, MORTAR, G_GLASS, FURNACE, CRYSTAL, COOL2CRYSTAL, MELTING, EXTRUDER, EXTRUDER_SIMPLE)         .uumMcfg( 0, SiO2           , 1*U)                                                                                                                          .aspects(TC.VITREUS, 2).qual(1, 1.0, 1,  0).heat(1210),
	...
	*/
	...
	Glowstone               = glowstone     ( 8341, "Glowstone"             , SET_REDSTONE          , 255, 255,   0, 255)                                                                                                                                           .uumMcfg( 0, Phosphorite    , 5*U, Au               , 3*U, SiO2             , 1*U)                                                  .aspects(TC.LUX, 2, TC.SENSUS, 1).heat(500, 600),
	...
	Gloomstone              = glowstone     ( 8456, "Gloomstone"            , SET_REDSTONE          ,  19, 250, 255, 255)                                                                                                                                           .uumMcfg( 0, Phosphorite    , 5*U, Au               , 3*U, SiO2             , 1*U)                                                  .aspects(TC.LUX, 2, TC.SENSUS, 1, TC.SPIRITUS, 1).heat(500, 600),
...
//  HexoriumRainbow         = hexorium      ( 9242, 224, 224, 224, DYE_INDEX_White    ),
	...
	Sand                    = dust          ( 8100, "Sand"                  , SET_SAND              , 250, 250, 200, 255, FURNACE, UNRECYCLABLE)                                                                                                                                                                                                                                                                                .aspects(TC.TERRA       , 1                ).stealStatsElement(SiO2).setSmelting(RoughGlass, U).setForging(RoughGlass, U),
	RedSand                 = dust          ( 8104, "Red Sand"              , SET_SAND              , 170,  86,  35, 255, FURNACE)                                                                                                                                                                                                                                                                                              .aspects(TC.METALLUM    , 1                ).stealStatsElement(SiO2).setSmelting(RoughGlass, U).setForging(RoughGlass, U),
	EndSandWhite            = dust          ( 8105, "White End Sand"        , SET_SAND              , 230, 250, 250, 255, FURNACE)                                                                                                                                                                                                                                                                                              .aspects(TC.ALIENIS     , 1                ).stealStatsElement(SiO2).setSmelting(RoughGlass, U).setForging(RoughGlass, U),
	EndSandBlack            = dust          ( 8106, "Black End Sand"        , SET_SAND              ,  40,  60,  60, 255, FURNACE)                                                                                                                                                                                                                                                                                              .aspects(TC.ALIENIS     , 1                ).stealStatsElement(SiO2).setSmelting(RoughGlass, U).setForging(RoughGlass, U),
	...
	VibraniumSteel          = slloymachine  ( 8704, "Vibranium Steel"                               ,  40,  24,  50     , MOLTEN, CENTRIFUGE, UNBURNABLE, MAGNETIC_PASSIVE).qual(3,   50.0, 2048, 10)                                                                       .uumAloy( 0, Vb             , 1*U, Steel            , 3*U)                                                                                                  .aspects(TC.SENSUS, 1, TC.VITREUS, 1, TC.METALLUM, 1),
	VibraniumSilver         = slloy         ( 8705, "Vibranium Silver"                              , 240, 240, 255     , MOLTEN, CENTRIFUGE, UNBURNABLE, ENDER_DRAGON_PROOF).qual(3,  100.0,  512,  9)                                                                     .uumAloy( 0, Vb             , 1*U, Ag               , 3*U)                                                                                                  .aspects(TC.SENSUS, 1, TC.VITREUS, 1, TC.LUCRUM, 1),
	Vibramantium            = slloymachine  ( 8706, "Vibramantium"                                  , 250, 250, 250     , MOLTEN, CENTRIFUGE, UNBURNABLE, MAGNETIC_PASSIVE).qual(3, 200.0, 5120, 15)                                                                       .uumAloy( 0, Vb             , 1*U, Ad               , 3*U)                                                                                                  .aspects(TC.SENSUS, 1, TC.VITREUS, 1, TC.PRAECANTIO, 1, TC.METALLUM, 1),
...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60     ).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                  ,
	...
	ElectricalSteel         = alloy         ( 8730, "Electrical Steel"                              , 140, 140, 140     , MAGNETIC_PASSIVE, MOLTEN).qual(Steel)                                                                                                             .uumAloy( 1, Steel          , 1*U, Si               , 1*U)                                                                                                  .aspects(TC.METALLUM, 3, TC.ELECTRUM, 1),
	...
	Manasteel               = slloymachine  ( 8720, "Manasteel"                                     , 110, 200, 250     , MAGICAL, MOLTEN)                                                                                                                                  .setMcfg( 1, Fe             , 1*U, Ma               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 2).steal(Steel).qual(3, 12.0, 256, 3).heat(Fe.mMeltingPoint+ 500, Fe.mBoilingPoint+1000),
	Terrasteel              = slloymachine  ( 8721, "Terrasteel"                                    , 110, 200,  50     , MAGICAL, MOLTEN, UNBURNABLE)                                                                                                                                                                                                                                                                                  .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 2).steal(Steel).qual(3, 16.0,2048, 4).heat(Fe.mMeltingPoint+ 750, Fe.mBoilingPoint+1500),
	ElvenElementium         = slloymachore  ( 8722, "Elven Elementium"                              , 250, 120, 250     , MAGICAL, MOLTEN, UNBURNABLE, "Elementium")                                                                                                                                                                                                                                                                    .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 2).steal(Steel).qual(3, 14.0, 512, 3).heat(Fe.mMeltingPoint+1000, Fe.mBoilingPoint+2000).setLocal("Elementium"),
	GaiaSpirit              = slloymachine  ( 8735, "Gaia Spirit"                                   , 250, 250, 250     , MAGICAL, MOLTEN, UNBURNABLE, GLOWING).qual(3, 20.0,2048, 4)                                                                                                                                                                                                                                                   .aspects(TC.AURAM, 4, TC.SPIRITUS, 4, TC.PRAECANTIO, 4).heat(W.mMeltingPoint+250, W.mBoilingPoint+500),
	...
	DuraniumAlloy           = alloymachine  ( 8751, "Duranium"                                      ,  75, 175, 175      , MOLTEN       ).qual(3,  8.0,   1280,  4)                                                                                                         .uumAloy( 0, Dn             , 7*U, Mg               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 2).setLocal("Duranium Alloy"), // That Info with Magnesium/Magnesite was pretty hard to find, but I found it!
	TritaniumAlloy          = alloymachine  ( 8752, "Tritanium"                                     ,  55, 155, 155      , MOLTEN       ).qual(3, 12.0,   2560,  5)                                                                                                         .uumAloy( 0, Tn             , 3*U, Dn               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 3, TC.VITREUS, 1).setLocal("Tritanium Alloy"),
	...
	Trinitanium             = clloymachine  ( 8790, "Trinitanium"                                   , 235, 175, 255     , MOLTEN).qual(3, 16.0,   5120,  4)                                                                                                                 .uumAloy( 0, Ke             , 2*U, Ti               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 2, TC.VITREUS, 2),
	
	
	Iritanium               = alloymachine  ( 8793, "Titanium Iridium"                              , 220, 220, 255     , "Iritanium", MOLTEN).qual(3,  8.0,   7680,  4)                                                                                                    .uumAloy( 0, Ir             , 1*U, Ti               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 1, TC.MACHINA, 1).setLocal("Iritanium"),
	TitaniumAluminide       = alloymachine  ( 8794, "Titanium Aluminide"                            , 200, 200, 255     , MOLTEN).qual(3, 12.0,   3840,  3)                                                                                                                 .uumAloy( 3, Ti             , 3*U, Al               , 7*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 1, TC.VOLATUS, 1);
...
//          Al                      .addAlloyingRecipe(new OreDictConfigurationComponent( 1, OM.stack(OREMATS.Bauxite               , 2*U), OM.stack(K                  , 1*U)));
			...
			Glass                   .addAlloyingRecipe(new OreDictConfigurationComponent(81, OM.stack(RoughGlass                    ,81*U), OM.stack(CaCO3              , 9*U), OM.stack(OREMATS.Borax, U)));
	...
	public static class OREMATS {
		...
		Uraninite               = oredustdcmp( 9134, "Uraninite"                 , SET_RAD       ,  35,  35,  35, 255, BLACKLISTED_SMELTER                                                            )                                          .addSourceOf(U_238    ).setMcfg( 1, U_238          , 1*U, O                , 2*U)                                                                                                ,
		...
		Pitchblende             = oredustdcmp( 9155, "Pitchblende"               , SET_RAD       , 100, 110,   0, 255, MORTAR, BLACKLISTED_SMELTER                                                    )                                          .addSourceOf(U_238,Th ).setMcfg( 0, Uraninite      , 3*U, Th               , 1*U, Pb               , 1*U)                                                                        ,
		...
		Borax                   = oredustdcmp( 9139, "Borax"                     , SET_FINE      , 250, 250, 250, 255, MORTAR, BLACKLISTED_SMELTER                                                    )                         .addSourceOf(B,Na     ).setMcfg( 0, Na             , 2*U, B                , 4*U, H2O              ,30*U, O                , 7*U) .heat(1174,1803)                                               ,
