...
public class MT {
	...
	Au_198  = noblemetal  ( 791, "Gold-198"       , "Au-198",  79, 119,  1337,  3129, 19.282     , SET_SHINY   , 255, 230,  80                  , COPPER_GROUP   , G_INGOT_ORES        , WASHING_MERCURY, MOLTEN, VALUABLE, WITHER_PROOF, "Gol198"                              ).aspects_met_rad(2, 1                                   ).qual(3, 12.5, 64, 2),
...
//  HexoriumRainbow         = hexorium      ( 9242, 224, 224, 224, DYE_INDEX_White    ),
	...
	Mingrade                = alloy         ( 8804, "Mingrade"              , SET_COPPER            , 255, 138,  77     , MORTAR, WIRES, FURNACE, EXTRUDER_SIMPLE)                                                                                                  .uumMcfg( 0, Cu             , 1*U, Redstone         , 1*U)                                                                                                  .aspects(TC.MACHINA, 2).heat(1400, Cu.mBoilingPoint).setLocal("Red Copper"),
