...
public class MT {
	...
	CaF2                    = fluorite      ( 9215, "Fluorite"              , SET_RUBY              , 225, 185, 140)                                                                                                                                                                                                                                                                                                                , Fluorite = CaF2,
	...
	FluoriteBlack           = fluorite      ( 8440, "Black Fluorite"        , SET_RUBY              ,  48,  48,  48)                                                                                                                                                                                                                                                                                                                ,
	...
	*/
	...
	InductiveAlloy          = alloymachine  ( 8604, "GoldInductive"         , SET_SHINY             , 255, 150,  75, 255)                                                                                                                                               .uumMcfg( 0, Au             , 1*U, Redstone         , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.MAGNETO, 1).alloyCentrifuge().setLocal("Inductive Alloy"),
