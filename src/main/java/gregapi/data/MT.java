...
//      CassiteriteSand         = oredustelec   ( 9109, "Cassiterite Sand"          , SET_SAND              , 220, 220, 220, 255, MORTAR, FURNACE                                                                ).setSmelting(Sn, 3*U4)     .uumMcfg( 1, Sn             , 1*U, O                , 2*U)                                                                                                  .heat(3 * Sn.mMeltingPoint / 2),
		...
		BrownLimonite           = oredustdcmp   ( 9106, "Brown Limonite"            , SET_METALLIC          , 200, 100,   0, 255, MORTAR, MELTING, MOLTEN, MAGNETIC_PASSIVE                                      )                           .setMcfg( 0, Fe             , 1*U, H                , 1*U, O                , 2*U)                                                                          .qual(0).heat(2 * Fe.mMeltingPoint / 3), // FeO(OH)
		YellowLimonite          = oredustdcmp   ( 9137, "Yellow Limonite"           , SET_METALLIC          , 200, 200,   0, 255, MORTAR, MELTING, MOLTEN, MAGNETIC_PASSIVE                                      )                           .setMcfg( 0, Fe             , 1*U, H                , 1*U, O                , 2*U)                                                                          .qual(0).heat(2 * Fe.mMeltingPoint / 3), // FeO(OH) + a bit Ni and Co
