...
public class MT {
	...
	OnyxBlack               = valgemelec    ( 8416, "OnyxBlack"             , SET_LAPIS             ,  50,  50,  50, 255).lens(DYE_INDEX_Black      ).put(MD.VOLTZ)                                                                                                     .uumMcfg( 0, SiO2           , 1*U)                                                                                                                          .aspects(TC.VITREUS, 4, TC.LUCRUM                   , 2).qual(3,  7.0,   256,  2).setLocal("Black Onyx"),
	Jasper                  = valgemelec    ( 8309, "Jasper"                , SET_EMERALD           , 200,  80,  80, 150).lens(DYE_INDEX_Red        )                                                                                                                   .uumMcfg( 0, SiO2           , 2*U, Fe               , 1*U)                                                                                                  .aspects(TC.VITREUS, 2, TC.LUCRUM, 2, TC.METALLUM   , 1).qual(3,  7.0,   256,  2),
	...
	SmokeyQuartz            = quartz        ( 8397, "Smokey Quartz"         , SET_QUARTZ            ,  20,  20,  20, 255).put(CRYSTALLISABLE, "QuartzSmoky")                                                                                                            .uumMcfg( 0, SiO2           , 1*U)                                                                                                                          .aspects(TC.POTENTIA, 1, TC.VITREUS, 1, TC.TENEBRAE     , 1).qual(1, 2.5, 32, 1),
