...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60     ).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                  ,
	...
	public static class TECH {
		...
		static void init() {
			...
			Fe                      .addEnchantmentForTools(Enchantment.sharpness, 1).addEnchantmentForTools(Enchantment.power, 1);
			IronMagnetic            .addEnchantmentForTools(Enchantment.sharpness, 1).addEnchantmentForTools(Enchantment.power, 1);
			Ice                     .addEnchantmentForTools(Enchantment.sharpness, 1).addEnchantmentForTools(Enchantment.power, 1);
			Glass                   .addEnchantmentForTools(Enchantment.sharpness, 1).addEnchantmentForTools(Enchantment.power, 1);
			Bronze                  .addEnchantmentForTools(Enchantment.sharpness, 1).addEnchantmentForTools(Enchantment.power, 1);
			GildedIron              .addEnchantmentForTools(Enchantment.sharpness, 1).addEnchantmentForTools(Enchantment.power, 1);
			PulsatingIron           .addEnchantmentForTools(Enchantment.sharpness, 1).addEnchantmentForTools(Enchantment.power, 1);
			ConductiveIron          .addEnchantmentForTools(Enchantment.sharpness, 1).addEnchantmentForTools(Enchantment.power, 1);
			RedstoneAlloy           .addEnchantmentForTools(Enchantment.sharpness, 1).addEnchantmentForTools(Enchantment.power, 1);
			ElectricalSteel         .addEnchantmentForTools(Enchantment.sharpness, 2).addEnchantmentForTools(Enchantment.power, 2);
			Brass                   .addEnchantmentForTools(Enchantment.sharpness, 2).addEnchantmentForTools(Enchantment.power, 2);
			CobaltBrass             .addEnchantmentForTools(Enchantment.sharpness, 2).addEnchantmentForTools(Enchantment.power, 2);
			HSLA                    .addEnchantmentForTools(Enchantment.sharpness, 2).addEnchantmentForTools(Enchantment.power, 2);
			Steel                   .addEnchantmentForTools(Enchantment.sharpness, 2).addEnchantmentForTools(Enchantment.power, 2);
			SteelMagnetic           .addEnchantmentForTools(Enchantment.sharpness, 2).addEnchantmentForTools(Enchantment.power, 2);
			SteelGalvanized         .addEnchantmentForTools(Enchantment.sharpness, 2).addEnchantmentForTools(Enchantment.power, 2);
			Syrmorite               .addEnchantmentForTools(Enchantment.sharpness, 2).addEnchantmentForTools(Enchantment.power, 2);
			WroughtIron             .addEnchantmentForTools(Enchantment.sharpness, 2).addEnchantmentForTools(Enchantment.power, 2);
			PigIron                 .addEnchantmentForTools(Enchantment.sharpness, 2).addEnchantmentForTools(Enchantment.power, 2);
			Meteorite               .addEnchantmentForTools(Enchantment.sharpness, 2).addEnchantmentForTools(Enchantment.power, 2);
			FierySteel              .addEnchantmentForTools(Enchantment.sharpness, 2).addEnchantmentForTools(Enchantment.power, 2);
			FrozenIron              .addEnchantmentForTools(Enchantment.sharpness, 2).addEnchantmentForTools(Enchantment.power, 2);
			MeteoricIron            .addEnchantmentForTools(Enchantment.sharpness, 2).addEnchantmentForTools(Enchantment.power, 2);
			MeteoricSteel           .addEnchantmentForTools(Enchantment.sharpness, 3).addEnchantmentForTools(Enchantment.power, 3);
			VanadiumSteel           .addEnchantmentForTools(Enchantment.sharpness, 3).addEnchantmentForTools(Enchantment.power, 3);
			StainlessSteel          .addEnchantmentForTools(Enchantment.sharpness, 3).addEnchantmentForTools(Enchantment.power, 3);
			Knightmetal             .addEnchantmentForTools(Enchantment.sharpness, 3).addEnchantmentForTools(Enchantment.power, 3);
			DeepIron                .addEnchantmentForTools(Enchantment.sharpness, 3).addEnchantmentForTools(Enchantment.power, 3);
			ShadowIron              .addEnchantmentForTools(Enchantment.sharpness, 3).addEnchantmentForTools(Enchantment.power, 3);
			BlackSteel              .addEnchantmentForTools(Enchantment.sharpness, 3).addEnchantmentForTools(Enchantment.power, 3);
			MeteoricBlackSteel      .addEnchantmentForTools(Enchantment.sharpness, 3).addEnchantmentForTools(Enchantment.power, 3);
			RedSteel                .addEnchantmentForTools(Enchantment.sharpness, 3).addEnchantmentForTools(Enchantment.power, 3);
			MeteoricRedSteel        .addEnchantmentForTools(Enchantment.sharpness, 3).addEnchantmentForTools(Enchantment.power, 3);
			BlueSteel               .addEnchantmentForTools(Enchantment.sharpness, 3).addEnchantmentForTools(Enchantment.power, 3);
			MeteoricBlueSteel       .addEnchantmentForTools(Enchantment.sharpness, 3).addEnchantmentForTools(Enchantment.power, 3);
			Ti                      .addEnchantmentForTools(Enchantment.sharpness, 3).addEnchantmentForTools(Enchantment.power, 3);
			TitaniumGold            .addEnchantmentForTools(Enchantment.sharpness, 3).addEnchantmentForTools(Enchantment.power, 3);
			TungstenAlloy           .addEnchantmentForTools(Enchantment.sharpness, 3).addEnchantmentForTools(Enchantment.power, 3);
			TungstenSteel           .addEnchantmentForTools(Enchantment.sharpness, 4).addEnchantmentForTools(Enchantment.power, 4);
			NetherizedDiamond       .addEnchantmentForTools(Enchantment.sharpness, 4).addEnchantmentForTools(Enchantment.power, 4);
			HSSG                    .addEnchantmentForTools(Enchantment.sharpness, 4).addEnchantmentForTools(Enchantment.power, 4);
			HSSE                    .addEnchantmentForTools(Enchantment.sharpness, 4).addEnchantmentForTools(Enchantment.power, 4);
			HSSS                    .addEnchantmentForTools(Enchantment.sharpness, 4).addEnchantmentForTools(Enchantment.power, 4);
			ShadowSteel             .addEnchantmentForTools(Enchantment.sharpness, 4).addEnchantmentForTools(Enchantment.power, 4);
			Zanite                  .addEnchantmentForTools(Enchantment.sharpness, 4).addEnchantmentForTools(Enchantment.power, 4);
			DamascusSteel           .addEnchantmentForTools(Enchantment.sharpness, 5).addEnchantmentForTools(Enchantment.power, 5);
			Elvorium                .addEnchantmentForTools(Enchantment.sharpness, 5).addEnchantmentForTools(Enchantment.power, 5);
			InfusedEntropy          .addEnchantmentForTools(Enchantment.sharpness, 5).addEnchantmentForTools(Enchantment.power, 5);
			Ke                      .addEnchantmentForTools(Enchantment.sharpness, 6).addEnchantmentForTools(Enchantment.power, 6);
			Trinitanium             .addEnchantmentForTools(Enchantment.sharpness, 7).addEnchantmentForTools(Enchantment.power, 7);
			Trinaquadalloy          .addEnchantmentForTools(Enchantment.sharpness, 8).addEnchantmentForTools(Enchantment.power, 8);
			Infinity                .addEnchantmentForTools(Enchantment.sharpness,10).addEnchantmentForTools(Enchantment.power,10);
