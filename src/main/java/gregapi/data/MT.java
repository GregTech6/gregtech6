...
public class MT {
	...
	Be_7    = alkaline    (  41, "Beryllium-7"    , "Be-7"  ,   4,   3,  1560,  2742,  1.85      , SET_RAD     , 110, 190, 110     ,      FUSION                                                                                                                   ).aspects(TC.METALLUM, 2, TC.LUCRUM, 1, TC.RADIO, 1      ),
	Be_8    = alkaline    (  42, "Beryllium-8"    , "Be-8"  ,   4,   4,  1560,  2742,  1.85      , SET_RAD     , 110, 200, 110     ,      FUSION                                                                                                                   ).aspects(TC.METALLUM, 2, TC.LUCRUM, 1, TC.RADIO, 1      ),
	...
	B_11    = metalloid   (  51, "Boron-11"       , "B-11"  ,   5,   6,  2349,  4200,  2.34      , SET_RAD     , 240, 240, 240, 255,      FUSION, ICOSAGEN                                                                                                         ).aspects(TC.METALLUM, 1, TC.VITREUS, 1, TC.RADIO, 1     ),
...
//  HexoriumRainbow         = hexorium      ( 9242, 224, 224, 224, DYE_INDEX_White    ),
	...
	HSLA                    = alloymachine  ( 8637, "HSLA-Steel"                                    , 210, 210, 255     , RAILS, CENTRIFUGE, MORTAR, MAGNETIC_PASSIVE, "HSLA")                                                                                      .uumMcfg( 0, WroughtIron    , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.ORDO, 1).steal(Steel).heat(1873, Fe.mBoilingPoint, Fe.mPlasmaPoint).setRGBaLiquid(180, 80, 30, 255),
	...
	TungstenAlloy           = alloymachine  ( 8766, "Tungsten Alloy"                                , 179, 119, 190     , CENTRIFUGE, MAGNETIC_PASSIVE)                                                                                                             .uumMcfg(180,SpringSteel   ,180*U, W                , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 1).steal(SpringSteel).qual(3,  7.0, 1024, 2),
