...
//  InfusedGold             = alloymachore  ( 8712, "Infused Gold"          , SET_SHINY             , 255, 200,  60, 255).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                      ,
	...
	RefinedGlowstone        = alloy         ( 8713, "GlowstoneRefined"      , SET_REDSTONE          , 255, 255,   0, 255).put("RefinedGlowstone", GLOWING).setLocal("Refined Glowstone")                                                                                .uumMcfg( 1, Glowstone      , 1*U, FakeOsmium       , 1*U)                                                                                                  .aspects(TC.METALLUM, 4, TC.LUX, 4).alloyCentrifuge(),
	RefinedObsidian         = alloy         ( 8714, "ObsidianRefined"       , SET_REDSTONE          ,  80,  50, 100, 255).put("RefinedObsidian").setLocal("Refined Obsidian")                                                                                           .uumMcfg( 1, Obsidian       , 1*U, Diamond          , 1*U)                                                                                                  .aspects(TC.VITREUS, 4, TC.IGNIS, 4).alloyCentrifuge(),
