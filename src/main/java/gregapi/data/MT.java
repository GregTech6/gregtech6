...
public class MT {
	...
	protected static OreDictMaterial grain        (int aID, String aNameOreDict                    , long aR, long aG, long aB, long aA    , Object... aRandomData)  {return dustfood        (aID, aNameOreDict, SET_POWDER      , aR, aG, aB, aA, aRandomData).put(ANY.Grains, ANY.FlourGrains, FLAMMABLE).aspects(TC.MESSIS, 2).setBurning(Ash, U9);}
	...
	CaF2                    = fluorite      ( 9215, "Fluorite"                                      , 225, 185, 140)                                                                                                                                                                                                                                                                                                            , Fluorite = CaF2,
	...
	OatAbyssal              = grain         ( 9719, "Abyssal Oat"                                   , 177,  92,  25, 255)                                                                                                                                                                                                                                                                                                       ,
