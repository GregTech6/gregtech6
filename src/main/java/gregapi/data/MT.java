...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60     ).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                      ,
	...
	NetherizedDiamond       = alloymachine  ( 8746, "Netherized Diamond"                            ,  90,  80,  90     ).put(G_GEM    , UNBURNABLE, WITHER_PROOF, VALUABLE, COATED).qual(3, 12.0, 2560,  4)                                                            .setMcfg( 4, Netherite      , 1*U, Diamond          , 4*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.FABRICO, 2, TC.LUCRUM, 2, TC.VITREUS, 2).heat(MeteoricSteel),
