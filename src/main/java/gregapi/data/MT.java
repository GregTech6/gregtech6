...
//  InfusedGold             = alloymachore  ( 8712, "Infused Gold"          , SET_SHINY             , 255, 200,  60, 255).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                      ,
	...
	ElvenElementium         = alloymachore  ( 8722, "Elven Elementium"      , SET_SHINY             , 250, 120, 250, 255).put(MAGICAL).qual(3, 14.0, 512, 3)                                                                                                                                                                                                                                                                        .aspects(TC.METALLUM, 2, TC.ALIENIS, 2).heat(Fe.mMeltingPoint+1000, Fe.mBoilingPoint+2000).setLocal("Elementium"),
