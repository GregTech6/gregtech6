...
public class MT {
	...
	Cu      = noblemetal    (  290, "Copper"                , "Cu"      ,  29,  34,  1357,  2835,  8.96      , SET_SHINY            , 255, 100,   0, 255).put(  G_INGOT_MACHINE_ORES        , UUM, COPPER_GROUP           ).aspects(TC.METALLUM, 2, TC.PERMUTATIO, 1               ).qual(2,  4.0,   64, 0).put(WASHING_PERSULFATE, FURNACE, EXTRUDER_SIMPLE, MORTAR, MOLTEN, RAILS, MD.IC2),
	...
	Ir      = platingroup   (  770, "Iridium"               , "Ir"      ,  77, 115,  2719,  4701, 22.56      , SET_DULL             , 240, 240, 245, 255).put(  G_INGOT_MACHINE_ORES        , UUM, COBALT_GROUP           ).aspects(TC.METALLUM, 2, TC.MACHINA, 1                  ).qual(3,  6.0, 5120, 4).put(MOLTEN, VALUABLE, MD.IC2).setRGBaLiquid(255, 128, 200, 255),
	...
	Pb      = posttrans     (  820, "Lead"                  , "Pb"      ,  82, 125,   600,  2022, 11.342     , SET_DULL             ,  60,  40, 110, 255).put(  G_INGOT_MACHINE_ORES        , UUM, CRYSTALLOGEN           ).aspects(TC.METALLUM, 2, TC.ORDO, 1                     ).qual(2,  8.0, 64, 1).put(SOLDERING_MATERIAL, SOLDERING_MATERIAL_BAD, MOLTEN, MD.TE),
	...
	SiC                     = metalore      ( 8003, "Carborundum"           , SET_QUARTZ            ,  77,  77,  77, 255).put(BRITTLE, QUARTZ, DECOMPOSABLE)                                                                                                            .uumMcfg( 0, Si             , 1*U, C                , 1*U)                                                                                                  .aspects(TC.VITREUS, 1).setOriginalMod(MD.IHL).alloyElectrolyzer(3000, 3100).qual(3, 8.0, 1280, 3),
	Datolite                = oredustelec   ( 8006, "Datolite"              , SET_ROUGH             , 222, 255, 222, 255)                                                                                                                                               .uumMcfg( 0, H              , 2*U, Ca               , 2*U, B                , 2*U, Si               , 2*U, O                ,10*U)                          .setOriginalMod(MD.IHL), H2Ca2B2Si2O10 = Datolite,
	...
	WoodRubber              = wood          ( 8224, "WoodRubber"            , SET_WOOD              , 120,  60,   0, 255).put(TICKS_PER_SMELT/ 4, FLAMMABLE, APPROXIMATE, MD.IC2)                                                                                       .setMcfg( 0, C              , 6*U, H2O              ,15*U)                                                                                                  .aspects(TC.ARBOR, 1                   ).setBurning(Ash, U4).setSmelting(Ash, U2).qual(1, 1.5, 12, 0).heat(350, 450).setLocal("Rubber Wood"),
	...
	Porcelain               = mixdust       ( 8273, "Porcelain"             , SET_ROUGH             , 195, 195, 222, 255).put(PLATES, BRITTLE, MORTAR, MD.IHL)                                                                                                          .uumMcfg( 0, Clay           , 2*U, SiO2             , 1*U, PotassiumFeldspar, 1*U)                                                                          .heat(1800).setCompressing(null, 0).setBending(null, 0).setForging(null, 0).setSmashing(null, 0),
	...
	Jasper                  = valgemelec    ( 8309, "Jasper"                , SET_EMERALD           , 200,  80,  80, 150).lens(DYE_INDEX_Red        ).put(MD.TFC)                                                                                                       .uumMcfg( 0, SiO2           , 2*U, Fe               , 1*U)                                                                                                  .aspects(TC.VITREUS, 2, TC.LUCRUM, 2, TC.METALLUM   , 1).qual(3,  7.0,   256,  2),
	...
	RoseGold                = alloymachine  ( 8602, "Rose Gold"             , SET_SHINY             , 255, 230,  30, 255).put(MORTAR, VALUABLE, WITHER_PROOF, "Tumbaga").qual(3, 14.0,  128, 2)                                                                         .uumMcfg( 0, Cu             , 1*U, Au               , 4*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.LUCRUM, 2).setOriginalMod(MD.TFC).alloyCentrifuge(),
