...
public class MT {
	...
	Marshmallow             = wood          ( 9715, "Marshmallow"           , SET_FINE              , 255, 220, 220, 255).put(FOOD, MD.CANDY)                                                                                                                                                                                                                                                                                       .aspects(TC.FAMES, 1),
	...
	PEZ                     = orefood       ( 9716, "PEZ"                   , SET_FINE              , 210, 210, 210, 255)                                                                                                                                                                                                                                                                                                           .aspects(TC.FAMES, 1).setOriginalMod(MD.CANDY),
	Licorice                = orefood       ( 9717, "Licorice"              , SET_FINE              ,  30,  30,  30, 255)                                                                                                                                                                                                                                                                                                           .aspects(TC.FAMES, 1).setOriginalMod(MD.CANDY),
