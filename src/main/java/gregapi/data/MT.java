...
//  HexoriumRainbow         = hexorium      ( 9242, 224, 224, 224, DYE_INDEX_White    ),
	...
	Prometheum              = metalore      ( 8774, "Prometheum"                                    ,  90, 129,  86     , CENTRIFUGE, DECOMPOSABLE)                                                                                                                 .setMcfg( 0, Pm             , 3*U, O                , 4*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.POTENTIA                            , 1).qual(3,  8.0,  512, 1),
	...
	RedAlloy                = clloy         ( 8660, "Red Alloy"                                     , 200,   0,   0     , MORTAR, WIRES, FURNACE, EXTRUDER_SIMPLE, MOLTEN)                                                                                          .uumAloy( 1, Cu             , 1*U, Redstone         , 4*U)                                                                                                  .aspects(TC.MACHINA , 3                  ).stealStatsElement(Cu).heat(1400, Cu.mBoilingPoint),
	BlueAlloy               = clloy         ( 8659, "Blue Alloy"                                    , 100, 180, 255     , MORTAR, WIRES, FURNACE, EXTRUDER_SIMPLE, MOLTEN)                                                                                          .uumAloy( 1, Ag             , 1*U, Nikolite         , 4*U)                                                                                                  .aspects(TC.ELECTRUM, 3                  ).stealStatsElement(Ag).heat(1400, Ag.mBoilingPoint),
	...
	ElectrumFlux            = slloy         ( 8711, "Electrum Flux"                                 , 255, 255, 120     ).qual(3, 14.0,  64, 2)                                                                                                                     .uumAloy( 1, Electrum       , 1*U, Redstone         , 2*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.PERMUTATIO, 2).stealStatsElement(Electrum),
	...
	EnergeticSilver         = alloy         ( 8808, "Energetic Silver"                              ,  93, 126, 151     )                                                                                                                                           .uumAloy( 1, Ag             , 1*U, Redstone         , 1*U, Glowstone        , 1*U)                                                                          .aspects(TC.METALLUM, 2, TC.POTENTIA  , 1).stealStatsElement(Ag),
	...
	Steeleaf                = alloymachine  ( 8673, "Steeleaf"              , SET_LEAF              ,  50, 127,  50     , MAGICAL, CENTRIFUGE, MAGNETIC_PASSIVE, WOOD  , MORTAR, AUTO_COLLECTING).qual(2,  8.0, 144, 3)                                             .setMcfg( 1, Steel             , 1*U, Ma            , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.HERBA, 1, TC.PRAECANTIO, 1).setSmelting(Steel, U4),
	...
	Fireleaf                = alloymachine  ( 8698, "Fireleaf"              , SET_LEAF              , 127,  50,  50     , MAGICAL, CENTRIFUGE, MAGNETIC_PASSIVE, WOOD  , WITHER_PROOF, UNBURNABLE, BURNING, GLOWING, AUTO_COLLECTING).qual(2, 12.0,  288, 4)        .setMcfg( 1, Steel             , 1*U, Ma            , 2*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.IGNIS, 3, TC.PRAECANTIO, 1, TC.HERBA, 1).setSmelting(FierySteel, U4).heat(Steel.mBoilingPoint-200, Steel.mBoilingPoint+500),
