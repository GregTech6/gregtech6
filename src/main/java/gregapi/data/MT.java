...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60     ).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                  ,
	...
	public static class TECH {
		...
		static void init() {
			...
			STONES.Mazerock         .put(MD.TF).visDefault();
...
//      GlauconiteSand          = oredustelec( 9151, "Glauconite Sand"           , SET_DULL      , 130, 180,  60, 255, MORTAR, BLACKLISTED_SMELTER                                                    )                         .addSourceOf(Al,K     ).setMcfg( 0, Al2O3          ,10*U, K                , 1*U, Mg               , 2*U, H2O              , 3*U, O                , 7*U)                        , // (K,Na)(Fe3+,Al,Mg)2(Si,Al)4O10(OH)2
	...
	public static class STONES {
		...
		SkyStone     = stone    ( 8528, "Sky Stone"               ,  81,  92,  96, 255)                                                                                                                                                                      .aspects(TC.VOLATUS     , 1).qual(1, 5.0, 64, 2).heat(2200),
		...
		Mazerock     = stone    ( 8526, "Mazerock"                , 110, 120, 110, 255)                                                                                                                                                                      .aspects(TC.ITER        , 1).qual(1, 5.0,128, 3).heat(2000),
		Castlerock   = stone    ( 8527, "Castlerock"              , 198, 185, 186, 255)                                                                                                                                                                      .aspects(TC.TUTAMEN     , 1).qual(1, 5.0,128, 3).heat(2000),
