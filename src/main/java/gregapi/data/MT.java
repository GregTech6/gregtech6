...
//  HexoriumRainbow         = hexorium      ( 9242, 224, 224, 224, DYE_INDEX_White    ),
	...
	SolderingAlloy          = clloy         ( 8669, "Soldering Alloy"                               , 220, 220, 230     , MORTAR, MOLTEN, BRITTLE, EXTRUDER_SIMPLE, SOFT, SOLDERING_MATERIAL, SOLDERING_MATERIAL_GOOD, WIRES)                                       .uumAloy( 0, Sn             , 9*U, Sb               , 1*U)                                                                                                  ,
