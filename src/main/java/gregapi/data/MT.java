...
public class MT {
	...
	Zanite                  = valgemelec    ( 8292, "Zanite"                , SET_REDSTONE          , 146,  73, 255, 127, CRYSTALLISABLE                                      ).lens(DYE_INDEX_Purple     )                                                         .uumMcfg( 0, Al2O3          ,15*U, SiO2             ,18*U, Ca               , 4*U, H2O              , 3*U, O                , 4*U)                          .aspects(TC.VITREUS, 3, TC.PERFODIO                 , 4).qual(3, 16.0,   512,  2),
	...
	AmberDominican          = valgem        ( 8422, "Dominican Amber"       , SET_RUBY              ,  80,  80, 240, 127                      , MORTAR, CRYSTALLISABLE        ).lens(DYE_INDEX_Blue       )                                                                                                                                                                                                                     .aspects(TC.VITREUS, 1, TC.VINCULUM, 2, TC.SENSUS   , 2).qual(3,  5.0,   384,  3).heat(473).setLocal("Blue Amber"),
	...
	*/
	...
	Chimerite               = gem           ( 8454, "Chimerite"             , SET_RUBY              , 255, 255, 255, 255)                                                                                                                                                                                                                                                                                                       .aspects(TC.SENSUS, 3, TC.PERMUTATIO, 1).qual(3, 10.0, 256,  3),
	...
	NetherQuartz            = quartz        ( 8346, "Nether Quartz"                                 , 230, 210, 210, 255, CRYSTALLISABLE)                                                                                                                           .uumMcfg( 0, SiO2           , 1*U)                                                                                                                          .aspects(TC.POTENTIA, 1, TC.VITREUS                  , 1).qual(1, 2.5, 32, 3),
	VoidQuartz              = quartz        ( 8457, "Void Quartz"                                   , 183, 120, 212, 255, CRYSTALLISABLE)                                                                                                                           .uumMcfg( 0, SiO2           , 1*U)                                                                                                                          .aspects(TC.POTENTIA, 1, TC.VITREUS, 1, TC.VACUOS    , 1).qual(1, 2.5, 48, 3),
	SunnyQuartz             = quartz        ( 8393, "Sunny Quartz"                                  , 255, 255, 200, 255, CRYSTALLISABLE)                                                                                                                           .uumMcfg( 0, SiO2           , 1*U)                                                                                                                          .aspects(TC.POTENTIA, 1, TC.VITREUS, 1, TC.LUX       , 1).qual(1, 2.5, 32, 3),
	LavenderQuartz          = quartz        ( 8394, "Lavender Quartz"                               , 255, 200, 255, 255, CRYSTALLISABLE)                                                                                                                           .uumMcfg( 0, SiO2           , 1*U)                                                                                                                          .aspects(TC.POTENTIA, 1, TC.VITREUS, 1, TC.SENSUS    , 1).qual(1, 2.5, 32, 3),
	RedQuartz               = quartz        ( 8395, "Red Quartz"                                    , 255, 210, 210, 255, CRYSTALLISABLE)                                                                                                                           .uumMcfg( 0, SiO2           , 1*U)                                                                                                                          .aspects(TC.POTENTIA, 1, TC.VITREUS, 1, TC.MACHINA   , 1).qual(1, 2.5, 32, 3),
	BlazeQuartz             = quartz        ( 8396, "Blaze Quartz"                                  , 255, 230, 200, 255, CRYSTALLISABLE)                                                                                                                           .uumMcfg( 0, SiO2           , 1*U)                                                                                                                          .aspects(TC.POTENTIA, 1, TC.VITREUS, 1, TC.IGNIS     , 1).qual(1, 2.5, 32, 3),
	SmokeyQuartz            = quartz        ( 8397, "Smokey Quartz"                                 ,  20,  20,  20, 255, CRYSTALLISABLE, "QuartzSmoky", "SmokyQuartz")                                                                                             .uumMcfg( 0, SiO2           , 1*U)                                                                                                                          .aspects(TC.POTENTIA, 1, TC.VITREUS, 1, TC.TENEBRAE  , 1).qual(1, 2.5, 32, 3),
	ManaQuartz              = quartz        ( 8398, "Mana Quartz"                                   , 210, 210, 255, 255, CRYSTALLISABLE)                                                                                                                           .setMcfg( 0, SiO2           , 1*U)                                                                                                                          .aspects(TC.POTENTIA, 1, TC.VITREUS, 1, TC.PRAECANTIO, 1).qual(1, 2.5, 64, 3),
	ElvenQuartz             = quartz        ( 8399, "Elven Quartz"                                  , 210, 255, 210, 255, CRYSTALLISABLE)                                                                                                                           .setMcfg( 0, SiO2           , 1*U)                                                                                                                          .aspects(TC.POTENTIA, 1, TC.VITREUS, 1, TC.ALIENIS   , 1).qual(1, 2.5, 64, 3),
	BlackQuartz             = quartz        ( 8374, "QuartzBlack"                                   ,  20,  20,  20, 255, CRYSTALLISABLE, DECOMPOSABLE, CENTRIFUGE)                                                                                                 .uumMcfg( 1, SiO2           , 1*U, C                , 1*U)                                                                                                  .aspects(TC.POTENTIA, 1, TC.VITREUS, 1, TC.TENEBRAE  , 1).qual(1, 2.5, 32, 3).setLocal("Black Quartz"),
	...
	CertusQuartz            = quartz        ( 8347, "Certus Quartz"                                 , 210, 210, 230, 255, CRYSTALLISABLE)                                                                                                                           .uumMcfg( 0, SiO2           , 1*U)                                                                                                                          .aspects(TC.POTENTIA, 1, TC.VITREUS                  , 1).qual(1, 5.0, 32, 3),
...
//  HexoriumRainbow         = hexorium      ( 9242, 224, 224, 224, DYE_INDEX_White    ),
	...
	Concrete                = stone         ( 8501, "Concrete"              , SET_BRICK             , 100, 100, 100, 255, MELTING)                                                                                                                                  .setMcfg( 0, Stone          , 1*U)                                                                                                                          .aspects(TC.TERRA       , 1).stealStatsElement(SiO2).qual(1, 2.5, 32, 0).heat( 500).setSmelting(Stone, U),
	...
	NetherBrick             = stone         ( 8503, "Nether Brick"          , SET_BRICK             , 100,   0,   0, 255, UNBURNABLE, "BrickNether")                                                                                                                                                                                                                                                                            .aspects(TC.IGNIS       , 1).stealStatsElement(SiO2).qual(1, 2.0, 24, 1).heat(1800, 3000).setPulver(Netherrack, U),
	Endstone                = stone         ( 8504, "Endstone"                                      , 217, 222, 158, 255, ENDER_DRAGON_PROOF)                                                                                                                                                                                                                                                                                   .aspects(TC.TENEBRAE    , 1).stealStatsElement(SiO2).qual(1, 3.0, 16, 1).heat(1200).addSourceOf(He,He_3),
	...
	Bedrock                 = create        ( 8599, "Bedrock"               , SET_STONE             ,  64,  64,  64, 255, G_STONE, STONE, BRITTLE, MELTING, UNBURNABLE)                                                                                                                                                                                                                                                         .aspects(TC.TERRA       , 5).stealStatsElement(Ad  ).qual(1, 8.0, 2048, 5).heat(4000).setRGBaLiquid(128,  96,  64, 255).addSourceOf(Ad,Atl,RareEarth),
	...
	WroughtIron             = metalmachnd   ( 8643, "Wrought Iron"          , SET_METALLIC          , 200, 180, 180     , RAILS, MORTAR, MAGNETIC_PASSIVE, MOLTEN, NEVER_FURNACE, "WrougtIron")                                                                     .uumAloy( 0, Fe             , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1).setPulver(Fe, U).steal(Fe).heat(Fe.mMeltingPoint + 200, Fe.mBoilingPoint).qual(3,  6.0,  384,  2).setRGBaLiquid(255, 80, 40, 255),
	AnnealedCopper          = metalmachnd   ( 8640, "Annealed Copper"       , SET_COPPER            , 255, 100,   0     , MOLTEN, FURNACE, EXTRUDER_SIMPLE, MORTAR, WIRES, RAILS, SOFT)                                                                             .uumAloy( 0, Cu             , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.PERMUTATIO  , 1).setPulver(Cu, U).steal(Cu).heat(                  2800, Cu.mBoilingPoint),
	...
	Mithril                 = slloymachore  ( 8678, "Mithril"                                       , 100, 140, 250     , MAGICAL, MOLTEN, WASHING_MERCURY, VALUABLE, CENTRIFUGE, "Mythril")                                                                        .setMcfg( 2, Pt             , 2*U, Ma               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.LUCRUM          , 3, TC.PRAECANTIO  , 1).qual(3, 14.0,   64, 3).heat(Pt),
	...
	MeteoricIron            = metalmachore  ( 8649, "Meteoric Iron"         , SET_SPACE             , 150, 140, 120     , MOLTEN, MAGNETIC_ACTIVE, AUTO_COLLECTING, RAILS, DECOMPOSABLE)                                                                            .uumMcfg( 0, Fe             , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.MAGNETO, 1).steal(WroughtIron).qual(3, 7.0, 896, 2).heat(Fe.mMeltingPoint + 200, Fe.mBoilingPoint + 200),
	MeteoricSteel           = alloymachine  ( 8650, "Meteoric Steel"        , SET_SPACE             , 130, 120, 100     , MOLTEN, MAGNETIC_ACTIVE, AUTO_COLLECTING, RAILS)                                                                                          .uumMcfg( 0, MeteoricIron   , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.MAGNETO, 1, TC.ORDO, 1).steal(Steel).qual(3, 8.0, 1280, 2).heat(Steel.mMeltingPoint + 200, Steel.mBoilingPoint + 200),
	MeteoricBlackSteel      = alloymachine  ( 8690, "Meteoric Black Steel"                          ,  85,  85,  85     , MOLTEN, MAGNETIC_ACTIVE, AUTO_COLLECTING).qual(3,  8.0, 1280, 2)                                                                          .uumAloy( 0, Ni             , 1*U, BlackBronze      , 1*U, MeteoricSteel    , 3*U)                                                                          .aspects(TC.METALLUM, 2, TC.MAGNETO, 1, TC.ORDO, 1, TC.INSTRUMENTUM, 1),
	MeteoricBlueSteel       = alloymachine  ( 8691, "Meteoric Blue Steel"                           ,  95,  95, 135     , MOLTEN, MAGNETIC_ACTIVE, AUTO_COLLECTING).qual(3,  8.5, 1408, 2)                                                                          .setAloy( 0, SterlingSilver , 1*U, BismuthBronze    , 1*U, MeteoricSteel    , 2*U, MeteoricBlackSteel,4*U)                                                  .aspects(TC.METALLUM, 2, TC.MAGNETO, 1, TC.ORDO, 1, TC.INSTRUMENTUM, 1),
	MeteoricRedSteel        = alloymachine  ( 8692, "Meteoric Red Steel"                            , 135,  95,  95     , MOLTEN, MAGNETIC_ACTIVE, AUTO_COLLECTING).qual(3,  9.0, 1536, 2)                                                                          .uumAloy( 0, RoseGold       , 1*U, Brass            , 1*U, MeteoricSteel    , 2*U, MeteoricBlackSteel,4*U)                                                  .aspects(TC.METALLUM, 2, TC.MAGNETO, 1, TC.ORDO, 1, TC.INSTRUMENTUM, 1),
	...
	Fireleaf                = alloymachine  ( 8698, "Fireleaf"              , SET_LEAF              , 127,  50,  50     , MAGICAL, CENTRIFUGE, MAGNETIC_PASSIVE, WOOD  , WITHER_PROOF, UNBURNABLE, BURNING, GLOWING, AUTO_COLLECTING, SOFT).qual(2, 12.0,  288, 4)  .setMcfg( 1, Steel             , 1*U, Ma            , 2*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.IGNIS, 3, TC.PRAECANTIO, 1, TC.HERBA, 1).setSmelting(FierySteel, U4).heat(Steel.mBoilingPoint-200, Steel.mBoilingPoint+500),
	...
	MeteoflameRedSteel      = alloymachine  ( 8696, "Meteoflame Red Steel"  , SET_FIERY             , 135,  95,  95     , MAGICAL, CENTRIFUGE, MAGNETIC_ACTIVE , MOLTEN, WITHER_PROOF, UNBURNABLE, BURNING, GLOWING, AUTO_COLLECTING).qual(3, 14.0, 1536, 4)        .setMcfg( 1, MeteoricRedSteel  , 1*U, Ma            , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.IGNIS, 3, TC.PRAECANTIO, 1, TC.MAGNETO, 1, TC.ORDO, 1, TC.INSTRUMENTUM, 1).heat(MeteoricRedSteel  .mBoilingPoint-200, MeteoricRedSteel  .mBoilingPoint+500),
	...
	DarkThaumium            = alloymachine  ( 8680, "Dark Thaumium"                                 , 100,  75,  75     , MAGICAL, CENTRIFUGE, MAGNETIC_PASSIVE, MOLTEN, WARPING).qual(3, 12.0,   512,  3)                                                                                                                                                                                                                      .aspects(TC.METALLUM, 2, TC.TENEBRAE, 1).heat(Thaumium),
...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60     , SOFT).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                            ,
	...
	Manasteel               = slloymachine  ( 8720, "Manasteel"                                     , 110, 200, 250     , MAGICAL)                                                                                                                                  .setMcfg( 1, Fe             , 1*U, Ma               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 2).steal(Steel).qual(3, 12.0, 256, 3).heat(Fe.mMeltingPoint+ 500, Fe.mBoilingPoint+1000),
	...
	Meteorite               = metalmachore  ( 8757, "Meteorite"             , SET_SPACE             , 222, 100, 222     , MOLTEN, MAGNETIC_ACTIVE, AUTO_COLLECTING, RAILS, DECOMPOSABLE)                                                                            .uumMcfg( 0, Fe             , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.MAGNETO, 1, TC.ALIENIS, 1).steal(MeteoricIron).qual(3, 8.0, 1200, 3),
...
//      GlauconiteSand          = oredustelec( 9151, "Glauconite Sand"           , SET_DULL      , 130, 180,  60, 255, MORTAR, BLACKLISTED_SMELTER                                                    )                         .addSourceOf(Al,K     ).setMcfg( 0, Al2O3          ,10*U, K                , 1*U, Mg               , 2*U, H2O              , 3*U, O                , 7*U)                        , // (K,Na)(Fe3+,Al,Mg)2(Si,Al)4O10(OH)2
	...
	public static class STONES {
		...
		SkyStone     = stonecent( 8528, "Sky Stone"               ,  81,  92,  96, 255)                                                            .setMcfg( 0, Peridot        , 2*U, RareEarth        , 1*U, MeteoricIron     , 1*U, Obsidian         , 5*U).aspects(TC.VOLATUS     , 1).qual(1, 5.0, 64, 2).heat(2200),
		...
		Komatiite    = stonecent( 9177, "Komatiite"               , 190, 190, 105, 255, UNBURNABLE)                                                .setMcfg( 0, Peridot        , 1*U, MgCO3            , 2*U, Flint            , 6*U, DarkAsh          , 3*U).aspects(TC.SANO        , 1).qual(1, 3.0, 32, 2).heat(1673),
		Pumice       = stonecent( 9000, "Pumice"      , SET_DULL  , 220, 216, 127, 255, UNBURNABLE)                                                .setMcfg( 0, Peridot        , 3*U, MgCO3            , 2*U, Flint            , 4*U, DarkAsh          , 2*U).aspects(TC.VITREUS     , 1).qual(1, 3.0, 32, 2).heat(1673),
		Gabbro       = stonecent( 9176, "Gabbro"                  ,  65,  60,  60, 255, UNBURNABLE)                                                .setMcfg( 0, Peridot        , 1*U, CaCO3            , 3*U, Flint            , 8*U, DarkAsh          , 4*U).aspects(TC.TENEBRAE    , 1).qual(1, 3.0, 32, 2).heat(1673),
		Basalt       = stonecent( 8505, "Basalt"                  ,  60,  50,  50, 255, UNBURNABLE, UNRECYCLABLE)                                  .setMcfg( 0, Peridot        , 1*U, CaCO3            , 3*U, Flint            , 8*U, DarkAsh          , 4*U).aspects(TC.TENEBRAE    , 1).qual(1, 3.0, 32, 2).heat(1673),
