...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60     ).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                  ,
	...
	DeshAlloy               = alloymachine  ( 8780, "Desh Alloy"                                    , 216,  42,  42     , MOLTEN).qual(3,  7.0,   2560,  2)                                                                                                         .uumMcfg( 4, Desh           , 4*U, Hg               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.ALIENIS, 1, TC.TELUM, 1).setLocal("Refined Desh"),
