...
public class MT {
	...
	Al2O3                   = oredustdcmp   ( 8008, "Alumina"               , SET_METALLIC          , 120, 195, 235, 255, MELTING, INGOTS)                                                                                                                          .uumMcfg( 0, Al             , 2*U, O                , 3*U)                                                                                                  .heat(2345, 3250),
	...
	UF6                     = gaschemdcmp   ( 9008, "Uranium Hexafluoride"                          ,  66,  98,  85, 255, GASSES)                                                                                                                                   .setMcfg( 0, U_238          , 1*U, F                , 6*U)                                                                                                  .aspects(TC.RADIO, 1, TC.PERDITIO, 3).heat( 100,  329),
	...
	U238F6                  = gaschemdcmp   ( 9010, "Uranium-238 Hexafluoride"                      ,  66,  98,  85, 255, GASSES)                                                                                                                                   .setMcfg( 0, U_238          , 1*U, F                , 6*U)                                                                                                  .aspects(TC.RADIO, 1, TC.PERDITIO, 3).heat( 100,  329),
...
//      CassiteriteSand         = oredustelec   ( 9109, "Cassiterite Sand"          , SET_SAND              , 220, 220, 220, 255, MORTAR, FURNACE                                                                ).setSmelting(Sn   , 3*U4).uumMcfg( 1, Sn             , 1*U, O                , 2*U)                                                                                                  .heat(3 * Sn.mMeltingPoint / 2),
		...
		BrownLimonite           = oredustdcmp   ( 9106, "Brown Limonite"            , SET_METALLIC          , 200, 100,   0, 255, MORTAR, MELTING, MOLTEN, MAGNETIC_PASSIVE                                      ).setSmelting(Fe2O3,   U2).setMcfg( 0, Fe             , 1*U, H                , 1*U, O                , 2*U)                                                                          .qual(0).heat(1523), // FeO(OH)
		YellowLimonite          = oredustdcmp   ( 9137, "Yellow Limonite"           , SET_METALLIC          , 200, 200,   0, 255, MORTAR, MELTING, MOLTEN, MAGNETIC_PASSIVE                                      ).setSmelting(Fe2O3,   U2).setMcfg( 0, Fe             , 1*U, H                , 1*U, O                , 2*U)                                                                          .qual(0).heat(1523), // FeO(OH) + a bit Ni and Co
