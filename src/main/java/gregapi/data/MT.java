...
//      CassiteriteSand         = oredustelec   ( 9109, "Cassiterite Sand"          , SET_SAND              , 220, 220, 220, 255).put(MORTAR, FURNACE                                                           ).setSmelting(Sn, 3*U4)     .uumMcfg( 1, Sn             , 1*U, O                , 2*U)                                                                                                  .heat(3 * Sn.mMeltingPoint / 2),
	...
	public static class UNUSED {
		...
		UF4                    		= dust   		( 8452, "Uranium Tetrafluoride"	, SET_SHARDS			, 86, 118, 105, 255).put(MELTING, MOLTEN)                                                                                                                    .uumMcfg( 0, U_238             , 1*U, F               , 4*U)                                                                                                  .aspects(TC.RADIO, 1, TC.PERDITIO, 2).setPriorityPrefix(2).heat(1309, 1690),
		UF6                    		= gaschem		( 8453, "Uranium Hexafluoride"	, SET_GAS			, 66, 98, 85, 255).put(GASSES)                                                                                                                    .uumMcfg( 0, U_238             , 1*U, F               , 6*U)                                                                                                  .aspects(TC.RADIO, 1, TC.PERDITIO, 3).setPriorityPrefix(2).heat( 100,  329),
		U238F4                    	= dust   		( 8454, "Uranium-238 Tetrafluoride"	, SET_SHARDS			, 86, 118, 105, 255).put(MELTING, MOLTEN)                                                                                                                    .uumMcfg( 0, U_238             , 1*U, F               , 4*U)                                                                                                  .aspects(TC.RADIO, 1, TC.PERDITIO, 2).setPriorityPrefix(2).heat(1309, 1690),
		U238F6                    	= gaschem   	( 8455, "Uranium-238 Hexafluoride"	, SET_GAS			, 66, 98, 85, 255).put(GASSES)                                                                                                                    .uumMcfg( 0, U_238             , 1*U, F               , 6*U)                                                                                                  .aspects(TC.RADIO, 1, TC.PERDITIO, 3).setPriorityPrefix(2).heat( 100,  329),
		U235F4                    	= dust   		( 8456, "Uranium-235 Tetrafluoride"	, SET_SHARDS			, 86, 118, 105, 255).put(MELTING, MOLTEN)                                                                                                                    .uumMcfg( 0, U_235             , 1*U, F               , 4*U)                                                                                                  .aspects(TC.RADIO, 1, TC.PERDITIO, 2).setPriorityPrefix(2).heat(1309, 1690),
		U235F6                    	= gaschem		( 8457, "Uranium-235 Hexafluoride"	, SET_GAS			, 66, 98, 85, 255).put(GASSES)                                                                                                                    .uumMcfg( 0, U_235             , 1*U, F               , 6*U)                                                                                                  .aspects(TC.RADIO, 1, TC.PERDITIO, 3).setPriorityPrefix(2).heat( 100,  329);
	}
}
