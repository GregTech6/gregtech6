...
//  HexoriumRainbow         = hexorium      ( 9242, 224, 224, 224, DYE_INDEX_White    ),
	...
	AnnealedCopper          = metalnd       ( 8640, "Annealed Copper"       , SET_COPPER            , 255, 100,   0     , MOLTEN, FURNACE, EXTRUDER_SIMPLE, MORTAR, WIRES, RAILS)                                                                                   .uumAloy( 0, Cu             , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.PERMUTATIO, 1         ).setPulver(Cu    , U)                                                                                                                                      .steal(Cu         ).heat(2800, Cu.mBoilingPoint),
...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60     ).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                  ,
	...
	DeshAlloy               = alloymachine  ( 8780, "Desh Alloy"                                    , 216,   4,   4     ).qual(3,  7.0,   2560,  2)                                                                                                                 .uumMcfg( 4, Desh           , 4*U, Hg               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.ALIENIS, 1, TC.TELUM, 1),
