...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60     ).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                  ,
	...
	public static class TECH {
		...
		static void init() {
			...
			Plastic                 .addEnchantmentForWeapons(Enchantment.knockback, 1).addEnchantmentForRanged(Enchantment.punch, 1);
			Rubber                  .addEnchantmentForWeapons(Enchantment.knockback, 2).addEnchantmentForRanged(Enchantment.punch, 2);
			Kalendrite              .addEnchantmentForWeapons(Enchantment.knockback, 2).addEnchantmentForRanged(Enchantment.punch, 2);
			InfusedAir              .addEnchantmentForWeapons(Enchantment.knockback, 2).addEnchantmentForRanged(Enchantment.punch, 2);
			Blitz                   .addEnchantmentForWeapons(Enchantment.knockback, 3).addEnchantmentForRanged(Enchantment.punch, 3);
			Gravitite               .addEnchantmentForWeapons(Enchantment.knockback, 3).addEnchantmentForRanged(Enchantment.punch, 3);
			DarkIron                .addEnchantmentForWeapons(Enchantment.knockback, 3).addEnchantmentForRanged(Enchantment.punch, 3);
			Tartarite               .addEnchantmentForWeapons(Enchantment.knockback, 3).addEnchantmentForRanged(Enchantment.punch, 3);
			DarkMatter              .addEnchantmentForWeapons(Enchantment.knockback, 3).addEnchantmentForRanged(Enchantment.punch, 3);
			RedMeteor               .addEnchantmentForWeapons(Enchantment.knockback, 3).addEnchantmentForRanged(Enchantment.punch, 3);
			Infinity                .addEnchantmentForWeapons(Enchantment.knockback,10).addEnchantmentForRanged(Enchantment.punch,10);
			
			Skyroot                 .addEnchantmentForTools(Enchantment.fortune, 1).addEnchantmentForWeapons(Enchantment.looting, 1).addEnchantmentForRanged(Enchantment.infinity, 1);
			IronWood                .addEnchantmentForTools(Enchantment.fortune, 1).addEnchantmentForWeapons(Enchantment.looting, 1).addEnchantmentForRanged(Enchantment.infinity, 1);
			Steeleaf                .addEnchantmentForTools(Enchantment.fortune, 2).addEnchantmentForWeapons(Enchantment.looting, 2).addEnchantmentForRanged(Enchantment.infinity, 2);
			Efrine                  .addEnchantmentForTools(Enchantment.fortune, 2).addEnchantmentForWeapons(Enchantment.looting, 2).addEnchantmentForRanged(Enchantment.infinity, 2);
			Soularium               .addEnchantmentForTools(Enchantment.fortune, 2).addEnchantmentForWeapons(Enchantment.looting, 2).addEnchantmentForRanged(Enchantment.infinity, 2);
			Midasium                .addEnchantmentForTools(Enchantment.fortune, 2).addEnchantmentForWeapons(Enchantment.looting, 2).addEnchantmentForRanged(Enchantment.infinity, 2);
			Mithril                 .addEnchantmentForTools(Enchantment.fortune, 3).addEnchantmentForWeapons(Enchantment.looting, 3).addEnchantmentForRanged(Enchantment.infinity, 3);
			ElvenQuartz             .addEnchantmentForTools(Enchantment.fortune, 3).addEnchantmentForWeapons(Enchantment.looting, 3).addEnchantmentForRanged(Enchantment.infinity, 3);
			Vinteum                 .addEnchantmentForTools(Enchantment.fortune, 1).addEnchantmentForWeapons(Enchantment.looting, 1).addEnchantmentForRanged(Enchantment.infinity, 1);
			Thaumium                .addEnchantmentForTools(Enchantment.fortune, 2).addEnchantmentForWeapons(Enchantment.looting, 2).addEnchantmentForRanged(Enchantment.infinity, 2);
			DarkThaumium            .addEnchantmentForTools(Enchantment.fortune, 2).addEnchantmentForWeapons(Enchantment.looting, 2).addEnchantmentForRanged(Enchantment.infinity, 2);
			VoidMetal               .addEnchantmentForTools(Enchantment.fortune, 3).addEnchantmentForWeapons(Enchantment.looting, 3).addEnchantmentForRanged(Enchantment.infinity, 3);
			InfusedWater            .addEnchantmentForTools(Enchantment.fortune, 3).addEnchantmentForWeapons(Enchantment.looting, 3).addEnchantmentForRanged(Enchantment.infinity, 3);
			Eximite                 .addEnchantmentForTools(Enchantment.fortune, 3).addEnchantmentForWeapons(Enchantment.looting, 3).addEnchantmentForRanged(Enchantment.infinity, 3);
			DarkMatter              .addEnchantmentForTools(Enchantment.fortune, 3).addEnchantmentForWeapons(Enchantment.looting, 3).addEnchantmentForRanged(Enchantment.infinity, 3);
			RedMatter               .addEnchantmentForTools(Enchantment.fortune, 3).addEnchantmentForWeapons(Enchantment.looting, 3).addEnchantmentForRanged(Enchantment.infinity, 3);
			Jade                    .addEnchantmentForTools(Enchantment.fortune, 3).addEnchantmentForWeapons(Enchantment.looting, 3).addEnchantmentForRanged(Enchantment.infinity, 3);
			Sugilite                .addEnchantmentForTools(Enchantment.fortune, 3).addEnchantmentForWeapons(Enchantment.looting, 3).addEnchantmentForRanged(Enchantment.infinity, 3);
			EnderAmethyst           .addEnchantmentForTools(Enchantment.fortune, 3).addEnchantmentForWeapons(Enchantment.looting, 3).addEnchantmentForRanged(Enchantment.infinity, 3);
			Continuum               .addEnchantmentForTools(Enchantment.fortune, 3).addEnchantmentForWeapons(Enchantment.looting, 3).addEnchantmentForRanged(Enchantment.infinity, 3);
			Basalz                  .addEnchantmentForTools(Enchantment.fortune, 4).addEnchantmentForWeapons(Enchantment.looting, 4).addEnchantmentForRanged(Enchantment.infinity, 4);
			Ma                      .addEnchantmentForTools(Enchantment.fortune, 4).addEnchantmentForWeapons(Enchantment.looting, 4).addEnchantmentForRanged(Enchantment.infinity, 4);
			Haderoth                .addEnchantmentForTools(Enchantment.fortune, 4).addEnchantmentForWeapons(Enchantment.looting, 4).addEnchantmentForRanged(Enchantment.infinity, 4);
			VibraniumSteel          .addEnchantmentForTools(Enchantment.fortune, 5).addEnchantmentForWeapons(Enchantment.looting, 5).addEnchantmentForRanged(Enchantment.infinity, 5);
			Vibramantium            .addEnchantmentForTools(Enchantment.fortune, 5).addEnchantmentForWeapons(Enchantment.looting, 5).addEnchantmentForRanged(Enchantment.infinity, 5);
			Vb                      .addEnchantmentForTools(Enchantment.fortune, 5).addEnchantmentForWeapons(Enchantment.looting, 5).addEnchantmentForRanged(Enchantment.infinity, 5);
			Infinity                .addEnchantmentForTools(Enchantment.fortune,10).addEnchantmentForWeapons(Enchantment.looting,10).addEnchantmentForRanged(Enchantment.infinity,10);
			...
			Obsidian                .addEnchantmentForWeapons(Enchantment.fireAspect, 1).addEnchantmentForRanged(Enchantment.flame, 1);
			STONES.Gneiss           .addEnchantmentForWeapons(Enchantment.fireAspect, 2).addEnchantmentForRanged(Enchantment.flame, 2);
			NetherBrick             .addEnchantmentForWeapons(Enchantment.fireAspect, 2).addEnchantmentForRanged(Enchantment.flame, 2);
			ObsidianSteel           .addEnchantmentForWeapons(Enchantment.fireAspect, 2).addEnchantmentForRanged(Enchantment.flame, 2);
			Ignatius                .addEnchantmentForWeapons(Enchantment.fireAspect, 2).addEnchantmentForRanged(Enchantment.flame, 2);
			Prometheum              .addEnchantmentForWeapons(Enchantment.fireAspect, 3).addEnchantmentForRanged(Enchantment.flame, 3).addEnchantmentForTools(Enchantment.fireAspect, 3);
			Octine                  .addEnchantmentForWeapons(Enchantment.fireAspect, 3).addEnchantmentForRanged(Enchantment.flame, 3).addEnchantmentForTools(Enchantment.fireAspect, 3);
			Kreknorite              .addEnchantmentForWeapons(Enchantment.fireAspect, 3).addEnchantmentForRanged(Enchantment.flame, 3).addEnchantmentForTools(Enchantment.fireAspect, 3);
			Firestone               .addEnchantmentForWeapons(Enchantment.fireAspect, 3).addEnchantmentForRanged(Enchantment.flame, 3).addEnchantmentForTools(Enchantment.fireAspect, 3);
			FierySteel              .addEnchantmentForWeapons(Enchantment.fireAspect, 3).addEnchantmentForRanged(Enchantment.flame, 3).addEnchantmentForTools(Enchantment.fireAspect, 3);
			Pyrotheum               .addEnchantmentForWeapons(Enchantment.fireAspect, 3).addEnchantmentForRanged(Enchantment.flame, 3).addEnchantmentForTools(Enchantment.fireAspect, 3);
			Blaze                   .addEnchantmentForWeapons(Enchantment.fireAspect, 3).addEnchantmentForRanged(Enchantment.flame, 3).addEnchantmentForTools(Enchantment.fireAspect, 3);
			InfusedFire             .addEnchantmentForWeapons(Enchantment.fireAspect, 3).addEnchantmentForRanged(Enchantment.flame, 3).addEnchantmentForTools(Enchantment.fireAspect, 3);
			Vulcanite               .addEnchantmentForWeapons(Enchantment.fireAspect, 3).addEnchantmentForRanged(Enchantment.flame, 3).addEnchantmentForTools(Enchantment.fireAspect, 3);
			Amordrine               .addEnchantmentForWeapons(Enchantment.fireAspect, 3).addEnchantmentForRanged(Enchantment.flame, 3).addEnchantmentForTools(Enchantment.fireAspect, 3);
			MuspelheimPower         .addEnchantmentForWeapons(Enchantment.fireAspect, 3).addEnchantmentForRanged(Enchantment.flame, 3).addEnchantmentForTools(Enchantment.fireAspect, 3);
			RedMatter               .addEnchantmentForWeapons(Enchantment.fireAspect, 3).addEnchantmentForRanged(Enchantment.flame, 3).addEnchantmentForTools(Enchantment.fireAspect, 3);
			Netherite               .addEnchantmentForWeapons(Enchantment.fireAspect, 3).addEnchantmentForRanged(Enchantment.flame, 3).addEnchantmentForTools(Enchantment.fireAspect, 3);
			NetherizedDiamond       .addEnchantmentForWeapons(Enchantment.fireAspect, 3).addEnchantmentForRanged(Enchantment.flame, 3).addEnchantmentForTools(Enchantment.fireAspect, 3);
			Infinity                .addEnchantmentForWeapons(Enchantment.fireAspect,10).addEnchantmentForRanged(Enchantment.flame,10).addEnchantmentForTools(Enchantment.fireAspect,10);
			
			Hepatizon               .addEnchantmentForWeapons(Enchantment.smite, 2);
			BlackBronze             .addEnchantmentForWeapons(Enchantment.smite, 2);
			RedSteel                .addEnchantmentForWeapons(Enchantment.smite, 3);
			MeteoricRedSteel        .addEnchantmentForWeapons(Enchantment.smite, 3);
			Au                      .addEnchantmentForWeapons(Enchantment.smite, 3);
			TitaniumGold            .addEnchantmentForWeapons(Enchantment.smite, 3);
			Electrum                .addEnchantmentForWeapons(Enchantment.smite, 3);
			GildedIron              .addEnchantmentForWeapons(Enchantment.smite, 3);
			STONES.Holystone        .addEnchantmentForWeapons(Enchantment.smite, 3);
			RoseGold                .addEnchantmentForWeapons(Enchantment.smite, 4);
			EnergeticAlloy          .addEnchantmentForWeapons(Enchantment.smite, 4);
			SpectreIron             .addEnchantmentForWeapons(Enchantment.smite, 5);
			VibrantAlloy            .addEnchantmentForWeapons(Enchantment.smite, 5);
			Mauftrium               .addEnchantmentForWeapons(Enchantment.smite, 5);
			Carmot                  .addEnchantmentForWeapons(Enchantment.smite, 5);
			Pt                      .addEnchantmentForWeapons(Enchantment.smite, 5);
			Mithril                 .addEnchantmentForWeapons(Enchantment.smite, 5);
			InfusedVis              .addEnchantmentForWeapons(Enchantment.smite, 5);
			Infinity                .addEnchantmentForWeapons(Enchantment.smite,10);
			
			Pb                      .addEnchantmentForWeapons(Enchantment.baneOfArthropods, 2);
			Ni                      .addEnchantmentForWeapons(Enchantment.baneOfArthropods, 2);
			Constantan              .addEnchantmentForWeapons(Enchantment.baneOfArthropods, 2);
			Nichrome                .addEnchantmentForWeapons(Enchantment.baneOfArthropods, 2);
			Invar                   .addEnchantmentForWeapons(Enchantment.baneOfArthropods, 3);
			Sb                      .addEnchantmentForWeapons(Enchantment.baneOfArthropods, 3);
			Aredrite                .addEnchantmentForWeapons(Enchantment.baneOfArthropods, 3);
			BatteryAlloy            .addEnchantmentForWeapons(Enchantment.baneOfArthropods, 4);
			Bi                      .addEnchantmentForWeapons(Enchantment.baneOfArthropods, 4);
			Orichalcum              .addEnchantmentForWeapons(Enchantment.baneOfArthropods, 4);
			BismuthBronze           .addEnchantmentForWeapons(Enchantment.baneOfArthropods, 4);
			InfusedEarth            .addEnchantmentForWeapons(Enchantment.baneOfArthropods, 5);
			Celenegil               .addEnchantmentForWeapons(Enchantment.baneOfArthropods, 5);
			Infinity                .addEnchantmentForWeapons(Enchantment.baneOfArthropods,10);
			...
			GildedIron              .addEnchantmentForWeapons(Enchantment.sharpness, 1).addEnchantmentForRanged(Enchantment.power, 1);
			PulsatingIron           .addEnchantmentForWeapons(Enchantment.sharpness, 1).addEnchantmentForRanged(Enchantment.power, 1);
			ConductiveIron          .addEnchantmentForWeapons(Enchantment.sharpness, 1).addEnchantmentForRanged(Enchantment.power, 1);
			RedstoneAlloy           .addEnchantmentForWeapons(Enchantment.sharpness, 1).addEnchantmentForRanged(Enchantment.power, 1);
			ElectricalSteel         .addEnchantmentForWeapons(Enchantment.sharpness, 2).addEnchantmentForRanged(Enchantment.power, 2);
			Brass                   .addEnchantmentForWeapons(Enchantment.sharpness, 2).addEnchantmentForRanged(Enchantment.power, 2);
			CobaltBrass             .addEnchantmentForWeapons(Enchantment.sharpness, 2).addEnchantmentForRanged(Enchantment.power, 2);
			HSLA                    .addEnchantmentForWeapons(Enchantment.sharpness, 2).addEnchantmentForRanged(Enchantment.power, 2);
			Steel                   .addEnchantmentForWeapons(Enchantment.sharpness, 2).addEnchantmentForRanged(Enchantment.power, 2);
			SteelMagnetic           .addEnchantmentForWeapons(Enchantment.sharpness, 2).addEnchantmentForRanged(Enchantment.power, 2);
			SteelGalvanized         .addEnchantmentForWeapons(Enchantment.sharpness, 2).addEnchantmentForRanged(Enchantment.power, 2);
			Syrmorite               .addEnchantmentForWeapons(Enchantment.sharpness, 2).addEnchantmentForRanged(Enchantment.power, 2);
			WroughtIron             .addEnchantmentForWeapons(Enchantment.sharpness, 2).addEnchantmentForRanged(Enchantment.power, 2);
			PigIron                 .addEnchantmentForWeapons(Enchantment.sharpness, 2).addEnchantmentForRanged(Enchantment.power, 2);
			Meteorite               .addEnchantmentForWeapons(Enchantment.sharpness, 2).addEnchantmentForRanged(Enchantment.power, 2);
			FierySteel              .addEnchantmentForWeapons(Enchantment.sharpness, 2).addEnchantmentForRanged(Enchantment.power, 2);
			...
			DeepIron                .addEnchantmentForWeapons(Enchantment.sharpness, 3).addEnchantmentForRanged(Enchantment.power, 3);
			ShadowIron              .addEnchantmentForWeapons(Enchantment.sharpness, 3).addEnchantmentForRanged(Enchantment.power, 3);
			BlackSteel              .addEnchantmentForWeapons(Enchantment.sharpness, 3).addEnchantmentForRanged(Enchantment.power, 3);
			MeteoricBlackSteel      .addEnchantmentForWeapons(Enchantment.sharpness, 3).addEnchantmentForRanged(Enchantment.power, 3);
			RedSteel                .addEnchantmentForWeapons(Enchantment.sharpness, 3).addEnchantmentForRanged(Enchantment.power, 3);
			MeteoricRedSteel        .addEnchantmentForWeapons(Enchantment.sharpness, 3).addEnchantmentForRanged(Enchantment.power, 3);
			BlueSteel               .addEnchantmentForWeapons(Enchantment.sharpness, 3).addEnchantmentForRanged(Enchantment.power, 3);
			MeteoricBlueSteel       .addEnchantmentForWeapons(Enchantment.sharpness, 3).addEnchantmentForRanged(Enchantment.power, 3);
			Ti                      .addEnchantmentForWeapons(Enchantment.sharpness, 3).addEnchantmentForRanged(Enchantment.power, 3);
			TitaniumGold            .addEnchantmentForWeapons(Enchantment.sharpness, 3).addEnchantmentForRanged(Enchantment.power, 3);
			TungstenAlloy           .addEnchantmentForWeapons(Enchantment.sharpness, 3).addEnchantmentForRanged(Enchantment.power, 3);
			TungstenSteel           .addEnchantmentForWeapons(Enchantment.sharpness, 4).addEnchantmentForRanged(Enchantment.power, 4);
			NetherizedDiamond       .addEnchantmentForWeapons(Enchantment.sharpness, 4).addEnchantmentForRanged(Enchantment.power, 4);
			HSSG                    .addEnchantmentForWeapons(Enchantment.sharpness, 4).addEnchantmentForRanged(Enchantment.power, 4);
			HSSE                    .addEnchantmentForWeapons(Enchantment.sharpness, 4).addEnchantmentForRanged(Enchantment.power, 4);
			HSSS                    .addEnchantmentForWeapons(Enchantment.sharpness, 4).addEnchantmentForRanged(Enchantment.power, 4);
			ShadowSteel             .addEnchantmentForWeapons(Enchantment.sharpness, 4).addEnchantmentForRanged(Enchantment.power, 4);
			Zanite                  .addEnchantmentForWeapons(Enchantment.sharpness, 4).addEnchantmentForRanged(Enchantment.power, 4);
			DamascusSteel           .addEnchantmentForWeapons(Enchantment.sharpness, 5).addEnchantmentForRanged(Enchantment.power, 5);
			Elvorium                .addEnchantmentForWeapons(Enchantment.sharpness, 5).addEnchantmentForRanged(Enchantment.power, 5);
			InfusedEntropy          .addEnchantmentForWeapons(Enchantment.sharpness, 5).addEnchantmentForRanged(Enchantment.power, 5);
			Ke                      .addEnchantmentForWeapons(Enchantment.sharpness, 6).addEnchantmentForRanged(Enchantment.power, 6);
			Trinitanium             .addEnchantmentForWeapons(Enchantment.sharpness, 7).addEnchantmentForRanged(Enchantment.power, 7);
			Trinaquadalloy          .addEnchantmentForWeapons(Enchantment.sharpness, 8).addEnchantmentForRanged(Enchantment.power, 8);
			Infinity                .addEnchantmentForWeapons(Enchantment.sharpness,10).addEnchantmentForRanged(Enchantment.power,10);
