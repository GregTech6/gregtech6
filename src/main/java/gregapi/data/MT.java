...
public class MT {
	...
	static OreDictMaterial glowstone    (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, long aA    )  {return oredustcent     (aID, aNameOreDict, aSets           , aR, aG, aB, aA).put(PLATES, STICKS, MORTAR, BRITTLE, UNBURNABLE, MELTING, CRYSTAL, G_GEM_ORES_TRANSPARENT, GLOWING, LIGHTING).setPriorityPrefix(2).addReRegistrations(ANY.Glowstone).setOreMultiplier(4);}
	...
	H2O2                    = lquddcmp      ( 9809, "Hydrogen Peroxide"                             ,  20,  20, 255, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, H              , 2*U, O                , 2*U)                                                                                                  .aspects(TC.AQUA, 3).heat(CS.C, CS.C+150).setDensity(1.0),
	Glyceryl                = lqudchemelec  ( 9821, "Glyceryl"                                      ,   0, 150, 150, 255).put(LIQUID, FLAMMABLE, EXPLOSIVE)                                                                                                             .uumMcfg( 0, C              , 3*U, H                , 5*U, N                , 3*U, O                , 9*U)                                                  .heat( 287,  323),
	Glycerol                = lqudchemelec  ( 9828, "Glycerol"                                      ,   0, 180, 180, 255).put(LIQUID, FLAMMABLE)                                                                                                                        .uumMcfg( 0, C              , 3*U, H                , 8*U, O                , 3*U)                                                                          .heat( 291,  563),
	H2SO4                   = lqudaciddcmp  ( 9824, "Sulfuric Acid"                                 , 255, 128,   0, 255).put(LIQUID, "SulphuricAcid")                                                                                                                  .uumMcfg( 0, H              , 2*U, S                , 1*U, O                , 4*U)                                                                          .heat( 200,  400), SulfuricAcid = H2SO4,
	H2S2O7                  = lqudaciddcmp  ( 9844, "Disulfuric Acid"                               , 255, 150,   0, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, H              , 2*U, S                , 2*U, O                , 7*U)                                                                          .heat( 200,  400),
	HNO3                    = lqudaciddcmp  ( 9825, "Nitric Acid"                                   , 128, 255,   0, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, H              , 1*U, N                , 1*U, O                , 3*U)                                                                          .heat( 231,  356), NitricAcid = HNO3,
	H2SiF6                  = lqudacidelec  ( 8011, "Hexafluorosilicic Acid"                        , 190, 200, 190, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, H              , 2*U, Si               , 1*U, F                , 6*U)                                                                          .heat( 250,  381), HexafluorosilicicAcid = H2SiF6,
...
//      CassiteriteSand         = oredustelec   ( 9109, "Cassiterite Sand"          , SET_SAND              , 220, 220, 220, 255).put(MORTAR, FURNACE                                                           ).setSmelting(Sn, 3*U4)     .uumMcfg( 1, Sn             , 1*U, O                , 2*U)                                                                                                  .heat(3 * Sn.mMeltingPoint / 2),
	...
	public static class UNUSED {
		...
		InfusedGold                 = unused        ("Infused Gold"                 ).put(G_INGOT),
		Daffergon                   = unused        ("Daffergon"                    ).put(G_INGOT_ORES, MD.HBM), // Dellite Ore
		Reiium                      = unused        ("Reiium"                       ).put(G_INGOT_ORES, MD.HBM), // Reiite Ore
		Weidanium                   = unused        ("Weidanium"                    ).put(G_INGOT_ORES, MD.HBM), // Weidite Ore
		Verticium                   = unused        ("Verticium"                    ).put(G_INGOT_ORES, MD.HBM),
		Australium                  = unused        ("Australium"                   ).put(G_INGOT_ORES, MD.HBM),
		Schrabidium                 = unused        ("Schrabidium"                  ).put(G_INGOT_ORES, MD.HBM, MAGNETIC_ACTIVE),
		Starmetal                   = unused        ("Starmetal"                    ).put(G_INGOT_MACHINE_ORES, MD.HBM),
		Unobtainium                 = unused        ("Unobtainium"                  ).put(G_INGOT_MACHINE_ORES, MD.HBM),
		CMBSteel                    = unused        ("CMB Steel"                    ).put(G_INGOT_MACHINE, MD.HBM),
		DuraSteel                   = unused        ("DuraSteel"                    ).put(G_INGOT_MACHINE, MD.HBM).setLocal("High-Speed Steel"),
		AdvancedAlloy               = unused        ("Advanced Alloy"               ).put(G_INGOT_MACHINE, MD.HBM),
		Saturnite                   = unused        ("Saturnite"                    ).put(G_INGOT_MACHINE, MD.HBM),
		Dineutronium                = unused        ("Dineutronium"                 ).put(G_INGOT_MACHINE, MD.HBM),
		MagnetizedTungsten          = unused        ("Magnetized Tungsten"          ).put(G_INGOT, MD.HBM, MAGNETIC_ACTIVE),
		Thorium232                  = unused        ("Thorium-232"                  ).put(G_INGOT, MD.HBM),
		Euphemium                   = unused        ("Euphemium"                    ).put(G_INGOT, MD.HBM),
		Plutonium240                = unused        ("Plutonium-240"                ).put(G_INGOT, MD.HBM),
		Plutonium238                = unused        ("Plutonium-238"                ).put(G_INGOT, MD.HBM),
