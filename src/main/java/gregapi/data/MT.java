...
public class MT {
	...
	*/
	...
	Pyrotheum               = mixdust       ( 8212, "Pyrotheum"             , SET_FIERY             , 255, 200,  60, 255, CONTAINERS, MELTING, MORTAR)                                                                                                              .setMcfg(18, Coal           , 9*U, S                , 9*U, Redstone         , 9*U, Blaze            , 1*U)                                                  .aspects(TC.PRAECANTIO, 2, TC.IGNIS, 1).heat(3800, 6400),
...
//      CassiteriteSand         = oredustelec   ( 9109, "Cassiterite Sand"          , SET_SAND              , 220, 220, 220, 255, MORTAR, FURNACE                                                           ).setSmelting(Sn, 3*U4)     .uumMcfg( 1, Sn             , 1*U, O                , 2*U)                                                                                                  .heat(3 * Sn.mMeltingPoint / 2),
		...
		Cinnabar                = oredustcent   ( 9114, "Cinnabar"                  , SET_REDSTONE          , 150,   0,   0, 255, MORTAR, FURNACE, PULVERIZING_CINNABAR, CRYSTAL, G_GEM_ORES_TRANSPARENT    ).setSmelting(Hg,   U3)     .uumMcfg( 0, Hg             , 1*U, S                , 1*U)                                                                                                  ,
