...
public class MT {
	...
	TitaniumGold            = alloymachine  ( 8654, "Titanium Gold Alloy"   , SET_METALLIC          , 222, 222, 255, 255).qual(3, 12.0, 5120, 4)                                                                                                                        .uumMcfg( 0, Ti             , 3*U, Au               , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 3, TC.LUCRUM, 1).alloyCentrifuge(),
