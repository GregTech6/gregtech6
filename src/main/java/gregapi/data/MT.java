...
public class MT {
	...
	Ad      = element( 2220, "Adamantium"            , "Ad"      , 222, 580, 5225, 14528, 13.35624762, SET_SHINY   , 255, 255, 255, 255, G_INGOT_MACHINE_ORES, UUM, SMITHABLE, MELTING, MOLTEN, EXTRUDER, MAGICAL, MAGNETIC_PASSIVE, UNBURNABLE, WITHER_PROOF, ENDER_DRAGON_PROOF, "Adamant", "Bibibium").qual(3, 10.0, 5120, 5).aspects(TC.METALLUM, 10, TC.PRAECANTIO, 10), Bbb = Ad,
...
//  HexoriumRainbow         = hexorium      ( 9242, 224, 224, 224, DYE_INDEX_White    ),
	...
	AluminiumBrass          = alloymachine  ( 8700, "Aluminium Brass"                               , 220, 220, 130     , MOLTEN, "AluminumBrass").qual(2, 6.0,  64,  2)                                                                                            .uumAloy( 0, Al             , 3*U, Cu               , 1*U)                                                                                                  .aspects(TC.STRONTIO, 1),
...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60     ).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                  ,
	...
	ElvenElementium         = slloymachore  ( 8722, "Elven Elementium"                              , 250, 120, 250     , MAGICAL, UNBURNABLE)                                                                                                                                                                                                                                                                                  .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 2).steal(Steel).qual(3, 14.0, 512, 3).heat(Fe.mMeltingPoint+1000, Fe.mBoilingPoint+2000).setLocal("Elementium"),
	...
	HSSG                    = alloymachine  ( 8796, "HSS-G"                                         , 153, 153,   0     , MOLTEN, UNBURNABLE).qual(3, 10.0, 4000, 3)                                                                                                .uumAloy( 0, TungstenSteel  , 5*U, Cr               , 1*U, Mo               , 2*U, V                , 1*U)                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 1, TC.MACHINA, 1),
	HSSE                    = alloymachine  ( 8797, "HSS-E"                                         ,  51, 102,   0     , MOLTEN, UNBURNABLE).qual(3, 10.0, 5120, 4)                                                                                                .uumAloy( 0, HSSG           , 6*U, Co               , 1*U, Mn               , 1*U, Si               , 1*U)                                                  .aspects(TC.METALLUM, 2, TC.TUTAMEN, 2, TC.MACHINA, 2),
	HSSS                    = alloymachine  ( 8798, "HSS-S"                                         , 102,   0,  51     , MOLTEN, UNBURNABLE).qual(3, 14.0, 3000, 4)                                                                                                .uumAloy( 0, HSSG           , 6*U, Osmiridium       , 2*U, Ir               , 1*U)                                                                          .aspects(TC.METALLUM, 2, TC.TUTAMEN, 2, TC.MACHINA, 2, TC.NEBRISUM, 1),
