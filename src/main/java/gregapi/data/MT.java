...
public class MT {
	...
	static OreDictMaterial garnet       (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, byte aColor)  {return valgemelec      (aID, aNameOreDict, aSets, aR, aG, aB, 127).lens(aColor).put(MELTING, MD.GT).aspects(TC.VITREUS, 3, TC.LUCRUM, 1).qual(3, 7.0, 128, 2);}
	static OreDictMaterial emerald      (int aID, String aNameOreDict, TextureSet[] aSets, long aR, long aG, long aB, byte aColor)  {return valgemelec      (aID, aNameOreDict, aSets, aR, aG, aB, 127).lens(aColor).put(MELTING       ).aspects(TC.VITREUS, 3, TC.LUCRUM, 3).qual(3, 9.0, 128, 2).setSmelting(Be, U36);}
