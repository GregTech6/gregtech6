...
//      GlauconiteSand          = oredustelec( 9151, "Glauconite Sand"           , SET_DULL      , 130, 180,  60, 255, MORTAR, BLACKLISTED_SMELTER                                                    )                         .addSourceOf(Al,K     ).setMcfg( 0, Al2O3          ,10*U, K                , 1*U, Mg               , 2*U, H2O              , 3*U, O                , 7*U)                        , // (K,Na)(Fe3+,Al,Mg)2(Si,Al)4O10(OH)2
	...
	public static class STONES {
		...
		Pitstone     = stone    ( 8520, "Pitstone"                , 120, 160,  50, 255)                                                                                                                                                                      .aspects(TC.TENEBRAE    , 1).qual(1, 3.0, 32, 1).heat(1200),
		Cragrock     = stone    ( 8524, "Cragrock"                ,  93,  96, 107, 255)                                                                                                                                                                      .aspects(TC.VENENUM     , 1).qual(1, 3.0, 32, 1).heat(1400),
		Templerock   = stone    ( 8525, "Templerock"              , 171, 158, 106, 255)                                                                                                                                                                      .aspects(TC.VINCULUM    , 1).qual(1, 3.0, 32, 1).heat(1600),
