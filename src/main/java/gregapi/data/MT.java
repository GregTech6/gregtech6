...
public class MT {
	...
	F       = diatomicgas (  90, "Fluorine"       , "F"     ,   9,   9,    53,    85,  0.001696  , SET_DULL    ,  64, 192,   0, 255, UUM, FUSION, HALOGEN        , CONTAINERS_GAS                                                                                               ).aspects(TC.PERDITIO, 2                                 ),
	...
	Ra      = alkaline    ( 880, "Radium"         , "Ra"    ,  88, 136,   973,  2010,  5.5       , SET_RAD     , 255, 255, 205                                                         , "Radium226"                                                                            ).aspects_met_rad(2, 1                                   ),
...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60     ).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                  ,
	...
	CrystallineAlloy        = alloy         ( 8807, "Crystalline Alloy"                             , 109, 169, 169     )                                                                                                                                                                                                                                                                                                       .aspects(TC.METALLUM, 2, TC.VITREUS, 1),
	CrystallinePinkSlime    = alloy         ( 8808, "Crystalline Pink Slime"                        , 176, 112, 166     )                                                                                                                                                                                                                                                                                                       .aspects(TC.METALLUM, 2, TC.VITREUS, 1, TC.LIMUS, 1),
	EndSteel                = alloy         ( 8809, "End Steel"                                     , 164, 157, 116     )                                                                                                                                           .setAloy( 1, Endstone       , 1*U, ObsidianSteel    , 1*U, Obsidian         , 9*U)                                                                          .aspects(TC.METALLUM, 2, TC.ALIENIS, 1),
	EnergeticSilver         = alloy         ( 8810, "Energetic Silver"                              ,  93, 126, 151     )                                                                                                                                           .uumAloy( 1, Ag             , 1*U, Redstone         , 1*U, Glowstone        , 1*U)                                                                          .aspects(TC.METALLUM, 2, TC.POTENTIA, 1),
	MelodicAlloy            = alloy         ( 8811, "Melodic Alloy"                                 , 138,  92, 138     )                                                                                                                                           .setAloy( 1, EndSteel       , 1*U, EnderEye         , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.SENSUS, 1),
	StellarAlloy            = alloy         ( 8812, "Stellar Alloy"                                 , 170, 181, 164     )                                                                                                                                           .setAloy( 2, MelodicAlloy   , 1*U, NetherStar       , 1*U, Clay             , 4*U)                                                                          .aspects(TC.METALLUM, 2, TC.AURAM, 1),
	VividAlloy              = alloy         ( 8813, "Vivid Alloy"                                   ,  60, 139, 160     )                                                                                                                                           .setAloy( 1, EnergeticSilver, 1*U, EnderPearl       , 1*U)                                                                                                  .aspects(TC.METALLUM, 2, TC.LUX, 1),
