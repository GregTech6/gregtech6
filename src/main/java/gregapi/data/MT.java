...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60     ).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                  ,
	...
	Desh                    = alloymachore  ( 8750, "Desh"                  , SET_DULL              ,  40,  40,  40     ).qual(3,  4.0,   1280,  3)                                                                                                                 .uumAloy( 9, C              , 9*U, B                , 2*U, La, 2*U, Hg, 2*U, Li, 1*U, Nd, 1*U, Ce, 1*U, Co, 1*U, Nb, 1*U)                                   .aspects(TC.METALLUM, 2, TC.ALIENIS, 1, TC.TELUM, 1),
	...
	public static class TECH {
		...
		static void init() {
			...
			TiO2                            .addOreByProducts(Fe2O3                     , OREMATS.Coltan            , Zircon                );
			Ti                              .addOreByProducts(Fe2O3                     , OREMATS.Coltan            , Zircon                );
			...
			Mn                              .addOreByProducts(MnO2                      , Fe2O3                     , OREMATS.Coltan        , OREMATS.Chromite      );
			MnO2                            .addOreByProducts(OREMATS.Bromargyrite      , Fe2O3                     , OREMATS.Coltan        , OREMATS.Chromite      );
			...
			OREMATS.Kyanite                 .addOreByProducts(STONES.Quartzite          , OREMATS.Lepidolite        , OREMATS.Spodumene      , OREMATS.Coltan);
...
//          Al                      .addAlloyingRecipe(new OreDictConfigurationComponent( 1, OM.stack(OREMATS.Bauxite               , 2*U), OM.stack(K                  , 1*U)));
	...
	public static class OREMATS {
		...
		Tantalite               = oredustelec( 9148, "Tantalite"                 , SET_METALLIC  , 145,  80,  40, 255, MORTAR, BLACKLISTED_SMELTER                                                    ).setSmelting(Ta   ,   U9).setMcfg( 0, Mn             , 1*U, Ta               , 2*U, O                , 6*U)                                                                        , // (Fe, Mn)Ta2O6
		Columbite               = oredustelec( 9246, "Columbite"                 , SET_METALLIC  ,  65,  77,  14, 255, MORTAR, BLACKLISTED_SMELTER                                                    ).setSmelting(Nb   ,   U9).setMcfg( 0, Mn             , 1*U, Nb               , 2*U, O                , 6*U)                                                                        , // (Fe, Mn)Nb2O6
