...
public class MT {
	...
	Al      = posttrans   ( 130, "Aluminium"      , "Al"    ,  13,  13,   933,  2792,  2.698     , SET_COPPER  , 128, 200, 240     , UUM, FUSION, ICOSAGEN       , G_INGOT_MACHINE_ORES, RAILS, MOLTEN, "Aluminum", "NaturalAluminum"                              ).aspects(TC.METALLUM, 2, TC.VOLATUS, 1                  ).qual(2, 10.0, 128, 2),
	...
	Ta      = refractmetal( 730, "Tantalum"       , "Ta"    ,  73, 107,  3290,  5731, 16.654     , SET_COPPER  , 120, 120, 140, 255, UUM        , VANADIUM_GROUP                                                                                                   ).aspects(TC.METALLUM, 2, TC.VINCULUM, 1                 ),
...
//  HexoriumRainbow         = hexorium      ( 9242, 224, 224, 224, DYE_INDEX_White    ),
	...
	DamascusSteel           = alloymachine  ( 8634, "Damascus Steel"        , SET_COPPER            , 110, 110, 110     , MOLTEN, CENTRIFUGE, MAGNETIC_PASSIVE).qual(3,  8.0, 1280, 2)                                                                              .uumMcfg(50, Steel          ,50*U, V                , 1*U, W                , 1*U)                                                                          .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.INSTRUMENTUM, 1, TC.TELUM, 1),
	...
	RedAlloy                = alloy         ( 8660, "Red Alloy"             , SET_COPPER            , 200,   0,   0     , MORTAR, WIRES, MOLTEN, FURNACE, EXTRUDER_SIMPLE)                                                                                          .uumAloy( 1, Cu             , 1*U, Redstone         , 4*U)                                                                                                  .aspects(TC.MACHINA, 3).heat(1400, Cu.mBoilingPoint),
	BlueAlloy               = alloy         ( 8659, "Blue Alloy"            , SET_COPPER            , 100, 180, 255     , MORTAR, WIRES, MOLTEN, FURNACE, EXTRUDER_SIMPLE)                                                                                          .uumAloy( 1, Ag             , 1*U, Nikolite         , 4*U)                                                                                                  .aspects(TC.ELECTRUM, 3).heat(1400, Ag.mBoilingPoint),
	PurpleAlloy             = alloy         ( 8657, "Purple Alloy"          , SET_COPPER            , 255, 120, 255     , MORTAR, WIRES, MOLTEN, FURNACE, EXTRUDER_SIMPLE)                                                                                          .uumAloy( 1, RedAlloy       , 1*U, BlueAlloy        , 1*U)                                                                                                  .aspects(TC.MACHINA, 3, TC.ELECTRUM, 3).heat(1400, Ag.mBoilingPoint),
	...
	Constantan              = alloymachine  ( 8662, "Constantan"            , SET_COPPER            , 227, 150, 128     , MORTAR, MAGNETIC_PASSIVE, MOLTEN, "Cupronickel").qual(3,  6.0,  64,  1)                                                                   .uumAloy( 0, Cu             , 1*U, Ni               , 1*U)                                                                                                  , Cupronickel = Constantan,
