...
public enum FL {
	...
	, Oil_Sunflower				("sunfloweroil"												, SIMPLE, LIQUID, FOOD, COOKING_OIL)
	, Oil_Olive					("binnie.juiceolive"		, "oliveoil"					, SIMPLE, LIQUID, FOOD, COOKING_OIL)
	, Oil_Nut					("nutoil"													, SIMPLE, LIQUID, FOOD, COOKING_OIL)
	, Oil_Lin					("linoil"					, "linseedoil"					, SIMPLE, LIQUID, FOOD, COOKING_OIL)
	, Oil_Hemp					("hempoil"					, "hempseedoil"					, SIMPLE, LIQUID, FOOD, COOKING_OIL)
	, Oil_Seed					("seedoil"													, SIMPLE, LIQUID, FOOD, COOKING_OIL)
	, Oil_Fish					("fishoil"													, SIMPLE, LIQUID, FOOD, COOKING_OIL)
	, Oil_Frying				("hotfryingoil"												, SIMPLE, LIQUID, FOOD, COOKING_OIL)
	, Oil_Canola				("canolaoil"												, SIMPLE, LIQUID)
	, Oil_Plant					("plantoil"													, SIMPLE, LIQUID)
	, Oil_Creosote				("creosote"													, SIMPLE, LIQUID)
