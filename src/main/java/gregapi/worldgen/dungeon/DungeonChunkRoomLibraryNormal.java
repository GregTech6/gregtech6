...
public class DungeonChunkRoomLibraryNormal extends DungeonChunkRoomLibrary {
	...
	public boolean generate(DungeonData aData) {
		...
		if (aData.mRoomLayout[aData.mRoomX+1][aData.mRoomZ] == 0) {
			aData.set  (14, 1,  5, ((BlockMetaType)BlocksGT.Planks2).mSlabs[0], 0);
			aData.shelf(14, 1,  6,  7839, SIDE_X_NEG, ChestGenHooks.STRONGHOLD_LIBRARY);
			aData.set  (14, 1,  7, ((BlockMetaType)BlocksGT.Planks2).mSlabs[0], 0);
			aData.set  (14, 1,  8, ((BlockMetaType)BlocksGT.Planks2).mSlabs[0], 0);
			aData.shelf(14, 1,  9,  7839, SIDE_X_NEG, ChestGenHooks.STRONGHOLD_LIBRARY);
			aData.set  (14, 1, 10, ((BlockMetaType)BlocksGT.Planks2).mSlabs[0], 0);
		...
		if (aData.mRoomLayout[aData.mRoomX-1][aData.mRoomZ] == 0) {
			aData.set  ( 1, 1,  5, ((BlockMetaType)BlocksGT.Planks2).mSlabs[0], 0);
			aData.shelf( 1, 1,  6,  7839, SIDE_X_POS, ChestGenHooks.STRONGHOLD_LIBRARY);
			aData.set  ( 1, 1,  7, ((BlockMetaType)BlocksGT.Planks2).mSlabs[0], 0);
			aData.set  ( 1, 1,  8, ((BlockMetaType)BlocksGT.Planks2).mSlabs[0], 0);
			aData.shelf( 1, 1,  9,  7839, SIDE_X_POS, ChestGenHooks.STRONGHOLD_LIBRARY);
			aData.set  ( 1, 1, 10, ((BlockMetaType)BlocksGT.Planks2).mSlabs[0], 0);
		...
		if (aData.mRoomLayout[aData.mRoomX][aData.mRoomZ+1] == 0) {
			aData.set  ( 5, 1, 14, ((BlockMetaType)BlocksGT.Planks2).mSlabs[0], 0);
			aData.shelf( 6, 1, 14,  7839, SIDE_Z_NEG, ChestGenHooks.STRONGHOLD_LIBRARY);
			aData.set  ( 7, 1, 14, ((BlockMetaType)BlocksGT.Planks2).mSlabs[0], 0);
			aData.set  ( 8, 1, 14, ((BlockMetaType)BlocksGT.Planks2).mSlabs[0], 0);
			aData.shelf( 9, 1, 14,  7839, SIDE_Z_NEG, ChestGenHooks.STRONGHOLD_LIBRARY);
			aData.set  (10, 1, 14, ((BlockMetaType)BlocksGT.Planks2).mSlabs[0], 0);
		...
		if (aData.mRoomLayout[aData.mRoomX][aData.mRoomZ-1] == 0) {
			aData.set  ( 5, 1,  1, ((BlockMetaType)BlocksGT.Planks2).mSlabs[0], 0);
			aData.shelf( 6, 1,  1,  7839, SIDE_Z_POS, ChestGenHooks.STRONGHOLD_LIBRARY);
			aData.set  ( 7, 1,  1, ((BlockMetaType)BlocksGT.Planks2).mSlabs[0], 0);
			aData.set  ( 8, 1,  1, ((BlockMetaType)BlocksGT.Planks2).mSlabs[0], 0);
			aData.shelf( 9, 1,  1,  7839, SIDE_Z_POS, ChestGenHooks.STRONGHOLD_LIBRARY);
			aData.set  (10, 1,  1, ((BlockMetaType)BlocksGT.Planks2).mSlabs[0], 0);
