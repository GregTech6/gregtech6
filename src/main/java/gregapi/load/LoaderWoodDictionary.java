...
public class LoaderWoodDictionary implements Runnable {
	...
	public void run() {
		...
		if (MD.NeLi.mLoaded) {
			new SaplingEntry(ST.make(MD.NeLi, "Fungus", 1, 0), new WoodEntry(ST.make(MD.NeLi, "Stem" , 1, 0), new BeamEntry(ST.make(MD.NeLi, "Stem" , 1, 1), new PlankEntry(ST.make(MD.NeLi, "Planks", 1, 0), ST.make(MD.NeLi, "PlankSingleSlab", 1, 0), ST.make(MD.NeLi, "CrimsonStairs", 1, W), MT.WOODS.Crimson, 235), 1, 150), 1, 150, ST.make(MD.NeLi, "Fungus", 1, 0), MT.WOODS.Crimson), ST.make(MD.NeLi, "FullWood", 1, 0));
			new SaplingEntry(ST.make(MD.NeLi, "Fungus", 1, 1), new WoodEntry(ST.make(MD.NeLi, "Stem" , 1, 2), new BeamEntry(ST.make(MD.NeLi, "Stem" , 1, 3), new PlankEntry(ST.make(MD.NeLi, "Planks", 1, 1), ST.make(MD.NeLi, "PlankSingleSlab", 1, 1), ST.make(MD.NeLi, "WarpedStairs" , 1, W), MT.WOODS.Warped , 236), 1, 200), 1, 200, ST.make(MD.NeLi, "Fungus", 1, 1), MT.WOODS.Warped ), ST.make(MD.NeLi, "FullWood", 1, 2));
			new SaplingEntry(ST.make(MD.NeLi, "Fungus", 1, 2), new WoodEntry(ST.make(MD.NeLi, "Stem2", 1, 0), new BeamEntry(ST.make(MD.NeLi, "Stem2", 1, 1), new PlankEntry(ST.make(MD.NeLi, "Planks", 1, 2), ST.make(MD.NeLi, "PlankSingleSlab", 1, 2), ST.make(MD.NeLi, "FoxfireStairs", 1, W), MT.WOODS.Foxfire, 237), 1, 250), 1, 250, ST.make(MD.NeLi, "Fungus", 1, 2), MT.WOODS.Foxfire), ST.make(MD.NeLi, "FullWood", 1, 4));
			new WoodEntry(ST.make(MD.NeLi, "FullWood", 1, 0), new BeamEntry(ST.make(MD.NeLi, "FullWood", 1, 1), WoodDictionary.PLANKS.get(MD.NeLi, "Planks", 0), 1, 150), 1, 150, ST.make(MD.NeLi, "Fungus", 1, 0), MT.WOODS.Crimson);
			new WoodEntry(ST.make(MD.NeLi, "FullWood", 1, 2), new BeamEntry(ST.make(MD.NeLi, "FullWood", 1, 3), WoodDictionary.PLANKS.get(MD.NeLi, "Planks", 1), 1, 200), 1, 200, ST.make(MD.NeLi, "Fungus", 1, 1), MT.WOODS.Warped );
			new WoodEntry(ST.make(MD.NeLi, "FullWood", 1, 4), new BeamEntry(ST.make(MD.NeLi, "FullWood", 1, 5), WoodDictionary.PLANKS.get(MD.NeLi, "Planks", 2), 1, 250), 1, 250, ST.make(MD.NeLi, "Fungus", 1, 2), MT.WOODS.Foxfire);
		}
