...
public class LoaderOreDictReRegistrations implements Runnable {
	...
	public void run() {
		...
		OreDictManager.INSTANCE.addReRegistration("aetherRecord"					, "record");
		...
		OreDictManager.INSTANCE.addReRegistration("gemFlawlessRedstone"				, "itemRedstone");
		OreDictManager.INSTANCE.addReRegistration("gemRedstone"						, "itemRedstone");
		OreDictManager.INSTANCE.addReRegistration("dustRedstone"					, "itemRedstone");
		OreDictManager.INSTANCE.addReRegistration("plateRedstone"					, "itemRedstone");
		OreDictManager.INSTANCE.addReRegistration("plateGemRedstone"				, "itemRedstone");
		...
		OreDictManager.INSTANCE.addReRegistration("itemLeatherTreated"				, "craftingLeather");
		...
		OreDictManager.INSTANCE.addReRegistration("plateGemAnySilicon"				, "itemSilicon");
		OreDictManager.INSTANCE.addReRegistration("plateAnySilicon"					, "itemSilicon");
		...
		OreDictManager.INSTANCE.addReRegistration("bottleFishOil"					, "foodFishoil");
		OreDictManager.INSTANCE.addReRegistration("bottleSeedOil"					, "foodSeedoil");
		OreDictManager.INSTANCE.addReRegistration("bottleHempOil"					, "foodHempoil");
		OreDictManager.INSTANCE.addReRegistration("bottleLinOil"					, "foodLinoil");
		...
		OreDictManager.INSTANCE.addReRegistration("bucketHoney"						, "container1000honey");
		...
		OreDictManager.INSTANCE.addReRegistration("cellHoney"						, "container1000honey");
		...
		OreDictManager.INSTANCE.addReRegistration("cropBlackthorn"					, "listAllfruit");
		...
		OreDictManager.INSTANCE.addReRegistration("cropCurrants"					, "listAllfruit");
		...
		OreDictManager.INSTANCE.addReRegistration("cropElderberry"					, "listAllfruit");
		OreDictManager.INSTANCE.addReRegistration("cropAllspice"					, "listAllfruit");
		OreDictManager.INSTANCE.addReRegistration("cropBerry"						, "listAllfruit");
		...
		OreDictManager.INSTANCE.setAutomaticItemData("chipsetDiamond"	, new OreDictItemData(MT.Redstone, U, MT.Diamond, U));
		...
		OreDictManager.INSTANCE.setAutomaticItemData("craftingChest", new OreDictItemData(ANY.Wood, U * 8));
		OreDictManager.INSTANCE.setAutomaticItemData("craftingPiston", new OreDictItemData(MT.Stone, U * 4, ANY.Wood, U * 3));
		OreDictManager.INSTANCE.setAutomaticItemData("craftingFurnace", new OreDictItemData(MT.Stone, U * 8));
		OreDictManager.INSTANCE.setAutomaticItemData("craftingAnvil", new OreDictItemData(MT.Fe, U * 10));
		OreDictManager.INSTANCE.setAutomaticItemData("craftingRedstoneTorch", new OreDictItemData(MT.Redstone, U, ANY.Wood, U2));
		OreDictManager.INSTANCE.setAutomaticItemData("craftingHardenedClay", new OreDictItemData(MT.Ceramic, U*1));
		OreDictManager.INSTANCE.setAutomaticItemData("itemRedstone", new OreDictItemData(MT.Redstone, U));
