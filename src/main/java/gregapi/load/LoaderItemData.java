...
//      OM.data(MD.RoC, "rotarycraft_item_machine"  , 1,  74/* Cooling Fin                  */  ); // yep no value, too different Recipes, which have nothing in common
		...
		OM.data(MD.HEX, "blockHexoriumMonolithRed"               , 1,   0, MT.HexoriumRed        ,  U *16);
		OM.data(MD.HEX, "blockHexoriumMonolithGreen"             , 1,   0, MT.HexoriumGreen      ,  U *16);
		OM.data(MD.HEX, "blockHexoriumMonolithBlue"              , 1,   0, MT.HexoriumBlue       ,  U *16);
		OM.data(MD.HEX, "blockHexoriumMonolithBlack"             , 1,   0, MT.HexoriumBlack      ,  U *12);
		OM.data(MD.HEX, "blockHexoriumMonolithWhite"             , 1,   0, MT.HexoriumWhite      ,  U *12);
		OM.data(MD.HEX, "blockHexoriumNetherMonolithRed"         , 1,   0, MT.HexoriumRed        ,  U *12);
		OM.data(MD.HEX, "blockHexoriumNetherMonolithGreen"       , 1,   0, MT.HexoriumGreen      ,  U *12);
		OM.data(MD.HEX, "blockHexoriumNetherMonolithBlue"        , 1,   0, MT.HexoriumBlue       ,  U *12);
		OM.data(MD.HEX, "blockHexoriumNetherMonolithBlack"       , 1,   0, MT.HexoriumBlack      ,  U *16);
		OM.data(MD.HEX, "blockHexoriumNetherMonolithWhite"       , 1,   0, MT.HexoriumWhite      ,  U *16);
		OM.data(MD.HEX, "blockEnergizedHexoriumMonolithRed"      , 1,   0, MT.HexoriumRed        ,  U * 8);
		OM.data(MD.HEX, "blockEnergizedHexoriumMonolithGreen"    , 1,   0, MT.HexoriumGreen      ,  U * 8);
		OM.data(MD.HEX, "blockEnergizedHexoriumMonolithBlue"     , 1,   0, MT.HexoriumBlue       ,  U * 8);
		OM.data(MD.HEX, "blockEnergizedHexoriumMonolithBlack"    , 1,   0, MT.HexoriumBlack      ,  U * 8);
		OM.data(MD.HEX, "blockEnergizedHexoriumMonolithWhite"    , 1,   0, MT.HexoriumWhite      ,  U * 8);
		OM.data(MD.HEX, "blockEnergizedHexoriumMonolithDarkGray" , 1,   0, MT.HexoriumBlack      ,  U * 6, MT.HexoriumWhite      ,  U * 2);
		OM.data(MD.HEX, "blockEnergizedHexoriumMonolithGray"     , 1,   0, MT.HexoriumBlack      ,  U * 4, MT.HexoriumWhite      ,  U * 4);
		OM.data(MD.HEX, "blockEnergizedHexoriumMonolithLightGray", 1,   0, MT.HexoriumBlack      ,  U * 2, MT.HexoriumWhite      ,  U * 6);
		OM.data(MD.HEX, "blockEnergizedHexoriumMonolithOrange"   , 1,   0, MT.HexoriumRed        ,  U * 6, MT.HexoriumGreen      ,  U * 2);
		OM.data(MD.HEX, "blockEnergizedHexoriumMonolithYellow"   , 1,   0, MT.HexoriumRed        ,  U * 4, MT.HexoriumGreen      ,  U * 4);
		OM.data(MD.HEX, "blockEnergizedHexoriumMonolithLime"     , 1,   0, MT.HexoriumRed        ,  U * 2, MT.HexoriumGreen      ,  U * 6);
		OM.data(MD.HEX, "blockEnergizedHexoriumMonolithTurquoise", 1,   0, MT.HexoriumGreen      ,  U * 6, MT.HexoriumBlue       ,  U * 2);
		OM.data(MD.HEX, "blockEnergizedHexoriumMonolithCyan"     , 1,   0, MT.HexoriumGreen      ,  U * 4, MT.HexoriumBlue       ,  U * 4);
		OM.data(MD.HEX, "blockEnergizedHexoriumMonolithSkyBlue"  , 1,   0, MT.HexoriumGreen      ,  U * 2, MT.HexoriumBlue       ,  U * 6);
		OM.data(MD.HEX, "blockEnergizedHexoriumMonolithPurple"   , 1,   0, MT.HexoriumBlue       ,  U * 6, MT.HexoriumRed        ,  U * 2);
		OM.data(MD.HEX, "blockEnergizedHexoriumMonolithMagenta"  , 1,   0, MT.HexoriumBlue       ,  U * 4, MT.HexoriumRed        ,  U * 4);
		OM.data(MD.HEX, "blockEnergizedHexoriumMonolithPink"     , 1,   0, MT.HexoriumBlue       ,  U * 2, MT.HexoriumRed        ,  U * 6);
		OM.data(MD.HEX, "blockEnergizedHexoriumMonolithRainbow"  , 1,   0, MT.HexoriumWhite      ,  U * 2, MT.HexoriumRed        ,  U * 2, MT.HexoriumGreen      ,  U * 2, MT.HexoriumBlue       ,  U * 2);
		OM.data(MD.HEX, "blockEnergizedHexoriumRed"              , 1,   0, MT.HexoriumRed        ,  U * 8);
		OM.data(MD.HEX, "blockEnergizedHexoriumGreen"            , 1,   0, MT.HexoriumGreen      ,  U * 8);
		OM.data(MD.HEX, "blockEnergizedHexoriumBlue"             , 1,   0, MT.HexoriumBlue       ,  U * 8);
		OM.data(MD.HEX, "blockEnergizedHexoriumBlack"            , 1,   0, MT.HexoriumBlack      ,  U * 8);
		OM.data(MD.HEX, "blockEnergizedHexoriumWhite"            , 1,   0, MT.HexoriumWhite      ,  U * 8);
		OM.data(MD.HEX, "blockEnergizedHexoriumDarkGray"         , 1,   0, MT.HexoriumBlack      ,  U * 6, MT.HexoriumWhite      ,  U * 2);
		OM.data(MD.HEX, "blockEnergizedHexoriumGray"             , 1,   0, MT.HexoriumBlack      ,  U * 4, MT.HexoriumWhite      ,  U * 4);
		OM.data(MD.HEX, "blockEnergizedHexoriumLightGray"        , 1,   0, MT.HexoriumBlack      ,  U * 2, MT.HexoriumWhite      ,  U * 6);
		OM.data(MD.HEX, "blockEnergizedHexoriumOrange"           , 1,   0, MT.HexoriumRed        ,  U * 6, MT.HexoriumGreen      ,  U * 2);
		OM.data(MD.HEX, "blockEnergizedHexoriumYellow"           , 1,   0, MT.HexoriumRed        ,  U * 4, MT.HexoriumGreen      ,  U * 4);
		OM.data(MD.HEX, "blockEnergizedHexoriumLime"             , 1,   0, MT.HexoriumRed        ,  U * 2, MT.HexoriumGreen      ,  U * 6);
		OM.data(MD.HEX, "blockEnergizedHexoriumTurquoise"        , 1,   0, MT.HexoriumGreen      ,  U * 6, MT.HexoriumBlue       ,  U * 2);
		OM.data(MD.HEX, "blockEnergizedHexoriumCyan"             , 1,   0, MT.HexoriumGreen      ,  U * 4, MT.HexoriumBlue       ,  U * 4);
		OM.data(MD.HEX, "blockEnergizedHexoriumSkyBlue"          , 1,   0, MT.HexoriumGreen      ,  U * 2, MT.HexoriumBlue       ,  U * 6);
		OM.data(MD.HEX, "blockEnergizedHexoriumPurple"           , 1,   0, MT.HexoriumBlue       ,  U * 6, MT.HexoriumRed        ,  U * 2);
		OM.data(MD.HEX, "blockEnergizedHexoriumMagenta"          , 1,   0, MT.HexoriumBlue       ,  U * 4, MT.HexoriumRed        ,  U * 4);
		OM.data(MD.HEX, "blockEnergizedHexoriumPink"             , 1,   0, MT.HexoriumBlue       ,  U * 2, MT.HexoriumRed        ,  U * 6);
		OM.data(MD.HEX, "blockEnergizedHexoriumRainbow"          , 1,   0, MT.HexoriumWhite      ,  U * 2, MT.HexoriumRed        ,  U * 2, MT.HexoriumGreen      ,  U * 2, MT.HexoriumBlue       ,  U * 2);
