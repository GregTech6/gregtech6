...
public class Recipe {
	public static class RecipeMap implements Runnable {
		...
		public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration, long   aChance   , ItemStack aInput                                                                                  , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , ZL_FS                             , ZL_FS                             , aDuration, aEUt, 0));}
		public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration, long   aChance   , ItemStack aInput1, ItemStack aInput2                                                              , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , ZL_FS                             , ZL_FS                             , aDuration, aEUt, 0));}
		public Recipe addRecipeX(boolean aOptimize, long aEUt, long aDuration, long   aChance   , ItemStack[] aInputs                                                                               , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, aInputs                             , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , ZL_FS                             , ZL_FS                             , aDuration, aEUt, 0));}
		public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration                   , ItemStack aInput                                                                                  , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , aOutputs                  , NI, ZL_LONG               , ZL_FS                             , ZL_FS                             , aDuration, aEUt, 0));}
		public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration                   , ItemStack aInput1, ItemStack aInput2                                                              , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , aOutputs                  , NI, ZL_LONG               , ZL_FS                             , ZL_FS                             , aDuration, aEUt, 0));}
		...
		public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration, long[] aChances  , ItemStack aInput                                                                                  , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , aOutputs                  , NI, aChances              , ZL_FS                             , ZL_FS                             , aDuration, aEUt, 0));}
		public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration, long[] aChances  , ItemStack aInput1, ItemStack aInput2                                                              , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , aOutputs                  , NI, aChances              , ZL_FS                             , ZL_FS                             , aDuration, aEUt, 0));}
		...
		public Recipe addRecipe0(boolean aOptimize, long aEUt, long aDuration, long   aChance                                               , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, ZL_IS                               , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration, long   aChance   , ItemStack aInput                          , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration, long   aChance   , ItemStack aInput1, ItemStack aInput2      , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipeX(boolean aOptimize, long aEUt, long aDuration, long   aChance   , ItemStack[] aInputs                       , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, aInputs                             , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipe0(boolean aOptimize, long aEUt, long aDuration                                                               , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, ZL_IS                               , aOutputs                  , NI, ZL_LONG               , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration                   , ItemStack aInput                          , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , aOutputs                  , NI, ZL_LONG               , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration                   , ItemStack aInput1, ItemStack aInput2      , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , aOutputs                  , NI, ZL_LONG               , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipeX(boolean aOptimize, long aEUt, long aDuration                   , ItemStack[] aInputs                       , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, aInputs                             , aOutputs                  , NI, ZL_LONG               , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipe0(boolean aOptimize, long aEUt, long aDuration, long[] aChances                                              , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, ZL_IS                               , aOutputs                  , NI, aChances              , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration, long[] aChances  , ItemStack aInput                          , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , aOutputs                  , NI, aChances              , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration, long[] aChances  , ItemStack aInput1, ItemStack aInput2      , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , aOutputs                  , NI, aChances              , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipeX(boolean aOptimize, long aEUt, long aDuration, long[] aChances  , ItemStack[] aInputs                       , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, aInputs                             , aOutputs                  , NI, aChances              , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipe0(boolean aOptimize, long aEUt, long aDuration                                                               , FluidStack   aFluidInput , FluidStack... aFluidOutputs                        ) {return addRecipe(new Recipe(aOptimize, T, T, ZL_IS                               , ZL_IS                     , NI, ZL_LONG               , new FluidStack[] {aFluidInput}    , aFluidOutputs                     , aDuration, aEUt, 0));}
		public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration                   , ItemStack aInput                          , FluidStack   aFluidInput , FluidStack... aFluidOutputs                        ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , ZL_IS                     , NI, ZL_LONG               , new FluidStack[] {aFluidInput}    , aFluidOutputs                     , aDuration, aEUt, 0));}
		public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration                   , ItemStack aInput1, ItemStack aInput2      , FluidStack   aFluidInput , FluidStack... aFluidOutputs                        ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , ZL_IS                     , NI, ZL_LONG               , new FluidStack[] {aFluidInput}    , aFluidOutputs                     , aDuration, aEUt, 0));}
		public Recipe addRecipeX(boolean aOptimize, long aEUt, long aDuration                   , ItemStack[] aInputs                       , FluidStack   aFluidInput , FluidStack... aFluidOutputs                        ) {return addRecipe(new Recipe(aOptimize, T, T, aInputs                             , ZL_IS                     , NI, ZL_LONG               , new FluidStack[] {aFluidInput}    , aFluidOutputs                     , aDuration, aEUt, 0));}
		public Recipe addRecipe0(boolean aOptimize, long aEUt, long aDuration, long   aChance                                               , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, ZL_IS                               , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration, long   aChance   , ItemStack aInput                          , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration, long   aChance   , ItemStack aInput1, ItemStack aInput2      , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipeX(boolean aOptimize, long aEUt, long aDuration, long   aChance   , ItemStack[] aInputs                       , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, aInputs                             , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipe0(boolean aOptimize, long aEUt, long aDuration                                                               , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, ZL_IS                               , aOutputs                  , NI, ZL_LONG               , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration                   , ItemStack aInput                          , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , aOutputs                  , NI, ZL_LONG               , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration                   , ItemStack aInput1, ItemStack aInput2      , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , aOutputs                  , NI, ZL_LONG               , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipeX(boolean aOptimize, long aEUt, long aDuration                   , ItemStack[] aInputs                       , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, aInputs                             , aOutputs                  , NI, ZL_LONG               , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipe0(boolean aOptimize, long aEUt, long aDuration, long[] aChances                                              , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, ZL_IS                               , aOutputs                  , NI, aChances              , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration, long[] aChances  , ItemStack aInput                          , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , aOutputs                  , NI, aChances              , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration, long[] aChances  , ItemStack aInput1, ItemStack aInput2      , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , aOutputs                  , NI, aChances              , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		public Recipe addRecipeX(boolean aOptimize, long aEUt, long aDuration, long[] aChances  , ItemStack[] aInputs                       , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, aInputs                             , aOutputs                  , NI, aChances              , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0));}
		...
		public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration                   , ItemStack aInput                          , FluidStack[] aFluidInputs, FluidStack... aFluidOutputs                        ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , ZL_IS                     , NI, ZL_LONG               , aFluidInputs                      , aFluidOutputs                     , aDuration, aEUt, 0));}
		public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration                   , ItemStack aInput1, ItemStack aInput2      , FluidStack[] aFluidInputs, FluidStack... aFluidOutputs                        ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , ZL_IS                     , NI, ZL_LONG               , aFluidInputs                      , aFluidOutputs                     , aDuration, aEUt, 0));}
		...
		public Recipe addRecipe0(boolean aOptimize, long aEUt, long aDuration, long   aChance                                               , FluidStack[] aFluidInputs, FluidStack[]  aFluidOutputs, ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, ZL_IS                               , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , aFluidInputs                      , aFluidOutputs                     , aDuration, aEUt, 0));}
		public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration, long   aChance   , ItemStack aInput                          , FluidStack[] aFluidInputs, FluidStack[]  aFluidOutputs, ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , aFluidInputs                      , aFluidOutputs                     , aDuration, aEUt, 0));}
		public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration, long   aChance   , ItemStack aInput1, ItemStack aInput2      , FluidStack[] aFluidInputs, FluidStack[]  aFluidOutputs, ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , aFluidInputs                      , aFluidOutputs                     , aDuration, aEUt, 0));}
		public Recipe addRecipeX(boolean aOptimize, long aEUt, long aDuration, long   aChance   , ItemStack[] aInputs                       , FluidStack[] aFluidInputs, FluidStack[]  aFluidOutputs, ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, aInputs                             , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , aFluidInputs                      , aFluidOutputs                     , aDuration, aEUt, 0));}
		...
		public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration                   , ItemStack aInput                          , FluidStack[] aFluidInputs, FluidStack[]  aFluidOutputs, ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , aOutputs                  , NI, ZL_LONG               , aFluidInputs                      , aFluidOutputs                     , aDuration, aEUt, 0));}
		public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration                   , ItemStack aInput1, ItemStack aInput2      , FluidStack[] aFluidInputs, FluidStack[]  aFluidOutputs, ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , aOutputs                  , NI, ZL_LONG               , aFluidInputs                      , aFluidOutputs                     , aDuration, aEUt, 0));}
		...
		public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration, long[] aChances  , ItemStack aInput                          , FluidStack[] aFluidInputs, FluidStack[]  aFluidOutputs, ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , aOutputs                  , NI, aChances              , aFluidInputs                      , aFluidOutputs                     , aDuration, aEUt, 0));}
		public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration, long[] aChances  , ItemStack aInput1, ItemStack aInput2      , FluidStack[] aFluidInputs, FluidStack[]  aFluidOutputs, ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , aOutputs                  , NI, aChances              , aFluidInputs                      , aFluidOutputs                     , aDuration, aEUt, 0));}
		...
		public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long   aChance    , ItemStack aInput                                                                                  , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , ZL_FS                             , ZL_FS                             , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe2(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long   aChance    , ItemStack aInput1, ItemStack aInput2                                                              , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , ZL_FS                             , ZL_FS                             , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipeX(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long   aChance    , ItemStack[] aInputs                                                                               , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, aInputs                             , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , ZL_FS                             , ZL_FS                             , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration                    , ItemStack aInput                                                                                  , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , aOutputs                  , NI, ZL_LONG               , ZL_FS                             , ZL_FS                             , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe2(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration                    , ItemStack aInput1, ItemStack aInput2                                                              , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , aOutputs                  , NI, ZL_LONG               , ZL_FS                             , ZL_FS                             , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		...
		public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long[] aChances   , ItemStack aInput                                                                                  , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , aOutputs                  , NI, aChances              , ZL_FS                             , ZL_FS                             , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe2(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long[] aChances   , ItemStack aInput1, ItemStack aInput2                                                              , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , aOutputs                  , NI, aChances              , ZL_FS                             , ZL_FS                             , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		...
		public Recipe addRecipe0(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long   aChance                                                , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, ZL_IS                               , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long   aChance    , ItemStack aInput                          , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe2(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long   aChance    , ItemStack aInput1, ItemStack aInput2      , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipeX(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long   aChance    , ItemStack[] aInputs                       , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, aInputs                             , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe0(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration                                                                , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, ZL_IS                               , aOutputs                  , NI, ZL_LONG               , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration                    , ItemStack aInput                          , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , aOutputs                  , NI, ZL_LONG               , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe2(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration                    , ItemStack aInput1, ItemStack aInput2      , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , aOutputs                  , NI, ZL_LONG               , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipeX(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration                    , ItemStack[] aInputs                       , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, aInputs                             , aOutputs                  , NI, ZL_LONG               , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe0(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long[] aChances                                               , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, ZL_IS                               , aOutputs                  , NI, aChances              , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long[] aChances   , ItemStack aInput                          , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , aOutputs                  , NI, aChances              , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe2(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long[] aChances   , ItemStack aInput1, ItemStack aInput2      , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , aOutputs                  , NI, aChances              , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipeX(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long[] aChances   , ItemStack[] aInputs                       , FluidStack   aFluidInput , FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, aInputs                             , aOutputs                  , NI, aChances              , new FluidStack[] {aFluidInput}    , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe0(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration                                                                , FluidStack   aFluidInput , FluidStack... aFluidOutputs                        ) {return addRecipe(new Recipe(aOptimize, T, T, ZL_IS                               , ZL_IS                     , NI, ZL_LONG               , new FluidStack[] {aFluidInput}    , aFluidOutputs                     , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration                    , ItemStack aInput                          , FluidStack   aFluidInput , FluidStack... aFluidOutputs                        ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , ZL_IS                     , NI, ZL_LONG               , new FluidStack[] {aFluidInput}    , aFluidOutputs                     , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe2(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration                    , ItemStack aInput1, ItemStack aInput2      , FluidStack   aFluidInput , FluidStack... aFluidOutputs                        ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , ZL_IS                     , NI, ZL_LONG               , new FluidStack[] {aFluidInput}    , aFluidOutputs                     , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipeX(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration                    , ItemStack[] aInputs                       , FluidStack   aFluidInput , FluidStack... aFluidOutputs                        ) {return addRecipe(new Recipe(aOptimize, T, T, aInputs                             , ZL_IS                     , NI, ZL_LONG               , new FluidStack[] {aFluidInput}    , aFluidOutputs                     , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe0(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long   aChance                                                , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, ZL_IS                               , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long   aChance    , ItemStack aInput                          , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe2(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long   aChance    , ItemStack aInput1, ItemStack aInput2      , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipeX(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long   aChance    , ItemStack[] aInputs                       , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, aInputs                             , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe0(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration                                                                , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, ZL_IS                               , aOutputs                  , NI, ZL_LONG               , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration                    , ItemStack aInput                          , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , aOutputs                  , NI, ZL_LONG               , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe2(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration                    , ItemStack aInput1, ItemStack aInput2      , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , aOutputs                  , NI, ZL_LONG               , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipeX(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration                    , ItemStack[] aInputs                       , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, aInputs                             , aOutputs                  , NI, ZL_LONG               , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe0(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long[] aChances                                               , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, ZL_IS                               , aOutputs                  , NI, aChances              , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long[] aChances   , ItemStack aInput                          , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , aOutputs                  , NI, aChances              , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe2(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long[] aChances   , ItemStack aInput1, ItemStack aInput2      , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , aOutputs                  , NI, aChances              , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipeX(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long[] aChances   , ItemStack[] aInputs                       , FluidStack[] aFluidInputs, FluidStack    aFluidOutput , ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, aInputs                             , aOutputs                  , NI, aChances              , aFluidInputs                      , new FluidStack[] {aFluidOutput}   , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		...
		public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration                    , ItemStack aInput                          , FluidStack[] aFluidInputs, FluidStack... aFluidOutputs                        ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , ZL_IS                     , NI, ZL_LONG               , aFluidInputs                      , aFluidOutputs                     , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe2(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration                    , ItemStack aInput1, ItemStack aInput2      , FluidStack[] aFluidInputs, FluidStack... aFluidOutputs                        ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , ZL_IS                     , NI, ZL_LONG               , aFluidInputs                      , aFluidOutputs                     , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		...
		public Recipe addRecipe0(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long   aChance                                                , FluidStack[] aFluidInputs, FluidStack[]  aFluidOutputs, ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, ZL_IS                               , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , aFluidInputs                      , aFluidOutputs                     , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long   aChance    , ItemStack aInput                          , FluidStack[] aFluidInputs, FluidStack[]  aFluidOutputs, ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , aFluidInputs                      , aFluidOutputs                     , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe2(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long   aChance    , ItemStack aInput1, ItemStack aInput2      , FluidStack[] aFluidInputs, FluidStack[]  aFluidOutputs, ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , aFluidInputs                      , aFluidOutputs                     , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipeX(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long   aChance    , ItemStack[] aInputs                       , FluidStack[] aFluidInputs, FluidStack[]  aFluidOutputs, ItemStack    aOutput  ) {return addRecipe(new Recipe(aOptimize, T, T, aInputs                             , new ItemStack[] {aOutput} , NI, new long[] {aChance}  , aFluidInputs                      , aFluidOutputs                     , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		...
		public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration                    , ItemStack aInput                          , FluidStack[] aFluidInputs, FluidStack[]  aFluidOutputs, ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , aOutputs                  , NI, ZL_LONG               , aFluidInputs                      , aFluidOutputs                     , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe2(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration                    , ItemStack aInput1, ItemStack aInput2      , FluidStack[] aFluidInputs, FluidStack[]  aFluidOutputs, ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , aOutputs                  , NI, ZL_LONG               , aFluidInputs                      , aFluidOutputs                     , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		...
		public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long[] aChances   , ItemStack aInput                          , FluidStack[] aFluidInputs, FluidStack[]  aFluidOutputs, ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput}            , aOutputs                  , NI, aChances              , aFluidInputs                      , aFluidOutputs                     , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		public Recipe addRecipe2(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden, boolean aLogErrors, long aEUt, long aDuration, long[] aChances   , ItemStack aInput1, ItemStack aInput2      , FluidStack[] aFluidInputs, FluidStack[]  aFluidOutputs, ItemStack... aOutputs ) {return addRecipe(new Recipe(aOptimize, T, T, new ItemStack[] {aInput1, aInput2}  , aOutputs                  , NI, aChances              , aFluidInputs                      , aFluidOutputs                     , aDuration, aEUt, 0), aCheckForCollisions, aFakeRecipe, aHidden, aLogErrors);}
		...
		public boolean containsInput(ItemStack aStack, IHasWorldAndCoords aTileEntity, ItemStack aSpecialSlot) {
			...
			if (mRecipeItemMap.containsKey(new ItemStackContainer(aStack))) return T;
			if (mRecipeItemMap.containsKey(new ItemStackContainer(aStack, W))) return T;
	...
	public boolean isRecipeInputEqual(boolean aDecreaseStacksizeBySuccess, boolean aDontCheckStackSizes, FluidStack[] aFluidInputs, ItemStack... aInputs) {
		...
		for (ItemStack tStack : mInputs) if (ST.valid(tStack)) {
			boolean temp = T;
			for (ItemStack aStack : aInputs) if (ST.valid(aStack) && OreDictManager.INSTANCE.equal_(F, aStack, tStack) && (aDontCheckStackSizes || aStack.stackSize >= tStack.stackSize)) {temp = F; break;}
			if (temp) return F;
		}
		
		if (aDecreaseStacksizeBySuccess) {
			for (FluidStack tFluid : mFluidInputs   ) if (tFluid != null)           for (FluidStack aFluid : aFluidInputs   ) if (aFluid != null && aFluid.isFluidEqual(tFluid)                                 && (aDontCheckStackSizes || aFluid.amount       >= tFluid.amount    )) {aFluid.amount       -= tFluid.amount; break;}
			for (ItemStack  tStack : mInputs        ) if (ST.valid(tStack)) for (ItemStack  aStack : aInputs        ) if (ST.valid(aStack) && OreDictManager.INSTANCE.equal_(F, aStack, tStack) && (aDontCheckStackSizes || aStack.stackSize    >= tStack.stackSize )) {aStack.stackSize    -= tStack.stackSize; break;}
		}
	...
	public boolean isRecipeInputEqual(boolean aDecreaseStacksizeBySuccess, boolean aDontCheckStackSizes, IFluidTank[] aFluidInputs, ItemStack... aInputs) {
		...
		if (aDecreaseStacksizeBySuccess) {
			for (FluidStack tFluid : mFluidInputs   ) if (tFluid != null)   for (IFluidTank tTank : aFluidInputs) {FluidStack aFluid = tTank.getFluid();    if (aFluid != null && aFluid.isFluidEqual(tFluid)                           && (aDontCheckStackSizes || aFluid.amount       >= tFluid.amount    )) {tTank.drain(tFluid.amount, T); break;}}
			for (ItemStack  tStack : mInputs        ) if (ST.valid(tStack)) for (ItemStack  aStack : aInputs    )                                           if (ST.valid(aStack) && OreDictManager.INSTANCE.equal_(F, aStack, tStack)   && (aDontCheckStackSizes || aStack.stackSize    >= tStack.stackSize )) {aStack.stackSize -= tStack.stackSize; break;}
		}
	...
	public int isRecipeInputEqual(int aMaxProcessCount, IFluidTank[] aFluidInputs, ItemStack... aInputs) {
		...
		while (rProcessCount < aMaxProcessCount) {
			...
			for (ItemStack tStack : mInputs) if (ST.valid(tStack)) {
				boolean temp = T;
				for (ItemStack aStack : aInputs) if (ST.valid(aStack) && OreDictManager.INSTANCE.equal_(F, aStack, tStack) && (aStack.stackSize >= tStack.stackSize)) {temp = F; break;}
				if (temp) return rProcessCount;
			}
