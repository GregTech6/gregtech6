		...
		if (tPaper != null && tUSB != null) {
			if (OM.is_("gt:canvas", tPaper)) {
				if (tData.hasKey(NBT_CANVAS_BLOCK) && (!tPaper.hasTagCompound() || !tPaper.getTagCompound().hasKey(NBT_CANVAS_BLOCK))) {
					rRecipe = new Recipe(F, F, F, new ItemStack[] {ST.amount(1, tPaper), ST.amount(0, tUSB)}, new ItemStack[] {ST.amount(1, tPaper)}, null, null, new FluidStack[] {FL.mul(DYE_FLUIDS_CHEMICAL[DYE_INDEX_Black], 1, 9, T), FL.mul(DYE_FLUIDS_CHEMICAL[DYE_INDEX_Cyan], 1, 9, T), FL.mul(DYE_FLUIDS_CHEMICAL[DYE_INDEX_Magenta], 1, 9, T), FL.mul(DYE_FLUIDS_CHEMICAL[DYE_INDEX_Yellow], 1, 9, T)}, null, 64, 16, 0);
			...
			if (IL.Paper_Blueprint_Empty.equal(tPaper, F, T)) {
				...
				if (tBlueprint != ZL_IS) {
					...
					return new Recipe(F, F, F, new ItemStack[] {ST.amount(1, tPaper), ST.amount(0, tUSB)}, new ItemStack[] {IL.Paper_Blueprint_Used.getWithNameAndNBT(1, tCrafted==null?null:tCrafted.getDisplayName(), UT.NBT.setBlueprintCrafting(UT.NBT.make(), tBlueprint))}, null, null, new FluidStack[] {FL.mul(DYE_FLUIDS_CHEMICAL[DYE_INDEX_White], 1, 9, T)}, null, 32, 16, 0);
				}
				return rRecipe;
			}
			if (IL.Paper_Punch_Card_Empty.equal(tPaper, F, T)) {
				if (UT.Code.stringValid(UT.NBT.getPunchCardData(tData))) {
					rRecipe = new Recipe(F, F, F, new ItemStack[] {ST.amount(1, tPaper), ST.amount(0, tUSB)}, new ItemStack[] {IL.Paper_Punch_Card_Encoded.get(1)}, null, null, new FluidStack[] {FL.mul(DYE_FLUIDS_CHEMICAL[DYE_INDEX_Black], 1, 9, T)}, null, 32, 16, 0);
			...
			if (OM.is_(OD.paperEmpty, tPaper)) {
				if (IL.GC_Schematic_1.exists() && tData.hasKey("gc_schematics_1")) return new Recipe(F, F, F, new ItemStack[] {ST.amount(8, tPaper), ST.amount(0, tUSB)}, new ItemStack[] {IL.GC_Schematic_1.getWithMeta(1, tData.getShort("gc_schematics_1"))}, null, null, new FluidStack[] {FL.mul(DYE_FLUIDS_CHEMICAL[DYE_INDEX_Black], 4, 1, T)}, null, 2048, 16, 0);
				if (IL.GC_Schematic_2.exists() && tData.hasKey("gc_schematics_2")) return new Recipe(F, F, F, new ItemStack[] {ST.amount(8, tPaper), ST.amount(0, tUSB)}, new ItemStack[] {IL.GC_Schematic_2.getWithMeta(1, tData.getShort("gc_schematics_2"))}, null, null, new FluidStack[] {FL.mul(DYE_FLUIDS_CHEMICAL[DYE_INDEX_Black], 4, 1, T)}, null, 2048, 16, 0);
				if (IL.GC_Schematic_3.exists() && tData.hasKey("gc_schematics_3")) return new Recipe(F, F, F, new ItemStack[] {ST.amount(8, tPaper), ST.amount(0, tUSB)}, new ItemStack[] {IL.GC_Schematic_3.getWithMeta(1, tData.getShort("gc_schematics_3"))}, null, null, new FluidStack[] {FL.mul(DYE_FLUIDS_CHEMICAL[DYE_INDEX_Black], 4, 1, T)}, null, 2048, 16, 0);
				if (IL.IE_Blueprint_Projectiles_Common.exists() && tData.hasKey("ie_blueprint")) return new Recipe(F, F, F, new ItemStack[] {ST.amount(3, tPaper), ST.amount(0, tUSB)}, new ItemStack[] {IL.IE_Blueprint_Projectiles_Common.getWithMeta(1, tData.getShort("ie_blueprint"))}, null, null, new FluidStack[] {FL.mul(DYE_FLUIDS_CHEMICAL[DYE_INDEX_Blue], 3, 1, T)}, null, 2048, 16, 0);
				ItemStack[] tBlueprint = UT.NBT.getBlueprintCrafting(tData);
				if (tBlueprint != ZL_IS) {
				...
				if (UT.Code.stringValid(UT.NBT.getBookTitle(tData)) && UT.Code.stringValid(UT.NBT.getBookAuthor(tData))) {
					...
					rRecipe = new Recipe(F, F, F, new ItemStack[] {ST.amount(tUseManyPages?6:3, tPaper), ST.amount(0, tUSB)}, new ItemStack[] {tUseManyPages?IL.Paper_Printed_Pages_Many.get(1):IL.Paper_Printed_Pages.get(1)}, null, null, new FluidStack[] {FL.mul(DYE_FLUIDS_CHEMICAL[DYE_INDEX_Black], 1, tUseManyPages?1:2, T)}, null, tUseManyPages?1024:512, 16, 0);
			...
			if (tPaper.getItem() == Items.map) {
				...
				if (tMapID >= 0) {
					return new Recipe(F, F, F, new ItemStack[] {ST.amount(1, tPaper), ST.amount(0, tUSB)}, new ItemStack[] {ST.make(Items.filled_map, 1, tMapID)}, null, null, new FluidStack[] {FL.mul(DYE_FLUIDS_CHEMICAL[DYE_INDEX_Black], 1, 9, T), FL.mul(DYE_FLUIDS_CHEMICAL[DYE_INDEX_Cyan], 1, 9, T), FL.mul(DYE_FLUIDS_CHEMICAL[DYE_INDEX_Magenta], 1, 9, T), FL.mul(DYE_FLUIDS_CHEMICAL[DYE_INDEX_Yellow], 1, 9, T)}, null, 64, 16, 0);
				}
				return rRecipe;
			}
			return rRecipe;
