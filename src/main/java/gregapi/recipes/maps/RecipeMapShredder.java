...
public class RecipeMapShredder extends RecipeMapSpecialSingleInput {
	...
	protected Recipe getRecipeFor(ItemStack aInput) {
		...
		if (aData == null || aData.mPrefix != null || (aData.mMaterial != null && aData.mMaterial.mMaterial.contains(TD.Atomic.ANTIMATTER)) || UT.Fluids.getFluidForFilledItem(aInput, T) != null) return null;
