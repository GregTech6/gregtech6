...
public class RecipeMapShredder extends RecipeMapSpecialSingleInput {
	...
	protected Recipe getRecipeFor(ItemStack aInput) {
		...
		if (aData == null || (aData.mPrefix != null && aData.mPrefix.containsAny(TD.Prefix.DUST_BASED, TD.Prefix.ORE, TD.Prefix.ORE_PROCESSING_BASED)) || (aData.mMaterial != null && aData.mMaterial.mMaterial.contains(TD.Atomic.ANTIMATTER)) || UT.Fluids.getFluidForFilledItem(aInput, T) != null) return null;
