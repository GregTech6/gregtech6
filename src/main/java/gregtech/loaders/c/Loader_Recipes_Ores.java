...
public class Loader_Recipes_Ores implements Runnable {
	@Override public void run() {
		...
		RM.Centrifuge   .addRecipe1(T, 256, 256, new long[] {10000,  300      }, crushedPurifiedTiny   .mat(MT.B        , 1), crushedCentrifugedTiny.mat(MT.B        , 1), crushedCentrifugedTiny.mat(MT.B_11, 8));
		RM.Centrifuge   .addRecipe1(T, 256,2304, new long[] {10000, 2700      }, crushedPurified       .mat(MT.B        , 1), crushedCentrifuged    .mat(MT.B        , 1), crushedCentrifugedTiny.mat(MT.B_11, 8));
