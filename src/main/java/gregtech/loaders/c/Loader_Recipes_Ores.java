...
public class Loader_Recipes_Ores implements Runnable {
	@Override public void run() {
		...
		RM.MagneticSeparator.addRecipe1(T, 16, 1296, new long[] { 9640,5832,5832,5832,5832,5832}, blockDust .mat(MT.SluiceSand, 1)      , dust     .mat(MT.Stone, 9), dustTiny.mat(MT.Fe2O3, 5), dustTiny.mat(MT.Nd, 1), dustTiny.mat(MT.Ni, 1), dustTiny.mat(MT.Co, 1), dustTiny.mat(MT.Mn, 1));
		...
		RM.Centrifuge       .addRecipe0(T, 64,  128, new long[] {8000,  250,  250,  250,  250,  250}, FL.Lava           .make(100), NF, dustTiny.mat(MT.STONES.Basalt, 1), nugget.mat(MT.Cu, 8), nugget.mat(MT.Sn, 4), nugget.mat(MT.Pb, 2), nugget.mat(MT.Au, 1), nugget.mat(MT.Ag, 1));
		RM.Centrifuge       .addRecipe0(T, 64,  192, new long[] {9000,  300,  300,  300,  300,  300}, FL.Lava_Pahoehoe  .make(100), NF, dustTiny.mat(MT.STONES.Basalt, 1), nugget.mat(MT.Cu, 8), nugget.mat(MT.Sn, 4), nugget.mat(MT.Pb, 2), nugget.mat(MT.Au, 1), nugget.mat(MT.Ag, 1));
		RM.Centrifuge       .addRecipe1(T, 64,   16, new long[] {9000,10000, 1000                  }, ST.make(Blocks.sand, 1, 1), ST.make(Blocks.sand, 1, 0), dustTiny.mat(MT.Fe2O3, 3), dustDiv72.mat(MT.Diamond, 1));
		if (IL.NePl_SoulSoil.exists())
		RM.Centrifuge       .addRecipe1(T, 64,  128, new long[] {9000, 8000, 2000, 2000            }, IL.NePl_SoulSoil       .wild(1), NF, FL.Oil_Soulsand.make(50), ST.make(Blocks.sand, 1, 0), dustSmall.mat(MT.Niter, 1), dustTiny.mat(MT.Coal, 1), dustTiny.mat(MT.Bone, 1));
		if (IL.NeLi_SoulSoil.exists())
		RM.Centrifuge       .addRecipe1(T, 64,  128, new long[] {9000, 8000, 2000, 2000            }, IL.NeLi_SoulSoil       .wild(1), NF, FL.Oil_Soulsand.make(50), ST.make(Blocks.sand, 1, 0), dustSmall.mat(MT.Niter, 1), dustTiny.mat(MT.Coal, 1), dustTiny.mat(MT.Bone, 1));
		...
		RM.Centrifuge       .addRecipe1(T, 64,  128, new long[] {9000,  625,  625                  }, OM.dust(MT.STONES.SpaceRock   ), ZL_FS, FL.array(MT.He.gas(U8, F), MT.He_3.gas(U20, F), MT.NO2.gas(U4, F), MT.CO2.gas(U4, F), MT.H.gas(U8, F), MT.D.gas(U8, F)), ST.make(Blocks.sand, 1, 0), dustTiny.mat(MT.Pt, 1), dustTiny.mat(MT.MeteoricIron, 1));
		RM.Centrifuge       .addRecipe1(T, 64,  256, new long[] {9000, 9000, 9000, 9000, 9000, 1000}, OM.dust(MT.STONES.MoonTurf    ), ZL_FS, FL.array(MT.He.gas(U8, F), MT.He_3.gas(U20, F), MT.NO2.gas(U4, F), MT.CO2.gas(U4, F), MT.H.gas(U8, F), MT.D.gas(U8, F)), dustTiny.mat(MT.SiO2, 2), dustTiny.mat(MT.STONES.Basalt, 2), dustTiny.mat(MT.Al2O3, 1), dustTiny.mat(MT.OREMATS.Ilmenite, 1), dustTiny.mat(MT.MnO2, 1), dustTiny.mat(MT.MeteoricIron, 1));
		RM.Centrifuge       .addRecipe1(T, 64,  128, new long[] {9000, 5000, 4000, 3000, 1000,  500}, OM.dust(MT.STONES.MoonRock    ), NF, NF, dustSmall.mat(MT.STONES.Basalt, 3), dustTiny.mat(MT.SiO2, 1), dustTiny.mat(MT.Al2O3, 1), dustTiny.mat(OREMATS.Ilmenite, 1), dustTiny.mat(MT.RareEarth, 1), dustTiny.mat(MT.Pt, 1));
		...
		if (IL.BoP_Coarse_Silty     .exists())  RM.Sifting.addRecipe1(T, 16, 100, new long[] {  500,  6000,   250,   100                                                        }, IL.BoP_Coarse_Silty          .get( 1)/*|*/, ST.make(Blocks.sand, 1, 0), OM.dust(MT.STONES.Siltstone , U4), OM.dust(MT.Kaolinite   ), IL.Clay_Ball_White .get(1));
		...
		if (IL.NeLi_Gravel          .exists())  RM.Sifting.addRecipe1(T, 16, 200, new long[] { 1000,  5000,  2500,   500,   200,  5000,   500,   100                            }, IL.NeLi_Gravel               .wild(1)/*|*/, ST.make(Blocks.sand, 1, 1), OM.dust(MT.STONES.Blackstone, U4), rockGt.mat(MT.STONES.Blackstone, 1), OM.dust(MT.ClayRed), IL.Clay_Ball_Red       .get(1), ST.make(Items.flint, 1, 0), OM.dust(MT.NetherQuartz, U4), OM.gem(MT.NetherQuartz, U));
		...
		if (IL.NePl_SoulSoil        .exists())  RM.Sifting.addRecipe1(T, 16, 300, new long[] { 9000,  4000,   500,   500,   200,  2000,  4000,   400,   200                     }, IL.NePl_SoulSoil             .wild(1)/*|*/, OM.dust(MT.Netherrack, U4), rockGt.mat(MT.Netherrack, 1), OM.dust(MT.ClayRed), IL.Clay_Ball_Red.get(1), OM.dust(MT.Niter, U4), OM.dust(MT.NetherQuartz, U4), OM.gem(MT.NetherQuartz, U), ST.make(Items.bone, 1, 0), ST.make(Items.nether_wart, 1, 0));
		if (IL.NeLi_SoulSoil        .exists())  RM.Sifting.addRecipe1(T, 16, 300, new long[] { 9000,  4000,   500,   500,   200,  2000,  4000,   400,   200                     }, IL.NeLi_SoulSoil             .wild(1)/*|*/, OM.dust(MT.Netherrack, U4), rockGt.mat(MT.Netherrack, 1), OM.dust(MT.ClayRed), IL.Clay_Ball_Red.get(1), OM.dust(MT.Niter, U4), OM.dust(MT.NetherQuartz, U4), OM.gem(MT.NetherQuartz, U), ST.make(Items.bone, 1, 0), ST.make(Items.nether_wart, 1, 0));
		...
		RM.Sifting      .addRecipe1(T, 16,  128, new long[] {      8000, 5000}, crushedPurified    .mat(MT.Fluix              , 1), gem.mat(MT.Fluix              , 1), dust.mat(MT.Fluix, 1));
		...
		RM.Sifting          .addRecipe1(T, 16,  200, new long[] {9900, 500, 500}     , ST.make(BlocksGT.Sands, 1, 1), dust.mat(MT.OREMATS.BasalticMineralSand, 1), rockGt.mat(MT.STONES.Gabbro, 1), nugget.mat(MT.Au, 1));
		...
		RM.Sifting          .addRecipe1(T, 16,  200, new long[] {9900, 500, 500}     , ST.make(BlocksGT.Sands, 1, 2), dust.mat(MT.OREMATS.GraniticMineralSand, 1), rockGt.mat(MT.STONES.GraniteBlack, 1), nugget.mat(MT.Au, 1));
