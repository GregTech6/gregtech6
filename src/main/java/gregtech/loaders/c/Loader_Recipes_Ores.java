...
public class Loader_Recipes_Ores implements Runnable {
	@Override public void run() {
		...
		/* Misc                             */  RM.Sifting.addRecipe1(T, 16, 200, new long[] { 8000,  1000,   500,   500,   500                                                 }, ST.make(Blocks.dirt          ,  1, 2)/*|*/, ST.make(Blocks.dirt, 1, 1), OM.dust(MT.Ash, U4), IL.MaCu_Bait_Ant.get(2), IL.MaCu_Bait_Maggot.get(1), IL.MaCu_Bait_Worm.get(1));
												...
												RM.Sifting.addRecipe1(T, 16, 300, new long[] { 9000,  4000,  2000,  4000,   500,   500,   200,   400,   200                     }, OM.dust(MT.SoulSand                 )/*|*/, OM.dust(MT.Netherrack, U4), rockGt.mat(MT.Netherrack, 1), OM.dust(MT.Niter, U4), OM.dust(MT.NetherQuartz, U4), OM.gem(MT.NetherQuartz, U), OM.dust(MT.ClayRed), IL.Clay_Ball_Red.get(1), ST.make(Items.bone, 1, 0), ST.make(Items.nether_wart, 1, 0));
												RM.Sifting.addRecipe1(T, 16, 300, new long[] { 9000,  4000,  2000,  4000,   500,   500,   200,   400,   200                     }, ST.make(Blocks.soul_sand     ,  1, W)/*|*/, OM.dust(MT.Netherrack, U4), rockGt.mat(MT.Netherrack, 1), OM.dust(MT.Niter, U4), OM.dust(MT.NetherQuartz, U4), OM.gem(MT.NetherQuartz, U), OM.dust(MT.ClayRed), IL.Clay_Ball_Red.get(1), ST.make(Items.bone, 1, 0), ST.make(Items.nether_wart, 1, 0));
		if (IL.NePl_SoulSoil        .exists())  RM.Sifting.addRecipe1(T, 16, 300, new long[] { 9000,  4000,  2000,  4000,   500,   500,   200,   400,   200                     }, IL.NePl_SoulSoil              .get(1)/*|*/, OM.dust(MT.Netherrack, U4), rockGt.mat(MT.Netherrack, 1), OM.dust(MT.Niter, U4), OM.dust(MT.NetherQuartz, U4), OM.gem(MT.NetherQuartz, U), OM.dust(MT.ClayRed), IL.Clay_Ball_Red.get(1), ST.make(Items.bone, 1, 0), ST.make(Items.nether_wart, 1, 0));
