...
public class Loader_Recipes_Ores implements Runnable {
	@Override public void run() {
		...
		RM.MagneticSeparator    .addRecipe1(T, 64,  144, new long[] { 7000,3000,3000,3000,3000,3000}, dustImpure.mat(MT.Bedrock, 1)             , dust      .mat(MT.Bedrock, 1), dustTiny.mat(MT.Adamantine, 1), dustTiny.mat(MT.RareEarth, 2), dustTiny.mat(MT.OREMATS.Ilmenite, 2), dustTiny.mat(MT.Nd, 3), dustTiny.mat(MT.V2O5, 3));
		...
		RM.Centrifuge           .addRecipe0(T, 64,  128, new long[] {8000, 2000, 1000, 1000,  250,  250}, FL.Lava           .make(100), NF, dust.mat(MT.Basalt, 1), nugget.mat(MT.Cu, 1), nugget.mat(MT.Sn, 1), nugget.mat(MT.Fe, 1), nugget.mat(MT.Au, 1), nugget.mat(MT.Ag, 1));
		RM.Centrifuge           .addRecipe0(T, 64,  128, new long[] {8000, 2000, 1000, 1000,  250,  250}, FL.Lava_Pahoehoe  .make(100), NF, dust.mat(MT.Basalt, 1), nugget.mat(MT.Cu, 1), nugget.mat(MT.Sn, 1), nugget.mat(MT.Fe, 1), nugget.mat(MT.Au, 1), nugget.mat(MT.Ag, 1));
		...
		RM.Centrifuge           .addRecipe1(T, 64,  128, new long[] {9000, 8000, 2000, 2000            }, ST.make(Blocks.soul_sand, 1, W), NF, FL.Oil_Soulsand.make(50), ST.make(Blocks.sand, 1, 0), dustSmall.mat(MT.KNO3, 1), dustTiny.mat(MT.Coal, 1), dustTiny.mat(MT.Bone, 1));
		...
		RM.Centrifuge           .addRecipe1(T, 64,  256, new long[] {9000, 9000, 9000, 9000, 9000, 1000}, OM.dust(MT.MoonTurf   ), ZL_FS, new FluidStack[] {MT.He.gas(U8, F), MT.He_3.gas(U20, F), MT.NO2.gas(U4, F), MT.CO2.gas(U4, F), MT.H.gas(U8, F), MT.D.gas(U8, F)}, dustTiny.mat(MT.SiO2, 2), dustTiny.mat(MT.Basalt, 2), dustTiny.mat(MT.Al2O3, 1), dustTiny.mat(MT.OREMATS.Ilmenite, 1), dustTiny.mat(MT.MnO2, 1), dustTiny.mat(MT.MeteoricIron, 1));
		// TODO MARS ROCKS AND SAND => Ice
		
		for (OreDictMaterial tMat : new OreDictMaterial[] {MT.Mg, MT.Pyrope, MT.Olivine, MT.OREMATS.Magnesite}) {
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(tMat, 1), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.PinkVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 3));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(tMat, 9), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.PinkVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 3));
		}
		...
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(tMat, 1), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.CyanVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 3));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(tMat, 9), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.CyanVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 3));
		}
		...
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(tMat, 1), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.GrayVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 3));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(tMat, 9), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.GrayVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 3));
		}
		...
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(tMat, 1), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.RedVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 3));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(tMat, 9), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.RedVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 3));
		}
		for (OreDictMaterial tMat : new OreDictMaterial[] {MT.Zn, MT.Sn, MT.Sb, MT.OREMATS.Sphalerite, MT.OREMATS.Smithsonite}) {
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(tMat, 1), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.WhiteVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 3));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(tMat, 9), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.WhiteVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 3));
		}
		for (OreDictMaterial tMat : new OreDictMaterial[] {MT.Al, MT.Almandine, MT.OREMATS.Bauxite}) {
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(tMat, 1), new FluidStack[] {MT.H2SO4.fluid(21* U2, T)}, new FluidStack[] {MT.VitriolOfClay.fluid(17* U2, F), MT.H.gas(3*U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 3));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(tMat, 9), new FluidStack[] {MT.H2SO4.fluid(21* U2, T)}, new FluidStack[] {MT.VitriolOfClay.fluid(17* U2, F), MT.H.gas(3*U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 3));
		}
		...
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(tMat, 1), new FluidStack[] {MT.AquaRegia.fluid(39*U4, T)}, new FluidStack[] {MT.ChloroplatinicAcid.fluid(18*U4, F), MT.NO.gas(6*U4, F), FL.Water.make(4500)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(MT.PlatinumGroupSludge, 3));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(tMat, 9), new FluidStack[] {MT.AquaRegia.fluid(39*U4, T)}, new FluidStack[] {MT.ChloroplatinicAcid.fluid(18*U4, F), MT.NO.gas(6*U4, F), FL.Water.make(4500)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(MT.PlatinumGroupSludge, 3));
		}
		...
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(tMat, 1), new FluidStack[] {MT.HF.gas(U2, T)}, ZL_FS, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(MT.Graphite, 3));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(tMat, 9), new FluidStack[] {MT.HF.gas(U2, T)}, ZL_FS, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(MT.Graphite, 3));
		}
		...
		RM.Bath         .addRecipe1(T,  0,  256, crushedPurified    .mat(tMat, 1), new FluidStack[] {MT.HCl.fluid(U * 4, T)}, new FluidStack[] {MT.H2O.fluid(U * 3, F), MT.Cl.gas(U * 1, F)}, crushedCentrifuged.mat(tMat, 1), OM.dust(MT.MnCl2, U2*3));
		RM.Bath         .addRecipe1(T,  0,  256, crushedPurifiedTiny.mat(tMat, 9), new FluidStack[] {MT.HCl.fluid(U * 4, T)}, new FluidStack[] {MT.H2O.fluid(U * 3, F), MT.Cl.gas(U * 1, F)}, crushedCentrifuged.mat(tMat, 1), OM.dust(MT.MnCl2, U2*3));
		}
		
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(MT.Au                        , 1), new FluidStack[] {MT.AquaRegia    .fluid(13*U2, T)}, new FluidStack[] {MT.ChloroauricAcid.fluid( 3*U , F), MT.NO.gas(U, F), FL.Water.make(3000)}, crushedCentrifuged.mat(MT.Au        , 1), crushedCentrifugedTiny.mat(MT.Cu, 3));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(MT.Au                        , 9), new FluidStack[] {MT.AquaRegia    .fluid(13*U2, T)}, new FluidStack[] {MT.ChloroauricAcid.fluid( 3*U , F), MT.NO.gas(U, F), FL.Water.make(3000)}, crushedCentrifuged.mat(MT.Au        , 1), crushedCentrifugedTiny.mat(MT.Cu, 3));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(MT.Cu                        , 1), new FluidStack[] {MT.AquaRegia    .fluid(13*U2, T)}, new FluidStack[] {MT.ChloroauricAcid.fluid( 3*U , F), MT.NO.gas(U, F), FL.Water.make(3000)}, crushedCentrifuged.mat(MT.Cu        , 1), crushedCentrifugedTiny.mat(MT.Co, 3));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(MT.Cu                        , 9), new FluidStack[] {MT.AquaRegia    .fluid(13*U2, T)}, new FluidStack[] {MT.ChloroauricAcid.fluid( 3*U , F), MT.NO.gas(U, F), FL.Water.make(3000)}, crushedCentrifuged.mat(MT.Cu        , 1), crushedCentrifugedTiny.mat(MT.Co, 3));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(MT.Midasium                  , 1), new FluidStack[] {MT.AquaRegia    .fluid(13*U2, T)}, new FluidStack[] {MT.ChloroauricAcid.fluid( 3*U , F), MT.NO.gas(U, F), FL.Water.make(3000)}, crushedCentrifuged.mat(MT.Midasium  , 1), crushedCentrifugedTiny.mat(MT.Co, 3));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(MT.Midasium                  , 9), new FluidStack[] {MT.AquaRegia    .fluid(13*U2, T)}, new FluidStack[] {MT.ChloroauricAcid.fluid( 3*U , F), MT.NO.gas(U, F), FL.Water.make(3000)}, crushedCentrifuged.mat(MT.Midasium  , 1), crushedCentrifugedTiny.mat(MT.Co, 3));
		
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(MT.Sn                        , 1), new FluidStack[] {MT.AquaRegia    .fluid(13*U , T)}, new FluidStack[] {MT.StannicChloride.fluid( 5*U2, F), MT.HCl.gas(4*U, F), MT.NO2.gas(3*U, F), /*MT.NO2.gas(3* U2, F), MT.NO.gas(U, F), FL.Water.make(4500)*/}, crushedCentrifuged.mat(MT.Sn                      , 1), crushedCentrifugedTiny.mat(MT.Zn, 3));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(MT.Sn                        , 9), new FluidStack[] {MT.AquaRegia    .fluid(13*U , T)}, new FluidStack[] {MT.StannicChloride.fluid( 5*U2, F), MT.HCl.gas(4*U, F), MT.NO2.gas(3*U, F), /*MT.NO2.gas(3* U2, F), MT.NO.gas(U, F), FL.Water.make(4500)*/}, crushedCentrifuged.mat(MT.Sn                      , 1), crushedCentrifugedTiny.mat(MT.Zn, 3));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(MT.OREMATS.Cassiterite       , 1), new FluidStack[] {MT.AquaRegia    .fluid(13*U , T)}, new FluidStack[] {MT.StannicChloride.fluid( 5*U2, F), MT.HCl.gas(4*U, F), MT.NO2.gas(3*U, F), /*MT.NO2.gas(3* U2, F), MT.NO.gas(U, F), FL.Water.make(4500)*/}, crushedCentrifuged.mat(MT.OREMATS.Cassiterite     , 1), crushedCentrifugedTiny.mat(MT.Zn, 3));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(MT.OREMATS.Cassiterite       , 9), new FluidStack[] {MT.AquaRegia    .fluid(13*U , T)}, new FluidStack[] {MT.StannicChloride.fluid( 5*U2, F), MT.HCl.gas(4*U, F), MT.NO2.gas(3*U, F), /*MT.NO2.gas(3* U2, F), MT.NO.gas(U, F), FL.Water.make(4500)*/}, crushedCentrifuged.mat(MT.OREMATS.Cassiterite     , 1), crushedCentrifugedTiny.mat(MT.Zn, 3));
		...
		if (IL.EB_Dirt_Alfisol      .exists())  RM.Sifting.addRecipe1(T, 16, 100, new long[] { 8000,   500,   250,   250,   250,   250,   500                                   }, IL.EB_Dirt_Alfisol           .get( 1)/*|*/, ST.make(Blocks.dirt, 1, 1), ST.make(Items.wheat_seeds, 1, 0), ST.make(Items.melon_seeds, 1, 0), ST.make(Items.pumpkin_seeds, 1, 0), IL.BoP_Turnip_Seeds.get(1), IL.EtFu_Beet_Seeds.get(1, IL.GaSu_Beet_Seeds.get(1)), IL.MaCu_Bait_Worm.get(1));
		if (IL.EB_Dirt_Andisol      .exists())  RM.Sifting.addRecipe1(T, 16, 100, new long[] { 8000,   500,   250,   250,   250,   250,   500                                   }, IL.EB_Dirt_Andisol           .get( 1)/*|*/, ST.make(Blocks.dirt, 1, 1), ST.make(Items.wheat_seeds, 1, 0), ST.make(Items.melon_seeds, 1, 0), ST.make(Items.pumpkin_seeds, 1, 0), IL.BoP_Turnip_Seeds.get(1), IL.EtFu_Beet_Seeds.get(1, IL.GaSu_Beet_Seeds.get(1)), IL.MaCu_Bait_Worm.get(1));
		if (IL.EB_Dirt_Gelisol      .exists())  RM.Sifting.addRecipe1(T, 16, 100, new long[] { 8000,   500,   250,   250,   250,   250,   500                                   }, IL.EB_Dirt_Gelisol           .get( 1)/*|*/, ST.make(Blocks.dirt, 1, 1), ST.make(Items.wheat_seeds, 1, 0), ST.make(Items.melon_seeds, 1, 0), ST.make(Items.pumpkin_seeds, 1, 0), IL.BoP_Turnip_Seeds.get(1), IL.EtFu_Beet_Seeds.get(1, IL.GaSu_Beet_Seeds.get(1)), IL.MaCu_Bait_Worm.get(1));
		if (IL.EB_Dirt_Histosol     .exists())  RM.Sifting.addRecipe1(T, 16, 100, new long[] { 8000,   500,   250,   250,   250,   250,   500                                   }, IL.EB_Dirt_Histosol          .get( 1)/*|*/, ST.make(Blocks.dirt, 1, 1), ST.make(Items.wheat_seeds, 1, 0), ST.make(Items.melon_seeds, 1, 0), ST.make(Items.pumpkin_seeds, 1, 0), IL.BoP_Turnip_Seeds.get(1), IL.EtFu_Beet_Seeds.get(1, IL.GaSu_Beet_Seeds.get(1)), IL.MaCu_Bait_Worm.get(1));
		...
		if (IL.EB_Dirt_Mollisol     .exists())  RM.Sifting.addRecipe1(T, 16, 100, new long[] { 8000,   500,   250,   250,   250,   250,   500                                   }, IL.EB_Dirt_Mollisol          .get( 1)/*|*/, ST.make(Blocks.dirt, 1, 1), ST.make(Items.wheat_seeds, 1, 0), ST.make(Items.melon_seeds, 1, 0), ST.make(Items.pumpkin_seeds, 1, 0), IL.BoP_Turnip_Seeds.get(1), IL.EtFu_Beet_Seeds.get(1, IL.GaSu_Beet_Seeds.get(1)), IL.MaCu_Bait_Worm.get(1));
		if (IL.EB_Dirt_Oxisol       .exists())  RM.Sifting.addRecipe1(T, 16, 100, new long[] { 8000,   500,   250,   250,   250,   250,   500                                   }, IL.EB_Dirt_Oxisol            .get( 1)/*|*/, ST.make(Blocks.dirt, 1, 1), ST.make(Items.wheat_seeds, 1, 0), ST.make(Items.melon_seeds, 1, 0), ST.make(Items.pumpkin_seeds, 1, 0), IL.BoP_Turnip_Seeds.get(1), IL.EtFu_Beet_Seeds.get(1, IL.GaSu_Beet_Seeds.get(1)), IL.MaCu_Bait_Worm.get(1));
		...
		/* Gravel                           */  RM.Sifting.addRecipe1(T, 16, 200, new long[] { 1000,  5000,  2500,   500,   200,  5000,   500,   100                            }, ST.make(Blocks.gravel        ,  1, W)/*|*/, ST.make(Blocks.sand, 1, 0), OM.dust(MT.Stone     , U4), rockGt.mat(MT.Stone, 1), OM.dust(MT.Clay), ST.make(Items.clay_ball, 1, 0), ST.make(Items.flint, 1, 0), OM.dust(MT.Quartzite, U4), OM.gem(MT.Quartzite, U));
												RM.Sifting.addRecipe1(T, 16, 200, new long[] { 1000,  5000,  2500,   500,   200,  5000,   500,   100                            }, OM.dust(MT.Gravel                   )/*|*/, ST.make(Blocks.sand, 1, 0), OM.dust(MT.Stone     , U4), rockGt.mat(MT.Stone, 1), OM.dust(MT.Clay), ST.make(Items.clay_ball, 1, 0), ST.make(Items.flint, 1, 0), OM.dust(MT.Quartzite, U4), OM.gem(MT.Quartzite, U));
		if (IL.EtFu_Gravel          .exists())  RM.Sifting.addRecipe1(T, 16, 200, new long[] { 1000,  5000,  2500,   500,   200,  5000,   500,   100                            }, IL.EtFu_Gravel               .wild(1)/*|*/, ST.make(Blocks.sand, 1, 0), OM.dust(MT.Stone     , U4), rockGt.mat(MT.Stone, 1), OM.dust(MT.Clay), ST.make(Items.clay_ball, 1, 0), ST.make(Items.flint, 1, 0), OM.dust(MT.Quartzite, U4), OM.gem(MT.Quartzite, U));
		...
		/* Misc                             */  RM.Sifting.addRecipe1(T, 16, 200, new long[] { 8000,  1000,   500,   500,   500                                                 }, ST.make(Blocks.dirt          ,  1, 2)/*|*/, ST.make(Blocks.dirt, 1, 1), OM.dust(MT.Ash, U4), IL.MaCu_Bait_Ant.get(2), IL.MaCu_Bait_Maggot.get(1), IL.MaCu_Bait_Worm.get(1));
												...
												RM.Sifting.addRecipe1(T, 16, 300, new long[] { 9000,  4000,  2000,  4000,   500,   400,   200                                   }, ST.make(Blocks.soul_sand     ,  1, W)/*|*/, OM.dust(MT.Netherrack, U4), rockGt.mat(MT.Netherrack, 1), OM.dust(MT.KNO3, U4), OM.dust(MT.NetherQuartz, U4), OM.gem(MT.NetherQuartz, U), ST.make(Items.bone, 1, 0), ST.make(Items.nether_wart, 1, 0));
		...
		RM.Sifting      .addRecipe1(T, 16,  128, new long[] {10000, 10, 40, 150, 200, 400, 500}, crushedPurified    .mat(MT.Sn                      , 1), crushedCentrifuged.mat(MT.Sn                      , 1), gemExquisite.mat(MT.Zr, 1), gemFlawless.mat(MT.Zr, 1), gem.mat(MT.Zr, 1), gemFlawed.mat(MT.Zr, 1), gemChipped.mat(MT.Zr, 1), dust.mat(MT.Zr, 1));
		RM.Sifting      .addRecipe1(T, 16,  128, new long[] {10000, 10, 40, 150, 200, 400, 500}, crushedPurifiedTiny.mat(MT.Sn                      , 9), crushedCentrifuged.mat(MT.Sn                      , 1), gemExquisite.mat(MT.Zr, 1), gemFlawless.mat(MT.Zr, 1), gem.mat(MT.Zr, 1), gemFlawed.mat(MT.Zr, 1), gemChipped.mat(MT.Zr, 1), dust.mat(MT.Zr, 1));
		RM.Sifting      .addRecipe1(T, 16,  128, new long[] {10000, 10, 40, 150, 200, 400, 500}, crushedPurified    .mat(MT.OREMATS.Cassiterite     , 1), crushedCentrifuged.mat(MT.OREMATS.Cassiterite     , 1), gemExquisite.mat(MT.Zr, 1), gemFlawless.mat(MT.Zr, 1), gem.mat(MT.Zr, 1), gemFlawed.mat(MT.Zr, 1), gemChipped.mat(MT.Zr, 1), dust.mat(MT.Zr, 1));
		RM.Sifting      .addRecipe1(T, 16,  128, new long[] {10000, 10, 40, 150, 200, 400, 500}, crushedPurifiedTiny.mat(MT.OREMATS.Cassiterite     , 9), crushedCentrifuged.mat(MT.OREMATS.Cassiterite     , 1), gemExquisite.mat(MT.Zr, 1), gemFlawless.mat(MT.Zr, 1), gem.mat(MT.Zr, 1), gemFlawed.mat(MT.Zr, 1), gemChipped.mat(MT.Zr, 1), dust.mat(MT.Zr, 1));
		RM.Sifting      .addRecipe1(T, 16,  128, new long[] {10000, 10, 40, 150, 200, 400, 500}, crushedPurified    .mat(MT.OREMATS.CassiteriteSand , 1), crushedCentrifuged.mat(MT.OREMATS.CassiteriteSand , 1), gemExquisite.mat(MT.Zr, 1), gemFlawless.mat(MT.Zr, 1), gem.mat(MT.Zr, 1), gemFlawed.mat(MT.Zr, 1), gemChipped.mat(MT.Zr, 1), dust.mat(MT.Zr, 1));
		RM.Sifting      .addRecipe1(T, 16,  128, new long[] {10000, 10, 40, 150, 200, 400, 500}, crushedPurifiedTiny.mat(MT.OREMATS.CassiteriteSand , 9), crushedCentrifuged.mat(MT.OREMATS.CassiteriteSand , 1), gemExquisite.mat(MT.Zr, 1), gemFlawless.mat(MT.Zr, 1), gem.mat(MT.Zr, 1), gemFlawed.mat(MT.Zr, 1), gemChipped.mat(MT.Zr, 1), dust.mat(MT.Zr, 1));
		...
		for (OreDictMaterial aMat : OreDictMaterial.MATERIAL_ARRAY) if (aMat != null && !aMat.contains(ANTIMATTER)) {
			...
			if (ST.valid(tPurified) && ST.valid(tPurifiedTiny)) {
				...
				RM.Centrifuge   .addRecipe1(T, 16, 144 + 144 * aMat.mToolQuality, tPurified                     , ZL_FS, new FluidStack[] {tFluid1, tFluid2, tFluid3}, dust    .mat(aMat, 1), tFluid1==null?crushedCentrifugedTiny.mat(tMat1, 1, dustTiny.mat(tMat1, 1)):null, tFluid2==null?crushedCentrifugedTiny.mat(tMat2, 1, dustTiny.mat(tMat2, 1)):null, tFluid3==null?crushedCentrifugedTiny.mat(tMat3, 1, dustTiny.mat(tMat3, 1)):null);
				RM.Centrifuge   .addRecipe1(T, 16, 144 + 144 * aMat.mToolQuality, ST.amount(9,tPurifiedTiny)    , ZL_FS, new FluidStack[] {tFluid1, tFluid2, tFluid3}, dustTiny.mat(aMat, 9), tFluid1==null?crushedCentrifugedTiny.mat(tMat1, 1, dustTiny.mat(tMat1, 1)):null, tFluid2==null?crushedCentrifugedTiny.mat(tMat2, 1, dustTiny.mat(tMat2, 1)):null, tFluid3==null?crushedCentrifugedTiny.mat(tMat3, 1, dustTiny.mat(tMat3, 1)):null);
			}
			...
			if (ST.valid(tImpure)) {
				...
				RM.Centrifuge   .addRecipe1(T, 16, 256 + 256 * aMat.mToolQuality            , tImpure, NF, tFluid, tDust, tFluid==null?OM.dust(tMaterial, U9):null);
				...
				RM.Electrolyzer .addRecipe2(T, 16, 256 + 256 * aMat.mToolQuality, ST.tag(0) , tImpure, NF, tFluid, tDust, tFluid==null?OM.dust(tMaterial, U9):null);
			}
			...
			if (ST.valid(tPure)) {
				...
				RM.Centrifuge   .addRecipe1(T, 16, 256 + 256 * aMat.mToolQuality            , tPure, NF, tFluid, tDust, tFluid==null?OM.dust(tMaterial, U9):null);
				...
				RM.Electrolyzer .addRecipe2(T, 16, 256 + 256 * aMat.mToolQuality, ST.tag(0) , tPure, NF, tFluid, tDust, tFluid==null?OM.dust(tMaterial, U9):null);
			}
			...
			if (ST.valid(tRefined)) {
				...
				RM.Centrifuge   .addRecipe1(T, 16, 256 + 256 * aMat.mToolQuality            , tRefined, NF, tFluid, tDust, tFluid==null?OM.dust(tMaterial, U9):null);
				...
				RM.Electrolyzer .addRecipe2(T, 16, 256 + 256 * aMat.mToolQuality, ST.tag(0) , tRefined, NF, tFluid, tDust, tFluid==null?OM.dust(tMaterial, U9):null);
			}
		}
	}
}
