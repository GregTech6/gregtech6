...
public class Loader_Recipes_Ores implements Runnable {
	@Override public void run() {
		...
		/* Coarse Dirt                      */  RM.Sifting.addRecipe1(T, 16, 144, new long[] { 4500,  3000,   250,   100                                                        }, ST.make(Blocks.dirt          ,  1, 1)/*|*/, OM.dust(MT.Sand      , U   ), OM.dust(MT.Stone            , U), OM.dust(MT.ClayBrown   ), IL.Clay_Ball_Brown .get(1));
		if (IL.EtFu_Dirt            .exists())  RM.Sifting.addRecipe1(T, 16, 144, new long[] { 4500,  3000,   250,   100                                                        }, IL.EtFu_Dirt                 .wild(1)/*|*/, OM.dust(MT.Sand      , U   ), OM.dust(MT.Stone            , U), OM.dust(MT.ClayBrown   ), IL.Clay_Ball_Brown .get(1));
		if (IL.BoP_Coarse_Loamy     .exists())  RM.Sifting.addRecipe1(T, 16, 144, new long[] { 4500,  3000,  1000,   400                                                        }, IL.BoP_Coarse_Loamy          .get( 1)/*|*/, OM.dust(MT.Sand      , U   ), OM.dust(MT.Stone            , U), OM.dust(MT.Palygorskite), IL.Clay_Ball_Blue  .get(1));
		if (IL.BoP_Coarse_Silty     .exists())  RM.Sifting.addRecipe1(T, 16, 144, new long[] { 4500,  6000,   250,   100                                                        }, IL.BoP_Coarse_Silty          .get( 1)/*|*/, OM.dust(MT.Sand      , U   ), OM.dust(MT.STONES.Siltstone , U), OM.dust(MT.Kaolinite   ), IL.Clay_Ball_White .get(1));
		if (IL.BoP_Coarse_Sandy     .exists())  RM.Sifting.addRecipe1(T, 16, 144, new long[] { 9000,  3000,   250,   100                                                        }, IL.BoP_Coarse_Sandy          .get( 1)/*|*/, OM.dust(MT.Sand      , U *2), OM.dust(MT.Stone            , U), OM.dust(MT.Bentonite   ), IL.Clay_Ball_Yellow.get(1));
		if (IL.BoP_Dirt_Dried       .exists())  RM.Sifting.addRecipe1(T, 16, 144, new long[] { 9000,  2500,   250,   100                                                        }, IL.BoP_Dirt_Dried            .get( 1)/*|*/, OM.dust(MT.Sand      , U   ), OM.dust(MT.Stone            , U), OM.dust(MT.Bentonite   ), IL.Clay_Ball_Yellow.get(1));
		if (IL.BoP_Dirt_Hard        .exists())  RM.Sifting.addRecipe1(T, 16, 144, new long[] { 9000,  2500,   250,   100                                                        }, IL.BoP_Dirt_Hard             .get( 1)/*|*/, OM.dust(MT.Sand      , U   ), OM.dust(MT.Stone            , U), OM.dust(MT.Bentonite   ), IL.Clay_Ball_Yellow.get(1));
		/* Gravel                           */  RM.Sifting.addRecipe1(T, 16, 144, new long[] { 9000,  5000,  2500,   500,   200,  5000,   500,   100                            }, ST.make(Blocks.gravel        ,  1, W)/*|*/, OM.dust(MT.Sand      , U   ), OM.dust(MT.STONES.Deepslate , U), rockGt.mat(MT.Stone            , 1), OM.dust(MT.Clay   ), ST.make(Items.clay_ball, 1, 0), ST.make(Items.flint, 1, 0), OM.dust(MT.MilkyQuartz , U4), OM.gem(MT.MilkyQuartz , U));
		if (IL.EtFu_Gravel          .exists())  RM.Sifting.addRecipe1(T, 16, 144, new long[] { 9000,  5000,  2500,   500,   200,  5000,   500,   100                            }, IL.EtFu_Gravel               .wild(1)/*|*/, OM.dust(MT.Sand      , U   ), OM.dust(MT.STONES.Deepslate , U), rockGt.mat(MT.Stone            , 1), OM.dust(MT.Clay   ), ST.make(Items.clay_ball, 1, 0), ST.make(Items.flint, 1, 0), OM.dust(MT.MilkyQuartz , U4), OM.gem(MT.MilkyQuartz , U));
		if (IL.NeLi_Gravel          .exists())  RM.Sifting.addRecipe1(T, 16, 144, new long[] { 1000,  5000,  2500,   500,   200,  5000,   500,   100                            }, IL.NeLi_Gravel               .wild(1)/*|*/, OM.dust(MT.RedSand   , U   ), OM.dust(MT.STONES.Blackstone, U), rockGt.mat(MT.STONES.Blackstone, 1), OM.dust(MT.ClayRed), IL.Clay_Ball_Red       .get(1), ST.make(Items.flint, 1, 0), OM.dust(MT.NetherQuartz, U4), OM.gem(MT.NetherQuartz, U));
		...
		RM.Sifting      .addRecipe1(T, 16,  144, new long[] {7200,  900, 5000}, crushedPurified    .mat(MT.ChargedCertusQuartz, 1), gem.mat(MT.ChargedCertusQuartz, 1), gem.mat(MT.CertusQuartz, 1), dustTiny.mat(MT.CertusQuartz, 9));
		RM.Sifting      .addRecipe1(T, 16,   16, new long[] { 800,  100, 5000}, crushedPurifiedTiny.mat(MT.ChargedCertusQuartz, 1), gem.mat(MT.ChargedCertusQuartz, 1), gem.mat(MT.CertusQuartz, 1), dustTiny.mat(MT.CertusQuartz, 1));
		RM.Sifting      .addRecipe1(T, 16,  144, new long[] { 900, 7200, 5000}, crushedPurified    .mat(MT.CertusQuartz       , 1), gem.mat(MT.ChargedCertusQuartz, 1), gem.mat(MT.CertusQuartz, 1), dustTiny.mat(MT.CertusQuartz, 9));
		RM.Sifting      .addRecipe1(T, 16,   16, new long[] { 100,  800, 5000}, crushedPurifiedTiny.mat(MT.CertusQuartz       , 1), gem.mat(MT.ChargedCertusQuartz, 1), gem.mat(MT.CertusQuartz, 1), dustTiny.mat(MT.CertusQuartz, 1));
		RM.Sifting      .addRecipe1(T, 16,  144, new long[] {      7200, 5000}, crushedPurified    .mat(MT.NetherQuartz       , 1), gem.mat(MT.NetherQuartz       , 1)                             , dustTiny.mat(MT.NetherQuartz, 9));
		RM.Sifting      .addRecipe1(T, 16,   16, new long[] {       800, 5000}, crushedPurifiedTiny.mat(MT.NetherQuartz       , 1), gem.mat(MT.NetherQuartz       , 1)                             , dustTiny.mat(MT.NetherQuartz, 1));
		RM.Sifting      .addRecipe1(T, 16,  144, new long[] {      7200, 5000}, crushedPurified    .mat(MT.VoidQuartz         , 1), gem.mat(MT.VoidQuartz         , 1)                             , dustTiny.mat(MT.VoidQuartz  , 9));
		RM.Sifting      .addRecipe1(T, 16,   16, new long[] {       800, 5000}, crushedPurifiedTiny.mat(MT.VoidQuartz         , 1), gem.mat(MT.VoidQuartz         , 1)                             , dustTiny.mat(MT.VoidQuartz  , 1));
		RM.Sifting      .addRecipe1(T, 16,  144, new long[] {      7200, 5000}, crushedPurified    .mat(MT.MilkyQuartz        , 1), gem.mat(MT.MilkyQuartz        , 1)                             , dustTiny.mat(MT.MilkyQuartz , 9));
		RM.Sifting      .addRecipe1(T, 16,   16, new long[] {       800, 5000}, crushedPurifiedTiny.mat(MT.MilkyQuartz        , 1), gem.mat(MT.MilkyQuartz        , 1)                             , dustTiny.mat(MT.MilkyQuartz , 1));
		RM.Sifting      .addRecipe1(T, 16,  144, new long[] {      7200, 5000}, crushedPurified    .mat(MT.Fluix              , 1), gem.mat(MT.Fluix              , 1)                             , dustTiny.mat(MT.Fluix       , 9));
		...
		RM.Sifting          .addRecipe1(T, 16,  144, new long[] {9000, 1000,  500,  500}, ST.make(BlocksGT.Sands  , 1, 0), dust.mat(MT.STONES.Deepslate   , 4), rockGt.mat(MT.STONES.Deepslate   , 1), nugget.mat(MT.Au, 1));
		RM.MagneticSeparator.addRecipe1(T, 16,  144, new long[] {9000, 1000,  500,  500}, ST.make(BlocksGT.Sands  , 1, 0), dust.mat(MT.STONES.Deepslate   , 4), rockGt.mat(MT.STONES.Deepslate   , 1), nugget.mat(MT.Au, 1), dustTiny.mat(MT.Au, 2));
		RM.Centrifuge       .addRecipe1(T, 16,  288, new long[] {9000, 1000,  500,  500}, ST.make(BlocksGT.Sands  , 1, 0), dust.mat(MT.STONES.Deepslate   , 8), dust  .mat(MT.V2O5               , 1));
		RM.Sifting          .addRecipe1(T, 16,  144, new long[] {9000, 1000,  500,  500}, ST.make(BlocksGT.Sands  , 1, 1), dust.mat(MT.STONES.Gabbro      , 4), rockGt.mat(MT.STONES.Gabbro      , 1), nugget.mat(MT.Au, 1));
		RM.MagneticSeparator.addRecipe1(T, 16,  144, new long[] {9000, 1000,  500,  500}, ST.make(BlocksGT.Sands  , 1, 1), dust.mat(MT.STONES.Gabbro      , 4), rockGt.mat(MT.STONES.Gabbro      , 1), nugget.mat(MT.Au, 1), dustTiny.mat(MT.Au, 2));
		RM.Centrifuge       .addRecipe1(T, 16,  288, new long[] {9000, 1000,  500,  500}, ST.make(BlocksGT.Sands  , 1, 1), dust.mat(MT.STONES.Gabbro      , 8), dust  .mat(MT.V2O5               , 1));
		RM.Sifting          .addRecipe1(T, 16,  144, new long[] {9000, 1000,  500,  500}, ST.make(BlocksGT.Sands  , 1, 2), dust.mat(MT.STONES.GraniteBlack, 4), rockGt.mat(MT.STONES.GraniteBlack, 1), nugget.mat(MT.Au, 1));
		RM.MagneticSeparator.addRecipe1(T, 16,  144, new long[] {9000, 1000,  500,  500}, ST.make(BlocksGT.Sands  , 1, 2), dust.mat(MT.STONES.GraniteBlack, 4), rockGt.mat(MT.STONES.GraniteBlack, 1), nugget.mat(MT.Au, 1), dustTiny.mat(MT.Au, 2));
		RM.Centrifuge       .addRecipe1(T, 16,  288, new long[] {9000, 1000,  500,  500}, ST.make(BlocksGT.Sands  , 1, 2), dust.mat(MT.STONES.GraniteBlack, 8), dust  .mat(MT.V2O5               , 1));
		if (IL.PFAA_Sands.exists()) {
		RM.Sifting          .addRecipe1(T, 16,  144, new long[] {9000, 1000,  500,  500}, IL.PFAA_Sands.getWithMeta(1, 0), dust.mat(MT.STONES.Basalt      , 4), rockGt.mat(MT.STONES.Basalt      , 1), nugget.mat(MT.Au, 1));
		RM.MagneticSeparator.addRecipe1(T, 16,  144, new long[] {9000, 1000,  500,  500}, IL.PFAA_Sands.getWithMeta(1, 0), dust.mat(MT.STONES.Basalt      , 4), rockGt.mat(MT.STONES.Basalt      , 1), nugget.mat(MT.Au, 1), dustTiny.mat(MT.Au, 2));
		RM.Centrifuge       .addRecipe1(T, 16,  288, new long[] {9000, 1000,  500,  500}, IL.PFAA_Sands.getWithMeta(1, 0), dust.mat(MT.STONES.Basalt      , 8), dust  .mat(MT.V2O5               , 2));
		RM.Sifting          .addRecipe1(T, 16,  144, new long[] {9000, 1000,  500,  500}, IL.PFAA_Sands.getWithMeta(1, 3), dust.mat(MT.STONES.Granite     , 4), rockGt.mat(MT.STONES.Granite     , 1), nugget.mat(MT.Au, 1));
		RM.MagneticSeparator.addRecipe1(T, 16,  144, new long[] {9000, 1000,  500,  500}, IL.PFAA_Sands.getWithMeta(1, 3), dust.mat(MT.STONES.Granite     , 4), rockGt.mat(MT.STONES.Granite     , 1), nugget.mat(MT.Au, 1), dustTiny.mat(MT.Au, 2));
		RM.Centrifuge       .addRecipe1(T, 16,  288, new long[] {9000, 1000,  500,  500}, IL.PFAA_Sands.getWithMeta(1, 3), dust.mat(MT.STONES.Granite     , 8), dust  .mat(MT.V2O5               , 2));
		} if (IL.TROPIC_Sand_Black.exists()) {
		RM.Sifting          .addRecipe1(T, 16,  144, new long[] {9000, 1000,  500,  500}, IL.TROPIC_Sand_Black    .get(1), dust.mat(MT.STONES.Basalt      , 4), rockGt.mat(MT.STONES.Basalt      , 1), nugget.mat(MT.Au, 1));
		RM.MagneticSeparator.addRecipe1(T, 16,  144, new long[] {9000, 1000,  500,  500}, IL.TROPIC_Sand_Black    .get(1), dust.mat(MT.STONES.Basalt      , 4), rockGt.mat(MT.STONES.Basalt      , 1), nugget.mat(MT.Au, 1), dustTiny.mat(MT.Au, 2));
		RM.Centrifuge       .addRecipe1(T, 16,  288, new long[] {9000, 1000,  500,  500}, IL.TROPIC_Sand_Black    .get(1), dust.mat(MT.STONES.Basalt      , 8), dust  .mat(MT.V2O5               , 1));
		}
		...
		for (OreDictMaterial aMat : OreDictMaterial.MATERIAL_ARRAY) if (aMat != null && !aMat.contains(ANTIMATTER) && aMat != MT.Bedrock) {
			...
			if (ST.valid(tCrushed) && ST.valid(tCrushedTiny)) {
				...
				RM.Bath.addRecipe2(T, T, F, F, T, 0, 144, tCrushed                 , OP.dust    .mat(tPersulfate, 1), FL.Water.make(900), NF, OM.crushedPurified    (aMat, 1), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), tByproductPersulfate);
				RM.Bath.addRecipe2(T, T, F, T, T, 0, 144, tCrushed                 , OP.dust    .mat(tPersulfate, 1), FL.SpDew.make(900), NF, OM.crushedPurified    (aMat, 1), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), tByproductPersulfate);
				RM.Bath.addRecipe2(T, T, F, T, T, 0, 144, tCrushed                 , OP.dust    .mat(tPersulfate, 1), FL.DistW.make(900), NF, OM.crushedPurified    (aMat, 1), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), tByproductPersulfate);
				RM.Bath.addRecipe2(T, T, F, F, T, 0, 144, ST.amount(9,tCrushedTiny), OP.dust    .mat(tPersulfate, 1), FL.Water.make(900), NF, OM.crushedPurified    (aMat, 1), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), tByproductPersulfate);
				RM.Bath.addRecipe2(T, T, F, T, T, 0, 144, ST.amount(9,tCrushedTiny), OP.dust    .mat(tPersulfate, 1), FL.SpDew.make(900), NF, OM.crushedPurified    (aMat, 1), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), tByproductPersulfate);
				RM.Bath.addRecipe2(T, T, F, T, T, 0, 144, ST.amount(9,tCrushedTiny), OP.dust    .mat(tPersulfate, 1), FL.DistW.make(900), NF, OM.crushedPurified    (aMat, 1), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), tByproductPersulfate);
				RM.Bath.addRecipe2(T, T, F, F, T, 0, 144, tCrushed                 , OP.dustTiny.mat(tPersulfate, 9), FL.Water.make(900), NF, OM.crushedPurified    (aMat, 1), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), tByproductPersulfate);
				RM.Bath.addRecipe2(T, T, F, T, T, 0, 144, tCrushed                 , OP.dustTiny.mat(tPersulfate, 9), FL.SpDew.make(900), NF, OM.crushedPurified    (aMat, 1), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), tByproductPersulfate);
				RM.Bath.addRecipe2(T, T, F, T, T, 0, 144, tCrushed                 , OP.dustTiny.mat(tPersulfate, 9), FL.DistW.make(900), NF, OM.crushedPurified    (aMat, 1), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), ST.mul_(2, tByproductPersulfate), tByproductPersulfate);
				RM.Bath.addRecipe2(T, T, F, F, T, 0,  16, tCrushedTiny             , OP.dustTiny.mat(tPersulfate, 1), FL.Water.make(100), NF, OM.crushedPurifiedTiny(aMat, 1), tByproductPersulfate);
				RM.Bath.addRecipe2(T, T, F, T, T, 0,  16, tCrushedTiny             , OP.dustTiny.mat(tPersulfate, 1), FL.SpDew.make(100), NF, OM.crushedPurifiedTiny(aMat, 1), tByproductPersulfate);
				RM.Bath.addRecipe2(T, T, F, T, T, 0,  16, tCrushedTiny             , OP.dustTiny.mat(tPersulfate, 1), FL.DistW.make(100), NF, OM.crushedPurifiedTiny(aMat, 1), tByproductPersulfate);
				}
			}
