...
public class Loader_Recipes_Ores implements Runnable {
	@Override public void run() {
		...
		RM.Centrifuge           .addRecipe0(T, 64,  128, new long[] {8000,  250,  250,  250,  250,  250}, FL.Lava           .make(100), NF, dust.mat(MT.Basalt, 1), nugget.mat(MT.Cu, 8), nugget.mat(MT.Sn, 4), nugget.mat(MT.Fe, 4), nugget.mat(MT.Au, 1), nugget.mat(MT.Ag, 1));
		RM.Centrifuge           .addRecipe0(T, 64,  192, new long[] {9000,  300,  300,  300,  300,  300}, FL.Lava_Pahoehoe  .make(100), NF, dust.mat(MT.Basalt, 1), nugget.mat(MT.Cu, 8), nugget.mat(MT.Sn, 4), nugget.mat(MT.Fe, 4), nugget.mat(MT.Au, 1), nugget.mat(MT.Ag, 1));
		...
		RM.Bath         .addRecipe1(T,  0,  256, crushedPurified    .mat(tMat, 1), new FluidStack[] {MT.HCl.gas(U * 4, T)}, new FluidStack[] {MT.H2O.fluid(U * 3, F), MT.Cl.gas(U * 1, F)}, crushedCentrifuged.mat(tMat, 1), OM.dust(MT.MnCl2, U2*3));
		RM.Bath         .addRecipe1(T,  0,  256, crushedPurifiedTiny.mat(tMat, 9), new FluidStack[] {MT.HCl.gas(U * 4, T)}, new FluidStack[] {MT.H2O.fluid(U * 3, F), MT.Cl.gas(U * 1, F)}, crushedCentrifuged.mat(tMat, 1), OM.dust(MT.MnCl2, U2*3));
		}
		
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(MT.Au                        , 1), new FluidStack[] {MT.AquaRegia    .fluid(13*U2, T)}, new FluidStack[] {MT.ChloroauricAcid.fluid( 3*U , F), MT.NO.gas(U, F), FL.Water.make(3000)}, crushedCentrifuged.mat(MT.Au      , 1), crushedCentrifugedTiny.mat(MT.Cu, 9));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(MT.Au                        , 9), new FluidStack[] {MT.AquaRegia    .fluid(13*U2, T)}, new FluidStack[] {MT.ChloroauricAcid.fluid( 3*U , F), MT.NO.gas(U, F), FL.Water.make(3000)}, crushedCentrifuged.mat(MT.Au      , 1), crushedCentrifugedTiny.mat(MT.Cu, 9));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(MT.Cu                        , 1), new FluidStack[] {MT.AquaRegia    .fluid(13*U2, T)}, new FluidStack[] {MT.ChloroauricAcid.fluid( 3*U , F), MT.NO.gas(U, F), FL.Water.make(3000)}, crushedCentrifuged.mat(MT.Cu      , 1), crushedCentrifugedTiny.mat(MT.Co, 9));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(MT.Cu                        , 9), new FluidStack[] {MT.AquaRegia    .fluid(13*U2, T)}, new FluidStack[] {MT.ChloroauricAcid.fluid( 3*U , F), MT.NO.gas(U, F), FL.Water.make(3000)}, crushedCentrifuged.mat(MT.Cu      , 1), crushedCentrifugedTiny.mat(MT.Co, 9));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(MT.Midasium                  , 1), new FluidStack[] {MT.AquaRegia    .fluid(13*U2, T)}, new FluidStack[] {MT.ChloroauricAcid.fluid( 3*U , F), MT.NO.gas(U, F), FL.Water.make(3000)}, crushedCentrifuged.mat(MT.Midasium, 1), crushedCentrifugedTiny.mat(MT.Co, 9));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(MT.Midasium                  , 9), new FluidStack[] {MT.AquaRegia    .fluid(13*U2, T)}, new FluidStack[] {MT.ChloroauricAcid.fluid( 3*U , F), MT.NO.gas(U, F), FL.Water.make(3000)}, crushedCentrifuged.mat(MT.Midasium, 1), crushedCentrifugedTiny.mat(MT.Co, 9));
		
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(MT.Sn                        , 1), new FluidStack[] {MT.AquaRegia    .fluid(13*U , T)}, new FluidStack[] {MT.StannicChloride.fluid( 5*U2, F), MT.HCl.gas(4*U, F), MT.NO2.gas(3*U, F), /*MT.NO2.gas(3* U2, F), MT.NO.gas(U, F), FL.Water.make(4500)*/}, crushedCentrifuged.mat(MT.Sn                 , 1), crushedCentrifugedTiny.mat(MT.Zn, 9));
