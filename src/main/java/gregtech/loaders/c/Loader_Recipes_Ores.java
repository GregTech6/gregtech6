...
public class Loader_Recipes_Ores implements Runnable {
	@Override public void run() {
		...
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(tMat, 1), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.PinkVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 9));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(tMat, 9), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.PinkVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 9));
		}
		...
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(tMat, 1), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.CyanVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 9));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(tMat, 9), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.CyanVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 9));
		}
		...
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(tMat, 1), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.GrayVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 9));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(tMat, 9), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.GrayVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 9));
		}
		...
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(tMat, 1), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.GreenVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 9));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(tMat, 9), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.GreenVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 9));
		}
		...
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(tMat, 1), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.BlueVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 9));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(tMat, 9), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.BlueVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 9));
		}
		for (OreDictMaterial tMat : new OreDictMaterial[] {MT.Co, MT.Co_60, MT.OREMATS.Cobaltite}) {
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(tMat, 1), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.RedVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 9));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(tMat, 9), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.RedVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 9));
		}
		for (OreDictMaterial tMat : new OreDictMaterial[] {MT.Zn, MT.Sn, MT.Sb, MT.OREMATS.Sphalerite, MT.OREMATS.Smithsonite}) {
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(tMat, 1), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.WhiteVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 9));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(tMat, 9), new FluidStack[] {MT.H2SO4.fluid(7* U2, T)}, new FluidStack[] {MT.WhiteVitriol.fluid(3*U, F), MT.H.gas(U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 9));
		}
		for (OreDictMaterial tMat : new OreDictMaterial[] {MT.Al, MT.Almandine, MT.OREMATS.Bauxite}) {
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurified    .mat(tMat, 1), new FluidStack[] {MT.H2SO4.fluid(21* U2, T)}, new FluidStack[] {MT.VitriolOfClay.fluid(17* U2, F), MT.H.gas(3*U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 9));
		RM.Bath         .addRecipe1(T,  0,  256, new long[] {10000, 5000}, crushedPurifiedTiny.mat(tMat, 9), new FluidStack[] {MT.H2SO4.fluid(21* U2, T)}, new FluidStack[] {MT.VitriolOfClay.fluid(17* U2, F), MT.H.gas(3*U, F)}, crushedCentrifuged.mat(tMat, 1), crushedCentrifugedTiny.mat(tMat, 9));
		}
