	...
	@Override public void run() {OUT.println("GT_Mod: Doing GT Recipes for Ore Processing.");
		...
		for (OreDictMaterial aMat : OreDictMaterial.MATERIAL_ARRAY) if (aMat != null && !aMat.contains(ANTIMATTER)) {
			...
			if (ST.valid(tCrushed) && ST.valid(tCrushedTiny)) {
				...
				RM.Bath.addRecipe1(T, 0, 144, tCrushed	  , MT.Hg.liquid(U , T), NF, crushedPurified	.mat(aMat, 1), ST.mul(9, tByProductMercury));
				...
				RM.Bath.addRecipe2(T, 0, 144, tCrushed					, OP.dust	 .mat(tPersulfate, 1), FL.Water.make(900), NF, crushedPurified.mat(aMat, 1), ST.mul(9, tByproductPersulfate));
				RM.Bath.addRecipe2(T, 0, 144, tCrushed					, OP.dust	 .mat(tPersulfate, 1), FL.DistW.make(900), NF, crushedPurified.mat(aMat, 1), ST.mul(9, tByproductPersulfate));
				RM.Bath.addRecipe2(T, 0, 144, ST.amount(9,tCrushedTiny)	, OP.dust	 .mat(tPersulfate, 1), FL.Water.make(900), NF, crushedPurified.mat(aMat, 1), ST.mul(9, tByproductPersulfate));
				RM.Bath.addRecipe2(T, 0, 144, ST.amount(9,tCrushedTiny)	, OP.dust	 .mat(tPersulfate, 1), FL.DistW.make(900), NF, crushedPurified.mat(aMat, 1), ST.mul(9, tByproductPersulfate));
				RM.Bath.addRecipe2(T, 0, 144, tCrushed					, OP.dustTiny.mat(tPersulfate, 9), FL.Water.make(900), NF, crushedPurified.mat(aMat, 1), ST.mul(9, tByproductPersulfate));
				RM.Bath.addRecipe2(T, 0, 144, tCrushed					, OP.dustTiny.mat(tPersulfate, 9), FL.DistW.make(900), NF, crushedPurified.mat(aMat, 1), ST.mul(9, tByproductPersulfate));
