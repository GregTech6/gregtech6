...
public class Loader_Recipes_Food implements Runnable {
	@Override public void run() {
		...
		RM.Distillery   .addRecipe1(T        , 16,  10, ST.tag(0), FL.Juice_Lemon .make(   4), FL.Alcopops   .make( 2), ZL_IS);
		RM.Distillery   .addRecipe1(T        , 16,  10, ST.tag(0), FL.Juice_Lime  .make(   4), FL.Alcopops   .make( 2), ZL_IS);
		RM.Distillery   .addRecipe1(T        , 16,  10, ST.tag(0), FL.Juice_Potato.make(   4), FL.Vodka      .make( 2), ZL_IS);
		RM.Distillery   .addRecipe1(T        , 16,  10, ST.tag(0), FL.Rum_White   .make(   2), FL.Rum_Dark   .make( 1), ZL_IS);
		RM.Distillery   .addRecipe1(T        , 16,  10, ST.tag(0), FL.ShortMead   .make(   2), FL.Mead       .make( 1), ZL_IS);
		RM.Distillery   .addRecipe1(F        , 16,  10, ST.tag(0), FL.Vodka       .make(   2), FL.Vodka      .make( 1), ZL_IS);
		RM.Distillery   .addRecipe1(F        , 16,  10, ST.tag(0), FL.Rum_Dark    .make(   2), FL.Rum_Dark   .make( 1), ZL_IS);
