...
public class Loader_Recipes_Food implements Runnable {
	@Override public void run() {OUT.println("GT_Mod: Doing GT Recipes for Food Stuff.");
		...
		for (ItemStack tStack : new ItemStack[] {dustTiny.mat(MT.FishCooked, 9), dustSmall.mat(MT.FishCooked, 4), dust.mat(MT.FishCooked, 1), nugget.mat(MT.FishCooked, 9), chunkGt.mat(MT.FishCooked, 4), ingot.mat(MT.FishCooked, 1)})
		RM.food_can(tStack, 2, "Canned Fish", IL.CANS_FISH);
		for (ItemStack tStack : new ItemStack[] {dustTiny.mat(MT.MeatCooked, 9), dustSmall.mat(MT.MeatCooked, 4), dust.mat(MT.MeatCooked, 1), nugget.mat(MT.MeatCooked, 9), chunkGt.mat(MT.MeatCooked, 4), ingot.mat(MT.MeatCooked, 1)})
		RM.food_can(tStack, 2, "Canned Meat", IL.CANS_MEAT);
		for (ItemStack tStack : new ItemStack[] {dustTiny.mat(MT.Tofu, 9), dustSmall.mat(MT.Tofu, 4), dust.mat(MT.Tofu, 1), nugget.mat(MT.Tofu, 9), chunkGt.mat(MT.Tofu, 4), ingot.mat(MT.Tofu, 1)})
		RM.food_can(tStack, 2, "Canned Tofu", IL.CANS_VEGGIE);
		for (ItemStack tStack : new ItemStack[] {dustTiny.mat(MT.SoylentGreen, 9), dustSmall.mat(MT.SoylentGreen, 4), dust.mat(MT.SoylentGreen, 1), nugget.mat(MT.SoylentGreen, 9), chunkGt.mat(MT.SoylentGreen, 4), ingot.mat(MT.SoylentGreen, 1)})
		...
		addListener("foodScrapmeat", new IOreDictListenerEvent() {@Override public void onOreRegistration(OreDictRegistrationContainer aEvent) {
			...
			RM.Mixer.addRecipeX(T, 16,	256, new ItemStack[] {aEvent.mStack, ST.make(Items.fermented_spider_eye, 1, W), OM.dust(MT.MeatRotten), OM.dust(MT.Bone), IL.Food_Potato_Poisonous.get(1), IL.IC2_Scrap.get(1, ST.make(Blocks.red_mushroom, 1, W))}, new FluidStack[] {FL.Purple_Drink.make(1000), FL.Oil_Fish.make(1000)}, FL.Sludge.make(1000), IL.Food_Chum.get(8));
			RM.Mixer.addRecipeX(T, 16,	256, new ItemStack[] {aEvent.mStack, ST.make(Items.fermented_spider_eye, 1, W), OM.dust(MT.FishRotten), OM.dust(MT.Bone), IL.Food_Potato_Poisonous.get(1), IL.IC2_Scrap.get(1, ST.make(Blocks.red_mushroom, 1, W))}, new FluidStack[] {FL.Purple_Drink.make(1000), FL.Oil_Fish.make(1000)}, FL.Sludge.make(1000), IL.Food_Chum.get(8));
			
			if (IL.IE_Slag.exists()) {
			RM.Mixer.addRecipeX(T, 16,	256, new ItemStack[] {aEvent.mStack, ST.make(Items.fermented_spider_eye, 1, W), OM.dust(MT.MeatRotten), OM.dust(MT.Bone), IL.IE_Slag.get(1), IL.IC2_Scrap.get(1, ST.make(Blocks.red_mushroom, 1, W))}, new FluidStack[] {FL.Purple_Drink.make(1000), FL.Oil_Fish.make(1000)}, FL.Sludge.make(1000), IL.Food_Chum.get(8));
			RM.Mixer.addRecipeX(T, 16,	256, new ItemStack[] {aEvent.mStack, ST.make(Items.fermented_spider_eye, 1, W), OM.dust(MT.FishRotten), OM.dust(MT.Bone), IL.IE_Slag.get(1), IL.IC2_Scrap.get(1, ST.make(Blocks.red_mushroom, 1, W))}, new FluidStack[] {FL.Purple_Drink.make(1000), FL.Oil_Fish.make(1000)}, FL.Sludge.make(1000), IL.Food_Chum.get(8));
			}
			if (IL.TE_Slag.exists()) {
			RM.Mixer.addRecipeX(T, 16,	256, new ItemStack[] {aEvent.mStack, ST.make(Items.fermented_spider_eye, 1, W), OM.dust(MT.MeatRotten), OM.dust(MT.Bone), IL.TE_Slag.get(1), IL.IC2_Scrap.get(1, ST.make(Blocks.red_mushroom, 1, W))}, new FluidStack[] {FL.Purple_Drink.make(1000), FL.Oil_Fish.make(1000)}, FL.Sludge.make(1000), IL.Food_Chum.get(8));
			RM.Mixer.addRecipeX(T, 16,	256, new ItemStack[] {aEvent.mStack, ST.make(Items.fermented_spider_eye, 1, W), OM.dust(MT.FishRotten), OM.dust(MT.Bone), IL.TE_Slag.get(1), IL.IC2_Scrap.get(1, ST.make(Blocks.red_mushroom, 1, W))}, new FluidStack[] {FL.Purple_Drink.make(1000), FL.Oil_Fish.make(1000)}, FL.Sludge.make(1000), IL.Food_Chum.get(8));
			}
			if (IL.TE_Slag_Rich.exists()) {
			RM.Mixer.addRecipeX(T, 16,	256, new ItemStack[] {aEvent.mStack, ST.make(Items.fermented_spider_eye, 1, W), OM.dust(MT.MeatRotten), OM.dust(MT.Bone), IL.TE_Slag_Rich.get(1), IL.IC2_Scrap.get(1, ST.make(Blocks.red_mushroom, 1, W))}, new FluidStack[] {FL.Purple_Drink.make(1000), FL.Oil_Fish.make(1000)}, FL.Sludge.make(1000), IL.Food_Chum.get(8));
			RM.Mixer.addRecipeX(T, 16,	256, new ItemStack[] {aEvent.mStack, ST.make(Items.fermented_spider_eye, 1, W), OM.dust(MT.FishRotten), OM.dust(MT.Bone), IL.TE_Slag_Rich.get(1), IL.IC2_Scrap.get(1, ST.make(Blocks.red_mushroom, 1, W))}, new FluidStack[] {FL.Purple_Drink.make(1000), FL.Oil_Fish.make(1000)}, FL.Sludge.make(1000), IL.Food_Chum.get(8));
			}
		}});
		addListener("listAllfishraw", new IOreDictListenerEvent() {@Override public void onOreRegistration(OreDictRegistrationContainer aEvent) {
		...
		addListener("listAllmushroom", new IOreDictListenerEvent() {@Override public void onOreRegistration(OreDictRegistrationContainer aEvent) {
			if (!ST.equal(aEvent.mStack, ST.make(Blocks.brown_mushroom, 1, W)))
		...
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Mash_Wheat.make(50), FL.Mash_Hops.make(50)}, FL.Mash_WheatHops.make(100), ZL_IS);
		...
		for (ItemStack tStack : new ItemStack[] {dust.mat(MT.Hazelnut, 1), dustSmall.mat(MT.Hazelnut, 4), dustTiny.mat(MT.Hazelnut,	 9)}) {
		...
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Juice_Grape_White	.make(125), FL.Juice_Apple	.make(125)}, FL.Med_Laxative	.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Juice_Grape_Green	.make(125), FL.Juice_Apple	.make(125)}, FL.Med_Laxative	.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Juice_Grape_Red	.make(125), FL.Juice_Apple	.make(125)}, FL.Med_Laxative	.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Juice_Grape_Purple.make(125), FL.Juice_Apple	.make(125)}, FL.Med_Laxative	.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Juice_Grape_White	.make(125), FL.Juice_Plum	.make(125)}, FL.Med_Laxative	.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Juice_Grape_Green	.make(125), FL.Juice_Plum	.make(125)}, FL.Med_Laxative	.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Juice_Grape_Red	.make(125), FL.Juice_Plum	.make(125)}, FL.Med_Laxative	.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Juice_Grape_Purple.make(125), FL.Juice_Plum	.make(125)}, FL.Med_Laxative	.make(250), ZL_IS);
		
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Sap_Rainbow		.make(125), FL.Ambrosia		.make(125)}, FL.Med_Heal		.make(250), ZL_IS);
		
		
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice				.make(125)}, FL.Smoothie_Fruit			.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Ananas		.make(125)}, FL.Smoothie_Ananas			.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Apple			.make(125)}, FL.Smoothie_Apple			.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_AppleGrC		.make(125)}, FL.Smoothie_Apple			.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Apricot		.make(125)}, FL.Smoothie_Apricot		.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Banana		.make(125)}, FL.Smoothie_Banana			.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Blackberry	.make(125)}, FL.Smoothie_Blackberry		.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Blueberry		.make(125)}, FL.Smoothie_Blueberry		.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Cherry		.make(125)}, FL.Smoothie_Cherry			.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Cranberry		.make(125)}, FL.Smoothie_Cranberry		.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Currant		.make(125)}, FL.Smoothie_Currant		.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Elderberry	.make(125)}, FL.Smoothie_Elderberry		.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Gooseberry	.make(125)}, FL.Smoothie_Gooseberry		.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Grape_Red		.make(125)}, FL.Smoothie_Grape_Red		.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Grape_White	.make(125)}, FL.Smoothie_Grape_White	.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Grape_Green	.make(125)}, FL.Smoothie_Grape_Green	.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Grape_Purple	.make(125)}, FL.Smoothie_Grape_Purple	.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Grapefruit	.make(125)}, FL.Smoothie_Grapefruit		.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Kiwi			.make(125)}, FL.Smoothie_Kiwi			.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Lemon			.make(125)}, FL.Smoothie_Lemon			.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Lime			.make(125)}, FL.Smoothie_Lime			.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Melon			.make(125)}, FL.Smoothie_Melon			.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Orange		.make(125)}, FL.Smoothie_Orange			.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Persimmon		.make(125)}, FL.Smoothie_Persimmon		.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Peach			.make(125)}, FL.Smoothie_Peach			.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Pear			.make(125)}, FL.Smoothie_Pear			.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Plum			.make(125)}, FL.Smoothie_Plum			.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Raspberry		.make(125)}, FL.Smoothie_Raspberry		.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Strawberry	.make(125)}, FL.Smoothie_Strawberry		.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Mango			.make(125)}, FL.Smoothie_Mango			.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Starfruit		.make(125)}, FL.Smoothie_Starfruit		.make(250), ZL_IS);
		RM.Mixer			.addRecipe0(T, 16,	 16, new FluidStack[] {FL.Ice.make(125), FL.Juice_Fig			.make(125)}, FL.Smoothie_Fig			.make(250), ZL_IS);
