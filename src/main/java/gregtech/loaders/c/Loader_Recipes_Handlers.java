...
public class Loader_Recipes_Handlers implements Runnable {
	...
	public void run() {OUT.println("GT_Mod: Doing Recipe Map Handlers.");
		...
		RM.Mortar       .add(new RecipeMapHandlerPrefix(scrapGt                         , 1, null, 0, NF,  16, 0,    16, NF, null               , 0, null       , 0, NI, NI, T, T, F, new And(ANTIMATTER.NOT, MORTAR)));
		RM.Mortar       .add(new RecipeMapHandlerPrefix(chunkGt                         , 1, null, 0, NF,  16, 0,    16, NF, null               , 0, null       , 0, NI, NI, T, T, F, new And(ANTIMATTER.NOT, MORTAR)));
		RM.Mortar       .add(new RecipeMapHandlerPrefix(nugget                          , 1, null, 0, NF,  16, 0,    16, NF, null               , 0, null       , 0, NI, NI, T, T, F, new And(ANTIMATTER.NOT, MORTAR)));
		...
		RM.Mortar       .add(new RecipeMapHandlerPrefix(gemChipped                      , 1, null, 0, NF,  16, 0,    16, NF, null               , 0, null       , 0, NI, NI, T, T, F, new And(ANTIMATTER.NOT, MORTAR)));
		RM.Mortar       .add(new RecipeMapHandlerPrefix(gemFlawed                       , 1, null, 0, NF,  16, 0,    16, NF, null               , 0, null       , 0, NI, NI, T, T, F, new And(ANTIMATTER.NOT, MORTAR, new Or(BRITTLE, FOOD, gemChipped.NOT))));
		...
		RM.AnvilTwo     .add(new RecipeMapHandlerPrefix(ingot                           , 1, ingot          , 1, NF,  16, 0,    64, NF, ingotDouble             , 1, null       , 0, NI, NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE)));
		RM.AnvilTwo     .add(new RecipeMapHandlerPrefix(ingot                           , 1, ingotDouble    , 1, NF,  16, 0,    64, NF, ingotTriple             , 1, null       , 0, NI, NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE)));
		RM.AnvilTwo     .add(new RecipeMapHandlerPrefix(ingot                           , 1, ingotTriple    , 1, NF,  16, 0,    64, NF, ingotQuadruple          , 1, null       , 0, NI, NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE)));
		RM.AnvilTwo     .add(new RecipeMapHandlerPrefix(ingot                           , 1, ingotQuadruple , 1, NF,  16, 0,    64, NF, ingotQuintuple          , 1, null       , 0, NI, NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE)));
		RM.AnvilTwo     .add(new RecipeMapHandlerPrefix(ingotDouble                     , 1, ingotDouble    , 1, NF,  16, 0,    64, NF, ingotQuadruple          , 1, null       , 0, NI, NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE)));
		RM.AnvilTwo     .add(new RecipeMapHandlerPrefix(ingotDouble                     , 1, ingotTriple    , 1, NF,  16, 0,    64, NF, ingotQuintuple          , 1, null       , 0, NI, NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE)));
		RM.AnvilTwo     .add(new RecipeMapHandlerPrefix(plate                           , 1, plate          , 1, NF,  16, 0,    64, NF, plateDouble             , 1, null       , 0, NI, NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE)));
		RM.AnvilTwo     .add(new RecipeMapHandlerPrefix(plate                           , 1, plateDouble    , 1, NF,  16, 0,    64, NF, plateTriple             , 1, null       , 0, NI, NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE)));
		RM.AnvilTwo     .add(new RecipeMapHandlerPrefix(plate                           , 1, plateTriple    , 1, NF,  16, 0,    64, NF, plateQuadruple          , 1, null       , 0, NI, NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE)));
		RM.AnvilTwo     .add(new RecipeMapHandlerPrefix(plate                           , 1, plateQuadruple , 1, NF,  16, 0,    64, NF, plateQuintuple          , 1, null       , 0, NI, NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE)));
		RM.AnvilTwo     .add(new RecipeMapHandlerPrefix(plateDouble                     , 1, plateDouble    , 1, NF,  16, 0,    64, NF, plateQuadruple          , 1, null       , 0, NI, NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE)));
		RM.AnvilTwo     .add(new RecipeMapHandlerPrefix(plateDouble                     , 1, plateTriple    , 1, NF,  16, 0,    64, NF, plateQuintuple          , 1, null       , 0, NI, NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE)));
		RM.AnvilTwo     .add(new RecipeMapHandlerPrefix(stick                           , 1, stick          , 1, NF,  16, 0,    64, NF, stickLong               , 1, null       , 0, NI, NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE)));
		
		RM.AnvilOne     .add(new RecipeMapHandlerPrefix(chunkGt                                             , 1, NF,  16, 0,    64, NF, plateTiny                               , 1, NI, NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE)));
		RM.AnvilOne     .add(new RecipeMapHandlerPrefix(ingotDouble                                         , 1, NF,  16, 0,    64, NF, plate                                   , 1, NI, NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE)));
		RM.AnvilOne     .add(new RecipeMapHandlerPrefix(ingotTriple                                         , 1, NF,  16, 0,    64, NF, plateDouble                             , 1, NI, NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE)));
		...
		FluidStack[] tFluids = new FluidStack[] {FL.Water.make(1000), FL.DistW.make(1000), FL.Lubricant.make(1000), FL.LubRoCant.make(1000)};
		...
		RM.Generifier   .add(new RecipeMapHandlerMaterial(MT.Diamantine             , NF                                ,   0,   1, NF, MT.Diamond              , NI, T, tConditionP));
