...
public class Loader_Recipes_Handlers implements Runnable {
	...
	public void run() {
		...
		RM.Anvil                .add(new RecipeMapHandlerPrefixShredding(chunk                  , 1, null, 0, NF,  16, 0,    16, NF, dust               , 2, dustTiny   , 1, NI, NI, T, F, F, new And(ANTIMATTER.NOT, MORTAR)));
		RM.Anvil                .add(new RecipeMapHandlerPrefixShredding(rubble                 , 1, null, 0, NF,  16, 0,    16, NF, dust               , 2, dustTiny   , 1, NI, NI, T, F, F, new And(ANTIMATTER.NOT, MORTAR)));
		RM.Anvil                .add(new RecipeMapHandlerPrefixShredding(pebbles                , 1, null, 0, NF,  16, 0,    16, NF, dust               , 2, dustTiny   , 1, NI, NI, T, F, F, new And(ANTIMATTER.NOT, MORTAR)));
		RM.Anvil                .add(new RecipeMapHandlerPrefixShredding(clump                  , 1, null, 0, NF,  16, 0,    16, NF, dust               , 1, null       , 0, NI, NI, T, F, F, new And(ANTIMATTER.NOT, MORTAR)));
		RM.Anvil                .add(new RecipeMapHandlerPrefixShredding(reduced                , 1, null, 0, NF,  16, 0,    16, NF, dust               , 1, null       , 0, NI, NI, T, F, F, new And(ANTIMATTER.NOT, MORTAR)));
		RM.Anvil                .add(new RecipeMapHandlerPrefixShredding(crystalline            , 1, null, 0, NF,  16, 0,    16, NF, dust               , 1, null       , 0, NI, NI, T, F, F, new And(ANTIMATTER.NOT, MORTAR)));
		RM.Anvil                .add(new RecipeMapHandlerPrefixShredding(cleanGravel            , 1, null, 0, NF,  16, 0,    16, NF, dust               , 1, null       , 0, NI, NI, T, F, F, new And(ANTIMATTER.NOT, MORTAR)));
		RM.Anvil                .add(new RecipeMapHandlerPrefixShredding(cluster                , 1, null, 0, NF,  16, 0,    16, NF, dust               , 2, dustTiny   , 1, NI, NI, T, F, F, new And(ANTIMATTER.NOT, MORTAR)));
		RM.Anvil                .add(new RecipeMapHandlerPrefixShredding(crushed                , 1, null, 0, NF,  16, 0,    16, NF, dust               , 1, dustDiv72  , 9, NI, NI, T, F, F, new And(ANTIMATTER.NOT, MORTAR)));
		RM.Anvil                .add(new RecipeMapHandlerPrefixShredding(crushedPurified        , 1, null, 0, NF,  16, 0,    16, NF, dust               , 1, dustDiv72  ,18, NI, NI, T, F, F, new And(ANTIMATTER.NOT, MORTAR)));
		RM.Anvil                .add(new RecipeMapHandlerPrefixShredding(crushedCentrifuged     , 1, null, 0, NF,  16, 0,    16, NF, dust               , 1, dustDiv72  ,27, NI, NI, T, F, F, new And(ANTIMATTER.NOT, MORTAR)));
		RM.Anvil                .add(new RecipeMapHandlerPrefixShredding(crushedTiny            , 1, null, 0, NF,  16, 0,    16, NF, dustDiv72          , 9, null       , 0, NI, NI, T, F, F, new And(ANTIMATTER.NOT, MORTAR)));
		RM.Anvil                .add(new RecipeMapHandlerPrefixShredding(crushedPurifiedTiny    , 1, null, 0, NF,  16, 0,    16, NF, dustDiv72          ,10, null       , 0, NI, NI, T, F, F, new And(ANTIMATTER.NOT, MORTAR)));
		RM.Anvil                .add(new RecipeMapHandlerPrefixShredding(crushedCentrifugedTiny , 1, null, 0, NF,  16, 0,    16, NF, dustDiv72          ,11, null       , 0, NI, NI, T, F, F, new And(ANTIMATTER.NOT, MORTAR)));
