...
public class Loader_Recipes_Handlers implements Runnable {
	...
	public void run() {OUT.println("GT_Mod: Doing Recipe Map Handlers.");
		...
		RM.Anvil                .add(new RecipeMapHandlerPrefix(chunkGt                                             , 1, NF,  64, 0,    64, NF, plateTiny                               , 1, ST.emptySlot(), NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE, COATED.NOT)));
		RM.Anvil                .add(new RecipeMapHandlerPrefix(ingotDouble                                         , 1, NF,  64, 0,    64, NF, plate                                   , 1, ST.emptySlot(), NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE, COATED.NOT)));
		RM.Anvil                .add(new RecipeMapHandlerPrefix(ingotTriple                                         , 1, NF,  64, 0,    64, NF, plateDouble                             , 1, ST.emptySlot(), NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE, COATED.NOT)));
		RM.Anvil                .add(new RecipeMapHandlerPrefix(ingotQuadruple                                      , 1, NF,  64, 0,    64, NF, plateTriple                             , 1, ST.emptySlot(), NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE, COATED.NOT)));
		RM.Anvil                .add(new RecipeMapHandlerPrefix(ingotQuintuple                                      , 1, NF,  64, 0,    64, NF, plateQuadruple                          , 1, ST.emptySlot(), NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE, COATED.NOT)));
		RM.Anvil                .add(new RecipeMapHandlerPrefix(plateCurved                                         , 1, NF,  64, 0,    64, NF, plate                                   , 1, ST.emptySlot(), NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE, COATED.NOT)));
		RM.Anvil                .add(new RecipeMapHandlerPrefix(plate                                               , 1, NF,  64, 0,    64, NF, casingSmall                             , 1, ST.emptySlot(), NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE, COATED.NOT)));
		RM.Anvil                .add(new RecipeMapHandlerPrefix(gemLegendary                                        , 1, NF,  64, 0,    64, NF, gemExquisite                            , 2, ST.emptySlot(), NI, T, F, F, new And(ANTIMATTER.NOT)));
		RM.Anvil                .add(new RecipeMapHandlerPrefix(gemExquisite                                        , 1, NF,  64, 0,    64, NF, gemFlawless                             , 2, ST.emptySlot(), NI, T, F, F, new And(ANTIMATTER.NOT)));
		RM.Anvil                .add(new RecipeMapHandlerPrefix(gemFlawless                                         , 1, NF,  64, 0,    64, NF, gem                                     , 2, ST.emptySlot(), NI, T, F, F, new And(ANTIMATTER.NOT)));
		RM.Anvil                .add(new RecipeMapHandlerPrefix(gem                                                 , 1, NF,  64, 0,    64, NF, gemFlawed                               , 2, ST.emptySlot(), NI, T, F, F, new And(ANTIMATTER.NOT)));
		RM.Anvil                .add(new RecipeMapHandlerPrefix(gemFlawed                                           , 1, NF,  64, 0,    64, NF, gemChipped                              , 2, ST.emptySlot(), NI, T, F, F, new And(ANTIMATTER.NOT)));
		...
		RM.AnvilBendSmall       .add(new RecipeMapHandlerPrefix(stick                                               , 1, NF,  64, 0,    64, NF, springSmall                             , 1, ST.emptySlot(), NI, T, F, F, new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE)));
