...
public class Loader_Recipes_Forestry implements Runnable {
	@Override
	public void run() {if (MD.FR.mLoaded) {OUT.println("GT_Mod: Doing Forestry Recipes.");
		...
		RM.Printer.addRecipe2(F, 16, 16, OP.plateTiny.mat(MT.Paper, 1)  , OP.plateGemTiny.mat(MT.Diamond        , 1), FL.Glue.make( 25), NF, ST.make(MD.FR, "stamps", 1, 4));
		}
