...
//      RM.Mixer        .addRecipe1(T, 16,   96, OM.dust(MT.FeS                 ,U * 2), MT.HCl         .fluid(U * 4, T)                                                            , MT.H2S            .gas  (U * 3, F), OM.dust(MT.FeCl2, U*3));
		...
		RM.DistillationTower.addRecipe0(F, 64,  16                           , new FluidStack[] {FL.Biomass       .make( 80)}, new FluidStack[] {FL.BioEthanol.make(12), MT.Glycerol.liquid(U50, F), FL.Methane.make(4), FL.DistW.make(40)}, ZL_IS);
		RM.DistillationTower.addRecipe0(F, 64,  16                           , new FluidStack[] {FL.BiomassIC2    .make( 80)}, new FluidStack[] {FL.BioEthanol.make(12), MT.Glycerol.liquid(U50, F), FL.Methane.make(4), FL.DistW.make(40)}, ZL_IS);
