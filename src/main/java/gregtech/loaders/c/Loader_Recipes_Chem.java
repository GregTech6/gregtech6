...
//      RM.Mixer        .addRecipe1(T, 16,  144, OM.dust(MT.MgCO3               ,U * 5), new FluidStack[] {MT.HF.gas(U * 4, T)}                                                     , new FluidStack[] {MT.H2O.liquid(U * 3, F), MT.CO2.gas(U * 3, F)}, OM.dust(MT.MgF2, U*3));
		...
		RM.Mixer        .addRecipe1(T, 16,  160, OM.dust(MT.CaF2                ,U * 3), MT.H2SO4       .liquid(U* 7, T)                                                            , MT.HF             .gas  (U * 4, F), OM.dust(MT.CaSO4, U* 6));
...
//      RM.Mixer        .addRecipe1(T, 16,   96, OM.dust(MT.FeS                 ,U * 2), MT.HCl         .fluid(U * 4, T)                                                            , MT.H2S            .gas  (U * 3, F), OM.dust(MT.FeCl2, U*3));
		...
		RM.Mixer        .addRecipe0(T, 16,  176, new FluidStack[] {MT.SO3.gas(U*4, T), MT.H2SO4.liquid(U*7, T)}                                                                     , MT.H2S2O7         .liquid(U*11, F), ZL_IS);
		...
		RM.Autoclave    .addRecipe2(T,  0, 1500, new long[] {10000, 5000, 5000}, OP.dust        .mat(MT.OREMATS.Bauxite, 1), OP.dustSmall   .mat(MT.KOH , 6), FL.Steam.make(48000), FL.DistW.make(3225), OP.dust.mat(MT.KAlO2 , 2), OP.crushedCentrifugedTiny.mat(MT.OREMATS.Ilmenite, 2), OP.crushedCentrifugedTiny.mat(MT.TiO2, 1));
		RM.Autoclave    .addRecipe2(T,  0, 1500, new long[] {10000, 5000, 5000}, OP.dustSmall   .mat(MT.OREMATS.Bauxite, 4), OP.dustSmall   .mat(MT.KOH , 6), FL.Steam.make(48000), FL.DistW.make(3225), OP.dust.mat(MT.KAlO2 , 2), OP.crushedCentrifugedTiny.mat(MT.OREMATS.Ilmenite, 2), OP.crushedCentrifugedTiny.mat(MT.TiO2, 1));
		RM.Autoclave    .addRecipe2(T,  0, 1500, new long[] {10000, 5000, 5000}, OP.dustTiny    .mat(MT.OREMATS.Bauxite, 9), OP.dustSmall   .mat(MT.KOH , 6), FL.Steam.make(48000), FL.DistW.make(3225), OP.dust.mat(MT.KAlO2 , 2), OP.crushedCentrifugedTiny.mat(MT.OREMATS.Ilmenite, 2), OP.crushedCentrifugedTiny.mat(MT.TiO2, 1));
		RM.Autoclave    .addRecipe2(T,  0, 3000, new long[] {10000, 5000, 5000}, OP.dust        .mat(MT.OREMATS.Bauxite, 2), OP.dust        .mat(MT.KOH , 3), FL.Steam.make(96000), FL.DistW.make(6450), OP.dust.mat(MT.KAlO2 , 4), OP.crushedCentrifugedTiny.mat(MT.OREMATS.Ilmenite, 4), OP.crushedCentrifugedTiny.mat(MT.TiO2, 2));
		RM.Autoclave    .addRecipe2(T,  0, 3000, new long[] {10000, 5000, 5000}, OP.dustSmall   .mat(MT.OREMATS.Bauxite, 8), OP.dust        .mat(MT.KOH , 3), FL.Steam.make(96000), FL.DistW.make(6450), OP.dust.mat(MT.KAlO2 , 4), OP.crushedCentrifugedTiny.mat(MT.OREMATS.Ilmenite, 4), OP.crushedCentrifugedTiny.mat(MT.TiO2, 2));
		RM.Autoclave    .addRecipe2(T,  0, 3000, new long[] {10000, 5000, 5000}, OP.dustTiny    .mat(MT.OREMATS.Bauxite,18), OP.dust        .mat(MT.KOH , 3), FL.Steam.make(96000), FL.DistW.make(6450), OP.dust.mat(MT.KAlO2 , 4), OP.crushedCentrifugedTiny.mat(MT.OREMATS.Ilmenite, 4), OP.crushedCentrifugedTiny.mat(MT.TiO2, 2));
		RM.Autoclave    .addRecipe2(T,  0, 1500, new long[] {10000, 5000, 5000}, OP.dust        .mat(MT.OREMATS.Bauxite, 1), OP.dustSmall   .mat(MT.NaOH, 6), FL.Steam.make(48000), FL.DistW.make(3225), OP.dust.mat(MT.NaAlO2, 2), OP.crushedCentrifugedTiny.mat(MT.OREMATS.Ilmenite, 2), OP.crushedCentrifugedTiny.mat(MT.TiO2, 1));
		RM.Autoclave    .addRecipe2(T,  0, 1500, new long[] {10000, 5000, 5000}, OP.dustSmall   .mat(MT.OREMATS.Bauxite, 4), OP.dustSmall   .mat(MT.NaOH, 6), FL.Steam.make(48000), FL.DistW.make(3225), OP.dust.mat(MT.NaAlO2, 2), OP.crushedCentrifugedTiny.mat(MT.OREMATS.Ilmenite, 2), OP.crushedCentrifugedTiny.mat(MT.TiO2, 1));
		RM.Autoclave    .addRecipe2(T,  0, 1500, new long[] {10000, 5000, 5000}, OP.dustTiny    .mat(MT.OREMATS.Bauxite, 9), OP.dustSmall   .mat(MT.NaOH, 6), FL.Steam.make(48000), FL.DistW.make(3225), OP.dust.mat(MT.NaAlO2, 2), OP.crushedCentrifugedTiny.mat(MT.OREMATS.Ilmenite, 2), OP.crushedCentrifugedTiny.mat(MT.TiO2, 1));
		RM.Autoclave    .addRecipe2(T,  0, 3000, new long[] {10000, 5000, 5000}, OP.dust        .mat(MT.OREMATS.Bauxite, 2), OP.dust        .mat(MT.NaOH, 3), FL.Steam.make(96000), FL.DistW.make(6450), OP.dust.mat(MT.NaAlO2, 4), OP.crushedCentrifugedTiny.mat(MT.OREMATS.Ilmenite, 4), OP.crushedCentrifugedTiny.mat(MT.TiO2, 2));
		RM.Autoclave    .addRecipe2(T,  0, 3000, new long[] {10000, 5000, 5000}, OP.dustSmall   .mat(MT.OREMATS.Bauxite, 8), OP.dust        .mat(MT.NaOH, 3), FL.Steam.make(96000), FL.DistW.make(6450), OP.dust.mat(MT.NaAlO2, 4), OP.crushedCentrifugedTiny.mat(MT.OREMATS.Ilmenite, 4), OP.crushedCentrifugedTiny.mat(MT.TiO2, 2));
		RM.Autoclave    .addRecipe2(T,  0, 3000, new long[] {10000, 5000, 5000}, OP.dustTiny    .mat(MT.OREMATS.Bauxite,18), OP.dust        .mat(MT.NaOH, 3), FL.Steam.make(96000), FL.DistW.make(6450), OP.dust.mat(MT.NaAlO2, 4), OP.crushedCentrifugedTiny.mat(MT.OREMATS.Ilmenite, 4), OP.crushedCentrifugedTiny.mat(MT.TiO2, 2));
		...
		RM.DistillationTower.addRecipe0(F, 64,  16                         , new FluidStack[] {FL.Biomass       .make( 80)}, new FluidStack[] {FL.BioEthanol.make(20), MT.Glycerol.liquid(U50, F), FL.Methane.make(4), FL.DistW.make(50)}, ZL_IS);
		RM.DistillationTower.addRecipe0(F, 64,  16                         , new FluidStack[] {FL.BiomassIC2    .make( 80)}, new FluidStack[] {FL.BioEthanol.make(20), MT.Glycerol.liquid(U50, F), FL.Methane.make(4), FL.DistW.make(50)}, ZL_IS);
		RM.DistillationTower.addRecipe0(F, 64, 512, new long[] {9000, 9000}, new FluidStack[] {FL.Oil_ExtraHeavy.make( 50)}, new FluidStack[] {FL.Fuel.make(70), FL.Diesel.make(45), FL.Kerosine.make(40), FL.Petrol.make(35), FL.Propane.make(10), FL.Butane.make(10), FL.lube(100)}, dustTiny.mat(MT.WaxParaffin, 1), dustTiny.mat(MT.Asphalt, 1));
		RM.DistillationTower.addRecipe0(F, 64, 384, new long[] {7000, 7000}, new FluidStack[] {FL.Oil_Heavy     .make( 50)}, new FluidStack[] {FL.Fuel.make(60), FL.Diesel.make(35), FL.Kerosine.make(35), FL.Petrol.make(30), FL.Propane.make(15), FL.Butane.make(15), FL.lube( 80)}, dustTiny.mat(MT.WaxParaffin, 1), dustTiny.mat(MT.Asphalt, 1)); if (FL.Oil_Heavy2.exists())
		RM.DistillationTower.addRecipe0(F, 64, 384, new long[] {7000, 7000}, new FluidStack[] {FL.Oil_Heavy2    .make( 50)}, new FluidStack[] {FL.Fuel.make(60), FL.Diesel.make(35), FL.Kerosine.make(35), FL.Petrol.make(30), FL.Propane.make(15), FL.Butane.make(15), FL.lube( 80)}, dustTiny.mat(MT.WaxParaffin, 1), dustTiny.mat(MT.Asphalt, 1));
		RM.DistillationTower.addRecipe0(F, 64, 256, new long[] {5000, 5000}, new FluidStack[] {FL.Oil_Medium    .make( 50)}, new FluidStack[] {FL.Fuel.make(50), FL.Diesel.make(25), FL.Kerosine.make(25), FL.Petrol.make(25), FL.Propane.make(25), FL.Butane.make(25), FL.lube( 50)}, dustTiny.mat(MT.WaxParaffin, 1), dustTiny.mat(MT.Asphalt, 1));
		RM.DistillationTower.addRecipe0(F, 64, 256, new long[] {5000, 5000}, new FluidStack[] {FL.Oil_Normal    .make( 50)}, new FluidStack[] {FL.Fuel.make(50), FL.Diesel.make(25), FL.Kerosine.make(25), FL.Petrol.make(25), FL.Propane.make(25), FL.Butane.make(25), FL.lube( 50)}, dustTiny.mat(MT.WaxParaffin, 1), dustTiny.mat(MT.Asphalt, 1)); if (FL.Oil_HotCrude.exists())
		RM.DistillationTower.addRecipe0(F, 64, 128, new long[] {5000, 5000}, new FluidStack[] {FL.Oil_HotCrude  .make( 50)}, new FluidStack[] {FL.Fuel.make(50), FL.Diesel.make(25), FL.Kerosine.make(25), FL.Petrol.make(25), FL.Propane.make(25), FL.Butane.make(25), FL.lube( 50)}, dustTiny.mat(MT.WaxParaffin, 1), dustTiny.mat(MT.Asphalt, 1));
		RM.DistillationTower.addRecipe0(F, 64, 128, new long[] {3000, 3000}, new FluidStack[] {FL.Oil_Light     .make( 50)}, new FluidStack[] {FL.Fuel.make(25), FL.Diesel.make(15), FL.Kerosine.make(15), FL.Petrol.make(15), FL.Propane.make(50), FL.Butane.make(50), FL.lube( 25)}, dustTiny.mat(MT.WaxParaffin, 1), dustTiny.mat(MT.Asphalt, 1)); if (FL.Oil_Light2.exists())
		RM.DistillationTower.addRecipe0(F, 64, 128, new long[] {3000, 3000}, new FluidStack[] {FL.Oil_Light2    .make( 50)}, new FluidStack[] {FL.Fuel.make(25), FL.Diesel.make(15), FL.Kerosine.make(15), FL.Petrol.make(15), FL.Propane.make(50), FL.Butane.make(50), FL.lube( 25)}, dustTiny.mat(MT.WaxParaffin, 1), dustTiny.mat(MT.Asphalt, 1));
		RM.DistillationTower.addRecipe0(F, 64, 128, new long[] {2000, 2000}, new FluidStack[] {FL.Oil_Soulsand  .make( 50)}, new FluidStack[] {FL.Fuel.make(20), FL.Diesel.make(10), FL.Kerosine.make(10), FL.Petrol.make(10), FL.Propane.make(10), FL.Butane.make(10), FL.lube( 80)}, dustTiny.mat(MT.WaxParaffin, 1), dustTiny.mat(MT.Asphalt, 1));
		...
		RM.CatalyticCracking.addRecipe1(F, 16,  64, OP.dust.mat(MT.Pt, 0), new FluidStack[] {FL.Hydrogen.make(100), FL.Petrol.make(100)}, new FluidStack[] {FL.Ethylene.make(30), FL.Propylene.make(20)}, ZL_IS); // TODO proper Ratios
		RM.CatalyticCracking.addRecipe1(F, 16,  64, OP.dust.mat(MT.Pt, 0), new FluidStack[] {FL.Hydrogen.make(100), FL.Fuel  .make(100)}, new FluidStack[] {FL.Ethylene.make(40), FL.Propylene.make(10)}, ZL_IS); // TODO proper Ratios
		
		
		RM.Mixer            .addRecipe1(T, 16,  16, OP.dust.mat(MT.MgCl2, 0), new FluidStack[] {MT.TiCl4.liquid(U1000, T), FL.Ethylene .make(100)}, ZL_FS, OP.dust.mat(MT.Plastic, 1)); // TODO Fluidized Bed Reactor
