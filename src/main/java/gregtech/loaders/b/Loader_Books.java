...
public class Loader_Books implements Runnable {
	...
	public void run() {
		...
		, "Dark Tower¶===================¶..."
		, "Dark Tower¶===================¶..."
		, "Dark Tower¶===================¶The Ur-Ghast Trophy you get can be used to produce LU through a Magic Field Absorber. The Fiery Tears can be used the same as the Fiery Blood of the Hydra."
		, "Yeti Cave¶===================¶..."
		, "Yeti Cave¶===================¶..."
		, "Yeti Cave¶===================¶..."
		, "Aurora Tower¶===================¶..."
