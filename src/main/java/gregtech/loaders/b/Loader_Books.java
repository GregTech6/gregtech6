...
public class Loader_Books implements Runnable {
	...
	public void run() {
		...
		, "Yeti Cave¶===================¶The Yetis drop Fur which can be used for Armors, or you just take a Knife to the Crafting Grid and remove the Fur to make Leather out of it instead. The Ice Bombs can be fun to throw around too."
		...
		, "Aurora Tower¶===================¶The Snow Queen Trophy you get can be used to produce CU through a Magic Field Absorber. She drops a Tri-Bow or a Seeker-Bow, both of which are fun Weapons. The Ender-Bow and the Ice-Bow are from Loot Chests."
