...
public class Loader_Books implements Runnable {
	...
	public void run() {
		...
		, "This should conclude all the Stuff about Twilight Forest that seem noteworthy, aswell as most of the changes I made to improve the gameplay and add variety.¶¶Have Fun! ^^"
		});
