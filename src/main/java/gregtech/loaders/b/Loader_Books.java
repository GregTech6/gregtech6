...
public class Loader_Books implements Runnable {
	...
	public void run() {
		...
		, "Minoshroom Maze¶===================¶..."
		, "Minoshroom Vault¶===================¶..."
		, "Minoshroom Vault¶===================¶... (The Vault Room on the lower Levels is trapped, try digging at Floor Level and with an Autocollecting Pickaxe to avoid the Wooden Pressure Plates triggering the TNT)"
		, "Hydra Cave¶===================¶..."
		, "Hydra Cave¶===================¶..."
		, "Hydra Cave¶===================¶... (Hydra has a high damage bite attack instant killing you if you dont wear protection enchanted Armor)"
		, "Hydra Cave¶===================¶... (Hydra is immune to Long Range Damage)"
		, "Hydra Cave¶===================¶The Hydra Trophy you get can be used to produce HU through a Magic Field Absorber."
		, "Knight Stronghold¶===================¶..."
		, "Knight Stronghold¶===================¶..."
		, "Knight Stronghold¶===================¶..."
		, "Knight Stronghold¶===================¶... (There can be multiple Phantom Rooms in a Stronghold)"
		, "Knight Stronghold¶===================¶... (Do not place anything in the very middle of the Grave Room, the Loot Chest wont spawn!)"
		, "Dark Tower¶===================¶..."
		, "Dark Tower¶===================¶..."
		, "Dark Tower¶===================¶The Ur-Ghast Trophy you get can be used to produce LU through a Magic Field Absorber."
		, "Yeti Cave¶===================¶..."
		, "Yeti Cave¶===================¶..."
		, "Yeti Cave¶===================¶..."
		, "Aurora Tower¶===================¶..."
		, "Aurora Tower¶===================¶..."
		, "Aurora Tower¶===================¶The Snow Queen Trophy you get can be used to produce CU through a Magic Field Absorber."
		, "Troll Caves¶===================¶..."
		, "Troll Caves¶===================¶..."
		, "Troll Caves¶===================¶..."
		, "Cloud Giants¶===================¶..."
		...
		, "Thorn Castle¶===================¶With the Lamp of Cinders you can either burn the Thorns or use it as an infinite Lighter. The Castle itself is unfinished, so there is not much to do there. There is likely Ancient Debris below the Castle."
		});
