...
public class Loader_Worldgen implements Runnable {
	@Override
	public void run() {
		boolean tInfiniteOil = ConfigsGT.WORLDGEN.get(ConfigCategories.general, "GenerateInfiniteOilSources", T);
		...
		, new StoneLayerOres(MT.Zr                      , U64,  0, 32)
		);
		...
		new WorldgenPit             ("pit.clay.vanilla" , T, Blocks.clay        , 0, 1, 256, GEN_OVERWORLD, GEN_GT, GEN_PFAA);
		new WorldgenPit             ("pit.clay.brown"   , T, BlocksGT.Diggables , 1, 3, 256, GEN_OVERWORLD, GEN_GT, GEN_PFAA);
		
		new WorldgenBlackSand       ("river.magnetite"  , T, GEN_OVERWORLD, GEN_GT, GEN_PFAA);
		
		new WorldgenLogDry          ("log.dry"          , T, GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_TWILIGHT, GEN_EREBUS);
		new WorldgenLogRotten       ("log.rotten"       , T, GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_TWILIGHT, GEN_EREBUS);
		new WorldgenLogMossy        ("log.mossy"        , T, GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_TWILIGHT, GEN_EREBUS);
		...
		new WorldgenTreeHazel       ("tree.hazel"       , T, GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_TWILIGHT, GEN_EREBUS);
		new WorldgenTreeCinnamon    ("tree.cinnamon"    , T, GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_TWILIGHT, GEN_EREBUS);
		new WorldgenTreeRainbowood  ("tree.rainbowood"  , T, GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_TWILIGHT, GEN_EREBUS, GEN_AETHER);
		...
		new WorldgenSticks          ("sticks"           , T, GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_AETHER, GEN_ENVM);
		
		new WorldgenGlowtus         ("plant.glowtus"    , T, GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_TWILIGHT, GEN_EREBUS);
		new WorldgenBushes          ("plant.bush"       , T, GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_TWILIGHT, GEN_EREBUS);
		...
		new WorldgenFluidSpring ("overworld.fluid.oil.medium"       , T, BlocksGT.OilMedium     ,  7,  1, 70,200,   0,  16, null, F, tInfiniteOil ? UT.Fluids.make("liquid_medium_oil"      , 24000) : NF, 10, GEN_OVERWORLD, GEN_GT, GEN_PFAA);
		new WorldgenFluidSpring ("overworld.fluid.oil.light"        , T, BlocksGT.OilLight      ,  7,  1, 80,100,   0,  16, null, F, tInfiniteOil ? UT.Fluids.make("liquid_light_oil"       , 24000) : NF, 10, GEN_OVERWORLD, GEN_GT, GEN_PFAA);
		...
		new WorldgenOresSmall("ore.small.cassiterite"       , T,  60, 120,  16, MT.OREMATS.Cassiterite          , GEN_OVERWORLD, GEN_GT, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_NETHER, GEN_END);
		new WorldgenOresSmall("ore.small.copper"            , T,  60, 120,  16, MT.Cu                           , GEN_OVERWORLD, GEN_GT, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_NETHER, GEN_ASTEROIDS, GEN_MOON, GEN_PLANETS, GEN_END);
		new WorldgenOresSmall("ore.small.tin"               , T,  60, 120,  16, MT.Sn                           , GEN_OVERWORLD, GEN_GT, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_NETHER, GEN_ASTEROIDS, GEN_MOON, GEN_PLANETS, GEN_END);
		new WorldgenOresSmall("ore.small.bismuth"           , T,  80, 120,   8, MT.Bi                           , GEN_OVERWORLD, GEN_GT, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_NETHER, GEN_ASTEROIDS, GEN_MOON, GEN_PLANETS);
		...
		new WorldgenOresSmall("ore.small.hematite"          , T,  40,  80,  24, MT.Fe2O3                        , GEN_OVERWORLD, GEN_GT, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_NETHER, GEN_END);
		new WorldgenOresSmall("ore.small.salt"              , T,  40,  80,   6, MT.NaCl                         , GEN_OVERWORLD, GEN_GT, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_NETHER, GEN_END, GEN_PFAA);
		new WorldgenOresSmall("ore.small.rocksalt"          , T,  40,  80,   6, MT.KCl                          , GEN_OVERWORLD, GEN_GT, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_NETHER, GEN_END, GEN_PFAA);
		...
		new WorldgenOresSmall("ore.small.zinc"              , T,  40,  70,   4, MT.Zn                           , GEN_OVERWORLD, GEN_GT, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_NETHER, GEN_END, GEN_ASTEROIDS, GEN_MOON, GEN_PLANETS);
		new WorldgenOresSmall("ore.small.smithsonite"       , T,  30,  60,   2, MT.OREMATS.Smithsonite          , GEN_OVERWORLD, GEN_GT, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_NETHER, GEN_END);
		new WorldgenOresSmall("ore.small.galena"            , T,  40,  80,   8, MT.OREMATS.Galena               , GEN_OVERWORLD, GEN_GT, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_MARS, GEN_NETHER, GEN_END);
		new WorldgenOresSmall("ore.small.lead"              , T,  40,  80,   8, MT.Pb                           , GEN_OVERWORLD, GEN_GT, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_NETHER, GEN_END, GEN_ASTEROIDS, GEN_MOON, GEN_PLANETS);
		new WorldgenOresSmall("ore.small.gold"              , T,  20,  40,   4, MT.Au                           , GEN_OVERWORLD, GEN_GT, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_NETHER, GEN_END, GEN_ASTEROIDS, GEN_MOON, GEN_PLANETS);
		...
		new WorldgenOresSmall("ore.small.silver"            , T,  20,  40,   4, MT.Ag                           , GEN_OVERWORLD, GEN_GT, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_NETHER, GEN_END, GEN_ASTEROIDS, GEN_MOON, GEN_PLANETS);
		new WorldgenOresSmall("ore.small.pyrolusite"        , T,  20,  40,   4, MT.MnO2                         , GEN_OVERWORLD, GEN_GT, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_NETHER, GEN_END, GEN_MOON, GEN_PLANETS);
		new WorldgenOresSmall("ore.small.garnierite"        , T,  20,  40,   4, MT.OREMATS.Garnierite           , GEN_OVERWORLD, GEN_GT, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_NETHER, GEN_END);
		...
		new WorldgenOresSmall("ore.small.lapis"             , T,  20,  40,   4, MT.Lapis                        , GEN_OVERWORLD, GEN_GT, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER);
		new WorldgenOresSmall("ore.small.redstone"          , T,   5,  20,   8, MT.Redstone                     , GEN_OVERWORLD, GEN_GT, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_PFAA, GEN_MARS, GEN_PLANETS, GEN_NETHER);
		new WorldgenOresSmall("ore.small.graphite"          , T,   5,  10,   2, MT.Graphite                     , GEN_OVERWORLD, GEN_GT, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_PFAA, GEN_MARS, GEN_PLANETS, GEN_ASTEROIDS, GEN_NETHER);
		new WorldgenOresSmall("ore.small.scheelite"         , T,   5,  50,   1, MT.OREMATS.Scheelite            , GEN_OVERWORLD, GEN_GT, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_PFAA, GEN_MARS, GEN_PLANETS, GEN_ASTEROIDS, GEN_MOON, GEN_END);
		...
		new WorldgenOresSmall("ore.small.craponite"         , T,   5, 250,   1, MT.Craponite                    , GEN_OVERWORLD, GEN_GT, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_PFAA, GEN_MARS, GEN_ASTEROIDS, GEN_MOON, GEN_PLANETS, GEN_END);
		...
		new WorldgenOresSmall("ore.small.platinum"          , T,  20,  40,   6, MT.Pt                           , GEN_END, GEN_ASTEROIDS, GEN_AETHER);
		new WorldgenOresSmall("ore.small.iridium"           , T,  20,  40,   6, MT.Ir                           , GEN_END, GEN_ASTEROIDS, GEN_AETHER);
		...
		new WorldgenOresSmall("ore.small.certus"            , MD.AE     .mLoaded,  20,  40,   1, MT.CertusQuartz        , GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_PLANETS, GEN_ASTEROIDS, GEN_MOON);
		new WorldgenOresSmall("ore.small.vinteum"           , MD.ARS    .mLoaded,  30,  60,   8, MT.Vinteum             , GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_PLANETS);
		new WorldgenOresSmall("ore.small.perdito"           , MD.TC     .mLoaded,  10,  60,   8, MT.InfusedEntropy      , GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_PLANETS, GEN_NETHER, GEN_END);
		new WorldgenOresSmall("ore.small.ignis"             , MD.TC     .mLoaded,  10,  60,   8, MT.InfusedFire         , GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_PLANETS, GEN_NETHER, GEN_END);
		new WorldgenOresSmall("ore.small.aer"               , MD.TC     .mLoaded,  10,  60,   8, MT.InfusedAir          , GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_PLANETS, GEN_NETHER, GEN_END);
		new WorldgenOresSmall("ore.small.aqua"              , MD.TC     .mLoaded,  10,  60,   8, MT.InfusedWater        , GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_PLANETS, GEN_NETHER, GEN_END);
		new WorldgenOresSmall("ore.small.terra"             , MD.TC     .mLoaded,  10,  60,   8, MT.InfusedEarth        , GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_PLANETS, GEN_NETHER, GEN_END);
		new WorldgenOresSmall("ore.small.ordo"              , MD.TC     .mLoaded,  10,  60,   8, MT.InfusedOrder        , GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_PLANETS, GEN_NETHER, GEN_END);
		new WorldgenOresSmall("ore.small.nikolite"          , MD.RP     .mLoaded,  10,  40,   4, MT.Nikolite            , GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_PLANETS, GEN_NETHER, GEN_END);
		new WorldgenOresSmall("ore.small.teslatite"         , MD.BP     .mLoaded,  10,  40,   4, MT.Teslatite           , GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_PLANETS, GEN_NETHER, GEN_END);
		new WorldgenOresSmall("ore.small.electrotine"       , MD.PR     .mLoaded,  10,  40,   4, MT.Electrotine         , GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_ENVM, GEN_TWILIGHT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM, GEN_AETHER, GEN_MARS, GEN_PLANETS, GEN_NETHER, GEN_END);
		...
		new WorldgenOresLarge("ore.large.pitchblende"       , T, T,  10,  40,     40,   3,  16, MT.OREMATS.Pitchblende      , MT.OREMATS.Pitchblende    , MT.U_238                          , MT.OREMATS.Uraninite              , ORE_OVERWORLD, ORE_TWILIGHT, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_MARS, GEN_PLANETS);
		new WorldgenOresLarge("ore.large.monazite"          , T, T,  20,  40,     30,   3,  16, MT.OREMATS.Bastnasite       , MT.OREMATS.Bastnasite     , MT.Monazite                       , MT.Nd                             , ORE_OVERWORLD, ORE_TWILIGHT, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_MARS, GEN_PLANETS);
		new WorldgenOresLarge("ore.large.diamond"           , T, T,   5,  20,     40,   2,  16, MT.Graphite                 , MT.Graphite               , MT.Diamond                        , MT.Graphite                       , ORE_OVERWORLD, ORE_TWILIGHT, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_MARS, GEN_PLANETS);
		new WorldgenOresLarge("ore.large.galena"            , T, T,  30,  60,     40,   5,  16, MT.OREMATS.Galena           , MT.OREMATS.Galena         , MT.Ag                             , MT.Pb                             , ORE_OVERWORLD, ORE_TWILIGHT, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_MARS, GEN_PLANETS);
		new WorldgenOresLarge("ore.large.quartz"            , T, T,  40,  80,     60,   3,  16, MT.Quartzite                , MT.OREMATS.Barite         , MT.CertusQuartz                   , MT.CertusQuartz                   , ORE_OVERWORLD, ORE_TWILIGHT, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_MARS, GEN_PLANETS, ORE_MOON, ORE_ASTEROIDS);
		new WorldgenOresLarge("ore.large.olivine"           , T, T,  10,  40,     60,   3,  16, MT.OREMATS.Bentonite        , MT.OREMATS.Magnesite      , MT.Olivine                        , MT.OREMATS.Glauconite             , ORE_OVERWORLD, ORE_TWILIGHT, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_MARS, GEN_PLANETS, ORE_MOON, ORE_END);
		new WorldgenOresLarge("ore.large.gold"              , T, T,  20,  30,      5,   3,  16, MT.Pyrite                   , MT.OREMATS.Chalcopyrite   , MT.OREMATS.Arsenopyrite           , MT.Au                             , ORE_OVERWORLD, ORE_TWILIGHT, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_MARS, GEN_PLANETS, ORE_END, ORE_ASTEROIDS);
		new WorldgenOresLarge("ore.large.platinum"          , T, T,  40,  50,      5,   3,  16, MT.OREMATS.Cooperite        , MT.Pd                     , MT.Pt                             , MT.Ir                             , ORE_OVERWORLD, ORE_TWILIGHT, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_MARS, GEN_PLANETS, ORE_END, ORE_ASTEROIDS);
		new WorldgenOresLarge("ore.large.molybdenum"        , T, T,  20,  50,      5,   3,  16, MT.OREMATS.Wulfenite        , MT.OREMATS.Molybdenite    , MT.Mo                             , MT.OREMATS.Powellite              , ORE_OVERWORLD, ORE_TWILIGHT, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_MARS, GEN_PLANETS, ORE_END);
		new WorldgenOresLarge("ore.large.cassiterite"       , T, T,  40,  90,    170,   5,  24, MT.OREMATS.Stannite         , MT.OREMATS.Kesterite      , MT.OREMATS.Huebnerite             , MT.OREMATS.Cassiterite            , ORE_OVERWORLD, ORE_TWILIGHT, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_MARS, GEN_PLANETS, ORE_END);
		...
		new WorldgenOresLarge("ore.large.titanium"          , T, T,  10,  40,     40,   3,  16, MT.TiO2                     , MT.TiO2                   , MT.Zr                             , MT.OREMATS.Ilmenite               , ORE_OVERWORLD, ORE_TWILIGHT, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_MARS, ORE_NETHER, ORE_END);
		...
		new WorldgenOresLarge("ore.large.tetrahedrite"      , T, T,  70, 120,    150,   4,  24, MT.OREMATS.Tetrahedrite     , MT.OREMATS.Tetrahedrite   , MT.Cu                             , MT.OREMATS.Stibnite               , ORE_OVERWORLD, ORE_TWILIGHT, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_MARS, ORE_NETHER, GEN_PLANETS);
		new WorldgenOresLarge("ore.large.redstone"          , T, T,  10,  40,     60,   3,  24, MT.Redstone                 , MT.Redstone               , MT.Ruby                           , MT.OREMATS.Cinnabar               , ORE_OVERWORLD, ORE_TWILIGHT, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_MARS, ORE_NETHER, GEN_PLANETS);
