...
public class Loader_Worldgen implements Runnable {
	...
	public void run() {
		...
		new WorldgenStone("overworld.stone."+ ((BlockStones)tStone).mMaterial.mNameInternal.toLowerCase(), F, tStone,  0,  1, 200, 100, 0, 120, null, F, GEN_OVERWORLD, GEN_PFAA, GEN_AROMA, GEN_TFC, GEN_ENVM);
		...
		new WorldgenOresSmall("ore.small.malachite"        , T,  40,  70,  16, MT.OREMATS.Malachite   , GEN_OVERWORLD, GEN_GT          , GEN_AROMA, GEN_AROMA_GT, GEN_ENVM, GEN_ENVM_GT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM                                     , GEN_END, GEN_MARS);
		...
		new WorldgenOresSmall("ore.small.amber"            , T,   5,  70,   1, MT.Amber               , GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_AROMA, GEN_AROMA_GT, GEN_ENVM, GEN_ENVM_GT, GEN_EREBUS, GEN_BETWEENLANDS, GEN_ATUM             , GEN_AETHER);
