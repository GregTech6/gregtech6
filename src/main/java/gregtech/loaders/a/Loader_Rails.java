...
public class Loader_Rails implements Runnable {
	...
	public void run() {
		...
		BlocksGT.RailTitanium                = new BlockBaseRail(null, "gt.block.rail.titanium"                , "Titanium Track"                , F, F, 1.10F, 16, MT.Ti             .mToolQuality-1, Textures.BlockIcons.RAIL_STRAIGHT_TITANIUM       , Textures.BlockIcons.RAIL_TURNED_TITANIUM);
		BlocksGT.RailTungstenSteel           = new BlockBaseRail(null, "gt.block.rail.tungstensteel"           , "Tungstensteel Track"           , F, F, 1.20F, 20, MT.TungstenSteel  .mToolQuality-1, Textures.BlockIcons.RAIL_STRAIGHT_TUNGSTENSTEEL  , Textures.BlockIcons.RAIL_TURNED_TUNGSTENSTEEL);
		BlocksGT.RailTungstenCarbide         = new BlockBaseRail(null, "gt.block.rail.tungstencarbide"         , "Tungstencarbide Track"         , F, F, 1.30F, 24, MT.TungstenCarbide.mToolQuality-1, Textures.BlockIcons.RAIL_STRAIGHT_TUNGSTENCARBIDE, Textures.BlockIcons.RAIL_TURNED_TUNGSTENCARBIDE);
		...
		BlocksGT.RailTitaniumBooster         = new BlockBaseRail(null, "gt.block.rail.booster.titanium"        , "Titanium Booster Track"        , T, F, 1.10F, 16, MT.Ti             .mToolQuality-1, Textures.BlockIcons.RAIL_BOOSTER_TITANIUM        , Textures.BlockIcons.RAIL_BOOSTER_ACTIVE_TITANIUM);
		BlocksGT.RailTungstenSteelBooster    = new BlockBaseRail(null, "gt.block.rail.booster.tungstensteel"   , "Tungstensteel Booster Track"   , T, F, 1.20F, 20, MT.TungstenSteel  .mToolQuality-1, Textures.BlockIcons.RAIL_BOOSTER_TUNGSTENSTEEL   , Textures.BlockIcons.RAIL_BOOSTER_ACTIVE_TUNGSTENSTEEL);
		BlocksGT.RailTungstenCarbideBooster  = new BlockBaseRail(null, "gt.block.rail.booster.tungstencarbide" , "Tungstencarbide Booster Track" , T, F, 1.30F, 24, MT.TungstenCarbide.mToolQuality-1, Textures.BlockIcons.RAIL_BOOSTER_TUNGSTENCARBIDE , Textures.BlockIcons.RAIL_BOOSTER_ACTIVE_TUNGSTENCARBIDE);
		...
		BlocksGT.RailTitaniumDetector        = new BlockBaseRail(null, "gt.block.rail.detector.titanium"       , "Titanium Detector Track"       , F, T, 1.10F, 16, MT.Ti             .mToolQuality-1, Textures.BlockIcons.RAIL_DETECTOR_TITANIUM       , Textures.BlockIcons.RAIL_DETECTOR_ACTIVE_TITANIUM);
		BlocksGT.RailTungstenSteelDetector   = new BlockBaseRail(null, "gt.block.rail.detector.tungstensteel"  , "Tungstensteel Detector Track"  , F, T, 1.20F, 20, MT.TungstenSteel  .mToolQuality-1, Textures.BlockIcons.RAIL_DETECTOR_TUNGSTENSTEEL  , Textures.BlockIcons.RAIL_DETECTOR_ACTIVE_TUNGSTENSTEEL);
		BlocksGT.RailTungstenCarbideDetector = new BlockBaseRail(null, "gt.block.rail.detector.tungstencarbide", "Tungstencarbide Detector Track", F, T, 1.30F, 24, MT.TungstenCarbide.mToolQuality-1, Textures.BlockIcons.RAIL_DETECTOR_TUNGSTENCARBIDE, Textures.BlockIcons.RAIL_DETECTOR_ACTIVE_TUNGSTENCARBIDE);
