...
public class Loader_Rails implements Runnable {
	...
	public void run() {
		...
		BlocksGT.RailAdamantium              = new BlockBaseRail(null, "gt.block.rail.adamantium"              , "Adamantium Track"              , F, F, 4.00F, 80, MT.Ad             .mToolQuality-1, Textures.BlockIcons.RAIL_STRAIGHT_ADAMANTIUM     , Textures.BlockIcons.RAIL_TURNED_ADAMANTIUM);
		...
		BlocksGT.RailAdamantiumBooster       = new BlockBaseRail(null, "gt.block.rail.booster.adamantium"      , "Adamantium Booster Track"      , T, F, 4.00F, 80, MT.Ad             .mToolQuality-1, Textures.BlockIcons.RAIL_BOOSTER_ADAMANTIUM      , Textures.BlockIcons.RAIL_BOOSTER_ACTIVE_ADAMANTIUM);
		...
		BlocksGT.RailAdamantiumDetector      = new BlockBaseRail(null, "gt.block.rail.detector.adamantium"     , "Adamantium Detector Track"     , F, T, 4.00F, 80, MT.Ad             .mToolQuality-1, Textures.BlockIcons.RAIL_DETECTOR_ADAMANTIUM     , Textures.BlockIcons.RAIL_DETECTOR_ACTIVE_ADAMANTIUM);
