...
public class Loader_Tools implements Runnable {
	@Override
	public void run() {
		ArmorsGT.HAZMATS_INSECTS    .add(ArmorsGT.HAZMAT_INSECTS    [0] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.insect.head"     , "Bumblehead"                       , "Full Set protects against any Insects"         , "hazard_insects"   , 0, new int[] {1, 1, 1, 1}, 128, 8, 0, F, T, "RRR", "RGR", "q l", 'R', OP.foil.dat(MT.Rubber), 'G', ST.make(Blocks.stained_glass_pane, 1, DYE_INDEX_Black)));
		...
		ArmorsGT.HAZMATS_INSECTS    .add(ArmorsGT.HAZMAT_INSECTS    [3] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.insect.boots"    , "Bumbleboots"                      , "Full Set protects against any Insects"         , "hazard_insects"   , 3, new int[] {1, 1, 1, 1}, 128, 8, 0, F, T, "RlR", "RqR"       , 'R', OP.foil.dat(MT.Rubber)));
		
		ArmorsGT.HAZMATS_FROST      .add(ArmorsGT.HAZMAT_FROST      [0] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.frost.head"      , "Frost Protection Suit Mask"       , "Full Set protects against Cold"                , "hazard_frost"     , 0, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F));//, "RRR", "RGR", "q l", 'R', OP.plate.dat(MT.Rubber), 'G', ST.make(Blocks.stained_glass_pane, 1, DYE_INDEX_Black)));
		ArmorsGT.HAZMATS_FROST      .add(ArmorsGT.HAZMAT_FROST      [1] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.frost.chest"     , "Frost Protection Suit Shirt"      , "Full Set protects against Cold"                , "hazard_frost"     , 1, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F));//, "RqR", "RRR", "RRR", 'R', OP.plate.dat(MT.Rubber)));
		ArmorsGT.HAZMATS_FROST      .add(ArmorsGT.HAZMAT_FROST      [2] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.frost.legs"      , "Frost Protection Suit Pants"      , "Full Set protects against Cold"                , "hazard_frost"     , 2, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F));//, "RRR", "RqR", "RlR", 'R', OP.plate.dat(MT.Rubber)));
		ArmorsGT.HAZMATS_FROST      .add(ArmorsGT.HAZMAT_FROST      [3] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.frost.boots"     , "Frost Protection Suit Boots"      , "Full Set protects against Cold"                , "hazard_frost"     , 3, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F));//, "RlR", "RqR"       , 'R', OP.plate.dat(MT.Rubber)));
		...
		ArmorsGT.HAZMATS_RADIOACTIVE.add(ArmorsGT.HAZMAT_RADIOACTIVE[0] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.radiation.head"  , "Radiation Hazard Suit Mask"       , "Full Set protects against Radiation"           , "hazard_radiation" , 0, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "LLL", "LGL", "x l", 'L', OP.plate.dat(MT.Pb), 'G', Blocks.glass_pane));
		ArmorsGT.HAZMATS_RADIOACTIVE.add(ArmorsGT.HAZMAT_RADIOACTIVE[1] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.radiation.chest" , "Radiation Hazard Suit Shirt"      , "Full Set protects against Radiation"           , "hazard_radiation" , 1, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "LxL", "LLL", "LLL", 'L', OP.plate.dat(MT.Pb)));
		ArmorsGT.HAZMATS_RADIOACTIVE.add(ArmorsGT.HAZMAT_RADIOACTIVE[2] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.radiation.legs"  , "Radiation Hazard Suit Pants"      , "Full Set protects against Radiation"           , "hazard_radiation" , 2, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "LLL", "LxL", "LlL", 'L', OP.plate.dat(MT.Pb)));
		ArmorsGT.HAZMATS_RADIOACTIVE.add(ArmorsGT.HAZMAT_RADIOACTIVE[3] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.radiation.boots" , "Radiation Hazard Suit Boots"      , "Full Set protects against Radiation"           , "hazard_radiation" , 3, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "LlL", "LxL"       , 'L', OP.plate.dat(MT.Pb)));
		...
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.PICKAXE                   , "Pickaxe"                         , ""                                                    , new GT_Tool_Pickaxe()                                     .setMaterialAmount(OP.toolHeadPickaxe               .mAmount), OreDictToolNames.pickaxe                                                                                                                 , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.PERFODIO      , 4)                                                                ), TOOL_pickaxe);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.SHOVEL                    , "Shovel"                          , ""                                                    , new GT_Tool_Shovel()                                      .setMaterialAmount(OP.toolHeadShovel                .mAmount), OreDictToolNames.shovel                                                                                                                  , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.PERFODIO      , 4)                                                                ), TOOL_shovel);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.SPADE                     , "Spade"                           , "for Snow, Grass, Mycelium, Podzol, Mud and Clay"     , new GT_Tool_Spade()                                       .setMaterialAmount(OP.toolHeadSpade                 .mAmount), OreDictToolNames.shovel                                                                                                                  , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.PERFODIO      , 4)                                                                ), TOOL_shovel);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.AXE                       , "Axe"                             , "Faster on Logs. Chops down whole Trees."             , new GT_Tool_Axe()                                         .setMaterialAmount(OP.toolHeadAxe                   .mAmount), OreDictToolNames.axe                                                                                                                     , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.ARBOR         , 2)                                ), TOOL_axe);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.DOUBLE_AXE                , "Double Axe"                      , "Chops down whole Trees and has a slow Attack Rate"   , new GT_Tool_AxeDouble()                                   .setMaterialAmount(OP.toolHeadAxeDouble             .mAmount), OreDictToolNames.axe                                                                                                                     , TC.stack(TC.INSTRUMENTUM  , 3), TC.stack(TC.METO          , 2), TC.stack(TC.ARBOR         , 2)                                ), TOOL_axe);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.HOE                       , "Hoe"                             , ""                                                    , new GT_Tool_Hoe()                                         .setMaterialAmount(OP.toolHeadHoe                   .mAmount), OreDictToolNames.hoe                                                                                                                     , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.MESSIS        , 2)                                ), TOOL_hoe);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.SAW                       , "Saw"                             , "Faster on Planks. Slower on Logs. Can harvest Ice."  , new GT_Tool_Saw()                                         .setMaterialAmount(OP.toolHeadSaw                   .mAmount), OreDictToolNames.saw                                                                                                                     , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.ARBOR         , 2)                                ), TOOL_saw);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.HARDHAMMER                , "Hammer"                          , "Crushes Ores instead of harvesting them"             , new GT_Tool_HardHammer()                                  .setMaterialAmount(OP.toolHeadHammer                .mAmount), OreDictToolNames.hammer                                                                                                                  , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.FABRICO       , 2), TC.stack(TC.ORDO          , 2)                                ), TOOL_hammer);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.SOFTHAMMER                , "Soft Hammer"                     , ""                                                    , new GT_Tool_SoftHammer()                                  .setMaterialAmount(OP.toolHeadHammer                .mAmount), OreDictToolNames.softhammer                                                                                                              , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.LIMUS         , 4)                                                                ), TOOL_softhammer);
		...
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.FILE                      , "File"                            , ""                                                    , new GT_Tool_File()                                        .setMaterialAmount(OP.toolHeadFile                  .mAmount), OreDictToolNames.file                                                                                                                    , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.FABRICO       , 2), TC.stack(TC.ORDO          , 2)                                ), TOOL_file);
		...
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.SCREWDRIVER               , "Screwdriver"                     , ""                                                    , new GT_Tool_Screwdriver()                                 .setMaterialAmount(OP.toolHeadScrewdriver           .mAmount), OreDictToolNames.screwdriver                                                                                                             , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.FABRICO       , 2), TC.stack(TC.ORDO          , 2)                                ), TOOL_screwdriver);
...
//      ToolsGT.add(ToolIDs.sMetaTool.addTool(ToolIDs.SICKLE                    , "Sickle"                          , "Harvests Crops more efficiently"                     , new GT_Tool_Sickle()                                      .setMaterialAmount(3*U                                      ), OreDictToolNames.blade                                                                                                                   , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.GRANUM        , 2)                                ), TOOL_sickle);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.SENSE                     , "Sense"                           , "Because a Scythe doesn't make Sense"                 , new GT_Tool_Sense()                                       .setMaterialAmount(OP.toolHeadSense                 .mAmount), OreDictToolNames.blade                                                                                                                   , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.HERBA         , 2), TC.stack(TC.MORTUUS       , 2)), TOOL_sense);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.PLOW                      , "Plow"                            , "Used to get rid of Snow"                             , new GT_Tool_Plow()                                        .setMaterialAmount(OP.toolHeadPlow                  .mAmount), OreDictToolNames.plow                                                                                                                    , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.GELUM         , 2)                                ), TOOL_plow);
		...
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.CHISEL                    , "Chisel"                          , "Be slow/careful with it on Servers because Ping!"    , new GT_Tool_Chisel()                                      .setMaterialAmount(OP.toolHeadChisel                .mAmount), OreDictToolNames.chisel                                                                                                                  , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.PERMUTATIO    , 1), TC.stack(TC.PERDITIO      , 1)                                ), TOOL_chisel);
		...
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.CONSTRUCTION_PICK         , "Construction Pick"               , "Good for Bricks and alike, terrible for mining"      , new GT_Tool_PickaxeConstruction()                         .setMaterialAmount(OP.toolHeadConstructionPickaxe   .mAmount), OreDictToolNames.pickaxe                                                                                                                 , TC.stack(TC.INSTRUMENTUM  , 3), TC.stack(TC.PERFODIO      , 3)                                                                ), TOOL_pickaxe);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.MAGNIFYING_GLASS          , "Magnifying Glass"                , "Crafted with a Stick and a Lens"                     , new GT_Tool_MagnifyingGlass()                             .setMaterialAmount(OP.lens                          .mAmount), OreDictToolNames.magnifyingglass                                                                                                         , TC.stack(TC.INSTRUMENTUM  , 1), TC.stack(TC.SENSUS        , 2)                                                                ), TOOL_magnifyingglass);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.SCISSORS                  , "Scissors"                        , "Don't run around while holding them!"                , new GT_Tool_Scissors()                                    .setMaterialAmount(U*2+OP.screw.mAmount+2*OP.ring   .mAmount), OreDictToolNames.scissors, OreDictToolNames.shears                                                                                       , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.TELUM         , 2), TC.stack(TC.PANNUS        , 2)                                ), TOOL_scissors);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.PINCERS                   , "Pincers"                         , ""                                                    , new GT_Tool_Pincers()                                     .setMaterialAmount(U*2+OP.screw.mAmount+2*OP.stick  .mAmount), OreDictToolNames.pincers                                                                                                                 , TC.stack(TC.INSTRUMENTUM  , 4), TC.stack(TC.FABRICO       , 2)                                                                ), TOOL_pincers);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.GEM_PICK                  , "Gem tipped Pickaxe"              , ""                                                    , new GT_Tool_PickaxeGem()                                  .setMaterialAmount(OP.toolHeadPickaxeGem            .mAmount), OreDictToolNames.pickaxe                                                                                                                 , TC.stack(TC.INSTRUMENTUM  , 3), TC.stack(TC.PERFODIO      , 3)                                                                ), TOOL_pickaxe);
		
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.MININGDRILL_LV            , "Mining Drill (LV)"               , ""                                                    , new GT_Tool_MiningDrill_LV()                              .setMaterialAmount(OP.toolHeadDrill                 .mAmount), OreDictToolNames.miningdrill                                                                                                             , TC.stack(TC.MACHINA       , 2), TC.stack(TC.PERFODIO      , 4)                                                                ), TOOL_pickaxe);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.MININGDRILL_MV            , "Mining Drill (MV)"               , ""                                                    , new GT_Tool_MiningDrill_MV()                              .setMaterialAmount(OP.toolHeadDrill                 .mAmount), OreDictToolNames.miningdrill                                                                                                             , TC.stack(TC.MACHINA       , 2), TC.stack(TC.PERFODIO      , 4)                                                                ), TOOL_pickaxe);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.MININGDRILL_HV            , "Mining Drill (HV)"               , ""                                                    , new GT_Tool_MiningDrill_HV()                              .setMaterialAmount(OP.toolHeadDrill                 .mAmount), OreDictToolNames.miningdrill                                                                                                             , TC.stack(TC.MACHINA       , 2), TC.stack(TC.PERFODIO      , 4)                                                                ), TOOL_pickaxe);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.CHAINSAW_LV               , "Chainsaw (LV)"                   , "Can also harvest Ice"                                , new GT_Tool_Chainsaw_LV()                                 .setMaterialAmount(OP.toolHeadChainsaw              .mAmount), OreDictToolNames.saw                                                                                                                     , TC.stack(TC.MACHINA       , 2), TC.stack(TC.METO          , 2), TC.stack(TC.ARBOR         , 2)                                ), TOOL_saw);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.CHAINSAW_MV               , "Chainsaw (MV)"                   , "Can also harvest Ice"                                , new GT_Tool_Chainsaw_MV()                                 .setMaterialAmount(OP.toolHeadChainsaw              .mAmount), OreDictToolNames.saw                                                                                                                     , TC.stack(TC.MACHINA       , 2), TC.stack(TC.METO          , 2), TC.stack(TC.ARBOR         , 2)                                ), TOOL_saw);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.CHAINSAW_HV               , "Chainsaw (HV)"                   , "Can also harvest Ice"                                , new GT_Tool_Chainsaw_HV()                                 .setMaterialAmount(OP.toolHeadChainsaw              .mAmount), OreDictToolNames.saw                                                                                                                     , TC.stack(TC.MACHINA       , 2), TC.stack(TC.METO          , 2), TC.stack(TC.ARBOR         , 2)                                ), TOOL_saw);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.WRENCH_LV                 , "Wrench (LV)"                     , "Sneak Rightclick to switch to Monkey Wrench"         , new GT_Tool_Wrench_LV(ToolsGT.MONKEY_WRENCH_LV)           .setMaterialAmount(OP.toolHeadWrench                .mAmount), OreDictToolNames.wrench                                                                                                                  , TC.stack(TC.MACHINA       , 4), TC.stack(TC.ORDO          , 2)                                                                ), TOOL_wrench);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.WRENCH_MV                 , "Wrench (MV)"                     , "Sneak Rightclick to switch to Monkey Wrench"         , new GT_Tool_Wrench_MV(ToolsGT.MONKEY_WRENCH_MV)           .setMaterialAmount(OP.toolHeadWrench                .mAmount), OreDictToolNames.wrench                                                                                                                  , TC.stack(TC.MACHINA       , 4), TC.stack(TC.ORDO          , 2)                                                                ), TOOL_wrench);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.WRENCH_HV                 , "Wrench (HV)"                     , "Sneak Rightclick to switch to Monkey Wrench"         , new GT_Tool_Wrench_HV(ToolsGT.MONKEY_WRENCH_HV)           .setMaterialAmount(OP.toolHeadWrench                .mAmount), OreDictToolNames.wrench                                                                                                                  , TC.stack(TC.MACHINA       , 4), TC.stack(TC.ORDO          , 2)                                                                ), TOOL_wrench);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.JACKHAMMER_HV             , "JackHammer (HV)"                 , "Breaks Rocks into pieces"                            , new GT_Tool_JackHammer_HV()                               .setMaterialAmount(3*U2                                     ), OreDictToolNames.jackhammer                                                                                                              , TC.stack(TC.MACHINA       , 2), TC.stack(TC.PERFODIO      , 2), TC.stack(TC.PERDITIO      , 2)                                ), TOOL_pickaxe);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.BUZZSAW_LV                , "Buzzsaw (LV)"                    , "Not suitable for harvesting Blocks"                  , new GT_Tool_BuzzSaw_LV()                                  .setMaterialAmount(OP.toolHeadBuzzSaw               .mAmount), OreDictToolNames.saw                                                                                                                     , TC.stack(TC.MACHINA       , 2), TC.stack(TC.FABRICO       , 2), TC.stack(TC.ARBOR         , 2)                                ), TOOL_saw);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.SCREWDRIVER_LV            , "Screwdriver (LV)"                , ""                                                    , new GT_Tool_Screwdriver_LV()                              .setMaterialAmount(OP.toolHeadScrewdriver           .mAmount), OreDictToolNames.screwdriver                                                                                                             , TC.stack(TC.MACHINA       , 2), TC.stack(TC.FABRICO       , 2), TC.stack(TC.ORDO          , 2)                                ), TOOL_screwdriver);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.DRILL_LV                  , "Hand Drill (LV)"                 , ""                                                    , new GT_Tool_Drill_LV()                                    .setMaterialAmount(OP.stick                         .mAmount), OreDictToolNames.drill                                                                                                                   , TC.stack(TC.MACHINA       , 2), TC.stack(TC.FABRICO       , 2), TC.stack(TC.PERFODIO      , 1)                                ), TOOL_drill);
		...
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.MONKEY_WRENCH_LV          , "Monkey Wrench (LV)"              , "Sneak Rightclick to switch to Wrench"                , new GT_Tool_MonkeyWrench_LV(ToolsGT.WRENCH_LV)            .setMaterialAmount(OP.toolHeadWrench                .mAmount), OreDictToolNames.monkeywrench                                                                                                            , TC.stack(TC.MACHINA       , 4), TC.stack(TC.ORDO          , 2)                                                                ), TOOL_monkeywrench);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.MONKEY_WRENCH_MV          , "Monkey Wrench (MV)"              , "Sneak Rightclick to switch to Wrench"                , new GT_Tool_MonkeyWrench_MV(ToolsGT.WRENCH_MV)            .setMaterialAmount(OP.toolHeadWrench                .mAmount), OreDictToolNames.monkeywrench                                                                                                            , TC.stack(TC.MACHINA       , 4), TC.stack(TC.ORDO          , 2)                                                                ), TOOL_monkeywrench);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.MONKEY_WRENCH_HV          , "Monkey Wrench (HV)"              , "Sneak Rightclick to switch to Wrench"                , new GT_Tool_MonkeyWrench_HV(ToolsGT.WRENCH_HV)            .setMaterialAmount(OP.toolHeadWrench                .mAmount), OreDictToolNames.monkeywrench                                                                                                            , TC.stack(TC.MACHINA       , 4), TC.stack(TC.ORDO          , 2)                                                                ), TOOL_monkeywrench);
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.TRIMMER_LV                , "Trimmer (LV)"                    , ""                                                    , new GT_Tool_Trimmer_LV()                                  .setMaterialAmount(2*OP.toolHeadSword               .mAmount), OreDictToolNames.branchcutter                                                                                                            , TC.stack(TC.MACHINA       , 2), TC.stack(TC.METO          , 2), TC.stack(TC.HERBA         , 2)                                ), TOOL_grafter);
		...
		CR.shaped(ToolsGT.sMetaTool.getToolWithStats(ToolsGT.FLINT_AND_TINDER   , tMaterial                 , MT.Flint  ), CR.DEF_MIR   , "T ", " F", 'F', OD.itemFlint, 'T', OP.nugget.dat(tMaterial));
		...
		CR.shaped(ToolsGT.sMetaTool.getToolWithStats(ToolsGT.FLINT_AND_TINDER   , tMaterial                 , MT.Flint  ), CR.DEF_MIR   , "T ", " F", 'F', OD.itemFlint, 'T', OP.stone.dat(tMaterial));
		CR.shaped(ToolsGT.sMetaTool.getToolWithStats(ToolsGT.FLINT_AND_TINDER   , tMaterial                 , MT.Flint  ), CR.DEF_MIR   , "T ", " F", 'F', OD.itemFlint, 'T', OP.rockGt.dat(tMaterial));
		}
		...
		for (OreDictMaterial tMaterial : ANY.Wood.mToThis) if (tMaterial != MT.Wood) {
		CR.shaped(ToolsGT.sMetaTool.getToolWithStats(ToolsGT.CLUB               , tMaterial         , (OreDictMaterial)tHandle[0]   ), CR.DEF_MIR   , " FF", "FFF", "SF ", 'S', tHandle[1], 'F', OP.plank.dat(tMaterial));
		CR.shaped(ToolsGT.sMetaTool.getToolWithStats(ToolsGT.SOFTHAMMER         , tMaterial         , (OreDictMaterial)tHandle[0]   ), CR.DEF_MIR   , "FF ", "FFS", "FF ", 'S', tHandle[1], 'F', OP.plank.dat(tMaterial));
		}
		...
		CR.shaped(ToolsGT.sMetaTool.getToolWithStats(ToolsGT.SOFTHAMMER         , MT.Rubber         , (OreDictMaterial)tHandle[0]   ), CR.DEF_MIR   , "FF ", "FFS", "FF ", 'S', tHandle[1], 'F', OP.ingot.dat(MT.Rubber));
		CR.shaped(ToolsGT.sMetaTool.getToolWithStats(ToolsGT.SOFTHAMMER         , MT.Rubber         , (OreDictMaterial)tHandle[0]   ), CR.DEF_MIR   , "FF ", "FFS", "FF ", 'S', tHandle[1], 'F', OP.plate.dat(MT.Rubber));
		CR.shaped(ToolsGT.sMetaTool.getToolWithStats(ToolsGT.SOFTHAMMER         , MT.Plastic        , (OreDictMaterial)tHandle[0]   ), CR.DEF_MIR   , "FF ", "FFS", "FF ", 'S', tHandle[1], 'F', OP.ingot.dat(MT.Plastic));
		...
		toolHeadWrench              .addListener(new OreProcessing_Tool(WRENCH                  , tCategory + "Wrench"                  ,F,F,0,0, null                          , new String[][] {{"PhP", "PPP", " P "}, {"CfC", "CCC", " C "}}                             , new String[][] {{"hPW", "PVP", "WPd"}, {"hCW", "CVC", "WCd"}} , null          , null, null, ring.dat(ANY.Steel),screw.dat(ANY.Steel), new And(ANTIMATTER.NOT, typemin(2))));
		...
		GameRegistry.addRecipe(new AdvancedCraftingTool(PICKAXE                 , OP.toolHeadPickaxe));
		GameRegistry.addRecipe(new AdvancedCraftingTool(SHOVEL                  , OP.toolHeadShovel));
		GameRegistry.addRecipe(new AdvancedCraftingTool(SPADE                   , OP.toolHeadSpade));
		GameRegistry.addRecipe(new AdvancedCraftingTool(AXE                     , OP.toolHeadAxe));
		GameRegistry.addRecipe(new AdvancedCraftingTool(DOUBLE_AXE              , OP.toolHeadAxeDouble));
		GameRegistry.addRecipe(new AdvancedCraftingTool(HOE                     , OP.toolHeadHoe));
		GameRegistry.addRecipe(new AdvancedCraftingTool(SENSE                   , OP.toolHeadSense));
		GameRegistry.addRecipe(new AdvancedCraftingTool(PLOW                    , OP.toolHeadPlow));
		GameRegistry.addRecipe(new AdvancedCraftingTool(FILE                    , OP.toolHeadFile));
		GameRegistry.addRecipe(new AdvancedCraftingTool(CHISEL                  , OP.toolHeadChisel));
		GameRegistry.addRecipe(new AdvancedCraftingTool(SCREWDRIVER             , OP.toolHeadScrewdriver));
		GameRegistry.addRecipe(new AdvancedCraftingTool(SAW                     , OP.toolHeadSaw));
		
		toolHeadScrewdriver         .addListener(new OreProcessing_Tool(POCKET_MULTITOOL        , tCategory + "PocketMultitool"         ,F,F,0,0, null                          , new String[][] {{"AXO", "ZPV", "OWY"}}                                                    , null                                                          , toolHeadSaw, toolHeadChisel, toolHeadFile, toolHeadSword, toolHeadSword, new And(ANTIMATTER.NOT, WOOD.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(3))));
		
		
		for (ItemStack tBattery : OreDictManager.getOres("gt:re-battery1", F)) {
		toolHeadDrill               .addListener(new OreProcessing_Tool(MIXER_LV                , tCategory + "MixerLV"                 ,F,T, -1,V[1], MT.DATA.Electric_T[1]    , new String[][] {{"SSY", "SXW", "hVZ"}}                                                    , null                                                          , plateCurved.dat(MT.DATA.Electric_T[1]), ring.dat(MT.DATA.Electric_T[1]), plate.dat(MT.DATA.Electric_T[1]), tBattery, IL.MOTORS[1], new And(ANTIMATTER.NOT, WOOD.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(3))));
		toolHeadDrill               .addListener(new OreProcessing_Tool(DRILL_LV                , tCategory + "DrillLV"                 ,F,T, -1,V[1], MT.DATA.Electric_T[1]    , new String[][] {{"fSY", "TXW", "dVZ"}}                                                    , null                                                          , plateCurved.dat(MT.DATA.Electric_T[1]), ring.dat(MT.DATA.Electric_T[1]), plate.dat(MT.DATA.Electric_T[1]), tBattery, IL.MOTORS[1], new And(ANTIMATTER.NOT, WOOD.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(3))));
		toolHeadScrewdriver         .addListener(new OreProcessing_Tool(SCREWDRIVER_LV          , tCategory + "ScrewdriverLV"           ,F,T, -1,V[1], MT.DATA.Electric_T[1]    , new String[][] {{"XdA", "TWY", "VYX"}}                                                    , null                                                          , plateCurved.dat(MT.DATA.Electric_T[1]), ring.dat(MT.DATA.Electric_T[1]), null, tBattery, IL.MOTORS[1], new And(ANTIMATTER.NOT, WOOD.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(3))));
		toolHeadBuzzSaw             .addListener(new OreProcessing_Tool(BUZZSAW_LV              , tCategory + "BuzzSawLV"               ,F,T, -1,V[1], MT.DATA.Electric_T[1]    , new String[][] {{"YXV", "TWX", "AdY"}}                                                    , null                                                          , plateCurved.dat(MT.DATA.Electric_T[1]), plate.dat(MT.DATA.Electric_T[1]), null, tBattery, IL.MOTORS[1], new And(ANTIMATTER.NOT, WOOD.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(3))));
		toolHeadSword               .addListener(new OreProcessing_Tool(TRIMMER_LV              , tCategory + "TrimmerLV"               ,F,T, -1,V[1], MT.DATA.Electric_T[1]    , new String[][] {{"XAT", "ZYA", "VWd"}}                                                    , null                                                          , plateCurved.dat(MT.DATA.Electric_T[1]), ring.dat(MT.DATA.Electric_T[1]), stickLong.dat(MT.DATA.Electric_T[1]), tBattery, IL.PISTONS[1], new And(ANTIMATTER.NOT, WOOD.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(3))));
		
		toolHeadWrench              .addListener(new OreProcessing_Tool(WRENCH_LV               , tCategory + "WrenchLV"                ,F,T, -1,V[1], MT.DATA.Electric_T[1]    , new String[][] {{"dAT", "XWX", "XVX"}}                                                    , null                                                          , plateCurved.dat(MT.DATA.Electric_T[1]), null, null, tBattery, IL.MOTORS[1], new And(ANTIMATTER.NOT, WOOD.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(3))));
		toolHeadDrill               .addListener(new OreProcessing_Tool(MININGDRILL_LV          , tCategory + "MiningDrillLV"           ,F,T, -1,V[1], MT.DATA.Electric_T[1]    , new String[][] {{"dAT", "XWX", "XVX"}}                                                    , null                                                          , plateCurved.dat(MT.DATA.Electric_T[1]), null, null, tBattery, IL.MOTORS[1], new And(ANTIMATTER.NOT, WOOD.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(3))));
		toolHeadChainsaw            .addListener(new OreProcessing_Tool(CHAINSAW_LV             , tCategory + "ChainsawLV"              ,F,T, -1,V[1], MT.DATA.Electric_T[1]    , new String[][] {{"dAT", "XWX", "XVX"}}                                                    , null                                                          , plateCurved.dat(MT.DATA.Electric_T[1]), null, null, tBattery, IL.MOTORS[1], new And(ANTIMATTER.NOT, WOOD.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(3))));
		}
		for (ItemStack tBattery : OreDictManager.getOres("gt:re-battery2", F)) {
		toolHeadWrench              .addListener(new OreProcessing_Tool(WRENCH_MV               , tCategory + "WrenchMV"                ,F,T, -1,V[2], MT.DATA.Electric_T[2]    , new String[][] {{"dAT", "XWX", "XVX"}}                                                    , null                                                          , plateCurved.dat(MT.DATA.Electric_T[2]), null, null, tBattery, IL.MOTORS[2], new And(ANTIMATTER.NOT, WOOD.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(3))));
		toolHeadDrill               .addListener(new OreProcessing_Tool(MININGDRILL_MV          , tCategory + "MiningDrillMV"           ,F,T, -1,V[2], MT.DATA.Electric_T[2]    , new String[][] {{"dAT", "XWX", "XVX"}}                                                    , null                                                          , plateCurved.dat(MT.DATA.Electric_T[2]), null, null, tBattery, IL.MOTORS[2], new And(ANTIMATTER.NOT, WOOD.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(3))));
		toolHeadChainsaw            .addListener(new OreProcessing_Tool(CHAINSAW_MV             , tCategory + "ChainsawMV"              ,F,T, -1,V[2], MT.DATA.Electric_T[2]    , new String[][] {{"dAT", "XWX", "XVX"}}                                                    , null                                                          , plateCurved.dat(MT.DATA.Electric_T[2]), null, null, tBattery, IL.MOTORS[2], new And(ANTIMATTER.NOT, WOOD.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(3))));
		}
		for (ItemStack tBattery : OreDictManager.getOres("gt:re-battery3", F)) {
		toolHeadWrench              .addListener(new OreProcessing_Tool(WRENCH_HV               , tCategory + "WrenchHV"                ,F,T, -1,V[3], MT.DATA.Electric_T[3]    , new String[][] {{"dAT", "XWX", "XVX"}}                                                    , null                                                          , plateCurved.dat(MT.DATA.Electric_T[3]), null, null, tBattery, IL.MOTORS[3], new And(ANTIMATTER.NOT, WOOD.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(3))));
		toolHeadDrill               .addListener(new OreProcessing_Tool(MININGDRILL_HV          , tCategory + "MiningDrillHV"           ,F,T, -1,V[3], MT.DATA.Electric_T[3]    , new String[][] {{"dAT", "XWX", "XVX"}}                                                    , null                                                          , plateCurved.dat(MT.DATA.Electric_T[3]), null, null, tBattery, IL.MOTORS[3], new And(ANTIMATTER.NOT, WOOD.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(3))));
		toolHeadChainsaw            .addListener(new OreProcessing_Tool(CHAINSAW_HV             , tCategory + "ChainsawHV"              ,F,T, -1,V[3], MT.DATA.Electric_T[3]    , new String[][] {{"dAT", "XWX", "XVX"}}                                                    , null                                                          , plateCurved.dat(MT.DATA.Electric_T[3]), null, null, tBattery, IL.MOTORS[3], new And(ANTIMATTER.NOT, WOOD.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(3))));
		
		toolHeadDrill               .addListener(new OreProcessing_Tool(JACKHAMMER_HV           , tCategory + "JackhammerHV"            ,F,T, -1,V[3], MT.DATA.Electric_T[3]    , new String[][] {{"SVS", "XWX", "YSY"}}                                                    , null                                                          , plateCurved.dat(MT.DATA.Electric_T[3]), spring.dat(MT.DATA.Electric_T[3]), null, tBattery, IL.PISTONS[3], new And(ANTIMATTER.NOT, WOOD.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(3))));
		}
		}});
	}
