...
public class Loader_Tools implements Runnable {
	...
	public void run() {
		...
		ArmorsGT.HAZMATS_RADIOACTIVE.add(ArmorsGT.HAZMAT_RADIOACTIVE[3] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.radiation.boots" , "Radiation Hazard Suit Boots"      , "Full Set protects against Radiation"           , "hazard_radiation" , 3, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "LlL", "LxL"       , 'L', plate.dat(MT.Pb)));
										 ...
										 ArmorsGT.HAZMAT_BIOCHEMGAS [0] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.biochemgas.head" , "Biochemical Gas Hazard Suit Mask" , "Full Set protects against Chemicals and Gasses", "hazard_biochemgas", 0, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "RRR", "RGR", "q l", 'R', plate.dat(MT.Rubber), 'G', Blocks.glass_pane);
										 ArmorsGT.HAZMAT_BIOCHEMGAS [1] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.biochemgas.chest", "Biochemical Gas Hazard Suit Shirt", "Full Set protects against Chemicals and Gasses", "hazard_biochemgas", 1, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "RqR", "RRR", "RRR", 'R', plate.dat(MT.Rubber));
										 ArmorsGT.HAZMAT_BIOCHEMGAS [2] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.biochemgas.legs" , "Biochemical Gas Hazard Suit Pants", "Full Set protects against Chemicals and Gasses", "hazard_biochemgas", 2, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "RRR", "RqR", "RlR", 'R', plate.dat(MT.Rubber));
										 ArmorsGT.HAZMAT_BIOCHEMGAS [3] = new ItemArmorBase(MD.GT.mID, "gt.armor.hazmat.biochemgas.boots", "Biochemical Gas Hazard Suit Boots", "Full Set protects against Chemicals and Gasses", "hazard_biochemgas", 3, new int[] {1, 1, 1, 1}, 128, 8, 0, F, F, "RlR", "RqR"       , 'R', plate.dat(MT.Rubber));
...
//      ToolsGT.add(ToolIDs.sMetaTool.addTool(ToolIDs.SICKLE                    , "Sickle"                          , "Harvests Crops more efficiently"                     , new GT_Tool_Sickle()                                           .setMaterialAmount(3*U                                       ), OreDictToolNames.blade                                                                                                                   , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.GRANUM        , 2)                                ), TOOL_sickle);
		...
		ToolsGT.add(ToolsGT.sMetaTool.addTool(ToolsGT.PLUNGER                   , "Plunger"                         , "Not as good as burning Flowers at cleaning Pipes"    , new GT_Tool_Plunger()                                          .setMaterialAmount(0                                         ), OreDictToolNames.plunger                                                                                                                 , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.VACUOS        , 2), TC.stack(TC.ITER          , 2)                                ), TOOL_plunger);
		...
		toolHeadConstructionPickaxe .addListener(new OreProcessing_Tool(CONSTRUCTION_PICK       , tCategory + "ConstructionPickaxe"     ,T,F,0,0, null                          , null                                                                                      , new String[][] {{"PIP", "f h"       }, {"CGC", "f  "       }} , null          , null, null, null                              , null, new And(ANTIMATTER.NOT, COATED.NOT)));
		toolHeadPickaxe             .addListener(new OreProcessing_Tool(PICKAXE                 , tCategory + "Pickaxe"                 ,T,F,0,0, null                          , null                                                                                      , new String[][] {{"PII", "f h"       }, {"CGG", "f  "       }} , null          , null, null, null                              , null, new And(ANTIMATTER.NOT, COATED.NOT)));
		toolHeadShovel              .addListener(new OreProcessing_Tool(SHOVEL                  , tCategory + "Shovel"                  ,T,F,0,0, null                          , null                                                                                      , new String[][] {{"fPh"              }, {"fC "              }} , null          , null, null, null                              , null, new And(ANTIMATTER.NOT, COATED.NOT)));
		toolHeadSpade               .addListener(new OreProcessing_Tool(SPADE                   , tCategory + "Spade"                   ,T,F,0,0, null                          , null                                                                                      , new String[][] {{"fPh", " s "       }, {"fC ", " s "       }} , null          , null, null, null                              , null, new And(ANTIMATTER.NOT, COATED.NOT)));
		...
		toolHeadHoe                 .addListener(new OreProcessing_Tool(HOE                     , tCategory + "Hoe"                     ,T,F,0,0, null                          , null                                                                                      , new String[][] {{"PIh", "f  "       }, {"CG ", "f  "       }} , null          , null, null, null                              , null, new And(ANTIMATTER.NOT, COATED.NOT)));
		toolHeadAxe                 .addListener(new OreProcessing_Tool(AXE                     , tCategory + "Axe"                     ,T,F,0,0, null                          , null                                                                                      , new String[][] {{"PIh", "P  ", "f  "}, {"CG ", "C  ", "f  "}} , null          , null, null, null                              , null, new And(ANTIMATTER.NOT, COATED.NOT)));
		toolHeadAxeDouble           .addListener(new OreProcessing_Tool(DOUBLE_AXE              , tCategory + "DoubleAxe"               ,T,F,0,0, null                          , null                                                                                      , new String[][] {{"PIP", "P P", "f h"}, {"CGC", "C C", "f  "}} , null          , null, null, null                              , null, new And(ANTIMATTER.NOT, COATED.NOT, typemin(2))));
		toolHeadSense               .addListener(new OreProcessing_Tool(SENSE                   , tCategory + "Sense"                   ,T,F,0,0, null                          , null                                                                                      , new String[][] {{"PPI", "f h"       }, {"CCG", "f  "       }} , null          , null, null, null                              , null, new And(ANTIMATTER.NOT, COATED.NOT, typemin(2))));
		toolHeadPlow                .addListener(new OreProcessing_Tool(PLOW                    , tCategory + "Plow"                    ,T,F,0,0, null                          , null                                                                                      , new String[][] {{"PPP", "PPP", "f h"}, {"CCC", "CCC", "f  "}} , null          , null, null, null                              , null, new And(ANTIMATTER.NOT, COATED.NOT, typemin(2))));
		toolHeadFile                .addListener(new OreProcessing_Tool(FILE                    , tCategory + "File"                    ,T,F,0,0, null                          , new String[][] {{ "P" ,  "P" ,  "H" }, { "C" ,  "C" ,  "H" }}                             , new String[][] {{" P ", " P "       }, {" C ", " C "       }} , null          , null, null, null                              , null, new And(ANTIMATTER.NOT, COATED.NOT, typemin(2))));
		toolHeadChisel              .addListener(new OreProcessing_Tool(CHISEL                  , tCategory + "Chisel"                  ,T,F,0,0, null                          , null                                                                                      , new String[][] {{"hPf", " S "       }, {"Cf" , "S "        }} , null          , null, null, null                              , null, new And(ANTIMATTER.NOT, COATED.NOT, typemin(2))));
		toolHeadScrewdriver         .addListener(new OreProcessing_Tool(SCREWDRIVER             , tCategory + "Screwdriver"             ,T,F,0,0, null                          , null                                                                                      , new String[][] {{"hS" , "Sf"        }}                        , null          , null, null, null                              , null, new And(ANTIMATTER.NOT, COATED.NOT, typemin(2))));
		toolHeadSaw                 .addListener(new OreProcessing_Tool(SAW                     , tCategory + "Saw"                     ,T,F,0,0, null                          , null                                                                                      , new String[][] {{"PP" , "fh"        }, {"CC" , "f "        }} , null          , null, null, null                              , null, new And(ANTIMATTER.NOT, COATED.NOT, typemin(2))));
		toolHeadChainsaw            .addListener(new OreProcessing_Tool(CHAINSAW_LV             , tCategory + "Chainsaw"                ,F,F,0,0, null                          , null                                                                                      , new String[][] {{"WVW", "XhX", "WVW"}}                        , chain         , null, null, ring.dat(ANY.Steel),plate.dat(ANY.Steel), new And(ANTIMATTER.NOT, COATED.NOT, typemin(2))));
		toolHeadDrill               .addListener(new OreProcessing_Tool(MININGDRILL_LV          , tCategory + "MiningDrill"             ,F,F,0,0, null                          , null                                                                                      , new String[][] {{"PVP", "PVP", "VhV"}, {"CVC", "CVC", "VhV"}} , null          , null, null, plateCurved.dat(ANY.Steel)        , null, new And(ANTIMATTER.NOT, COATED.NOT, typemin(2))));
		toolHeadWrench              .addListener(new OreProcessing_Tool(WRENCH                  , tCategory + "Wrench"                  ,F,F,0,0, null                          , new String[][] {{"PhP", "PPP", " P "}, {"CfC", "CCC", " C "}}                             , new String[][] {{"hPW", "PVP", "WPd"}, {"hCW", "CVC", "WCd"}} , null          , null, null, ring.dat(ANY.Steel),screw.dat(ANY.Steel), new And(ANTIMATTER.NOT, COATED.NOT, typemin(2), qualmin(1))));
		...
		toolHeadWrench              .addListener(new OreProcessing_Tool(CROWBAR                 , tCategory + "Crowbar"                 ,F,F,0,0, null                          , new String[][] {{"hVS", "VSV", "SVf"}}                                                    , null                                                          , null          , null, null, DYE_OREDICTS[DYE_INDEX_Blue]      , null, new And(ANTIMATTER.NOT)));
		toolHeadWrench              .addListener(new OreProcessing_Tool(PLUNGER                 , tCategory + "Plunger"                 ,F,F,0,0, null                          , new String[][] {{"xVV", " SV", "S f"}}                                                    , null                                                          , null          , null, null, plate.dat(MT.Rubber)              , null, new And(ANTIMATTER.NOT)));
		...
		toolHeadPickaxe             .addListener(new OreProcessing_Tool(SCOOP                   , tCategory + "Scoop"                   ,F,F,0,0, null                          , new String[][] {{"SVS", "SSS", "xSh"}}                                                    , null                                                          , null          , null, null, Blocks.wool                       , null, new And(ANTIMATTER.NOT)));
		toolHeadSword               .addListener(new OreProcessing_Tool(SWORD                   , tCategory + "Sword"                   ,T,F,0,0, null                          , null                                                                                      , new String[][] {{" P ", "fPh"       }, {" C ", "fC "       }} , null          , null, null, null                              , null, new And(ANTIMATTER.NOT, COATED.NOT)));
		toolHeadSword               .addListener(new OreProcessing_Tool(KNIFE                   , tCategory + "Knife"                   ,F,F,0,0, null                          , new String[][] {{"fP" , "hH"        }, {"fC" , "hH"        }}                             , null                                                          , null          , null, null, null                              , null, new And(ANTIMATTER.NOT)));
		...
		toolHeadHammer              .addListener(new OreProcessing_Tool(HARDHAMMER              , tCategory + "HardHammer"              ,T,F,0,0, null                          , new String[][] {{"II ", "IIH", "II "}, {"GG ", "GGH", "GG "}}                             , new String[][] {{"II ", "IIh", "II "}, {"GG ", "GGf", "GG "}} , null          , null, null, null                              , null, new And(ANTIMATTER.NOT, COATED.NOT, new Nor(WOOD, BOUNCY, STRETCHY))));
		toolHeadHammer              .addListener(new OreProcessing_Tool(SOFTHAMMER              , tCategory + "SoftHammer"              ,T,F,0,0, null                          , new String[][] {{"II ", "IIH", "II "}, {"GG ", "GGH", "GG "}}                             , new String[][] {{"II ", "IIr", "II "}, {"GG ", "GGr", "GG "}} , null          , null, null, null                              , null, new And(ANTIMATTER.NOT, COATED.NOT, new Or (WOOD, BOUNCY, STRETCHY))));
