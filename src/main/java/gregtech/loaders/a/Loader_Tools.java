...
//      ToolsGT.add(ToolIDs.sMetaTool.addTool(ToolIDs.SICKLE                    , "Sickle"                          , "Harvests Crops more efficiently"                     , new GT_Tool_Sickle()                                           .setMaterialAmount(3*U                                       ), OreDictToolNames.blade                                                                                                                   , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.GRANUM        , 2)                                ), TOOL_sickle);
		...
		toolHeadFile               .addListener(new OreProcessing_Tool(FILE                  , tCategory + "File"                ,T,F,0,0, null, null                                                                                , new String[][] {{" P ", " P "       }, {" C ", " C "       }}, null         , null, null, null                              , null, new And(ANTIMATTER.NOT, COATED.NOT, typemin(2))));
		...
		toolHeadHammer             .addListener(new OreProcessing_Tool(HARDHAMMER            , tCategory + "HardHammer"          ,T,F,0,0, null, null                                                                                , new String[][] {{"II ", "IIh", "II "}, {"GG ", "GGf", "GG "}}, null         , null, null, null                              , null, new And(ANTIMATTER.NOT, COATED.NOT, new Nor(WOOD, BOUNCY, STRETCHY))));
		toolHeadHammer             .addListener(new OreProcessing_Tool(SOFTHAMMER            , tCategory + "SoftHammer"          ,T,F,0,0, null, null                                                                                , new String[][] {{"II ", "IIr", "II "}, {"GG ", "GGr", "GG "}}, null         , null, null, null                              , null, new And(ANTIMATTER.NOT, COATED.NOT, new Or (WOOD, BOUNCY, STRETCHY))));
