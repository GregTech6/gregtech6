...
//      ToolsGT.add(ToolIDs.sMetaTool.addTool(ToolIDs.SICKLE                    , "Sickle"                          , "Harvests Crops more efficiently"                     , new GT_Tool_Sickle()                                           .setMaterialAmount(3*U                                      ), OreDictToolNames.blade                                                                                                                   , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.GRANUM        , 2)                                ), TOOL_sickle);
		...
		toolHeadDrill               .addListener(new OreProcessing_Tool(JACKHAMMER_HV_Normal           , tCategory + "JackhammerHV"            ,F,T, -1,V[3], MT.DATA.Electric_T[3]    , new String[][] {{"SVS", "XWX", "YSY"}}                                                    , null                                                          , plateCurved.dat(MT.DATA.Electric_T[3]), spring.dat(MT.DATA.Electric_T[3]), null, tBattery, IL.PISTONS[3], new And(ANTIMATTER.NOT, WOOD.NOT, BOUNCY.NOT, STRETCHY.NOT, typemin(3))));
		}
		}});
	}
