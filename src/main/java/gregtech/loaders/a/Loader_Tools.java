...
//      ToolsGT.add(ToolIDs.sMetaTool.addTool(ToolIDs.SICKLE                    , "Sickle"                          , "Harvests Crops more efficiently"                     , new GT_Tool_Sickle()                                           .setMaterialAmount(3*U                                       ), OreDictToolNames.blade                                                                                                                   , TC.stack(TC.INSTRUMENTUM  , 2), TC.stack(TC.METO          , 2), TC.stack(TC.GRANUM        , 2)                                ), TOOL_sickle);
		...
		toolHeadBuilderwand        .addListener(new OreProcessing_Tool(BUILDERWAND           , tCategory + "Builderwand"         ,T,F,0,0, null, null                                                                                , new String[][] {{" P ", "fsh"       }, {" C ", "fsh"       }, {" G ", "fsh"       }}, null         , null, null, null                              , null, new And(ANTIMATTER.NOT)));
		...
		toolHeadChainsaw           .addListener(new OreProcessing_Tool(CHAINSAW_LV           , tCategory + "Chainsaw"            ,F,F,0,0, null, null                                                                                , new String[][] {{"WVW", "XhX", "WVW"}}                                              , chain        , null, null, ring.dat(ANY.Steel),plate.dat(ANY.Steel), new And(ANTIMATTER.NOT, MT.Wood.NOT, COATED.NOT, typemin(2))));
		toolHeadDrill              .addListener(new OreProcessing_Tool(MININGDRILL_LV        , tCategory + "MiningDrill"         ,F,F,0,0, null, null                                                                                , new String[][] {{"PVP", "PVP", "VhV"}, {"CVC", "CVC", "VhV"}                       }, null         , null, null, plateCurved.dat(ANY.Steel)        , null, new And(ANTIMATTER.NOT, MT.Wood.NOT, COATED.NOT, typemin(2))));
		toolHeadWrench             .addListener(new OreProcessing_Tool(WRENCH                , tCategory + "Wrench"              ,F,F,0,0, null, new String[][] {{"PhP", "PPP", " P "}, {"CfC", "CCC", " C "}}                       , new String[][] {{"hPW", "PVP", "WPd"}, {"hCW", "CVC", "WCd"}                       }, null         , null, null, ring.dat(ANY.Steel),screw.dat(ANY.Steel), new And(ANTIMATTER.NOT, MT.Wood.NOT, COATED.NOT, typemin(2), qualmin(1))));
		...
		GameRegistry.addRecipe(new AdvancedCraftingTool(HOE              , toolHeadHoe                , MT.WOODS.Birch)); // Suggests Wood for Hoes.
