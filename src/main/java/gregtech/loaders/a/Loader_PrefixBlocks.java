...
public class Loader_PrefixBlocks implements Runnable {
	...
	public void run() {
		...
		BlocksGT.crateGt64Gem               = new PrefixBlock_(MD.GT, "gt.meta.crate.64.gem"        , OP.crateGt64Gem           , OM.stack(MT.Wood, U)  , null, null, BlockTextureDefault.get(Textures.BlockIcons.CRATE)    , Material.wood , Block.soundTypeWood   , TOOL_crowbar  , 1.0F, 0.2F,   0,   0,   0, 0,0,0,1,1,1, T,F,F,F,T,T,F,T,T,T,b,F,F,T, OreDictMaterial.MATERIAL_ARRAY);
		BlocksGT.crateGt64Dust              = new PrefixBlock_(MD.GT, "gt.meta.crate.64.dust"       , OP.crateGt64Dust          , OM.stack(MT.Wood, U)  , null, null, BlockTextureDefault.get(Textures.BlockIcons.CRATE)    , Material.wood , Block.soundTypeWood   , TOOL_crowbar  , 1.0F, 0.2F,   0,   0,   0, 0,0,0,1,1,1, T,F,F,F,T,T,F,T,T,T,b,F,F,T, OreDictMaterial.MATERIAL_ARRAY);
