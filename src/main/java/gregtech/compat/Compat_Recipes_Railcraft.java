...
public class Compat_Recipes_Railcraft extends CompatMods {
	...
	@Override public void onPostLoad(FMLPostInitializationEvent aInitEvent) {OUT.println("GT_Mod: Doing RC Recipes.");
		...
		CR.shaped(ST.make(MD.RC, "machine.beta"           , 4,  0), tBits | DEL_IF_NO_DYES                                , "PIP"   , " "+tWrench+" " ,    "PIP"      , 'P', OP.plate.dat(ANY.Fe),'I'  ,OP.plate.dat(MT.StainlessSteel),'G',OD.paneGlassColorless    );
		CR.shaped(ST.make(MD.RC, "machine.beta"           , 4,  1), tBits | DEL_IF_NO_DYES                                , "PIP"   , "G"+tWrench+"G" ,    "PIP"      , 'P', OP.plate.dat(ANY.Fe),'I'  ,OP.plate.dat(MT.StainlessSteel),'G',OD.paneGlassColorless    );
		CR.shaped(ST.make(MD.RC, "machine.beta"           , 1,  2), tBits | DEL_IF_NO_DYES                                , "CCC"          , " "+tWrench+" "               , "P P"     , 'P', OP.plate.dat(ANY.Fe)                     , 'C', OP.plateCurved.dat(MT.StainlessSteel));
		...
		CR.shaped(ST.make(MD.RC, "machine.beta"           , 4, 13), tBits | DEL_IF_NO_DYES                                , "PIP"   , " "+tWrench+" " ,    "PIP"      , 'P', OP.plate.dat(ANY.Steel),'I'  ,OP.plate.dat(MT.StainlessSteel),'G',OD.paneGlassColorless);
		CR.shaped(ST.make(MD.RC, "machine.beta"           , 4, 14), tBits | DEL_IF_NO_DYES                                , "PIP"   , "G"+tWrench+"G" ,    "PIP"      , 'P', OP.plate.dat(ANY.Steel),'I'  ,OP.plate.dat(MT.StainlessSteel),'G',OD.paneGlassColorless);
		CR.shaped(ST.make(MD.RC, "machine.beta"           , 1, 15), tBits | DEL_IF_NO_DYES                                , "CCC"          , " "+tWrench+" "               , "P P"     , 'P', OP.plate.dat(ANY.Steel)                     , 'C', OP.plateCurved.dat(MT.StainlessSteel));
		...
		CR.shaped(ST.make(MD.RC, "machine.alpha"          , 6, 15), tBits                                                 , "P"+tHammer+"P" , "PGP"             , "P"+tWrench+"P"    , 'P', OP.plate.dat(ANY.Iron)    , 'C', OP.gearGt.dat(ANY.Steel));
