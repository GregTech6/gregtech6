...
public class Compat_Recipes_Railcraft extends CompatMods {
	...
	@Override public void onPostLoad(FMLPostInitializationEvent aInitEvent) {OUT.println("GT_Mod: Doing RC Recipes.");
		...
		CR.shaped(ST.make(MD.RC, "machine.beta"             , 1,  7), tBits | MIR                                               , "PPP"             , tHammer+"G"+tWrench   , "OTO"                 , 'P', OP.nugget.dat(MT.Au)                             , 'O', ST.make(MD.RC, "part.gear", 1, 0), 'G', Blocks.glass, 'T', OD.craftingPiston);
		CR.shaped(ST.make(MD.RC, "machine.beta"             , 1,  8), tBits | MIR                                               , "PPP"             , tHammer+"G"+tWrench   , "OTO"                 , 'P', OP.plate.dat(ANY.Fe)                             , 'O', ST.make(MD.RC, "part.gear", 1, 1), 'G', Blocks.glass, 'T', OD.craftingPiston);
		CR.shaped(ST.make(MD.RC, "machine.beta"             , 1,  9), tBits | MIR                                               , "PPP"             , tHammer+"G"+tWrench   , "OTO"                 , 'P', OP.plate.dat(ANY.Steel)                          , 'O', ST.make(MD.RC, "part.gear", 1, 2), 'G', Blocks.glass, 'T', OD.craftingPiston);
