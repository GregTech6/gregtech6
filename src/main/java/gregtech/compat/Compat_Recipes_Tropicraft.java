...
public class Compat_Recipes_Tropicraft extends CompatMods {
	...
	@Override public void onPostLoad(FMLPostInitializationEvent aInitEvent) {OUT.println("GT_Mod: Doing Tropicraft Recipes.");
		...
		RM.Sifting          .addRecipe1(T, 16, 200, new long[] {9900, 500, 500}     , IL.TROPIC_Sand_Black.get(1), dust.mat(MT.OREMATS.BasalticMineralSand, 1), rockGt.mat(MT.STONES.Basalt, 1), nugget.mat(MT.Au, 1));
		RM.MagneticSeparator.addRecipe1(T, 16, 144, new long[] {9900, 500, 500, 500}, IL.TROPIC_Sand_Black.get(1), dust.mat(MT.OREMATS.BasalticMineralSand, 1), rockGt.mat(MT.STONES.Basalt, 1), nugget.mat(MT.Au, 1), dustTiny.mat(MT.Au, 2));
