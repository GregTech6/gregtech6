...
//      RM.Printer.addFakeRecipe(F, ST.array(IL.Paper_Punch_Card_Empty   .get(1), IL.USB_Stick_1.getWithName(0, "Containing scanned Punchcard"           )), ST.array(IL.Paper_Punch_Card_Encoded.get(1)        ), null, null, FL.array(                                                                                                                                                                       FL.mul(DYE_FLUIDS_CHEMICAL[DYE_INDEX_Black], 1, 9, T)), ZL_FS,   32, 16, 0);
		...
		if (IL.TC_Loot_Common  .exists())   RM.Unboxinator.addFakeRecipe(F, ST.array(IL.TC_Loot_Common  .get(1)), ST.array(IL.TC_Loot_Common  .getWithName(1, "8 to 12 Random Singular Items"),                            NI,                               NI, ST.make(Items.diamond, 1, 0), ST.make(Items.emerald, 1, 0), ST.make(Items.ender_pearl, 1, 0), IL.TC_Gold_Coin.get(1), ST.make(Items.golden_apple, 1, 0), ST.make(Items.golden_apple, 1, 1), ST.make(Items.experience_bottle, 1, 0), ST.make(Items.enchanted_book, 1, 0), IL.TC_Knowledge_Fragment.get(1)), null, ZL_LONG, ZL_FS, ZL_FS, 16, 16, 0);
		if (IL.TC_Loot_Uncommon.exists())   RM.Unboxinator.addFakeRecipe(F, ST.array(IL.TC_Loot_Uncommon.get(1)), ST.array(IL.TC_Loot_Uncommon.getWithName(1, "8 to 12 Random Singular Items"),                            NI,                               NI, ST.make(Items.diamond, 1, 0), ST.make(Items.emerald, 1, 0), ST.make(Items.ender_pearl, 1, 0), IL.TC_Gold_Coin.get(1), ST.make(Items.golden_apple, 1, 0), ST.make(Items.golden_apple, 1, 1), ST.make(Items.experience_bottle, 1, 0), ST.make(Items.enchanted_book, 1, 0), IL.TC_Knowledge_Fragment.get(1)), null, ZL_LONG, ZL_FS, ZL_FS, 16, 16, 0);
		if (IL.TC_Loot_Rare    .exists())   RM.Unboxinator.addFakeRecipe(F, ST.array(IL.TC_Loot_Rare    .get(1)), ST.array(IL.TC_Loot_Rare    .getWithName(1, "8 to 12 Random Singular Items"), IL.TC_Primordial_Pearl.get(1), ST.make(Items.nether_star, 1, 0), ST.make(Items.diamond, 1, 0), ST.make(Items.emerald, 1, 0), ST.make(Items.ender_pearl, 1, 0), IL.TC_Gold_Coin.get(1), ST.make(Items.golden_apple, 1, 0), ST.make(Items.golden_apple, 1, 1), ST.make(Items.experience_bottle, 1, 0), ST.make(Items.enchanted_book, 1, 0), IL.TC_Knowledge_Fragment.get(1)), null, ZL_LONG, ZL_FS, ZL_FS, 16, 16, 0);
