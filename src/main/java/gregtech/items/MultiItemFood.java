...
public class MultiItemFood extends MultiItemRandom implements IItemRottable {
	...
	public void addItems() {
		...
		IL.Pill_Iodine                         .set(addItem(tLastID = 31001, "Radaway"                                  , "Pill that cures Effects of Radiation"                        , new FoodStat( 0, 0.000F,   0, C+37,  0.00F,   0,   0,   0,   0,   0, -50, EnumAction.eat, null                                 , T, F, F, T, PotionsGT.ID_RADIATION, -1, -1, 100), TC.stack(TC.SANO, 3), TD.Creative.HIDDEN     )); Sandwiches.INGREDIENTS.put(last(), (byte)42);
