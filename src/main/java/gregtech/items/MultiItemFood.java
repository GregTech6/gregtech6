...
public class MultiItemFood extends MultiItemRandom implements IItemRottable {
	...
	public void addItems() {
		...
		IL.Remains_Fruit.set(						addItem(tLastID = 12101, "Fruit Remains"							, ""															, "itemPlantRemains", TICKS_PER_SMELT / 4, TC.stack(TC.HERBA, 1)));
		IL.Remains_Veggie.set(						addItem(tLastID = 12102, "Vegetable Remains"						, ""															, "itemPlantRemains", TICKS_PER_SMELT / 4, TC.stack(TC.HERBA, 1)));
		IL.Remains_Nut.set(							addItem(tLastID = 12103, "Nut Remains"								, ""															, "itemPlantRemains", TICKS_PER_SMELT / 2, TC.stack(TC.HERBA, 1)));
		
		
		IL.Bark_Dry.set(							addItem(tLastID = 12201, "Dry Bark"									, "Useful for making a simple Fire Starter"						, "itemBarkDry", TICKS_PER_SMELT / 4, TC.stack(TC.ARBOR, 1), new OreDictItemData(MT.Bark, U2)));
		
		
		IL.Mud_Ball.set(							addItem(tLastID = 12300, "Mud Ball"									, ""															, "itemMud", TC.stack(TC.TERRA, 1)));
		IL.Clay_Ball_Brown.set(						addItem(tLastID = 12310, "Brown Clay Ball"							, ""															, "itemClay", TC.stack(TC.TERRA, 1), new OreDictItemData(MT.ClayBrown, U)));
		...
		IL.Comb_Honey.set(			addItem(tLastID = 30000, "Honey Comb"			, "", OD.beeComb, "materialHoneycomb", "foodFilledhoneycomb", TC.stack(TC.LIMUS, 1), TC.stack(TC.FAMES, 1), TC.stack(TC.SANO, 1)));
		...
		RM.Centrifuge.addRecipe1(T, 16, 64, new long[] {10000,  1000,  1000}		, IL.Comb_Royal		.get(1), NF, FL.Honey			.make(  80), OM.dust(MT.WaxBee)					, IL.FR_Royal_Jelly.get(1), ST.make(MD.HaC, "royaljellyItem", 1));
		...
		RM.CryoMixer.addRecipe1(T, 16, 16, OM.dust(MT.NaCl, U4), new FluidStack[] {FL.Water.make( 250), FL.Cream.make( 250)}, ZL_FS, IL.Food_Ice_Cream.get(1));
		RM.CryoMixer.addRecipe1(T, 16, 16, OM.dust(MT.NaCl, U4), new FluidStack[] {FL.DistW.make( 250), FL.Cream.make( 250)}, ZL_FS, IL.Food_Ice_Cream.get(1));
		RM.CryoMixer.addRecipe1(T, 16, 64, OM.dust(MT.NaCl, U ), new FluidStack[] {FL.Water.make(1000), FL.Cream.make(1000)}, ZL_FS, IL.Food_Ice_Cream.get(4));
		RM.CryoMixer.addRecipe1(T, 16, 64, OM.dust(MT.NaCl, U ), new FluidStack[] {FL.DistW.make(1000), FL.Cream.make(1000)}, ZL_FS, IL.Food_Ice_Cream.get(4));
		...
		RM.Mixer.addRecipeX(T, 16, 48, new ItemStack[] {IL.Food_Ice_Cream_Strawberry.get(1), IL.Food_Ice_Cream_Vanilla.get(1), IL.Food_Ice_Cream_Chocolate.get(1)}, IL.Food_Ice_Cream_Neapolitan.get(3));
		RM.Mixer.addRecipeX(T, 16, 48, new ItemStack[] {IL.Food_Ice_Cream_Cherry.get(1), IL.Food_Ice_Cream_Pistachio.get(1), IL.Food_Ice_Cream_Vanilla.get(1)}, IL.Food_Ice_Cream_Spumoni_Vanilla.get(3));
		RM.Mixer.addRecipeX(T, 16, 48, new ItemStack[] {IL.Food_Ice_Cream_Cherry.get(1), IL.Food_Ice_Cream_Pistachio.get(1), IL.Food_Ice_Cream_Chocolate.get(1)}, IL.Food_Ice_Cream_Spumoni_Chocolate.get(3));
		RM.Mixer.addRecipeX(T, 16, 48, new ItemStack[] {IL.Food_Ice_Cream_Cherry.get(1), IL.Food_Ice_Cream_Blueberry.get(1), IL.Food_Ice_Cream_Lemon.get(1)}, IL.Food_Ice_Cream_Superman.get(3));
