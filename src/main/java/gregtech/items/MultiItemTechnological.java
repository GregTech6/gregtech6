...
public class MultiItemTechnological extends MultiItemRandomWithCompat {
	...
	public void addItems() {
		...
		IL.Cover_Blank                           .set(addItem( 1000, "Blank Cover"                           , "*BLANK*"                                         , new CoverTextureMulti(T, T, "machines/covers/blank/", 6)   , TC.stack(TC.MACHINA, 2)));
		IL.Cover_Crafting                        .set(addItem( 1001, "Crafting Table Cover"                  , "A regular old Workbench as a Cover"              , new CoverCrafting("machines/covers/crafting/", 6)          , TC.stack(TC.MACHINA, 1), TC.stack(TC.FABRICO, 3)));
		IL.Cover_Machine_Display                 .set(addItem( 1002, "Machine Status Display Cover"          , "Shows Machine Status and has ON/OFF Switch"      , new CoverControllerDisplay()                               , TC.stack(TC.MACHINA, 1), TC.stack(TC.SENSUS, 3)));
		IL.Cover_Auto_Switch                     .set(addItem( 1003, "Automatic Machine Switch"              , "Automatically turns Machines ON/OFF when needed" , new CoverControllerAuto()                                  , TC.stack(TC.MACHINA, 1), TC.stack(TC.PERMUTATIO, 3)));
		IL.Cover_Energy_Display                  .set(addItem( 1004, "Energy Display Cover"                  , "Displays contained Energy"                       , new CoverDisplayEnergy()                                   , TC.stack(TC.MACHINA, 1), TC.stack(TC.SENSUS, 2), TC.stack(TC.POTENTIA, 1)));
		IL.Cover_Redstone_Switch                 .set(addItem( 1005, "Redstone Machine Switch"               , "Turns Machines ON/OFF using Redstone"            , new CoverControllerRedstone()                              , TC.stack(TC.MACHINA, 1), TC.stack(TC.PERMUTATIO, 2)));
		IL.Cover_Auto_Switch_Redstone            .set(addItem( 1006, "Auto Redstone Machine Switch"          , "Turns ON/OFF using Redstone but lets it finish"  , new CoverControllerAutoRedstone()                          , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 3)));
		IL.Cover_Redstone_Selector               .set(addItem( 1007, "Redstone Selector"                     , "Selector Cover that is controlled by Redstone"   , new CoverSelectorRedstone()                                , TC.stack(TC.MACHINA, 1), TC.stack(TC.PERMUTATIO, 2)));
		IL.Cover_Manual_Selector                 .set(addItem( 1008, "Manual Selector"                       , "Selector Cover that is controlled by Buttons"    , new CoverSelectorManual()                                  , TC.stack(TC.MACHINA, 1), TC.stack(TC.PERMUTATIO, 2)));
		IL.Cover_Auto_Switch_01_Minute           .set(addItem( 1009, "Auto Reboot Switch (1 min)"            , "Attempts to Reboot a Machine every Minute"       , new CoverControllerAutoTimer( 1200)                        , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Auto_Switch_05_Minute           .set(addItem( 1010, "Auto Reboot Switch (5 mins)"           , "Attempts to Reboot a Machine every 5 Minutes"    , new CoverControllerAutoTimer( 6000)                        , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Auto_Switch_10_Minute           .set(addItem( 1011, "Auto Reboot Switch (10 mins)"          , "Attempts to Reboot a Machine every 10 Minutes"   , new CoverControllerAutoTimer(12000)                        , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Auto_Switch_20_Minute           .set(addItem( 1012, "Auto Reboot Switch (20 mins)"          , "Attempts to Reboot a Machine every 20 Minutes"   , new CoverControllerAutoTimer(24000)                        , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Auto_Switch_30_Minute           .set(addItem( 1013, "Auto Reboot Switch (30 mins)"          , "Attempts to Reboot a Machine every 30 Minutes"   , new CoverControllerAutoTimer(36000)                        , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Scale_Energy                    .set(addItem( 1014, "Energy Sensor"                         , "Emits depending on Energy stored"                , new CoverScaleEnergy()                                     , TC.stack(TC.MACHINA, 2), TC.stack(TC.POTENTIA, 1)));
		IL.Cover_Detector_Possible               .set(addItem( 1015, "Activity Detector (Possible)"          , "Emits when Machine could run"                    , new CoverDetectorRunningPossible()                         , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Detector_Passively              .set(addItem( 1016, "Activity Detector (Running)"           , "Emits when Machine is running"                   , new CoverDetectorRunningPassively()                        , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Detector_Actively               .set(addItem( 1017, "Activity Detector (Processing)"        , "Emits when Machine is processing"                , new CoverDetectorRunningActively()                         , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Scale_Progress                  .set(addItem( 1018, "Progress Sensor"                       , "Emits depending on Progress"                     , new CoverScaleProgress()                                   , TC.stack(TC.MACHINA, 2), TC.stack(TC.FABRICO, 1)));
		IL.Cover_Detector_Success                .set(addItem( 1019, "Activity Detector (Success)"           , "Emits when Machine produced something"           , new CoverDetectorRunningSuccessfully()                     , TC.stack(TC.MACHINA, 2), TC.stack(TC.FABRICO, 1)));
		IL.Cover_Drain                           .set(addItem( 1020, "Drain"                                 , ""                                                , new CoverDrain()                                           , TC.stack(TC.MACHINA, 1), TC.stack(TC.AQUA, 1), TC.stack(TC.VACUOS, 1)));
		IL.Cover_Redstone_Emitter                .set(addItem( 1021, "Redstone Emitter"                      , "Emits a constant Redstone Signal"                , new CoverRedstoneEmitter()                                 , TC.stack(TC.MACHINA, 1), TC.stack(TC.POTENTIA, 1)));
		IL.Cover_Vent                            .set(addItem( 1022, "Air Vent"                              , "Ventilates Air into Tanks and Pipes"             , new CoverVent()                                            , TC.stack(TC.MACHINA, 1), TC.stack(TC.AER, 1), TC.stack(TC.VACUOS, 1)));
		IL.Cover_Filter_Item                     .set(addItem( 1023, "Item Filter"                           , "Filters for an Item"                             , new CoverFilterItem()                                      , TC.stack(TC.MACHINA, 1), TC.stack(TC.ORDO, 1), TC.stack(TC.ITER, 1)));
		IL.Cover_Filter_Fluid                    .set(addItem( 1024, "Fluid Filter"                          , "Filters for a Fluid"                             , new CoverFilterFluid()                                     , TC.stack(TC.MACHINA, 1), TC.stack(TC.ORDO, 1), TC.stack(TC.AQUA, 1)));
		IL.Cover_Controller                      .set(addItem( 1025, "Cover Controller"                      , "Turns Redstone into ON/OFF State for Covers"     , new CoverControllerCovers()                                , TC.stack(TC.MACHINA, 1), TC.stack(TC.PERMUTATIO, 2)));
		IL.Cover_Shutter                         .set(addItem( 1026, "Shutter Cover"                         , "Connects and Disconnects Pipes and Wires"        , new CoverShutter()                                         , TC.stack(TC.MACHINA, 2), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Button_Selector                 .set(addItem( 1027, "Button Panel Selector"                 , "Selector Cover that is controlled by Buttons"    , new CoverSelectorButtonPanel()                             , TC.stack(TC.MACHINA, 1), TC.stack(TC.PERMUTATIO, 1)));
		IL.Cover_Warning                         .set(addItem( 1028, "Warning Cover"                         , "Warns about certain Types of Danger"             , new CoverTextureMulti(T, T, "machines/covers/warning/", 20), TC.stack(TC.MACHINA, 1), TC.stack(TC.SENSUS, 1), TC.stack(TC.VINCULUM, 1)));
		IL.Cover_Redstone_Conductor_IN           .set(addItem( 1029, "Redstone Conductor Cover (Accept)"     , "Redstone will transfer to emitting Conductors"   , new CoverRedstoneConductorIN()                             , TC.stack(TC.MACHINA, 2), TC.stack(TC.SENSUS, 1)));
		IL.Cover_Redstone_Conductor_OUT          .set(addItem( 1030, "Redstone Conductor Cover (Emit)"       , "Redstone of accepting Conductors gets emitted"   , new CoverRedstoneConductorOUT()                            , TC.stack(TC.MACHINA, 2), TC.stack(TC.VINCULUM, 1)));
		IL.Cover_Retriever_Item                  .set(addItem( 1031, "Item Retriever Cover"                  , "Pulls Items from the attached Pipe Network"      , new CoverRetrieverItem()                                   , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 1), TC.stack(TC.VACUOS, 1), TC.stack(TC.ITER, 1)));
		...
		IL.Cover_Logistics_Display_CPU_Logic     .set(addItem( 1086, "Logistics Display (CPU Logic)"         , "For use with Logistics Cores and Wiring"         , CoverLogisticsDisplayCPULogic.INSTANCE                     , TC.stack(TC.MACHINA, 2), TC.stack(TC.SENSUS, 2), TC.stack(TC.ITER, 1)));
		IL.Cover_Logistics_Display_CPU_Control   .set(addItem( 1087, "Logistics Display (CPU Control)"       , "For use with Logistics Cores and Wiring"         , CoverLogisticsDisplayCPUControl.INSTANCE                   , TC.stack(TC.MACHINA, 2), TC.stack(TC.SENSUS, 2), TC.stack(TC.ITER, 1)));
		IL.Cover_Logistics_Display_CPU_Storage   .set(addItem( 1088, "Logistics Display (CPU Storage)"       , "For use with Logistics Cores and Wiring"         , CoverLogisticsDisplayCPUStorage.INSTANCE                   , TC.stack(TC.MACHINA, 2), TC.stack(TC.SENSUS, 2), TC.stack(TC.ITER, 1)));
		IL.Cover_Logistics_Display_CPU_Conversion.set(addItem( 1089, "Logistics Display (CPU Conversion)"    , "For use with Logistics Cores and Wiring"         , CoverLogisticsDisplayCPUConversion.INSTANCE                , TC.stack(TC.MACHINA, 2), TC.stack(TC.SENSUS, 2), TC.stack(TC.ITER, 1)));
		IL.Cover_Logistics_Fluid_Export          .set(addItem( 1090, "Filtered Logistics Export Bus (Fluid)" , "For use with Logistics Cores and Wiring"         , CoverLogisticsFluidExport.INSTANCE                         , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 2), TC.stack(TC.PERMUTATIO, 4), TC.stack(TC.ITER, 4)));
		IL.Cover_Logistics_Fluid_Import          .set(addItem( 1091, "Filtered Logistics Import Bus (Fluid)" , "For use with Logistics Cores and Wiring"         , CoverLogisticsFluidImport.INSTANCE                         , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 2), TC.stack(TC.PERMUTATIO, 4), TC.stack(TC.ITER, 4)));
		IL.Cover_Logistics_Fluid_Storage         .set(addItem( 1092, "Filtered Logistics Storage Bus (Fluid)", "For use with Logistics Cores and Wiring"         , CoverLogisticsFluidStorage.INSTANCE                        , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 2), TC.stack(TC.PERMUTATIO, 4), TC.stack(TC.ITER, 4)));
		IL.Cover_Logistics_Item_Export           .set(addItem( 1093, "Filtered Logistics Export Bus (Item)"  , "For use with Logistics Cores and Wiring"         , CoverLogisticsItemExport.INSTANCE                          , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 2), TC.stack(TC.PERMUTATIO, 4), TC.stack(TC.ITER, 4)));
		IL.Cover_Logistics_Item_Import           .set(addItem( 1094, "Filtered Logistics Import Bus (Item)"  , "For use with Logistics Cores and Wiring"         , CoverLogisticsItemImport.INSTANCE                          , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 2), TC.stack(TC.PERMUTATIO, 4), TC.stack(TC.ITER, 4)));
		IL.Cover_Logistics_Item_Storage          .set(addItem( 1095, "Filtered Logistics Storage Bus (Item)" , "For use with Logistics Cores and Wiring"         , CoverLogisticsItemStorage.INSTANCE                         , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 2), TC.stack(TC.PERMUTATIO, 4), TC.stack(TC.ITER, 4)));
		IL.Cover_Logistics_Generic_Export        .set(addItem( 1096, "Generic Logistics Export Bus"          , "For use with Logistics Cores and Wiring"         , CoverLogisticsGenericExport.INSTANCE                       , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 2), TC.stack(TC.PERMUTATIO, 4), TC.stack(TC.ITER, 4)));
		IL.Cover_Logistics_Generic_Import        .set(addItem( 1097, "Generic Logistics Import Bus"          , "For use with Logistics Cores and Wiring"         , CoverLogisticsGenericImport.INSTANCE                       , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 2), TC.stack(TC.PERMUTATIO, 4), TC.stack(TC.ITER, 4)));
		IL.Cover_Logistics_Generic_Storage       .set(addItem( 1098, "Generic Logistics Storage Bus"         , "For use with Logistics Cores and Wiring"         , CoverLogisticsGenericStorage.INSTANCE                      , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 2), TC.stack(TC.PERMUTATIO, 4), TC.stack(TC.ITER, 4)));
		IL.Cover_Logistics_Dump                  .set(addItem( 1099, "Logistics Dump Bus (Item)"             , "For use with Logistics Cores and Wiring"         , CoverLogisticsGenericDump.INSTANCE                         , TC.stack(TC.MACHINA, 2), TC.stack(TC.COGNITIO, 2), TC.stack(TC.PERMUTATIO, 4), TC.stack(TC.ITER, 4)));
		...
		IL.Cover_Pressure_Valve            .set(addItem( 2000, "Pressure Valve"                   , ""                                                , new CoverPressureValve()                              , TC.stack(TC.MACHINA, 1), TC.stack(TC.AER, 1), TC.stack(TC.VACUOS, 1)));
		...
		IL.Shape_Extruder_Empty            .set(addItem(10000, "Empty Extruder Shape"                     , "Raw Plate to make Extruder Shapes"                   , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		
		CR.shaped(IL.Shape_Extruder_Empty.get(1), CR.DEF_REV, "hf" , "xP", 'P', OP.plateDouble.dat(MT.TungstenCarbide));
		
		IL.Shape_Extruder_Plate            .set(addItem(10001, "Extruder Shape (Plate)"                   , "Extruder Shape for making Plates"                    , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Rod_Long         .set(addItem(10002, "Extruder Shape (Long Rod)"                , "Extruder Shape for making long Rods"                 , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Bolt             .set(addItem(10003, "Extruder Shape (Bolt)"                    , "Extruder Shape for making Bolts"                     , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Ring             .set(addItem(10004, "Extruder Shape (Ring)"                    , "Extruder Shape for making Rings"                     , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Cell             .set(addItem(10005, "Extruder Shape (Cell)"                    , "Extruder Shape for making Cells"                     , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Ingot            .set(addItem(10006, "Extruder Shape (Ingot)"                   , "Extruder Shape for making Ingots"                    , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Wire             .set(addItem(10007, "Extruder Shape (Wire)"                    , "Extruder Shape for making Wires"                     , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Casing           .set(addItem(10008, "Extruder Shape (Casing)"                  , "Extruder Shape for making Item Casings"              , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Pipe_Tiny        .set(addItem(10009, "Extruder Shape (Tiny Pipe)"               , "Extruder Shape for making tiny Pipes"                , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Pipe_Small       .set(addItem(10010, "Extruder Shape (Small Pipe)"              , "Extruder Shape for making small Pipes"               , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Pipe_Medium      .set(addItem(10011, "Extruder Shape (Normal Pipe)"             , "Extruder Shape for making Pipes"                     , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Pipe_Large       .set(addItem(10012, "Extruder Shape (Large Pipe)"              , "Extruder Shape for making large Pipes"               , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Pipe_Huge        .set(addItem(10013, "Extruder Shape (Huge Pipe)"               , "Extruder Shape for making full Block Pipes"          , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Block            .set(addItem(10014, "Extruder Shape (Block)"                   , "Extruder Shape for making Blocks"                    , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Sword            .set(addItem(10015, "Extruder Shape (Sword Blade)"             , "Extruder Shape for making Swords"                    , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Pickaxe          .set(addItem(10016, "Extruder Shape (Pickaxe Head)"            , "Extruder Shape for making Pickaxes"                  , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Shovel           .set(addItem(10017, "Extruder Shape (Shovel Head)"             , "Extruder Shape for making Shovels"                   , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Axe              .set(addItem(10018, "Extruder Shape (Axe Head)"                , "Extruder Shape for making Axes"                      , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Hoe              .set(addItem(10019, "Extruder Shape (Hoe Head)"                , "Extruder Shape for making Hoes"                      , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Hammer           .set(addItem(10020, "Extruder Shape (Hammer Head)"             , "Extruder Shape for making Hammers"                   , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_File             .set(addItem(10021, "Extruder Shape (File Head)"               , "Extruder Shape for making Files"                     , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Saw              .set(addItem(10022, "Extruder Shape (Saw Blade)"               , "Extruder Shape for making Saws"                      , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Gear             .set(addItem(10023, "Extruder Shape (Gear)"                    , "Extruder Shape for making Gears"                     , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Bottle           .set(addItem(10024, "Extruder Shape (Bottle)"                  , "Extruder Shape for making Bottles"                   , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Plate_Curved     .set(addItem(10025, "Extruder Shape (Curved Plate)"            , "Extruder Shape for making Curved Plates"             , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Gear_Small       .set(addItem(10026, "Extruder Shape (Small Gear)"              , "Extruder Shape for making small Gears"               , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Rod              .set(addItem(10027, "Extruder Shape (Rod)"                     , "Extruder Shape for making Rods"                      , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_CCC              .set(addItem(10028, "Extruder Shape (Capsule-Cell-Container)"  , "Extruder Shape for making Capsule-Cell-Containers"   , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Foil             .set(addItem(10029, "Extruder Shape (Foil)"                    , "Extruder Shape for making Foils from Non-Metals"     , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Plate_Tiny       .set(addItem(10030, "Extruder Shape (Tiny Plate)"              , "Extruder Shape for making Tiny Plates"               , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Extruder_Wire_Fine        .set(addItem(10031, "Extruder Shape (Fine Wire)"               , "Extruder Shape for making Fine Wires from Non-Metals", TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		...
		IL.Shape_SimpleEx_Empty            .set(addItem(10200, "Empty Extruder Shape"                             , "Raw Plate to make Extruder Shapes"                   , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		
		CR.shaped(IL.Shape_SimpleEx_Empty.get(1), CR.DEF_REV, "hf" , "xP", 'P', OP.plateDouble.dat(ANY.Steel));
		
		IL.Shape_SimpleEx_Plate            .set(addItem(10201, "Low Heat Extruder Shape (Plate)"                  , "Extruder Shape for making Plates"                    , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Rod_Long         .set(addItem(10202, "Low Heat Extruder Shape (Long Rod)"               , "Extruder Shape for making long Rods"                 , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Bolt             .set(addItem(10203, "Low Heat Extruder Shape (Bolt)"                   , "Extruder Shape for making Bolts"                     , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Ring             .set(addItem(10204, "Low Heat Extruder Shape (Ring)"                   , "Extruder Shape for making Rings"                     , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Cell             .set(addItem(10205, "Low Heat Extruder Shape (Cell)"                   , "Extruder Shape for making Cells"                     , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Ingot            .set(addItem(10206, "Low Heat Extruder Shape (Ingot)"                  , "Extruder Shape for making Ingots"                    , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Wire             .set(addItem(10207, "Low Heat Extruder Shape (Wire)"                   , "Extruder Shape for making Wires"                     , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Casing           .set(addItem(10208, "Low Heat Extruder Shape (Casing)"                 , "Extruder Shape for making Item Casings"              , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Pipe_Tiny        .set(addItem(10209, "Low Heat Extruder Shape (Tiny Pipe)"              , "Extruder Shape for making tiny Pipes"                , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Pipe_Small       .set(addItem(10210, "Low Heat Extruder Shape (Small Pipe)"             , "Extruder Shape for making small Pipes"               , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Pipe_Medium      .set(addItem(10211, "Low Heat Extruder Shape (Normal Pipe)"            , "Extruder Shape for making Pipes"                     , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Pipe_Large       .set(addItem(10212, "Low Heat Extruder Shape (Large Pipe)"             , "Extruder Shape for making large Pipes"               , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Pipe_Huge        .set(addItem(10213, "Low Heat Extruder Shape (Huge Pipe)"              , "Extruder Shape for making full Block Pipes"          , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Block            .set(addItem(10214, "Low Heat Extruder Shape (Block)"                  , "Extruder Shape for making Blocks"                    , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Sword            .set(addItem(10215, "Low Heat Extruder Shape (Sword Blade)"            , "Extruder Shape for making Swords"                    , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Pickaxe          .set(addItem(10216, "Low Heat Extruder Shape (Pickaxe Head)"           , "Extruder Shape for making Pickaxes"                  , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Shovel           .set(addItem(10217, "Low Heat Extruder Shape (Shovel Head)"            , "Extruder Shape for making Shovels"                   , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Axe              .set(addItem(10218, "Low Heat Extruder Shape (Axe Head)"               , "Extruder Shape for making Axes"                      , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Hoe              .set(addItem(10219, "Low Heat Extruder Shape (Hoe Head)"               , "Extruder Shape for making Hoes"                      , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Hammer           .set(addItem(10220, "Low Heat Extruder Shape (Hammer Head)"            , "Extruder Shape for making Hammers"                   , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_File             .set(addItem(10221, "Low Heat Extruder Shape (File Head)"              , "Extruder Shape for making Files"                     , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Saw              .set(addItem(10222, "Low Heat Extruder Shape (Saw Blade)"              , "Extruder Shape for making Saws"                      , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Gear             .set(addItem(10223, "Low Heat Extruder Shape (Gear)"                   , "Extruder Shape for making Gears"                     , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Bottle           .set(addItem(10224, "Low Heat Extruder Shape (Bottle)"                 , "Extruder Shape for making Bottles"                   , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Plate_Curved     .set(addItem(10225, "Low Heat Extruder Shape (Curved Plate)"           , "Extruder Shape for making Curved Plates"             , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Gear_Small       .set(addItem(10226, "Low Heat Extruder Shape (Small Gear)"             , "Extruder Shape for making small Gears"               , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Rod              .set(addItem(10227, "Low Heat Extruder Shape (Rod)"                    , "Extruder Shape for making Rods"                      , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_CCC              .set(addItem(10228, "Low Heat Extruder Shape (Capsule-Cell-Container)" , "Extruder Shape for making Capsule-Cell-Containers"   , TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Foil             .set(addItem(10229, "Low Heat Extruder Shape (Foil)"                   , "Extruder Shape for making Foils from Non-Metals"     , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Plate_Tiny       .set(addItem(10230, "Low Heat Extruder Shape (Tiny Plate)"             , "Extruder Shape for making Tiny Plates"               , TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		IL.Shape_SimpleEx_Wire_Fine        .set(addItem(10231, "Low Heat Extruder Shape (Fine Wire)"              , "Extruder Shape for making Fine Wires from Non-Metals", TC.stack(TC.FABRICO, 1), TC.stack(TC.METALLUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)55);
		...
		IL.Shape_Foodmold_Empty            .set(addItem(10800, "Empty Food Grade Mold"            , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		
		CR.shaped(IL.Shape_Foodmold_Empty.get(1), CR.DEF_REV, "hf" , "xP", 'P', OP.plateDouble.dat(MT.StainlessSteel));
		
		IL.Shape_Foodmold_Bun              .set(addItem(10801, "Food Grade Mold (Bun)"            , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Foodmold_Bread            .set(addItem(10802, "Food Grade Mold (Bread)"          , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Foodmold_Baguette         .set(addItem(10803, "Food Grade Mold (Baguette)"       , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Foodmold_Cylinder         .set(addItem(10804, "Food Grade Mold (Cylinder)"       , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Foodmold_Toast            .set(addItem(10805, "Food Grade Mold (Toast)"          , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		...
		IL.Shape_Press_Bullet_Casing_Small .set(addItem(10896, "Bullet Casing Mold (Small)"       , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.TELUM, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Press_Bullet_Casing_Medium.set(addItem(10897, "Bullet Casing Mold (Medium)"      , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.TELUM, 3))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Press_Bullet_Casing_Large .set(addItem(10898, "Bullet Casing Mold (Large)"       , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.TELUM, 4))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		...
		IL.Shape_Slicer_Empty              .set(addItem(10900, "Slicer Blade Frame"               , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		
		CR.shaped(IL.Shape_Slicer_Empty.get(1), CR.DEF_REV, " R ", "RhR", " R ", 'R', OP.stick.dat(MT.StainlessSteel));
		
		IL.Shape_Slicer_Flat               .set(addItem(10901, "Slicer Blades (Flat)"             , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1), TC.stack(TC.TELUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Slicer_Grid               .set(addItem(10902, "Slicer Blades (Grid)"             , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1), TC.stack(TC.TELUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Slicer_Eigths             .set(addItem(10903, "Slicer Blades (Eigths)"           , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1), TC.stack(TC.TELUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Slicer_Eigths_Hollow      .set(addItem(10904, "Slicer Blades (Hollow Eigths)"    , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1), TC.stack(TC.TELUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Slicer_Split              .set(addItem(10905, "Slicer Blades (Split)"            , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1), TC.stack(TC.TELUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Slicer_Quarters           .set(addItem(10906, "Slicer Blades (Quarters)"         , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1), TC.stack(TC.TELUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		IL.Shape_Slicer_Quarters_Hollow    .set(addItem(10907, "Slicer Blades (Hollow Quarters)"  , "", TC.stack(TC.FABRICO, 2), TC.stack(TC.METALLUM, 1), TC.stack(TC.TELUM, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)45);
		...
		IL.Comp_Laser_Gas_Empty            .set(addItem(11000, "Empty Gas Laser Emitter"          , "For Electric Lasers"                             , TC.stack(TC.LUX, 1), TC.stack(TC.VACUOS, 2)));
		...
		IL.Comp_Laser_Gas_He               .set(addItem(11001, "Helium Laser Emitter"             , "Purpose: Weak Optical Appliances"                , TC.stack(TC.LUX, 2), TC.stack(TC.AER, 1), OM.data(IL.Comp_Laser_Gas_Empty.get(1))));
		IL.Comp_Laser_Gas_Ne               .set(addItem(11002, "Neon Laser Emitter"               , "Purpose: Weak Optical Appliances"                , TC.stack(TC.LUX, 2), TC.stack(TC.AER, 1), OM.data(IL.Comp_Laser_Gas_Empty.get(1))));
		IL.Comp_Laser_Gas_Ar               .set(addItem(11003, "Argon Laser Emitter"              , "Purpose: Strong Optical Appliances"              , TC.stack(TC.LUX, 2), TC.stack(TC.AER, 1), OM.data(IL.Comp_Laser_Gas_Empty.get(1))));
		IL.Comp_Laser_Gas_Kr               .set(addItem(11004, "Krypton Laser Emitter"            , "Purpose: Science"                                , TC.stack(TC.LUX, 2), TC.stack(TC.AER, 1), OM.data(IL.Comp_Laser_Gas_Empty.get(1))));
		IL.Comp_Laser_Gas_Xe               .set(addItem(11005, "Xenon Laser Emitter"              , "Purpose: Science"                                , TC.stack(TC.LUX, 2), TC.stack(TC.AER, 1), OM.data(IL.Comp_Laser_Gas_Empty.get(1))));
		IL.Comp_Laser_Gas_HeNe             .set(addItem(11006, "Helium-Neon Laser Emitter"        , "Purpose: Weak Optical Appliances"                , TC.stack(TC.LUX, 2), TC.stack(TC.AER, 1), OM.data(IL.Comp_Laser_Gas_Empty.get(1))));
		IL.Comp_Laser_Gas_CO               .set(addItem(11007, "Carbon Monoxide Laser Emitter"    , "Purpose: Weak Material Processing"               , TC.stack(TC.LUX, 2), TC.stack(TC.AER, 1), OM.data(IL.Comp_Laser_Gas_Empty.get(1))));
		IL.Comp_Laser_Gas_CO2              .set(addItem(11008, "Carbon Dioxide Laser Emitter"     , "Purpose: Strong Material Processing"             , TC.stack(TC.LUX, 2), TC.stack(TC.AER, 1), OM.data(IL.Comp_Laser_Gas_Empty.get(1))));
		...
		IL.Battery_Lead_Acid_Cell_Empty    .set(addItem(20000, "Lead-Acid Cell (Empty)"           , "Battery Part (doesn't require Canning Machine!)" , ItemsGT.NEI_DONT_SHOW_FLUIDS, TC.stack(TC.METALLUM, 2), TC.stack(TC.VACUOS , 2), new OreDictItemData(MT.Pb, U, MT.BatteryAlloy, U)));
		IL.Battery_Lead_Acid_Cell_Filled   .set(addItem(20001, "Lead-Acid Cell (Filled)"          , "Battery Part"                                    , ItemsGT.NEI_DONT_SHOW_FLUIDS, TC.stack(TC.ELECTRUM, 2), TC.stack(TC.VENEMUM, 2), new OreDictItemData(MT.Pb, U, MT.BatteryAlloy, U, MT.H2SO4, 2*U), new FluidContainerData(MT.H2SO4.liquid(2*U, T), next(), last(), F)));
		...
		IL.Battery_LiCoO2_Cell_Empty       .set(addItem(20006, "Lithium-Cobalt Cell (Empty)"      , "Battery Part (doesn't require Canning Machine!)" , ItemsGT.NEI_DONT_SHOW_FLUIDS, TC.stack(TC.METALLUM, 2), TC.stack(TC.VACUOS , 2), new OreDictItemData(OM.stack(MT.BatteryAlloy, U), OM.stack(MT.Co, U2), OM.stack(MT.Cr, U), OM.stack(ANY.Plastic, U2), OM.stack(MT.Graphite, U2), OM.stack(MT.LiClO4, U*2))));
		IL.Battery_LiCoO2_Cell_Filled      .set(addItem(20007, "Lithium-Cobalt Cell (Filled)"     , "Battery Part"                                    , ItemsGT.NEI_DONT_SHOW_FLUIDS, TC.stack(TC.ELECTRUM, 2), TC.stack(TC.VENEMUM, 2), new OreDictItemData(OM.stack(MT.BatteryAlloy, U), OM.stack(MT.Co, U2), OM.stack(MT.Cr, U), OM.stack(ANY.Plastic, U2), OM.stack(MT.Graphite, U2), OM.stack(MT.LiClO4, U*2), OM.stack(MT.HCl, U*2)), new FluidContainerData(MT.HCl.gas(U*2, T), next(), last(), F)));
		...
		IL.Battery_LiMn_Cell_Empty         .set(addItem(20008, "Lithium-Manganese Cell (Empty)"   , "Battery Part (doesn't require Canning Machine!)" , ItemsGT.NEI_DONT_SHOW_FLUIDS, TC.stack(TC.METALLUM, 2), TC.stack(TC.VACUOS , 2), new OreDictItemData(OM.stack(MT.BatteryAlloy, U), OM.stack(MT.Mn, U2), OM.stack(MT.Cr, U), OM.stack(ANY.Plastic, U2), OM.stack(MT.Graphite, U2), OM.stack(MT.LiClO4, U*2))));
		IL.Battery_LiMn_Cell_Filled        .set(addItem(20009, "Lithium-Manganese Cell (Filled)"  , "Battery Part"                                    , ItemsGT.NEI_DONT_SHOW_FLUIDS, TC.stack(TC.ELECTRUM, 2), TC.stack(TC.VENEMUM, 2), new OreDictItemData(OM.stack(MT.BatteryAlloy, U), OM.stack(MT.Mn, U2), OM.stack(MT.Cr, U), OM.stack(ANY.Plastic, U2), OM.stack(MT.Graphite, U2), OM.stack(MT.LiClO4, U*2), OM.stack(MT.HF, U*2)), new FluidContainerData(MT.HF.gas(U*2, T), next(), last(), F)));
		...
		IL.Electrode_FR_Copper              .set(addItem(29987, "Electrode (Copper)"              , "Needs Glass Tube"                                , new OreDictItemData(ANY.Cu            , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Tin                 .set(addItem(29988, "Electrode (Tin)"                 , "Needs Glass Tube"                                , new OreDictItemData(MT.Sn             , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Bronze              .set(addItem(29989, "Electrode (Bronze)"              , "Needs Glass Tube"                                , new OreDictItemData(MT.Bronze         , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Iron                .set(addItem(29990, "Electrode (Iron)"                , "Needs Glass Tube"                                , new OreDictItemData(ANY.Fe            , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Gold                .set(addItem(29991, "Electrode (Gold)"                , "Needs Glass Tube"                                , new OreDictItemData(MT.Au             , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Diamond             .set(addItem(29992, "Electrode (Diamond)"             , "Needs Glass Tube"                                , new OreDictItemData(ANY.Diamond       , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Obsidian            .set(addItem(29993, "Electrode (Obsidian)"            , "Needs Glass Tube"                                , new OreDictItemData(MT.Obsidian       , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Blaze               .set(addItem(29994, "Electrode (Blaze)"               , "Needs Glass Tube"                                , new OreDictItemData(MT.Blaze          , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Rubber              .set(addItem(29995, "Electrode (Rubber)"              , "Needs Glass Tube"                                , new OreDictItemData(ANY.Rubber        , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Emerald             .set(addItem(29996, "Electrode (Emerald)"             , "Needs Glass Tube"                                , new OreDictItemData(ANY.Emerald       , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Apatite             .set(addItem(29997, "Electrode (Apatite)"             , "Needs Glass Tube"                                , new OreDictItemData(MT.Apatite        , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Lapis               .set(addItem(29998, "Electrode (Lapis)"               , "Needs Glass Tube"                                , new OreDictItemData(MT.Lapis          , 5*U4, MT.Redstone, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Electrode_FR_Ender               .set(addItem(29999, "Electrode (Ender)"               , "Needs Glass Tube"                                , new OreDictItemData(MT.Endstone       , 5*U4, MT.EnderEye, U2), TC.stack(TC.ELECTRUM, 1), MD.FR.mLoaded ? null : TD.Creative.HIDDEN));
		...
		IL.Circuit_Plate_Gold              .set(addItem(30004, "Circuit Plate (Gold)"             , "Needs Circuit Parts"                             , new OreDictItemData(MT.Au, U, ANY.SiO2, U, ANY.Plastic, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.LUCRUM, 1), "oc:materialCircuitBoardPrinted"));
		IL.Circuit_Wire_Platinum           .set(addItem(30005, "Circuit Wiring (Platinum)"        , "Needs to be placed on an empty Circuit Plate"    , new OreDictItemData(MT.Pt, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.NEBRISUM, 1)));
		IL.Circuit_Plate_Platinum          .set(addItem(30006, "Circuit Plate (Platinum)"         , "Needs Circuit Parts"                             , new OreDictItemData(MT.Pt, U, ANY.SiO2, U, ANY.Plastic, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.NEBRISUM, 1)));
		
		IL.Circuit_Wire_Magic              .set(addItem(30011, "Circuit Wiring (Magic)"           , "Needs to be placed on an empty Circuit Plate"    , TC.stack(TC.FABRICO, 1), TC.stack(TC.PRAECANTIO, 1)));
		IL.Circuit_Plate_Magic             .set(addItem(30012, "Circuit Plate (Magic)"            , "Needs Circuit Parts"                             , new OreDictItemData(ANY.SiO2, U, ANY.Plastic, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.PRAECANTIO, 1)));
		IL.Circuit_Wire_Enderium           .set(addItem(30013, "Circuit Wiring (Enderium)"        , "Needs to be placed on an empty Circuit Plate"    , new OreDictItemData(MT.Enderium, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.ALIENIS, 1)));
		...
		IL.Circuit_Part_Basic              .set(addItem(30101, "Circuit Part (Basic)"             , "Needs to be placed on a Copper Circuit Plate"    , TC.stack(TC.COGNITIO, 1)));
		IL.Circuit_Part_Good               .set(addItem(30102, "Circuit Part (Good)"              , "Needs to be placed on a Copper Circuit Plate"    , TC.stack(TC.COGNITIO, 1)));
		IL.Circuit_Part_Advanced           .set(addItem(30103, "Circuit Part (Advanced)"          , "Needs to be placed on a Gold Circuit Plate"      , TC.stack(TC.COGNITIO, 1)));
		IL.Circuit_Part_Elite              .set(addItem(30104, "Circuit Part (Elite)"             , "Needs to be placed on a Gold Circuit Plate"      , TC.stack(TC.COGNITIO, 1)));
		IL.Circuit_Part_Master             .set(addItem(30105, "Circuit Part (Master)"            , "Needs to be placed on a Platinum Circuit Plate"  , TC.stack(TC.COGNITIO, 1)));
		IL.Circuit_Part_Ultimate           .set(addItem(30106, "Circuit Part (Ultimate)"          , "Needs to be placed on a Platinum Circuit Plate"  , TC.stack(TC.COGNITIO, 1)));
		
		IL.Circuit_Part_Magic              .set(addItem(30111, "Circuit Part (Magic)"             , "Needs to be placed on a Magical Circuit Plate"   , TC.stack(TC.PRAECANTIO, 1)));
		IL.Circuit_Part_Enderium           .set(addItem(30113, "Circuit Part (Enderium)"          , "Needs to be placed on an Enderium Circuit Plate" , TC.stack(TC.ALIENIS, 1)));
		IL.Circuit_Part_Signalum           .set(addItem(30115, "Circuit Part (Signalum)"          , "Needs to be placed on a Signalum Circuit Plate"  , TC.stack(TC.POTENTIA, 1)));
		
		IL.Circuit_Part_EnderPearl         .set(addItem(30198, "Circuit Part (Enderpearl)"        , "Needs to be placed on a Circuit Plate"           , TC.stack(TC.ALIENIS, 1)));
		IL.Circuit_Part_EnderEye           .set(addItem(30199, "Circuit Part (Ender Eye)"         , "Needs to be placed on a Circuit Plate"           , TC.stack(TC.ALIENIS, 1)));
		...
		IL.Circuit_Board_Basic             .set(addItem(30201, "Circuit Board (Basic)"            , "Needs to be soldered properly"                   , TC.stack(TC.FABRICO, 1)));
		IL.Circuit_Board_Good              .set(addItem(30202, "Circuit Board (Good)"             , "Needs to be soldered properly"                   , TC.stack(TC.FABRICO, 1)));
		IL.Circuit_Board_Advanced          .set(addItem(30203, "Circuit Board (Advanced)"         , "Needs to be soldered properly"                   , TC.stack(TC.FABRICO, 1)));
		IL.Circuit_Board_Elite             .set(addItem(30204, "Circuit Board (Elite)"            , "Needs to be soldered properly"                   , TC.stack(TC.FABRICO, 1)));
		IL.Circuit_Board_Master            .set(addItem(30205, "Circuit Board (Master)"           , "Needs to be soldered properly"                   , TC.stack(TC.FABRICO, 1)));
		IL.Circuit_Board_Ultimate          .set(addItem(30206, "Circuit Board (Ultimate)"         , "Needs to be soldered properly"                   , TC.stack(TC.FABRICO, 1)));
		
		IL.Circuit_Board_Magic             .set(addItem(30211, "Circuit Board (Magic)"            , "Needs to be soldered properly"                   , TC.stack(TC.FABRICO, 1)));
		IL.Circuit_Board_Enderium          .set(addItem(30213, "Circuit Board (Enderium)"         , "Needs to be soldered properly"                   , TC.stack(TC.FABRICO, 1)));
		IL.Circuit_Board_Signalum          .set(addItem(30215, "Circuit Board (Signalum)"         , "Needs to be soldered properly"                   , TC.stack(TC.FABRICO, 1)));
		
		IL.Circuit_Board_BC_Redstone       .set(addItem(30280, "Circuit Board (BC Redstone)"      , "Needs to be soldered properly"                   , TC.stack(TC.FABRICO, 1), MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U))));
		IL.Circuit_Board_BC_Iron           .set(addItem(30281, "Circuit Board (BC Iron)"          , "Needs to be soldered properly"                   , TC.stack(TC.FABRICO, 1), MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U), OM.stack(ANY.Fe, 4*U))));
		IL.Circuit_Board_BC_Gold           .set(addItem(30282, "Circuit Board (BC Gold)"          , "Needs to be soldered properly"                   , TC.stack(TC.FABRICO, 1), MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U), OM.stack(MT.Au, 4*U))));
		IL.Circuit_Board_BC_Diamond        .set(addItem(30283, "Circuit Board (BC Diamond)"       , "Needs to be soldered properly"                   , TC.stack(TC.FABRICO, 1), MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U), OM.stack(ANY.Diamond, 4*U))));
		IL.Circuit_Board_BC_Ender          .set(addItem(30284, "Circuit Board (BC Ender)"         , "Needs to be soldered properly"                   , TC.stack(TC.FABRICO, 1), MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U), OM.stack(MT.EnderPearl, 4*U))));
		IL.Circuit_Board_BC_Quartz         .set(addItem(30285, "Circuit Board (BC Quartz)"        , "Needs to be soldered properly"                   , TC.stack(TC.FABRICO, 1), MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,5*U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U))));
		IL.Circuit_Board_BC_Comparator     .set(addItem(30286, "Circuit Board (BC Comparator)"    , "Needs to be soldered properly"                   , TC.stack(TC.FABRICO, 1), MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone,16*U))));
		IL.Circuit_Board_BC_Emerald        .set(addItem(30287, "Circuit Board (BC Emerald)"       , "Needs to be soldered properly"                   , TC.stack(TC.FABRICO, 1), MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U), OM.stack(ANY.Emerald, 4*U))));
		
		IL.Circuit_Board_HSLA_Circuit      .set(addItem(30298, "Circuit Board (HSLA Circuit)"     , "Needs to be soldered properly"                   , TC.stack(TC.FABRICO, 1), MD.RoC.mLoaded ? null : TD.Creative.HIDDEN));
		IL.Circuit_Board_Power_Module      .set(addItem(30299, "Circuit Board (Power Module)"     , "Needs to be soldered properly"                   , TC.stack(TC.FABRICO, 1), MD.RoC.mLoaded ? null : TD.Creative.HIDDEN));
		...
		IL.Circuit_Basic                   .set(addItem(30301, "Circuit T1 (Basic)"               , "Computes simple Data very slowly"                , MT.DATA.CIRCUITS[1], OD_CIRCUITS[1], TC.stack(TC.COGNITIO, 2)));
		IL.Circuit_Good                    .set(addItem(30302, "Circuit T2 (Good)"                , "Computes simple Data slowly"                     , MT.DATA.CIRCUITS[2], OD_CIRCUITS[2], TC.stack(TC.COGNITIO, 3)));
		IL.Circuit_Advanced                .set(addItem(30303, "Circuit T3 (Advanced)"            , "Computes simple Data with average speed"         , MT.DATA.CIRCUITS[3], OD_CIRCUITS[3], TC.stack(TC.COGNITIO, 4)));
		IL.Circuit_Elite                   .set(addItem(30304, "Circuit T4 (Elite)"               , "Computes simple Data with improved speed"        , MT.DATA.CIRCUITS[4], OD_CIRCUITS[4], TC.stack(TC.COGNITIO, 5)));
		IL.Circuit_Master                  .set(addItem(30305, "Circuit T5 (Master)"              , "Computes simple Data efficiently"                , MT.DATA.CIRCUITS[5], OD_CIRCUITS[5], TC.stack(TC.COGNITIO, 6)));
		IL.Circuit_Ultimate                .set(addItem(30306, "Circuit T6 (Ultimate)"            , "Computes simple Data very efficiently"           , MT.DATA.CIRCUITS[6], OD_CIRCUITS[6], TC.stack(TC.COGNITIO, 7)));
		...
		IL.Circuit_BC_Redstone             .set(addItem(30380, "Circuit (BC Redstone)"            , "Made for tweaking Recipes"                       , MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, TC.stack(TC.COGNITIO, 1), TC.stack(TC.POTENTIA, 3), TC.stack(TC.MACHINA, 1)     , new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U))));
		IL.Circuit_BC_Iron                 .set(addItem(30381, "Circuit (BC Iron)"                , "Made for tweaking Recipes"                       , MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, TC.stack(TC.COGNITIO, 2), TC.stack(TC.METALLUM, 4)                              , new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U), OM.stack(ANY.Fe, 4*U))));
		IL.Circuit_BC_Gold                 .set(addItem(30382, "Circuit (BC Gold)"                , "Made for tweaking Recipes"                       , MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, TC.stack(TC.COGNITIO, 3), TC.stack(TC.LUCRUM, 2), TC.stack(TC.METALLUM, 2)      , new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U), OM.stack(MT.Au, 4*U))));
		IL.Circuit_BC_Diamond              .set(addItem(30383, "Circuit (BC Diamond)"             , "Made for tweaking Recipes"                       , MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, TC.stack(TC.COGNITIO, 4), TC.stack(TC.LUCRUM, 2), TC.stack(TC.VITREUS, 2)       , new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U), OM.stack(ANY.Diamond, 4*U))));
		IL.Circuit_BC_Ender                .set(addItem(30384, "Circuit (BC Ender)"               , "Made for tweaking Recipes"                       , MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, TC.stack(TC.COGNITIO, 3), TC.stack(TC.ALIENIS, 4)                               , new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U), OM.stack(MT.EnderPearl, 4*U))));
		IL.Circuit_BC_Quartz               .set(addItem(30385, "Circuit (BC Quartz)"              , "Made for tweaking Recipes"                       , MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, TC.stack(TC.COGNITIO, 2), TC.stack(TC.POTENTIA, 2), TC.stack(TC.VITREUS, 2)     , new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,5*U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U))));
		IL.Circuit_BC_Comparator           .set(addItem(30386, "Circuit (BC Comparator)"          , "Made for tweaking Recipes"                       , MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, TC.stack(TC.COGNITIO, 2), TC.stack(TC.MACHINA, 4)                               , new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone,16*U))));
		IL.Circuit_BC_Emerald              .set(addItem(30387, "Circuit (BC Emerald)"             , "Made for tweaking Recipes"                       , MD.BC_SILICON.mLoaded ? null : TD.Creative.HIDDEN, TC.stack(TC.COGNITIO, 4), TC.stack(TC.LUCRUM, 2), TC.stack(TC.VITREUS, 2)       , new OreDictItemData(OM.stack(MT.Signalum, U), OM.stack(ANY.SiO2,  U), OM.stack(ANY.Plastic, U), OM.stack(MT.Redstone, 4*U), OM.stack(ANY.Emerald, 4*U))));
		...
		IL.Circuit_Crystal_Diamond         .set(addItem(30401, "Crystal Circuit (Diamond)"        , "Logic Diamond"                                   , TC.stack(TC.COGNITIO, 3), TC.stack(TC.LUCRUM, 2), TC.stack(TC.VITREUS, 2), new OreDictItemData(OM.stack(ANY.Diamond, U))));
		IL.Circuit_Crystal_Ruby            .set(addItem(30402, "Crystal Circuit (Ruby)"           , "Control Ruby"                                    , TC.stack(TC.COGNITIO, 3), TC.stack(TC.LUCRUM, 2), TC.stack(TC.VITREUS, 2), new OreDictItemData(OM.stack(MT.Ruby, U))));
		IL.Circuit_Crystal_Emerald         .set(addItem(30403, "Crystal Circuit (Emerald)"        , "Storage Emerald"                                 , TC.stack(TC.COGNITIO, 3), TC.stack(TC.LUCRUM, 2), TC.stack(TC.VITREUS, 2), new OreDictItemData(OM.stack(ANY.Emerald, U))));
		IL.Circuit_Crystal_Sapphire        .set(addItem(30404, "Crystal Circuit (Sapphire)"       , "Conversion Sapphire"                             , TC.stack(TC.COGNITIO, 3), TC.stack(TC.LUCRUM, 2), TC.stack(TC.VITREUS, 2), new OreDictItemData(OM.stack(ANY.Sapphire, U))));
		
		IL.Processor_Crystal_Empty         .set(addItem(30500, "Crystal Processor Socket"         , "Base for Crystal Circuits"                       , TC.stack(TC.COGNITIO, 5), TC.stack(TC.VACUOS, 2)));
		IL.Processor_Crystal_Diamond       .set(addItem(30501, "Crystal Processor (Diamond)"      , "Logic Processor Circuit"                         , TC.stack(TC.COGNITIO, 5), TC.stack(TC.LUCRUM, 2), TC.stack(TC.VITREUS, 2), new OreDictItemData(MT.Pt, U, ANY.Diamond, U)));
		IL.Processor_Crystal_Ruby          .set(addItem(30502, "Crystal Processor (Ruby)"         , "Control Processor Circuit"                       , TC.stack(TC.COGNITIO, 5), TC.stack(TC.LUCRUM, 2), TC.stack(TC.VITREUS, 2), new OreDictItemData(MT.Pt, U, MT.Ruby, U)));
		IL.Processor_Crystal_Emerald       .set(addItem(30503, "Crystal Processor (Emerald)"      , "Storage Processor Circuit"                       , TC.stack(TC.COGNITIO, 5), TC.stack(TC.LUCRUM, 2), TC.stack(TC.VITREUS, 2), new OreDictItemData(MT.Pt, U, ANY.Emerald, U)));
		IL.Processor_Crystal_Sapphire      .set(addItem(30504, "Crystal Processor (Sapphire)"     , "Conversion Processor Circuit"                    , TC.stack(TC.COGNITIO, 5), TC.stack(TC.LUCRUM, 2), TC.stack(TC.VITREUS, 2), new OreDictItemData(MT.Pt, U, ANY.Sapphire, U)));
		...
		IL.USB_Stick_1                     .set(addItem(32001, "USB 1.0 Stick"                    , "Stores Data"                                     , OD_USB_STICKS[1], Behavior_DataStorage.INSTANCE, TC.stack(TC.COGNITIO, 3), TC.stack(TC.ELECTRUM, 1)                       )); BooksGT.BOOK_REGISTER.put(last(), (byte)54);
		IL.USB_Stick_2                     .set(addItem(32002, "USB 2.0 Stick"                    , "Stores Data"                                     , OD_USB_STICKS[2], Behavior_DataStorage.INSTANCE, TC.stack(TC.COGNITIO, 4), TC.stack(TC.ELECTRUM, 2), TC.stack(TC.MOTUS, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)54);
		IL.USB_Stick_3                     .set(addItem(32003, "USB 3.0 Stick"                    , "Stores Data"                                     , OD_USB_STICKS[3], Behavior_DataStorage.INSTANCE, TC.stack(TC.COGNITIO, 5), TC.stack(TC.ELECTRUM, 3), TC.stack(TC.MOTUS, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)54);
		IL.USB_Stick_4                     .set(addItem(32004, "USB 4.0 Stick"                    , "Stores Data"                                     , OD_USB_STICKS[4], Behavior_DataStorage.INSTANCE, TC.stack(TC.COGNITIO, 6), TC.stack(TC.ELECTRUM, 4), TC.stack(TC.MOTUS, 3))); BooksGT.BOOK_REGISTER.put(last(), (byte)54);
		...
		IL.USB_Cable_1                     .set(addItem(32011, "USB 1.0 Cable"                    , "Replaces USB Sticks when connected to USB Ports" , OD_USB_CABLES[1], TC.stack(TC.COGNITIO, 2), TC.stack(TC.ELECTRUM, 1)                      ));
		IL.USB_Cable_2                     .set(addItem(32012, "USB 2.0 Cable"                    , "Replaces USB Sticks when connected to USB Ports" , OD_USB_CABLES[2], TC.stack(TC.COGNITIO, 3), TC.stack(TC.ELECTRUM, 2), TC.stack(TC.ITER, 1)));
		IL.USB_Cable_3                     .set(addItem(32013, "USB 3.0 Cable"                    , "Replaces USB Sticks when connected to USB Ports" , OD_USB_CABLES[3], TC.stack(TC.COGNITIO, 4), TC.stack(TC.ELECTRUM, 3), TC.stack(TC.ITER, 2)));
		IL.USB_Cable_4                     .set(addItem(32014, "USB 4.0 Cable"                    , "Replaces USB Sticks when connected to USB Ports" , OD_USB_CABLES[4], TC.stack(TC.COGNITIO, 5), TC.stack(TC.ELECTRUM, 4), TC.stack(TC.ITER, 3)));
		...
		IL.USB_HDD_1                       .set(addItem(32021, "USB 1.0 HDD"                      , "Stores up to 16 Files at once"                   , OD_USB_DRIVES[1], Behavior_DataStorage16.INSTANCE, TC.stack(TC.COGNITIO, 3), TC.stack(TC.ELECTRUM, 2), TC.stack(TC.MOTUS, 1))); BooksGT.BOOK_REGISTER.put(last(), (byte)54);
		IL.USB_HDD_2                       .set(addItem(32022, "USB 2.0 HDD"                      , "Stores up to 16 Files at once"                   , OD_USB_DRIVES[2], Behavior_DataStorage16.INSTANCE, TC.stack(TC.COGNITIO, 4), TC.stack(TC.ELECTRUM, 3), TC.stack(TC.MOTUS, 2))); BooksGT.BOOK_REGISTER.put(last(), (byte)54);
		IL.USB_HDD_3                       .set(addItem(32023, "USB 3.0 HDD"                      , "Stores up to 16 Files at once"                   , OD_USB_DRIVES[3], Behavior_DataStorage16.INSTANCE, TC.stack(TC.COGNITIO, 5), TC.stack(TC.ELECTRUM, 4), TC.stack(TC.MOTUS, 3))); BooksGT.BOOK_REGISTER.put(last(), (byte)54);
		IL.USB_HDD_4                       .set(addItem(32024, "USB 4.0 HDD"                      , "Stores up to 16 Files at once"                   , OD_USB_DRIVES[4], Behavior_DataStorage16.INSTANCE, TC.stack(TC.COGNITIO, 6), TC.stack(TC.ELECTRUM, 5), TC.stack(TC.MOTUS, 4))); BooksGT.BOOK_REGISTER.put(last(), (byte)54);
