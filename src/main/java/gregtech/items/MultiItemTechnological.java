...
public class MultiItemTechnological extends MultiItemRandom {
	...
	public void addItems() {
		...
		IL.Cover_Warning                         .set(addItem(tLastID =  1028, "Warning Cover"                         , "Warns about certain Types of Danger"             , new CoverTextureMulti(T, T, "machines/covers/warning/", 19), TC.stack(TC.MACHINA, 1), TC.stack(TC.SENSUS, 1), TC.stack(TC.VINCULUM, 1)));
