...
public class MultiItemTechnological extends MultiItemRandom {
	...
	public void addItems() {
		...
		CR.shaped(IL.Cover_Logistics_Fluid_Export   .get(1), CR.DEF_REV, "  w", "WQW", "CPC", 'Q', IL.Cover_Blank, 'P', IL.Processor_Crystal_Emerald, 'C', OD_CIRCUITS[4], 'W', OP.wireGt01.dat(MT.Os));
		CR.shaped(IL.Cover_Logistics_Fluid_Import   .get(1), CR.DEF_REV, " w ", "WQW", "CPC", 'Q', IL.Cover_Blank, 'P', IL.Processor_Crystal_Emerald, 'C', OD_CIRCUITS[4], 'W', OP.wireGt01.dat(MT.Os));
		CR.shaped(IL.Cover_Logistics_Fluid_Storage  .get(1), CR.DEF_REV, "w  ", "WQW", "CPC", 'Q', IL.Cover_Blank, 'P', IL.Processor_Crystal_Emerald, 'C', OD_CIRCUITS[4], 'W', OP.wireGt01.dat(MT.Os));
		CR.shaped(IL.Cover_Logistics_Item_Export    .get(1), CR.DEF_REV, "  r", "WQW", "CPC", 'Q', IL.Cover_Blank, 'P', IL.Processor_Crystal_Emerald, 'C', OD_CIRCUITS[4], 'W', OP.wireGt01.dat(MT.Os));
		CR.shaped(IL.Cover_Logistics_Item_Import    .get(1), CR.DEF_REV, " r ", "WQW", "CPC", 'Q', IL.Cover_Blank, 'P', IL.Processor_Crystal_Emerald, 'C', OD_CIRCUITS[4], 'W', OP.wireGt01.dat(MT.Os));
		CR.shaped(IL.Cover_Logistics_Item_Storage   .get(1), CR.DEF_REV, "r  ", "WQW", "CPC", 'Q', IL.Cover_Blank, 'P', IL.Processor_Crystal_Emerald, 'C', OD_CIRCUITS[4], 'W', OP.wireGt01.dat(MT.Os));
		CR.shaped(IL.Cover_Logistics_Generic_Export .get(1), CR.DEF_REV, "  d", "WQW", "CPC", 'Q', IL.Cover_Blank, 'P', IL.Processor_Crystal_Emerald, 'C', OD_CIRCUITS[4], 'W', OP.wireGt01.dat(MT.Os));
		CR.shaped(IL.Cover_Logistics_Generic_Import .get(1), CR.DEF_REV, " d ", "WQW", "CPC", 'Q', IL.Cover_Blank, 'P', IL.Processor_Crystal_Emerald, 'C', OD_CIRCUITS[4], 'W', OP.wireGt01.dat(MT.Os));
		CR.shaped(IL.Cover_Logistics_Generic_Storage.get(1), CR.DEF_REV, "d  ", "WQW", "CPC", 'Q', IL.Cover_Blank, 'P', IL.Processor_Crystal_Emerald, 'C', OD_CIRCUITS[4], 'W', OP.wireGt01.dat(MT.Os));
		CR.shaped(IL.Cover_Logistics_Dump           .get(1), CR.DEF_REV, "   ", "WQW", "CPC", 'Q', IL.Cover_Blank, 'P', IL.Processor_Crystal_Emerald, 'C', OD_CIRCUITS[4], 'W', OP.wireGt01.dat(MT.Os));
