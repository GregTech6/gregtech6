...
public class BlockPath extends BlockBaseMeta implements IBlockOnWalkOver, IRenderedBlock {
	...
	@Override @SuppressWarnings({"unchecked"}) public void addCollisionBoxesToList(World aWorld, int aX, int aY, int aZ, AxisAlignedBB aAABB, List aList, Entity aEntity) {aList.add(AxisAlignedBB.getBoundingBox(aX, aY, aZ, aX+1, aY+0.5, aZ+1)); if (!isHalfBlock(aWorld, aX, aY, aZ)) aList.add(AxisAlignedBB.getBoundingBox(aX, aY, aZ, aX+1, aY+1, aZ+1));}
