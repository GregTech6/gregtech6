...
public class MultiTileEntityGeneratorBrick extends MultiTileEntityGeneratorSolid {
	...
	public static IIconContainer[] sColoreds = new IIconContainer[] {
		...
		new Textures.BlockIcons.CustomIcon("machines/generators/burning_brick/overlay_active_glowing/bottom"),
		new Textures.BlockIcons.CustomIcon("machines/generators/burning_brick/overlay_active_glowing/top"),
		new Textures.BlockIcons.CustomIcon("machines/generators/burning_brick/overlay_active_glowing/left"),
		new Textures.BlockIcons.CustomIcon("machines/generators/burning_brick/overlay_active_glowing/front"),
		new Textures.BlockIcons.CustomIcon("machines/generators/burning_brick/overlay_active_glowing/right"),
		new Textures.BlockIcons.CustomIcon("machines/generators/burning_brick/overlay_active_glowing/back")
	};
