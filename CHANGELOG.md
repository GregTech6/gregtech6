...
[CHANGED] Gem tipped Pickaxe Heads can be made with Iron too now, also you can use pre-sharpened Pickaxe Heads too. Also they break into empty Toolheads now, which means I need to halve their Durability again, so they dont outclass Full-Gem Pickaxes.
