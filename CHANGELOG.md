...
[CHANGED] Scythes with the Auto Collect Modifier (Magnetic Material) should now properly rightclick harvest IC2 and Pams Crops. Unless Hunger Overhaul is installed and overrides the Scythe to make less Sense.
