...
[ADDED] Bentonite Clay and Palygorskite Clay (say that 3 times fast), which are Yellow and Blue Clay. The only reason I did this is, because I noticed PFAA added those, and they were dormant in my Ore Materials Section (I did not think of them as Clays), so I gave them Life! Please take note that I changed the Electrolyzation Output of Clay, and that Vanilla Clay does no longer give Lithium. Only Brown Clay does.
